package
{
   ...
   public class class_390 extends class_24
   {
      ...
      public function class_390(param1:int, param2:int, param3:int = 0)
      {
         ...
         this.var_682 = class_73.method_2108(class_183.var_7129);
         super();
         ...
         if(!_loc4_)
         {
            ...
            _loc4_.graphics.drawRect(-class_183.var_7127,-class_73.method_2108(class_183.var_7127),class_162.var_6351,class_73.method_2108(class_162.var_6351));
         ...
         var _loc5_:int = class_176.method_2643(param1)[class_73.method_2108(class_183.var_7129)];
         if(param3 != class_73.method_2108(class_183.var_7129) || _loc5_ == class_73.method_2108(class_121.var_5494))
         {
         ...
         if(class_73.method_2108(class_33.var_3679) > _loc6_)
         {
            _loc4_.width *= _loc6_;
            _loc4_.height *= _loc6_;
         }
         graphics.beginFill(class_183.var_7129,class_73.method_2116(class_4.var_3040));
         graphics.drawRoundRect(class_183.var_7129,class_73.method_2108(class_183.var_7129),class_390.name_38,class_390.name_58,class_73.method_2108(class_146.var_6117));
         graphics.endFill();
      ...
      public static function method_2922(param1:int, param2:int, param3:Boolean, param4:int = 0) : class_390
      {
         ...
         if(param3 && param2 == class_73.method_2108(class_183.var_7129))
         {
      ...
      public function method_1265(param1:int) : void
      {
         ...
         if(this.var_1727 <= class_73.method_2108(class_183.var_7129))
         {
