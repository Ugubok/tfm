package
{
   ...
   public class class_37 extends Sprite
   {
      ...
      public function class_37()
      {
         ...
         x = class_107.var_4998;
         y = class_89.var_4432;
         if(class_1.var_2884.var_127)
         {
            this.var_381 = new class_24(class_121.var_5493,class_165.var_6506);
            this.var_381.method_216(new class_245(class_243.const_640,class_183.var_7129));
            ...
            _loc2_.push(class_288.const_709,class_288.const_710,class_288.const_711,class_288.const_713,new class_288(-class_33.var_3679,null,class_62.var_4095));
            ...
            while(_loc3_ < _loc2_.length)
            {
               ...
               _loc4_.width = class_121.var_5494;
            ...
            this.var_379 = new class_88(class_183.var_7129,class_183.var_7129,class_26.method_1668(class_16.var_3404),this.method_301,null,class_16.var_3439);
            this.var_379.x = class_146.var_6117;
            this.var_379.y = class_183.var_7127;
         }
         this.var_380 = new Sprite();
         this.var_380.x = class_117.var_5287;
         if(class_1.const_43)
         {
         ...
         var _loc1_:Array = new Array(class_26.method_1668(class_102.var_4789),this.method_296,class_183.var_7129,class_26.method_1668(class_162.var_6297),this.method_300,class_102.var_4852,class_26.method_1668(class_127.var_5824),this.method_304,class_146.var_6117,class_26.method_1668(class_33.var_3605),this.method_292,class_146.var_6118,class_170.var_6672,this.method_307,class_162.var_6346,class_26.method_1668(class_9.var_3200),this.method_95,2);
         this.method_306(_loc1_);
         this.var_386 = class_175.method_118(class_9.var_3199);
         this.var_386.x = -class_146.var_6118;
         this.var_386.y = class_146.var_6118;
         this.var_386.scaleX = class_107.var_5029;
         this.var_386.scaleY = class_107.var_5029;
         this.var_386.mouseChildren = class_99.var_4682;
         this.var_386.cacheAsBitmap = class_99.var_4681;
         addChild(this.var_386);
         this.var_386.filters = [new GlowFilter(15130581,class_33.var_3679,class_146.var_6118,class_146.var_6118,class_165.var_6534,class_33.var_3679,false)];
      ...
      public function method_295(param1:int) : void
      {
         if(!this.var_383)
         {
            this.var_383 = class_175.method_118(class_124.var_5592);
         ...
         {
            this.var_383.gotoAndStop(class_33.var_3679);
         }
         else if(class_33.var_3679 == param1)
         {
            this.var_383.gotoAndStop(class_165.var_6534);
         }
         else
         {
      ...
      public function method_299() : void
      {
         ...
         var _loc1_:Array = new Array(class_26.method_1668(class_102.var_4789),this.method_296,class_183.var_7129,class_26.method_1668(class_162.var_6297),this.method_300,class_102.var_4852,class_26.method_1668(class_127.var_5824),this.method_304,class_146.var_6117,class_26.method_1668(class_33.var_3605),this.method_292,class_146.var_6118,class_170.var_6672,this.method_307,class_162.var_6346,class_26.method_1668(class_165.var_6456),this.method_291,1);
         this.method_306(_loc1_);
      }
      ...
      {
         class_1.var_2878.method_156();
         class_1.var_2884.method_58(String.fromCharCode(class_181.var_6939) + String.fromCharCode(class_181.var_6939));
      ...
      public function method_302(param1:Boolean) : void
      {
         ...
         if(this.var_384)
         {
            ...
            _loc2_ = new Array(class_26.method_1668(class_102.var_4789),this.method_296,class_183.var_7129,class_26.method_1668(class_162.var_6297),this.method_300,class_102.var_4852,class_26.method_1668(class_62.var_4094),this.method_304,class_146.var_6117,class_26.method_1668(class_33.var_3605),this.method_292,class_146.var_6118,class_170.var_6672,this.method_307,class_162.var_6346,class_26.method_1668(class_165.var_6456),this.method_291,1);
         }
         else
         {
            _loc2_ = new Array(class_26.method_1668(class_102.var_4789),this.method_296,class_183.var_7129,class_26.method_1668(class_162.var_6297),this.method_300,class_102.var_4852,class_26.method_1668(!!param1 ? class_62.var_4094 : class_127.var_5824),this.method_304,class_146.var_6117,class_26.method_1668(class_33.var_3605),this.method_292,class_146.var_6118,class_170.var_6672,this.method_307,class_162.var_6346,class_26.method_1668(class_9.var_3200),this.method_95,2);
         }
      ...
      public function method_306(param1:Array) : void
      {
         ...
         {
            this.var_380.removeChildAt(class_183.var_7129);
         }
         var _loc2_:int = class_165.var_6534 + x + this.var_380.x + class_146.var_6118 * class_117.var_5280;
         var _loc3_:int = -class_33.var_3679;
         var _loc4_:int = class_183.var_7129;
         while(_loc4_ < param1.length)
         {
            _loc3_++;
            _loc5_ = class_175.method_118(class_4.var_3007 + param1[_loc4_ + class_165.var_6534]);
            _loc5_.x = class_117.var_5280 * _loc3_;
            _loc5_.cacheAsBitmap = class_99.var_4681;
            class_202.method_2754(_loc5_,true,true);
            if(param1[_loc4_])
            {
               class_241.method_208(_loc5_,param1[_loc4_],-class_33.var_3679,_loc2_,y + this.var_380.y + class_170.var_6720);
            }
      ...
      {
         class_1.var_2878.method_156();
         class_18.method_1884(class_92.var_4584);
      }
      ...
      public function method_308(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.var_385.scaleX = class_146.var_6103;
