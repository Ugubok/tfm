package
{
   ...
   public class class_270 extends Sprite
   {
      ...
      {
         this.var_1327 = -class_73.method_2108(class_33.var_3679);
         super();
         this.var_1323 = param1;
         this.var_1324 = class_175.method_118(class_73.method_2111(class_107.var_4875) + param1);
         x = param2;
         y = param3;
         ...
         {
            this.var_1326 = class_73.method_2108(class_183.var_7129);
         }
         if(class_33.var_3679 == param1)
         {
            this.var_1326 = class_73.method_2108(class_146.var_6118);
         }
         ...
         {
            this.var_1326 = class_73.method_2108(class_121.var_5495);
         }
         ...
         {
            this.var_1326 = class_73.method_2108(class_165.var_6534);
         }
         if(class_9.var_3266 == param1)
         {
            this.var_1326 = class_73.method_2108(class_117.var_5287);
         }
