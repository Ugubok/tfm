package
{
   ...
   public class class_649 extends Sprite
   {
      ...
      public function class_649()
      {
         ...
         _loc1_.graphics.drawRoundRect(class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),class_102.var_4850,class_89.var_4444,class_33.var_3675);
         _loc1_.graphics.endFill();
         addChild(_loc1_);
         _loc1_.filters = new Array(new BevelFilter(class_73.method_2108(class_33.var_3679),class_9.var_3240,6983586,class_33.var_3679,class_183.var_7129,class_73.method_2108(class_33.var_3679),class_73.method_2108(class_33.var_3679),class_73.method_2108(class_33.var_3679),class_73.method_2108(class_33.var_3679)));
         ...
         _loc2_.text = class_26.method_1668(class_73.method_2111(class_170.var_6583));
         _loc2_.textColor = class_54.const_280;
         _loc2_.y = class_146.var_6117;
         _loc2_.width = class_102.var_4850;
         _loc2_.height = class_73.method_2108(class_9.var_3243);
         addChild(_loc2_);
         _loc3_ = class_175.method_118(class_73.method_2111(class_9.var_3106) + class_4.var_3028);
         _loc3_.x = class_183.var_7127;
         _loc3_.y = class_121.var_5456;
         _loc3_.width = class_73.method_2108(class_162.var_6327);
         addChild(_loc3_);
         _loc4_ = new TextField();
         _loc4_.defaultTextFormat = new TextFormat(class_26.var_3500,class_73.method_2108(class_162.var_6346),class_54.const_279,null,null,null,null,null,class_73.method_2111(class_165.var_6462));
         ...
         _loc4_.text = class_26.method_1668(class_73.method_2111(class_33.var_3538));
         _loc4_.x = class_73.method_2108(class_146.var_6117);
         _loc4_.y = class_165.var_6506;
         _loc4_.width = class_73.method_2108(class_9.var_3181);
         addChild(_loc4_);
         var _loc5_:MovieClip = class_175.method_118(class_89.var_4290);
         _loc5_.x = class_146.var_6117;
         _loc5_.y = class_73.method_2108(class_170.var_6717);
         _loc5_.width = class_73.method_2108(class_9.var_3181);
         addChild(_loc5_);
         this.var_2432 = new TextField();
         this.var_2432.defaultTextFormat = new TextFormat(class_26.var_3500,class_73.method_2108(class_170.var_6720),48059);
         ...
         this.var_2432.x = class_73.method_2108(class_170.var_6720);
         this.var_2432.y = class_73.method_2108(class_165.var_6489);
         ...
         var _loc6_:class_88 = new class_88(class_183.var_7127,class_60.var_3972,class_26.method_1668(class_107.var_5045),this.method_429,null,class_73.method_2108(class_9.var_3243),class_84.var_4254);
         addChild(_loc6_);
         var _loc7_:class_88 = new class_88(class_89.var_4400,class_73.method_2108(class_60.var_3972),class_26.method_1668(class_89.var_4289),this.method_1697,null,class_9.var_3243,class_84.var_4254);
         addChild(_loc7_);
         var _loc8_:class_88 = new class_88(class_73.method_2108(class_165.var_6438),class_73.method_2108(class_60.var_3972),class_26.method_1668(class_183.var_7052),this.method_143,null,class_73.method_2108(class_9.var_3243),class_84.var_4254);
         addChild(_loc8_);
         class_649.var_7365 = new Sprite();
         var _loc9_:Sprite = new Sprite();
         _loc9_.graphics.beginFill(3294800);
         _loc9_.graphics.drawRoundRect(class_73.method_2108(class_183.var_7129),class_183.var_7129,class_102.var_4850,class_62.var_4089,class_33.var_3675);
         _loc9_.graphics.endFill();
         class_649.var_7365.addChild(_loc9_);
         _loc9_.filters = new Array(new BevelFilter(class_33.var_3679,class_9.var_3240,6983586,class_33.var_3679,class_183.var_7129,class_33.var_3679,class_73.method_2108(class_33.var_3679),class_73.method_2108(class_33.var_3679),class_33.var_3679));
         var _loc10_:TextField = new TextField();
         _loc10_.defaultTextFormat = new TextFormat(class_26.var_3500,class_73.method_2108(class_183.var_7127),class_54.const_279,null,null,null,null,null,class_181.var_6903);
         ...
         _loc10_.text = class_26.method_1668(class_73.method_2111(class_89.var_4289));
         _loc10_.textColor = class_54.const_280;
         _loc10_.y = class_146.var_6117;
         _loc10_.width = class_73.method_2108(class_102.var_4850);
         _loc10_.height = class_73.method_2108(class_9.var_3243);
         class_649.var_7365.addChild(_loc10_);
         var _loc11_:MovieClip = class_175.method_118(class_73.method_2111(class_9.var_3106) + class_73.method_2111(class_4.var_3028));
         _loc11_.x = class_183.var_7127;
         _loc11_.y = class_121.var_5456;
         _loc11_.width = class_73.method_2108(class_162.var_6327);
         class_649.var_7365.addChild(_loc11_);
         this.var_2433 = new class_30(class_73.method_2108(class_9.var_3181),class_73.method_2108(class_121.var_5466),class_73.method_2108(class_183.var_7129),false,class_183.var_7129);
         this.var_2433.x = class_146.var_6117;
         this.var_2433.y = class_73.method_2108(class_165.var_6506);
         this.var_2433.Ascenseur();
         class_649.var_7365.addChild(this.var_2433);
         var _loc12_:class_88 = new class_88(class_73.method_2108(class_146.var_6117),class_73.method_2108(class_60.var_3945),class_26.method_1668(class_60.var_3934),this.method_1698,null,class_170.var_6653,class_84.var_4254);
      ...
      public static function method_3062(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               class_649.var_7364 = class_175.method_118(class_73.method_2111(class_146.var_5972));
               class_649.var_7364.cacheAsBitmap = class_99.var_4681;
               class_649.var_7364.x = class_117.var_5287;
               class_649.var_7364.y = class_73.method_2108(class_16.var_3473);
      ...
      public static function name_6(param1:Boolean) : void
      {
         if(param1)
         {
            if(!class_649.var_2884)
            {
               ...
               class_649.var_2884.x = class_73.method_2108(class_165.var_6487);
               class_649.var_2884.y = class_73.method_2108(class_121.var_5493);
            }
      ...
      public function method_1696() : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            _loc1_.defaultTextFormat = new TextFormat(class_26.var_3500,class_73.method_2108(class_170.var_6720),class_54.const_279);
            ...
            _loc5_ = class_165.var_6521 + (class_73.method_2108(class_33.var_3679) + _loc3_) + class_165.var_6384 + this.var_2434[_loc3_][class_183.var_7129] + class_4.var_2923 + this.var_2434[_loc3_][class_73.method_2108(class_33.var_3679)];
