package
{
   ...
   public class class_341
   {
      ...
      public function class_341(param1:Sprite, param2:int = 0, param3:int = 0, param4:int = 0)
      {
         ...
         super();
         var _loc5_:int = param4 / class_165.var_6534;
         if(param2)
         {
            _loc6_ = new Rectangle(class_183.var_7129,class_183.var_7129,class_102.var_4859,class_102.var_4859);
            _loc7_ = param2;
            _loc8_ = param3;
         }
         else
         ...
         this.var_1621 = new Rectangle(class_183.var_7129,class_183.var_7129,_loc7_,_loc8_);
         ...
         this.var_159 = new BitmapData(_loc7_,_loc8_,true,class_183.var_7129);
