package
{
   ...
   public class class_906 implements class_474
   {
      ...
      public function class_906(param1:class_484)
      {
         super();
         this.name_10 = param1;
      }
      ...
      {
         return class_165.var_6534 + this.var_2668.length;
      }
      
      public function lecture(param1:ByteArray) : void
      {
         var _loc2_:int = param1.readShort();
         this.var_2668 = param1.readUTFBytes(_loc2_);
      }
