   ...
   public class class_272
   {
      ...
      public static function method_2830(param1:int, param2:int) : Boolean
      {
         ...
         else
         {
            ...
            if(param1 < -(_loc4_ - class_73.method_2108(class_107.var_5074)) / class_165.var_6534)
            {
               return false;
            }
            if(param2 < -(_loc5_ - class_60.var_3979) / class_73.method_2108(class_165.var_6534))
            {
               return false;
            }
            if(param1 > class_107.var_5074 + (-class_73.method_2108(class_107.var_5074) + _loc4_) / class_165.var_6534)
            {
               return false;
            }
            if(param2 > class_60.var_3979 + (-class_73.method_2108(class_60.var_3979) + _loc5_) / class_73.method_2108(class_165.var_6534))
            {
               return false;
            }
         }
