package
{
   ...
   public class class_225 extends class_209
   {
      ...
      {
         super();
         method_824(class_73.method_2111(class_124.var_5597),this.method_900);
         method_824(class_73.method_2111(class_62.var_3998),this.method_885);
         method_824(class_73.method_2111(class_124.var_5516),this.method_902);
         method_824(class_73.method_2111(class_33.var_3564),this.method_893);
         method_824(class_73.method_2111(class_170.var_6562),this.method_901);
         method_824(new Array(class_73.method_2111(class_107.var_4890),class_73.method_2111(class_170.var_6561)),this.method_890);
         method_824(class_107.var_4889,this.method_899);
         method_824(class_73.method_2111(class_9.var_3091),this.method_891);
         method_824(class_117.var_5131,this.method_894);
         method_824(class_73.method_2111(class_89.var_4271),this.method_889);
         method_824(class_181.var_6789,this.method_895);
         method_824(class_73.method_2111(class_16.var_3288),this.method_896);
      ...
      {
         this.method_887(class_73.method_2111(class_62.var_3998),param1,param2);
      }
      
      public function method_886(param1:class_24) : void
      {
         var _loc2_:BitmapData = new BitmapData(param1.name_5,param1.var_206,true,class_73.method_2108(class_183.var_7129));
         _loc2_.draw(param1);
      ...
      public function method_887(param1:String, param2:String = null, param3:String = null) : void
      {
         ...
         if(param2)
         {
            if(!param2.match(new RegExp(class_9.var_3092,class_124.var_5633)))
            {
               ...
               _loc5_ = param3 === null ? int(-class_73.method_2108(class_33.var_3679)) : int(parseInt(param3,!!param3.match(new RegExp(class_170.var_6563)) ? int(class_16.var_3467) : int(class_146.var_6117)));
               if(!_loc4_ && (isNaN(_loc5_) || _loc5_ < class_73.method_2108(class_183.var_7129) || _loc5_ > 16777215))
               {
                  if(!this.const_21[class_62.var_3997])
                  {
                     this.const_21[class_73.method_2111(class_62.var_3997)] = new Vector.<String>();
                  }
                  this.const_21[class_73.method_2111(class_62.var_3997)].push(param1 + class_124.var_5647 + param2);
                  ...
                  if(class_1.var_2884.var_85[param2])
                  {
                     ...
                     if(param1 == class_73.method_2111(class_62.var_3998) && _loc7_.var_947 >= class_183.var_7129)
                     {
      ...
      public function method_892(param1:int) : void
      {
         ...
         {
            method_827(this.const_21[class_62.var_3997].shift() + class_73.method_2111(class_124.var_5647) + param1);
         }
      }
      ...
      public function method_893(param1:String = null) : void
      {
         ...
         class_285.method_2848(class_73.method_2108(class_146.var_6117),param1.substr(class_183.var_7129,class_73.method_2108(class_165.var_6534)));
      }
      ...
      {
         if(class_111.var_5100 && class_1.var_2884.var_66.indexOf(class_73.method_2111(class_146.var_5959)) != -class_73.method_2108(class_33.var_3679))
         {
