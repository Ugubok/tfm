package
{
   ...
   public class class_190
   {
      ...
      {
         class_119.method_849(new KeyboardEvent(KeyboardEvent.KEY_DOWN,true,false,class_73.method_2108(class_102.var_4859),class_73.method_2108(class_102.var_4859)));
      }
      
      public static function method_2726(param1:Event) : void
      {
         class_119.method_849(new KeyboardEvent(KeyboardEvent.KEY_DOWN,true,false,class_121.var_5457,class_73.method_2108(class_121.var_5457)));
      }
      ...
      public static function method_2727() : void
      {
         ...
         class_1.var_2878.var_180.var_1066[class_73.method_2111(class_102.var_4758)] = class_16.method_1881();
         class_1.var_2878.var_180.var_1067[class_102.var_4758] = class_16.method_1881();
         class_49.var_3756 = class_33.method_1926();
         class_1.var_2884.var_19[class_73.method_2111(class_146.var_6094)] = class_165.method_2587();
         class_1.var_2884.var_19[class_73.method_2111(class_121.var_5473)] = StageScaleMode.NO_BORDER;
      }
      
      public static function method_2728(param1:Event) : void
      {
         class_119.method_848(new KeyboardEvent(KeyboardEvent.KEY_DOWN,true,false,class_73.method_2108(class_102.var_4859),class_102.var_4859));
      }
      ...
      {
         class_119.method_848(new KeyboardEvent(KeyboardEvent.KEY_DOWN,true,false,class_73.method_2108(class_121.var_5457),class_121.var_5457));
      }
      ...
      public static function method_2731() : void
      {
         ...
         {
            _loc3_ = class_73.method_2108(class_89.var_4432);
         }
         ...
         _loc4_.graphics.drawRect(class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),class_107.var_5074,class_190.var_7139);
         _loc4_.graphics.endFill();
         _loc4_.y = _loc3_;
         _loc4_.cacheAsBitmap = class_99.var_4681;
         class_115.method_388(_loc4_,class_73.method_2108(class_183.var_7129));
         _loc5_ = new Sprite();
         _loc5_.addEventListener(class_73.method_2111(class_162.var_6261),class_190.name_25);
         ...
         _loc5_.x = class_73.method_2108(class_181.var_6913);
         ...
         _loc6_.addEventListener(class_73.method_2111(class_9.var_3165),class_190.method_2726);
         _loc6_.addEventListener(class_73.method_2111(class_165.var_6434),class_190.method_2726);
         _loc6_.addChild(class_175.method_2618(class_162.var_6260));
         _loc6_.x = class_33.var_3675;
         _loc6_.y = _loc3_ + class_117.var_5287;
         class_115.method_388(_loc6_,class_73.method_2108(class_183.var_7129));
         _loc7_ = new Sprite();
         _loc7_.addEventListener(class_162.var_6261,class_190.name_20);
         _loc7_.addEventListener(class_102.var_4757,class_190.name_20);
         _loc7_.addChild(class_175.method_2618(class_73.method_2111(class_9.var_3164)));
         _loc7_.x = class_73.method_2108(class_107.var_4969);
         ...
         _loc8_.addEventListener(class_73.method_2111(class_102.var_4757),class_190.method_2728);
         _loc8_.addEventListener(class_9.var_3165,class_190.method_2725);
         _loc8_.addEventListener(class_73.method_2111(class_165.var_6434),class_190.method_2725);
         _loc8_.addChild(class_175.method_2618(class_73.method_2111(class_4.var_2974)));
         _loc8_.x = class_73.method_2108(class_62.var_4144);
         _loc8_.y = _loc3_ + class_73.method_2108(class_117.var_5287);
         ...
         _loc9_.x = class_73.method_2108(class_165.var_6487);
         _loc9_.y = _loc3_;
