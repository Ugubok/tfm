package
{
   public class class_364
   {
      ...
      public static const const_404:class_364 = new class_364("$Mot_Chamane");
      ...
      public static const const_890:class_364 = new class_364("$Soldes");
      
      public static const const_891:class_364 = new class_364("$Collector");
      
      public static const const_118:class_364 = new class_364("$Lentilles",class_34.const_118);
      
      public static const const_119:class_364 = new class_364("$Mains",class_34.const_119);
      ...
      public function class_364(param1:String, param2:int = -1)
      {
         this.var_1024 = -class_33.var_3679;
         super();
         this.var_817 = param1;
         this.var_1024 = param2;
         this.var_1670 = param2 != -class_33.var_3679;
      }
   }
}
