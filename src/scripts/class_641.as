package
{
   ...
   public class class_641 extends class_640
   {
      ...
      public function class_641()
      {
         ...
         method_1100(class_26.method_1668(class_73.method_2111(class_107.var_5045)),this.method_429);
      ...
      public static function name_6(param1:Boolean, param2:String = null) : void
      {
         if(param1)
         {
            ...
            class_641.var_2884.method_955(class_26.method_1668(class_73.method_2111(class_127.var_5761),class_73.method_2111(class_121.var_5462) + (class_641.var_2346.length <= class_73.method_2108(class_16.var_3473) ? class_641.var_2346 : class_73.method_2111(class_107.var_5071) + class_641.var_2346) + class_124.var_5627),true);
            class_641.var_2884.var_2419.method_856(TextFormatAlign.CENTER);
            class_641.var_2884.var_2419.method_941(class_26.method_1668(class_73.method_2111(class_117.var_5218)),false);
            class_641.var_2884.method_967(class_73.method_2108(class_183.var_7129),class_73.method_2108(class_33.var_3675),class_107.var_5074,class_183.var_7096);
      ...
      {
         class_641.name_6(false);
         if(var_2419.var_1226.text != class_73.method_2111(class_9.var_3268))
         {
