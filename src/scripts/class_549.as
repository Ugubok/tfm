package
{
   ...
   public class class_549
   {
      ...
      public static function method_3052(param1:DisplayObject, param2:Number, param3:Number, param4:Boolean) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc5_:Rectangle = !!param4 ? new Rectangle(class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),class_183.var_7129) : param1.getBounds(param1);
