package
{
   public class class_850 extends class_715
   {
      ...
      public function class_850(param1:class_279, param2:class_279)
      {
      ...
      {
         return new class_850(param1,param2);
      }
      ...
      override public function method_1714(param1:class_342) : void
      {
         ...
         class_948.method_3101(this.var_2772,var_2516 as class_338,_loc5_.var_742,var_2517 as class_338,_loc6_.var_742);
         var _loc9_:Array = [false,false];
         _loc7_ = class_850.const_1294;
         ...
         if(class_73.method_2108(class_183.var_7129) < this.var_2772.var_2547)
         {
            ...
            while(_loc8_ < this.var_2772.var_2547)
            {
               ...
               while(_loc13_ < this.var_2773.var_2547)
               {
                  ...
                  {
                     _loc4_ = this.var_2773.var_2546[_loc13_];
                     if(_loc12_ == _loc4_.var_1768.var_2778)
                     {
                        _loc9_[_loc13_] = class_99.var_4681;
                        _loc10_.var_2538 = _loc4_.var_2538;
                        _loc10_.var_2539 = _loc4_.var_2539;
                        _loc11_ = class_99.var_4681;
                        if(param1 != null)
                        {
                           _loc7_.position = _loc5_.method_540(_loc10_.var_2544);
                           _loc2_ = _loc5_.method_574(_loc10_.var_2544);
                           _loc3_ = _loc6_.method_574(_loc10_.var_2545);
                           ...
                           _loc7_.var_2537 = _loc10_.var_2537;
                           _loc7_.var_1768.method_1792 = _loc12_;
         ...
         while(_loc8_ < this.var_2773.var_2547)
         {
            if(!_loc9_[_loc8_])
            {
               _loc4_ = this.var_2773.var_2546[_loc8_];
