package
{
   ...
   public class class_452 extends class_24
   {
      ...
      public static const const_1100:TextFormat = new TextFormat(class_73.method_2111("Lucida Console"),84 + -72,class_54.const_279);
      ...
      public function class_452(param1:String)
      {
         ...
         this.var_401 = new class_220(class_73.method_2111(class_9.var_3268),name_5,class_73.method_2108(class_183.var_7129));
         ...
         x = (class_107.var_5074 - name_5) / class_73.method_2108(class_165.var_6534);
         y = (-var_206 + class_89.var_4432) / class_73.method_2108(class_165.var_6534);
      ...
      public function method_143() : void
      {
         if(parent)
         {
            ...
            if(this.var_817.indexOf(class_73.method_2111(class_127.var_5800)) == class_183.var_7129)
            {
