   ...
   public class class_96
   {
      ...
      public static function method_2220(param1:int = -1) : void
      {
         ...
         if(!class_96.var_4665)
         {
            ...
            class_96.var_4665.y = class_73.method_2108(class_183.var_7096);
            class_96.var_4665.filters = new Array(new GlowFilter(class_183.var_7129,class_73.method_2108(class_33.var_3679),class_73.method_2108(class_146.var_6118),class_73.method_2108(class_146.var_6118),class_146.var_6118,class_73.method_2108(class_33.var_3679)));
            class_96.var_4665.mouseChildren = class_99.var_4682;
            class_96.var_4665.mouseEnabled = class_99.var_4682;
         }
         if(class_96.const_486 && class_58.var_3803 && class_58.var_3803.var_506 && class_58.var_3803.var_506.var_455 && class_58.var_3803.var_506.var_455.charAt(class_183.var_7129) == class_73.method_2111(class_33.var_3659) || class_96.const_482)
         {
            ...
            class_96.var_4666.y = class_73.method_2108(class_121.var_5495);
            class_96.var_4665.x = class_73.method_2108(class_107.var_5074) - class_96.var_4666.width - class_117.var_5265;
      ...
      public static function method_2221(param1:int) : void
      {
         ...
         if(class_96.const_483 || class_96.const_484 || class_96.const_486)
         {
            ...
            {
               if(_loc3_.var_506.var_455 == class_73.method_2111(class_146.var_5977) && _loc3_.var_506.var_455 != class_62.var_4030)
               {
            ...
            else if(class_96.const_483)
            {
               ...
               if(!_loc4_.var_366 && _loc6_)
               {
                  ...
                  while(++_loc7_ < _loc6_)
                  {
                     ...
                     if(class_114.method_2312(_loc8_.x + class_73.method_2108(class_92.var_4647),_loc8_.y + class_92.var_4647,_loc4_.x,_loc4_.y) < class_73.method_2108(class_183.var_7127))
                     {
                        ...
                        _loc2_.method_33(class_56.const_309,_loc8_.x + class_73.method_2108(class_92.var_4647),_loc8_.y + class_92.var_4647,class_146.var_6117,class_165.var_6534,true);
            ...
            {
               if(class_58.var_3803.var_531.var_956 == class_73.method_2108(class_170.var_6619) && class_96.var_4674 && class_58.var_3803.var_532)
               {
                  ...
                  if(!class_96.var_4673)
                  {
                     ...
                     {
                        class_96.var_4672 = param1 + class_62.var_4130 + Math.random() * class_73.method_2108(class_107.var_5037);
                        _loc9_.scaleX = Math.max(class_73.method_2108(class_183.var_7129),_loc9_.scaleX - class_4.var_3035);
                        _loc9_.scaleY = _loc9_.scaleX;
                        if(_loc9_.scaleX < class_16.var_3463 && class_152.var_6142)
                        {
                           class_39.var_3745.method_313(new class_400(-class_73.method_2108(class_165.var_6534)));
                        }
                     }
                  }
                  else
                  {
                     ...
                     {
                        class_96.var_4672 = param1 + class_73.method_2108(class_62.var_4130) + Math.random() * class_73.method_2108(class_107.var_5037);
                        _loc10_ = (class_73.method_2116(class_60.var_3843) + int(Math.random() * class_73.method_2108(class_146.var_6117)) / class_73.method_2108(class_146.var_6117)) / class_146.var_6117;
                     ...
                     if(class_96.var_4674.var_742.position.var_304 != class_96.var_4671.var_304 || class_96.var_4674.var_742.position.var_305 != class_96.var_4671.var_305)
                     {
                        ...
                        for each(_loc13_ in _loc12_)
                        {
                           ...
                           if(class_73.method_2108(class_183.var_7129) != _loc14_)
                           {
                              ...
                              else
                              {
                                 ...
                                 if(_loc14_ >= class_73.method_2108(class_92.var_4647) || _loc14_ <= class_73.method_2108(class_146.var_6118))
                                 {
                                    if(_loc14_ >= class_92.var_4647)
                                    {
                                       _loc9_.rotationY = class_73.method_2108(class_183.var_7129);
                                       _loc9_.rotationX = (_loc9_.y + class_96.var_4676 / class_165.var_6534 - _loc13_.y) / (class_96.var_4676 / class_73.method_2108(class_165.var_6534)) * class_73.method_2108(class_107.var_5038);
                                    }
                                    else
                                    {
                                       _loc9_.rotationY = class_73.method_2108(class_183.var_7129);
                                       _loc9_.rotationX = (_loc13_.var_1282 - (_loc9_.y - class_96.var_4676 / class_73.method_2108(class_165.var_6534))) / (class_96.var_4676 / class_165.var_6534) * -class_73.method_2108(class_107.var_5038);
                                    }
                                 }
                                 else if(_loc14_ % class_146.var_6118 == class_33.var_3679 || _loc14_ % class_146.var_6118 == class_183.var_7129)
                                 {
                                    if(_loc14_ % class_73.method_2108(class_146.var_6118) == class_73.method_2108(class_33.var_3679))
                                    {
                                       _loc9_.rotationX = class_183.var_7129;
                                       _loc9_.rotationY = (_loc9_.x + class_96.var_4675 / class_165.var_6534 - _loc13_.x) / (class_96.var_4675 / class_165.var_6534) * -class_73.method_2108(class_89.var_4436);
                                    }
                                    else
                                    {
                                       _loc9_.rotationX = class_183.var_7129;
                                       _loc9_.rotationY = (_loc13_.var_1281 - (_loc9_.x - class_96.var_4675 / class_73.method_2108(class_165.var_6534))) / (class_96.var_4675 / class_73.method_2108(class_165.var_6534)) * class_73.method_2108(class_89.var_4436);
                                    }
                                 }
                                 else
                                 {
                                    _loc9_.rotationX = class_73.method_2108(class_183.var_7129);
                                    _loc9_.rotationY = class_73.method_2108(class_183.var_7129);
                                 }
                              }
                           }
               ...
               else if(class_58.var_3803.var_531.var_956 == class_73.method_2108(class_62.var_4036) && !class_168.var_6539.var_366)
               {
                  _loc16_ = class_168.var_6539.var_925;
                  if(_loc16_.method_555().var_305 * class_162.var_6351 < class_183.var_7129)
                  {
                     class_168.var_6539.var_925.method_543(new class_167(class_73.method_2108(class_183.var_7129),class_121.var_5493),class_168.var_6539.var_925.method_534());
                  }
                  if(class_168.var_6539.x > class_73.method_2108(class_121.var_5451) && class_168.var_6539.x < class_60.var_3945)
                  {
                     class_168.var_6539.var_925.var_769 = class_99.var_4682;
                  }
                  else if(class_168.var_6539.x > class_73.method_2108(class_60.var_3945) && class_168.var_6539.var_925.var_769)
                  {
      ...
      public static function method_849(param1:int) : Boolean
      {
         ...
         {
            if(class_58.var_3803.var_531.var_956 == class_73.method_2108(class_170.var_6619))
            {
               if(class_119.method_2337(param1))
               {
                  ...
                  {
                     if(class_96.var_4670 == class_73.method_2108(class_170.var_6731))
                     {
                        class_96.var_4670 = class_73.method_2108(class_117.var_5287);
                     }
                     else
                     {
                        class_96.var_4670 = class_96.var_4670 == class_92.var_4647 ? int(class_121.var_5495) : int(class_73.method_2108(class_9.var_3267));
                     }
                  }
                  else if(class_119.method_2333(param1) && class_96.var_4670 % class_146.var_6118 == class_183.var_7129)
                  {
                     if(class_96.var_4670 == class_73.method_2108(class_9.var_3267))
                     {
                        class_96.var_4670 = class_73.method_2108(class_117.var_5287);
                     }
                     else
                     {
                        class_96.var_4670 = class_146.var_6118 == class_96.var_4670 ? int(class_165.var_6534) : int(class_73.method_2108(class_170.var_6731));
                     }
                  }
                  else if(class_119.method_2342(param1) && class_96.var_4670 <= class_146.var_6118)
                  {
                     ...
                     {
                        class_96.var_4670 = class_96.var_4670 == class_73.method_2108(class_33.var_3679) ? int(class_73.method_2108(class_121.var_5495)) : int(class_73.method_2108(class_9.var_3267));
                     }
                  }
                  else if(class_119.method_2341(param1) && class_96.var_4670 % class_73.method_2108(class_146.var_6118) == class_33.var_3679)
                  {
                     ...
                     {
                        class_96.var_4670 = class_96.var_4670 == class_73.method_2108(class_33.var_3679) ? int(class_73.method_2108(class_165.var_6534)) : int(class_73.method_2108(class_170.var_6731));
                     }
                  }
                  if(class_73.method_2108(class_9.var_3267) == class_96.var_4670)
                  {
                     Math.random();
                  }
      ...
      public static function method_2222(param1:int) : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(class_96.const_486 && class_58.var_3803.var_531.var_956 == class_73.method_2108(class_170.var_6619) && class_96.var_4674 && class_96.var_4673)
         {
            if(param1 < class_73.method_2108(class_183.var_7129))
            {
               class_96.var_4674.var_758 = class_73.method_2108(class_183.var_7129);
            ...
            if(param1 >= class_92.var_4647 && param1 <= class_73.method_2108(class_102.var_4852))
            {
               _loc4_--;
            }
            else if(param1 >= class_73.method_2108(class_33.var_3679) && param1 <= class_146.var_6118)
            {
               _loc4_++;
            }
            if(param1 % class_73.method_2108(class_146.var_6118) == class_33.var_3679)
            {
               _loc3_--;
            }
            else if(param1 % class_73.method_2108(class_146.var_6118) == class_183.var_7129)
            {
               _loc3_++;
            }
      ...
      public static function method_2223(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         var _loc7_:int = Math.random() < class_92.var_4648 ? int(class_33.var_3679) : int(-class_73.method_2108(class_33.var_3679));
         ...
         while(_loc8_ < param4)
         {
            ...
            _loc9_.var_305 = param3 + (Math.random() * class_146.var_6117 - class_73.method_2108(class_117.var_5287));
      ...
      public static function method_2224(param1:class_58) : void
      {
         ...
         {
            if(class_96.const_482 && param1.var_506.var_455 == class_73.method_2111(class_181.var_6812))
            {
               for each(_loc2_ in class_1.var_2884.var_85)
               {
                  _loc2_.var_925.var_755 = class_99.var_4681;
                  _loc2_.var_925.var_759 = class_73.method_2108(class_102.var_4852);
               }
            }
            ...
            else if(class_96.const_486)
            {
               if(class_62.var_4036 == class_58.var_3803.var_531.var_956)
               {
                  ...
                  {
                     _loc2_.var_925.var_755 = class_99.var_4681;
                     _loc2_.var_925.var_758 = class_73.method_2108(class_121.var_5495) + (Math.random() * class_121.var_5493 - class_73.method_2108(class_165.var_6506)) / class_73.method_2108(class_181.var_6922);
      ...
      public static function method_2226(param1:class_147) : void
      {
         ...
         class_96.var_4674.var_759 = class_73.method_2108(class_183.var_7129);
      ...
      public static function method_848(param1:int) : Boolean
      {
         ...
         {
            if(class_73.method_2108(class_62.var_4036) == class_58.var_3803.var_531.var_956)
            {
               if(class_119.method_2344(param1))
               {
                  class_168.var_6539.var_925.var_756.var_305 = class_168.var_6539.var_925.var_743 * -class_73.method_2108(class_9.var_3231);
            ...
            else if(class_58.var_3803.var_531.var_956 == class_170.var_6619)
            {
               ...
               {
                  _loc2_ = class_96.var_4670;
                  if(class_119.method_2344(param1) && class_96.var_4670 >= class_121.var_5495 && class_96.var_4670 <= class_73.method_2108(class_9.var_3267))
                  {
                     if(class_96.var_4670 == class_117.var_5287)
                     {
                        class_96.var_4670 = class_73.method_2108(class_170.var_6731);
                     }
                     else
                     {
                        class_96.var_4670 = class_96.var_4670 == class_73.method_2108(class_121.var_5495) ? int(class_73.method_2108(class_92.var_4647)) : int(class_73.method_2108(class_102.var_4852));
                     }
                  }
                  else if(class_119.method_2333(param1) && class_96.var_4670 % class_73.method_2108(class_146.var_6118) == class_165.var_6534)
                  {
                     if(class_96.var_4670 == class_73.method_2108(class_117.var_5287))
                     {
                        class_96.var_4670 = class_9.var_3267;
                     }
                     else
                     {
                        class_96.var_4670 = class_96.var_4670 == class_73.method_2108(class_165.var_6534) ? int(class_146.var_6118) : int(class_102.var_4852);
                     }
                  }
                  else if(class_119.method_2342(param1) && class_96.var_4670 >= class_121.var_5495 && class_96.var_4670 <= class_9.var_3267)
                  {
                     ...
                     {
                        class_96.var_4670 = class_73.method_2108(class_165.var_6534);
                     }
                     else
                     {
                        class_96.var_4670 = class_96.var_4670 == class_121.var_5495 ? int(class_73.method_2108(class_33.var_3679)) : int(class_73.method_2108(class_146.var_6118));
                     }
                  }
                  else if(class_119.method_2341(param1) && class_96.var_4670 % class_73.method_2108(class_146.var_6118) == class_73.method_2108(class_165.var_6534))
                  {
                     if(class_96.var_4670 == class_73.method_2108(class_117.var_5287))
                     {
                        class_96.var_4670 = class_73.method_2108(class_121.var_5495);
                     }
                     else
                     {
                        class_96.var_4670 = class_73.method_2108(class_165.var_6534) == class_96.var_4670 ? int(class_73.method_2108(class_33.var_3679)) : int(class_92.var_4647);
                     }
                  }
                  if(_loc2_ != class_96.var_4670)
                  {
