...
class ScrollSlider extends Slider
{
   ...
   override protected function drawHandle() : void
   {
      ...
      if(_orientation == HORIZONTAL)
      {
         ...
         _handle.graphics.drawRect(Style.SCROLLBAR_MARGIN,Style.SCROLLBAR_MARGIN,_loc1_ - Style.SCROLLBAR_MARGIN * 2,_height - Style.SCROLLBAR_MARGIN * 2);
      }
      else
      {
         ...
         _handle.graphics.endFill();
         _handle.graphics.beginFill(Style.BUTTON_FACE);
         _handle.graphics.drawRect(Style.SCROLLBAR_MARGIN,Style.SCROLLBAR_MARGIN,_width - Style.SCROLLBAR_MARGIN * 2,_loc1_ - Style.SCROLLBAR_MARGIN * 2);
      }
      _handle.graphics.endFill();
      this.positionHandle();
   }
