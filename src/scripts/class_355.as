package
{
   ...
   public class class_355 extends Sprite
   {
      ...
      {
         this.var_1656 = -class_73.method_2108(class_33.var_3679);
         this.var_1657 = -class_73.method_2108(class_33.var_3679);
         this.var_1658 = -class_73.method_2108(class_33.var_3679);
         this.var_1661 = new Vector.<MovieClip>();
         super();
         this.method_431();
         this.method_1212();
         this.var_1656 = param1 != -class_73.method_2108(class_33.var_3679) ? int(param1) : 2870697;
      ...
      {
         var _loc3_:String = param1.toString(class_73.method_2108(class_16.var_3467));
         if(param2)
         {
            while(class_73.method_2108(class_9.var_3267) > _loc3_.length)
            {
      ...
      public function method_142(param1:int = -1, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_1657 >> class_73.method_2108(class_16.var_3467) & 255;
            _loc4_ = this.var_1657 >> class_73.method_2108(class_170.var_6731) & 255;
            ...
            _loc9_ = class_33.var_3679 - _loc7_ / class_73.method_2108(class_124.var_5621);
            _loc3_ += (-_loc3_ + class_73.method_2108(class_124.var_5621)) * _loc8_;
            _loc4_ += (-_loc4_ + class_73.method_2108(class_124.var_5621)) * _loc8_;
            _loc5_ += (class_73.method_2108(class_124.var_5621) - _loc5_) * _loc8_;
            _loc3_ = int(Math.round(_loc9_ * _loc3_));
            _loc4_ = int(Math.round(_loc9_ * _loc4_));
            _loc5_ = int(Math.round(_loc9_ * _loc5_));
            this.couleurEnCours = (_loc3_ << class_73.method_2108(class_16.var_3467)) + (_loc4_ << class_170.var_6731) + _loc5_;
         }
         else
         {
      ...
      {
         var _loc1_:int = class_73.method_2108(class_124.var_5621);
         ...
         while(class_73.method_2108(class_183.var_7129) <= _loc1_)
         {
            this.const_22.push((_loc1_ << class_16.var_3467) + (_loc2_ << class_73.method_2108(class_170.var_6731)) + _loc3_);
            _loc1_--;
         }
         ...
         _loc2_ = class_73.method_2108(class_124.var_5621);
         while(class_73.method_2108(class_183.var_7129) <= _loc3_)
         {
            this.const_22.push((_loc1_ << class_73.method_2108(class_16.var_3467)) + (_loc2_ << class_170.var_6731) + _loc3_);
            _loc3_--;
         }
         _loc3_ = class_183.var_7129;
         while(class_73.method_2108(class_170.var_6642) > _loc1_)
         {
            this.const_22.push((_loc1_ << class_73.method_2108(class_16.var_3467)) + (_loc2_ << class_170.var_6731) + _loc3_);
            _loc1_++;
         }
         _loc1_ = class_124.var_5621;
         while(_loc2_ >= class_73.method_2108(class_183.var_7129))
         {
            this.const_22.push((_loc1_ << class_73.method_2108(class_16.var_3467)) + (_loc2_ << class_170.var_6731) + _loc3_);
            _loc2_--;
         }
      ...
      public function method_1204() : void
      {
         ...
         this.var_1659.graphics.drawRect(class_73.method_2108(class_183.var_7129),class_183.var_7129,class_165.var_6506,class_181.var_6910);
      ...
      public function couleur(param1:int, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         var _loc4_:* = param1 >> class_73.method_2108(class_16.var_3467) & 255;
         ...
         this.var_1655.y = class_73.method_2108(class_124.var_5621) - _loc8_;
         ...
         var _loc14_:int = (_loc11_ << class_16.var_3467) + (_loc12_ << class_73.method_2108(class_170.var_6731)) + _loc13_;
         this.method_1205(_loc14_,param2);
         var _loc15_:int = this.const_22.indexOf(_loc14_);
         if(_loc15_ == -class_73.method_2108(class_33.var_3679))
         {
      ...
      public function method_1205(param1:int, param2:Boolean = true) : void
      {
         ...
         _loc3_.createGradientBox(class_73.method_2108(class_170.var_6642),class_73.method_2108(class_170.var_6642),class_183.var_7129,class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129));
         ...
         this.var_1651.graphics.drawRect(class_73.method_2108(class_183.var_7129),class_183.var_7129,class_73.method_2108(class_170.var_6642),class_73.method_2108(class_170.var_6642));
         this.method_142(-class_73.method_2108(class_33.var_3679),param2);
      }
      ...
      public function method_1207() : void
      {
         ...
         this.var_1660.graphics.drawRect(class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),class_73.method_2108(class_165.var_6506),class_73.method_2108(class_181.var_6910));
      ...
      public function method_1209(param1:KeyboardEvent) : void
      {
         ...
         {
            this.couleur(this.var_1658 == -class_73.method_2108(class_33.var_3679) ? int(this.var_1656) : int(this.var_1658));
            this.method_1206();
            this.method_1210();
         }
      }
      ...
      {
         var _loc2_:int = this.var_1650[class_73.method_2111(class_107.var_5075)];
         var _loc3_:int = this.var_1650[class_73.method_2111(class_165.var_6533)];
         if(_loc2_ < class_73.method_2108(class_183.var_7129))
         {
            _loc2_ = class_183.var_7129;
         }
         else if(_loc2_ > class_73.method_2108(class_124.var_5621))
         {
      ...
      public function method_1212() : void
      {
         ...
         while(_loc2_ < class_170.var_6607)
         {
            ...
            this.var_1653.fillRect(new Rectangle(class_183.var_7129,_loc1_,class_33.var_3675,class_73.method_2108(class_33.var_3679)),_loc3_);
            _loc1_++;
      ...
      public function method_521(param1:MouseEvent) : void
      {
         ...
         var _loc3_:int = this.const_22[_loc2_ * class_73.method_2108(class_9.var_3267)];
      ...
      {
         var _loc2_:class_24 = new class_24(class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129));
         var _loc3_:MovieClip = class_175.method_118(class_73.method_2111(class_170.var_6609));
         (_loc3_[class_89.var_4336] as TextField).width = class_73.method_2108(class_92.var_4615);
         if(param1)
         {
      ...
      public function method_431() : void
      {
         ...
         this.var_1650.graphics.drawRect(class_183.var_7129,class_183.var_7129,class_73.method_2108(class_170.var_6642),class_73.method_2108(class_170.var_6642));
         this.var_1650.graphics.endFill();
         this.var_1651 = new Sprite();
         this.var_1650.addChild(this.var_1651);
         var _loc1_:Sprite = new Sprite();
         var _loc2_:Matrix = new Matrix();
         _loc2_.createGradientBox(class_170.var_6642,class_73.method_2108(class_170.var_6642),Math.PI / class_165.var_6534,class_183.var_7129,class_73.method_2108(class_183.var_7129));
         _loc1_.graphics.beginGradientFill(GradientType.LINEAR,[class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129)],class_355.var_7259,class_355.var_7258,_loc2_);
         _loc1_.graphics.drawRect(class_183.var_7129,class_183.var_7129,class_73.method_2108(class_170.var_6642),class_73.method_2108(class_170.var_6642));
         ...
         this.var_1653 = new BitmapData(class_33.var_3675,class_73.method_2108(class_170.var_6642),false,40349);
         this.var_1652.addChild(new Bitmap(this.var_1653));
         addChild(this.var_1652);
         this.var_1652.x = class_73.method_2108(class_170.var_6642) + class_73.method_2108(class_146.var_6117);
         this.var_1652.addEventListener(MouseEvent.MOUSE_DOWN,this.method_1215);
         this.var_1659 = new Shape();
         this.var_1659.x = class_73.method_2108(class_102.var_4859) + this.var_1652.x;
         addChild(this.var_1659);
         this.var_1660 = new Shape();
         this.var_1660.x = this.var_1659.x;
         this.var_1660.y = class_73.method_2108(class_181.var_6910);
         ...
         _loc4_.filters = new Array(new GlowFilter(class_183.var_7129,class_73.method_2108(class_33.var_3679),class_146.var_6118,class_146.var_6118,class_73.method_2108(class_9.var_3267),class_146.var_6118,false,true));
         _loc4_.graphics.beginFill(16711680);
         _loc4_.graphics.drawCircle(class_183.var_7129,class_73.method_2108(class_183.var_7129),class_117.var_5287);
         _loc4_.graphics.endFill();
         this.var_1655.addChild(_loc4_);
         this.var_1655.addChild(_loc3_);
         this.var_1655.x = class_89.var_4444;
         this.var_1655.y = class_73.method_2108(class_89.var_4444);
         ...
         this.var_1654.graphics.beginFill(class_73.method_2108(class_183.var_7129));
         this.var_1654.graphics.moveTo(class_73.method_2108(class_33.var_3675),class_183.var_7129);
         this.var_1654.graphics.lineTo(class_117.var_5265,-class_121.var_5495);
         this.var_1654.graphics.lineTo(class_73.method_2108(class_117.var_5265),class_121.var_5495);
         this.var_1654.graphics.lineTo(class_33.var_3675,class_73.method_2108(class_183.var_7129));
         this.var_1654.graphics.endFill();
         this.var_1654.graphics.beginFill(class_73.method_2108(class_183.var_7129));
         this.var_1654.graphics.moveTo(class_183.var_7129,class_183.var_7129);
         this.var_1654.graphics.lineTo(-class_73.method_2108(class_9.var_3267),-class_121.var_5495);
         this.var_1654.graphics.lineTo(-class_9.var_3267,class_121.var_5495);
         this.var_1654.graphics.lineTo(class_183.var_7129,class_73.method_2108(class_183.var_7129));
         this.var_1654.graphics.endFill();
         this.var_1654.graphics.lineStyle(class_73.method_2108(class_33.var_3679),class_73.method_2108(class_183.var_7129));
         this.var_1654.graphics.moveTo(class_183.var_7129,class_183.var_7129);
         this.var_1654.graphics.lineTo(class_73.method_2108(class_33.var_3675),class_183.var_7129);
         this.var_1654.graphics.endFill();
         this.var_1654.graphics.endFill();
