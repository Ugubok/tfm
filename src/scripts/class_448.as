package
{
   ...
   public class class_448 extends class_24
   {
      ...
      {
         super(class_73.method_2108(class_121.var_5458),class_181.var_6799);
         ...
         this.var_1902 = new class_24(name_5,class_73.method_2108(class_117.var_5280));
      ...
      public static function name_6(param1:ByteArray) : void
      {
         ...
         class_448.var_2884.x = int((-class_448.var_2884.name_5 + class_73.method_2108(class_107.var_5074)) / class_73.method_2108(class_165.var_6534));
         class_448.var_2884.y = (class_60.var_3979 - class_448.var_2884.var_206) * class_73.method_2116(class_92.var_4648);
      }
      ...
      public function name_9(param1:ByteArray) : void
      {
         ...
         while(var_7436 < var_7502)
         {
            ...
            var_1492 = new class_24(name_5,class_73.method_2108(class_33.var_3675));
            ...
            var_7571 = new class_220(class_9.var_3268 + var_1768,class_73.method_2108(class_102.var_4859),var_1492.var_206);
            var_7571.mouseEnabled = class_99.var_4681;
            var_7571.selectable = class_99.var_4681;
            var_7571.method_864(class_54.const_289);
            var_1403 = new class_220(var_817,class_73.method_2108(class_89.var_4444),var_1492.var_206);
            var_1403.mouseEnabled = class_99.var_4681;
            var_1403.selectable = class_99.var_4681;
            var_1403.method_864(class_54.const_280);
            var_7572 = new class_220(class_9.var_3268 + var_1412,class_73.method_2108(class_33.var_3675),var_1492.var_206);
            ...
            if(class_73.method_2108(class_33.var_3679) == var_1734)
            {
               var_7573.method_864(class_54.const_291);
            }
            else if(var_1734 == class_73.method_2108(class_165.var_6534) || var_1734 == class_146.var_6118)
            {
            ...
            var_7574 = new class_220(var_373,class_73.method_2108(class_102.var_4850),var_1492.var_206);
         ...
         var_7566 = new class_244(class_73.method_2108(class_127.var_5850)).method_941(class_4.var_3029);
         var_7567 = new class_244(class_73.method_2108(class_162.var_6351)).method_941(class_73.method_2111(class_117.var_5275));
         var_7568 = new class_244(class_121.var_5493).method_941(class_9.var_3167);
         var_7569 = new class_244(class_73.method_2108(class_124.var_5657)).method_941(class_73.method_2111(class_107.var_4894));
