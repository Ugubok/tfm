package
{
   ...
   public class class_660 extends class_640
   {
      ...
      public function class_660()
      {
         ...
         super(class_73.method_2108(class_89.var_4432));
         ...
         var _loc2_:MovieClip = class_21.method_1891(class_73.method_2108(class_165.var_6534),class_102.var_4852,null);
         ...
         _loc2_.x = (this.var_2459.name_5 - _loc2_.width) / class_73.method_2108(class_165.var_6534) - _loc3_.left * _loc4_;
         ...
         if(class_1.const_45)
         {
            method_196(class_73.method_2116(class_92.var_4648),class_92.var_4648,true);
         }
         else
         {
            x = (-name_5 + class_73.method_2108(class_107.var_5074)) / class_165.var_6534;
            y = class_73.method_2108(class_33.var_3675) + (class_73.method_2108(class_183.var_7096) - var_206) / class_165.var_6534;
         }
      }
      ...
      public function method_1701(param1:String) : Boolean
      {
         ...
         if(_loc3_.length < class_73.method_2108(class_146.var_6118) || _loc4_ <= class_73.method_2108(class_183.var_7129) || _loc4_ == _loc3_.length - class_73.method_2108(class_33.var_3679))
         {
            return false;
         }
         return true;
