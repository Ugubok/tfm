package
{
   ...
   public class class_564 extends class_166
   {
      ...
      public function class_564(param1:class_255)
      {
         ...
         this.var_2198 = new Vector.<Bitmap>(class_73.method_2108(class_146.var_6117),true);
         super(param1);
      }
      ...
      override public function name_2(param1:int) : void
      {
         ...
         if(var_873)
         {
            if(this.var_2193)
            {
               ...
               if(_loc3_.method_555().var_305 * class_73.method_2108(class_162.var_6351) < class_183.var_7129)
               {
               ...
               else if(!class_168.var_6539.var_366 && class_168.var_6539.x > class_73.method_2108(class_60.var_3945) && class_168.var_6539.var_925.var_769)
               {
      ...
      {
         var_873 = class_564.name_79.indexOf(param1.var_531.var_956) != -class_73.method_2108(class_33.var_3679);
         this.var_2191 = class_564.const_1217 == param1.var_531.var_956;
         this.var_2192 = class_564.const_1221.indexOf(param1.var_531.var_956) != -class_73.method_2108(class_33.var_3679);
      ...
      {
         var _loc2_:int = 0;
         if(param1.currentTarget.x > class_73.method_2108(class_124.var_5657))
         {
            _loc2_ = class_73.method_2108(class_146.var_6118);
         }
         ...
         class_1.var_2884.method_3(new Array(class_26.method_1668(class_162.var_6218,class_73.method_2111(class_165.var_6521) + _loc2_ + class_73.method_2111(class_117.var_5225)),this.method_1597,_loc2_));
      }
      ...
      override public function method_666(param1:class_501) : void
      {
         ...
         switch(param1.var_574)
         {
            case class_33.var_3679:
               ...
               _loc4_ = param1.method_1477(class_73.method_2108(class_165.var_6534));
            ...
            case class_121.var_5495:
               ...
               _loc7_ = param1.method_1477(class_73.method_2108(class_33.var_3679));
               _loc8_ = param1.method_1477(class_165.var_6534);
               _loc9_ = class_58.var_3803.var_506.var_424;
               if(_loc9_ && _loc9_.length > class_73.method_2108(class_183.var_7129))
               {
                  if(!_loc6_)
                  {
                     class_125.var_5689 = class_73.method_2108(class_170.var_6731);
                     ...
                     class_58.var_3803.method_388(new class_684(_loc9_[_loc7_].var_304 + _loc9_[_loc7_].var_1478.width / class_165.var_6534,_loc10_,class_73.method_2108(class_117.var_5287),class_183.var_7129,-class_73.method_2108(class_33.var_3679),class_73.method_2108(class_146.var_6087),class_73.method_2108(class_107.var_5038),16553492));
                     ...
                     class_58.var_3803.method_388(new class_684(_loc9_[_loc8_].var_304 + _loc9_[_loc8_].var_1478.width / class_165.var_6534,_loc10_,class_117.var_5287,class_183.var_7129,-class_73.method_2108(class_33.var_3679),class_146.var_6087,class_107.var_5038,16553492));
                     class_125.var_5689 = class_183.var_7129;
                  }
                  else
                  {
                     class_1.var_2884.method_33(class_56.const_193,_loc9_[_loc7_].var_304 + _loc9_[_loc7_].var_1478.width / class_73.method_2108(class_165.var_6534),_loc9_[_loc7_].var_305 + _loc9_[_loc7_].var_1478.height / class_165.var_6534,class_73.method_2108(class_146.var_6117),class_165.var_6534,false);
                     class_58.var_3803.method_399(_loc7_,class_146.var_6087);
                     class_1.var_2884.method_33(class_56.const_193,_loc9_[_loc8_].var_304 + _loc9_[_loc8_].var_1478.width / class_165.var_6534,_loc9_[_loc8_].var_305 + _loc9_[_loc8_].var_1478.height / class_73.method_2108(class_165.var_6534),class_73.method_2108(class_146.var_6117),class_73.method_2108(class_165.var_6534),false);
                     class_58.var_3803.method_399(_loc8_,class_73.method_2108(class_146.var_6087));
                  }
               }
               break;
         }
      ...
      public function method_1594() : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            _loc5_ = this.var_2197[_loc3_ + class_73.method_2108(class_33.var_3679)];
            _loc6_ = this.var_2197[_loc3_ + class_165.var_6534];
            if(_loc1_ > _loc5_)
            {
               this.var_2197.splice(_loc3_,class_146.var_6118);
               _loc3_ -= class_73.method_2108(class_146.var_6118);
               _loc2_ -= class_146.var_6118;
               this.var_2196[_loc4_].visible = class_99.var_4682;
               this.var_2196[_loc4_].gotoAndStop(class_73.method_2108(class_33.var_3679));
               _loc7_ = this.var_2198[_loc4_];
               if(_loc7_ && _loc7_.parent)
               {
                  _loc7_.parent.removeChild(_loc7_);
               }
               _loc7_ = class_175.method_2618(class_73.method_2111(class_62.var_4031) + _loc6_ + class_117.var_5274);
      ...
      override public function name_22(param1:class_168) : void
      {
         if(var_873)
         {
            if(this.var_2193 && !param1.var_366)
            {
               ...
               param1.var_925.var_758 = class_121.var_5495 + (Math.random() * class_121.var_5493 - class_165.var_6506) / class_73.method_2108(class_181.var_6922);
      ...
      public function method_1595(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         _loc6_ = this.var_2198[_loc5_ + class_73.method_2108(class_165.var_6534)];
         if(_loc6_ && _loc6_.parent)
         {
            _loc6_.parent.removeChild(_loc6_);
         }
         ...
         this.var_2196[_loc5_].gotoAndPlay(int(Math.random() * class_73.method_2108(class_117.var_5287)));
         this.var_2196[_loc5_ + class_33.var_3679].gotoAndPlay(int(Math.random() * class_73.method_2108(class_117.var_5287)));
         this.var_2196[_loc5_ + class_165.var_6534].gotoAndPlay(int(Math.random() * class_73.method_2108(class_117.var_5287)));
         var _loc7_:int = class_1.method_1816();
         this.var_2197.push(_loc5_,_loc7_ + class_73.method_2108(class_92.var_4625),param2);
         this.var_2197.push(_loc5_ + class_73.method_2108(class_33.var_3679),_loc7_ + class_146.var_6111,param3);
         this.var_2197.push(_loc5_ + class_73.method_2108(class_165.var_6534),_loc7_ + class_146.var_6087,param4);
      }
      ...
      public function method_1596() : void
      {
         ...
         _loc1_.y = class_73.method_2108(class_16.var_3436);
         var _loc2_:Sprite = new Sprite();
         _loc2_.addChild(class_175.method_2618(class_73.method_2111(class_121.var_5368)));
         class_58.var_3803.var_545.addChildAt(_loc2_,class_73.method_2108(class_183.var_7129));
         class_202.method_2754(_loc2_,true,true);
         _loc2_.addEventListener(MouseEvent.MOUSE_DOWN,this.method_1593);
         _loc2_.x = class_73.method_2108(class_170.var_6611);
         _loc2_.y = class_16.var_3436;
         var _loc3_:Sprite = new Sprite();
         _loc3_.addChild(class_175.method_2618(class_102.var_4725));
         class_58.var_3803.var_545.addChildAt(_loc3_,class_73.method_2108(class_183.var_7129));
         ...
         _loc3_.y = class_73.method_2108(class_16.var_3436);
         if(!this.var_2199)
         {
            this.var_2199 = new Vector.<Point>(class_73.method_2108(class_146.var_6117),true);
            _loc4_ = class_183.var_7129;
            while(_loc4_ < class_73.method_2108(class_146.var_6117))
            {
               if(_loc4_ < class_146.var_6118)
               {
                  this.var_2199[_loc4_] = new Point(class_73.method_2108(class_92.var_4637) + _loc4_ % class_73.method_2108(class_146.var_6118) * class_162.var_6351,class_162.var_6219);
               }
               else if(class_9.var_3267 > _loc4_)
               {
                  this.var_2199[_loc4_] = new Point(class_73.method_2108(class_62.var_4103) + _loc4_ % class_146.var_6118 * class_73.method_2108(class_162.var_6351),class_62.var_4033);
               }
               else
               {
                  this.var_2199[_loc4_] = new Point(class_183.var_7013 + _loc4_ % class_73.method_2108(class_146.var_6118) * class_73.method_2108(class_162.var_6351),class_162.var_6219);
               }
               _loc4_++;
            }
         }
         ...
         while(_loc4_ < class_73.method_2108(class_146.var_6117))
         {
            _loc5_ = class_175.method_118(class_73.method_2111(class_33.var_3557));
            _loc5_.gotoAndStop(class_73.method_2108(class_33.var_3679));
         ...
         _loc4_ = class_183.var_7129;
         while(_loc4_ < class_73.method_2108(class_102.var_4852))
         {
            class_175.method_2618(class_62.var_4031 + _loc4_ + class_73.method_2111(class_117.var_5274));
            _loc4_++;
         }
      }
         ...
         if(var_873)
         {
            if(this.var_2193)
            {
               for each(_loc2_ in param1)
               {
                  ...
                  _loc2_.var_925.var_758 = class_73.method_2108(class_121.var_5495) + (Math.random() * class_73.method_2108(class_121.var_5493) - class_73.method_2108(class_165.var_6506)) / class_73.method_2108(class_181.var_6922);
      ...
      {
         class_39.var_3745.method_313(method_660(class_73.method_2108(class_165.var_6534),param1));
      }
      ...
      public function method_1598(param1:int) : void
      {
         if(this.var_2191)
         {
            if(!this.var_2194)
            {
               ...
               this.var_2194.defaultTextFormat = new TextFormat(class_26.var_3500,class_73.method_2108(class_33.var_3675),16751705,null,null,null,null,null,TextFormatAlign.RIGHT);
               this.var_2194.multiline = class_99.var_4682;
               this.var_2194.wordWrap = class_99.var_4682;
               this.var_2194.x = class_73.method_2108(class_121.var_5485);
               this.var_2194.y = class_146.var_6074;
               this.var_2194.width = class_73.method_2108(class_127.var_5850);
               this.var_2194.height = class_73.method_2108(class_162.var_6351);
            }
