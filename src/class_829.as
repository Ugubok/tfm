package
{
   ...
   public class class_829 extends class_24
   {
      ...
      public function class_829(param1:class_659)
      {
         ...
         super(class_73.method_2108(class_62.var_4130),class_73.method_2108(class_62.var_4130));
         method_251(true,class_73.method_2108(class_146.var_6117));
         method_216(new class_245(class_243.const_640,class_170.var_6731));
         method_244(true);
         var _loc2_:Boolean = param1.var_2456.length > class_73.method_2108(class_183.var_7129) && param1.var_2456[class_183.var_7129] == class_183.var_7129;
         this.var_2739 = param1.var_2456.length > (!!_loc2_ ? class_33.var_3679 : class_73.method_2108(class_183.var_7129));
         if(param1.var_363 == class_111.var_363 && !_loc2_)
         {
            param1.var_2456.unshift(class_73.method_2108(class_183.var_7129));
         }
         ...
         while(++_loc3_ < _loc4_)
         {
            ...
            _loc6_ = class_175.method_118(class_73.method_2111(class_127.var_5833) + _loc5_,true);
            _loc7_ = new class_24(class_73.method_2108(class_102.var_4859),class_102.var_4859);
