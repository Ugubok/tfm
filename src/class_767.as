package
{
   ...
   public class class_767 extends class_755
   {
      ...
      public function class_767(param1:int, param2:class_483)
      {
         ...
         super(param1,class_16.var_3473,param2);
      ...
      public function method_1755() : void
      {
         ...
         if(this.name_47())
         {
            _loc1_.method_818(class_207.const_617,class_26.method_1668(class_121.var_5409),this.method_1757,null);
         }
         else
         {
            _loc1_.method_818(class_207.const_617,class_26.method_1668(class_107.var_4980),this.method_1357,null);
         }
      ...
      override public function method_431() : void
      {
         ...
         super.method_431();
         var_2596.method_216(new class_245(class_243.const_639,class_121.var_5495));
         var_2156 = new class_220(class_9.var_3268).method_865(class_162.var_6346);
         var_2156.htmlText = class_231.method_2798(var_2000.method_1377(),true,class_162.var_6346);
         var_2601 = new class_220(class_89.var_4390).method_864(class_54.const_289).method_865(class_146.var_6117).method_856(TextFormatAlign.CENTER);
         _loc1_ = new class_250(class_102.var_4769,class_16.var_3467,class_16.var_3467);
         ...
         if(!_loc2_)
         {
            var_1214 = new class_250(null,-var_2596.method_220(),class_183.var_7129);
         }
         var_2598 = new class_220(var_1931.method_1443(),class_183.var_7129,class_33.var_3675).method_864(class_54.const_280).method_865(class_162.var_6346);
         ...
         var_2600.method_865(class_162.var_6346).method_864(!!this.var_2624.name_47 ? int(const_1324) : int(const_1323)).method_856(TextFormatAlign.RIGHT);
         ...
         var _loc4_:int = var_2596.name_5 - class_121.var_5495;
         ...
         if(var_2000.method_1381())
         {
            ...
            if(_loc3_)
            {
               ...
               {
                  _loc11_ = class_92.var_4647;
                  _loc5_ = _loc10_ * Math.ceil(_loc11_ / class_165.var_6534) / _loc11_;
                  _loc12_ = _loc10_ * Math.floor(_loc11_ / class_165.var_6534) / _loc11_;
                  if(var_2598.textWidth + class_170.var_6731 < _loc12_)
                  {
                     var_2598.width = var_2598.textWidth + class_170.var_6731;
                     var_2156.width = -var_2598.width + _loc10_;
                  }
                  else if(var_2156.textWidth + class_170.var_6731 < _loc5_)
                  {
                     var_2156.width = var_2156.textWidth + class_170.var_6731;
         ...
         if(var_2156.width < var_2156.textWidth + class_170.var_6731)
         {
            ...
            do
            {
               _loc6_ = _loc8_.getCharIndexAtPoint(_loc8_.width - class_146.var_6118,_loc8_.height / class_165.var_6534);
               if(_loc6_ != -class_33.var_3679)
               {
                  _loc8_.htmlText = class_231.method_2798(var_2000.method_1377().substr(class_183.var_7129,_loc7_--),true,class_162.var_6346) + class_62.var_4072;
               }
            }
            while(_loc6_ != -class_33.var_3679 && _loc7_ > class_183.var_7129);
            
         }
         if(var_2598.width > class_183.var_7129 && var_2598.width < var_2598.textWidth + class_170.var_6731)
         {
            ...
            do
            {
               ...
               if(_loc6_ != -class_33.var_3679)
               {
                  _loc8_.htmlText = var_1931.method_1443().substr(class_183.var_7129,_loc7_--) + class_62.var_4072;
               }
            }
            while(_loc6_ != -class_33.var_3679 && _loc7_ > class_183.var_7129);
         ...
         if(var_2000.method_1381())
         {
            ...
            var_2596.method_221((-var_2599.name_5 + const_1319) / class_165.var_6534);
            var_2596.method_136(var_2599);
            var_2601.y = var_2156.y + class_33.var_3679;
            var_2598.y = var_2156.y;
            var_1214.y = var_2598.y + class_165.var_6534;
            var_2599.y = var_2598.y + class_165.var_6534;
            _loc1_.y = class_33.var_3679 + var_2598.y;
            _loc1_.x += class_33.var_3679;
         }
         else if(this.var_2624.var_1938)
         {
            if(var_2000.method_1380().getTime() != class_183.var_7129)
            {
         ...
         {
            _loc13_ = new class_250(class_9.var_3175,class_33.var_3593,class_16.var_3473);
            _loc13_.x = var_2602.width - class_33.var_3675;
            var_1541.addChildAt(_loc13_,class_183.var_7129);
            var_2598.filters = new Array(new GlowFilter(class_183.var_7129,class_33.var_3679,class_146.var_6118,class_146.var_6118,class_146.var_6118,class_146.var_6118));
         }
      }
      ...
      {
         class_207.method_2772(class_26.method_1903(class_111.var_5092,class_16.var_3381,class_231.method_2798(this.var_2624.var_817)),class_154.var_6144.method_1452,null);
      }
