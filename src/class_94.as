package
{
   ...
   public class class_94
   {
      ...
      public static function method_2199(param1:Event) : void
      {
         ...
         class_94.var_735 = class_94.var_4654[class_121.var_5460 + class_33.var_3639];
      ...
      {
         class_94.var_4654.x = class_1.var_2884.var_19[class_117.var_5248 + class_16.var_3443] - class_94.var_734;
         class_94.var_4654.y = class_1.var_2884.var_19[class_127.var_5853 + class_89.var_4408] - class_94.var_735;
      }
      
      public static function method_2201(param1:Boolean) : void
      {
         var _loc4_:MovieClip = null;
         if(class_67.name_62(class_127.var_5878))
         {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(param1)
            {
               _loc4_.transform.colorTransform = new ColorTransform(class_124.var_5624,class_124.var_5624,class_124.var_5624);
            }
            else
            {
      ...
      public static function method_2202(param1:Event, param2:MovieClip = null, param3:Boolean = false) : void
      {
         ...
         if(class_94.var_4651 && !class_94.var_4655)
         {
            ...
            class_94.var_1855.alpha = class_92.var_4648;
            ...
            class_94.var_4650[class_127.var_5852](class_94.var_4652,_loc4_);
      ...
      public static function method_2204() : void
      {
         ...
         class_94.var_4654.y = class_183.var_7129;
      }
      ...
      public static function method_2206(param1:Boolean = true) : void
      {
         ...
         {
            class_50.var_3769 = class_89.var_4444;
            class_50.var_3770 = class_89.var_4444;
         ...
         else
         {
            ...
            class_50.var_3768 = class_165.var_6506;
         }
         ...
         if(class_1.var_2884.var_26)
         {
            ...
            class_1.var_2884.var_26[class_9.var_3236] = class_50.var_3768;
         }
      }
      ...
      public static function method_2207(param1:int) : Boolean
      {
         ...
         if(class_94.var_4652.length)
         {
            ...
            {
               class_94.method_2198(class_102.var_4828,!!class_119.var_5292 ? class_146.var_6117 : class_33.var_3679,true);
               class_1.var_2884.var_53._Editeur[class_127.var_5852]();
               class_1.var_2884.var_53._Editeur._OSelection[class_127.var_5852]();
               class_94.var_4650.name_98();
               return true;
      ...
      public static function method_2208(param1:XMLNode, param2:MovieClip) : void
      {
         ...
         class_1.var_2884.x_nombreBonusDefilante = class_183.var_7129;
         ...
         param2.graphics.drawRect(-class_181.var_6922,-class_181.var_6922,class_92.var_4618,class_33.var_3638);
         param2.graphics.endFill();
         class_94.method_2201(false);
         class_94.var_4653 = new Array();
         var _loc6_:XMLNode = param1.childNodes[class_183.var_7129];
         var _loc7_:XMLNode = param1.childNodes[class_33.var_3679];
         ...
         if(_loc14_)
         {
            if(!class_94.var_4649 && _loc14_.charAt(class_183.var_7129) == class_165.var_6522)
            {
               _loc28_ = _loc14_.substr(class_33.var_3679).split(class_107.var_5062);
               class_310.method_2882(_loc28_[class_183.var_7129],parseInt(_loc28_[class_33.var_3679],class_146.var_6117),parseInt(_loc28_[class_165.var_6534],class_146.var_6117)).method_1097(_loc5_,_loc11_,_loc12_,class_183.var_7129);
            }
            else if(_loc14_.indexOf(class_107.var_5062) == -class_33.var_3679)
            {
               if(_loc14_.indexOf(class_170.var_6702) != -class_33.var_3679 && class_111.var_5102)
               {
                  _loc5_.addChild(class_175.method_2618(_loc14_,class_9.var_3268));
               }
               else
               {
            ...
            {
               _loc29_ = _loc14_.split(class_121.var_5459);
               _loc30_ = class_183.var_7129;
               while(_loc30_ < _loc29_.length)
               {
                  _loc31_ = _loc29_[_loc30_].split(class_107.var_5062);
                  if(_loc31_[class_183.var_7129].indexOf(class_170.var_6702) != -class_33.var_3679 && false)
                  {
                  ...
                  _loc32_.x = _loc31_[class_33.var_3679];
                  _loc32_.y = _loc31_[class_165.var_6534];
                  _loc5_.addChildAt(_loc32_,class_183.var_7129);
         ...
         if(_loc15_)
         {
            if(_loc15_.indexOf(class_107.var_5062) == -class_33.var_3679)
            {
               _loc3_.addChild(class_175.method_2618(_loc6_.attributes.d));
            }
            else
            {
               _loc35_ = _loc15_.split(class_107.var_5062);
               _loc20_ = class_183.var_7129;
               while(_loc20_ < _loc35_.length)
               {
                  if(_loc35_[class_183.var_7129].indexOf(class_170.var_6702) != -class_33.var_3679 && false)
                  {
                     _loc36_ = class_175.method_2618(_loc35_[class_183.var_7129],class_9.var_3268);
                  }
                  else
                  {
                     _loc36_ = class_175.method_2618(_loc35_[class_183.var_7129]);
                  }
                  _loc36_.x = _loc35_[class_33.var_3679];
                  _loc36_.y = _loc35_[class_165.var_6534];
         ...
         _loc4_.graphics.lineStyle(class_33.var_3679,43741,class_33.var_3679,true);
         _loc4_.graphics.drawRect(class_183.var_7129,class_183.var_7129,_loc11_,_loc12_);
         ...
         while(++_loc20_ < _loc19_)
         {
            ...
            {
               _loc41_ = class_175.method_118(class_89.var_4407);
               if(_loc13_)
               {
                  if(_loc21_)
                  {
            ...
            else if(_loc40_ == class_146.var_6077)
            {
               _loc41_ = class_175.method_118(class_60.var_3942);
               _loc41_.gotoAndStop(class_33.var_3679);
               _loc4_.addChild(_loc41_);
            }
            else if(_loc40_ == class_60.var_3941)
            {
               _loc38_ = _loc39_.attributes.T;
               _loc41_ = class_175.method_118(class_170.var_6701 + _loc38_,true);
               _loc42_ = _loc39_.attributes.P.split(class_107.var_5062);
               if(_loc42_[class_183.var_7129] == class_62.var_4157 && (_loc38_ != class_9.var_3234 && _loc38_ != class_102.var_4827))
               {
                  _loc4_.addChild(_loc41_);
               }
               if(_loc42_[class_33.var_3679] == class_62.var_4157)
               {
                  _loc41_.scaleX = -class_33.var_3679;
               }
               _loc43_ = _loc39_.attributes.C;
               if(_loc43_)
               {
                  _loc44_ = _loc43_.split(class_107.var_5062);
                  class_58.method_1980(_loc44_,_loc41_);
               }
            }
            if(!_loc41_.parent)
            {
               if(_loc38_ == class_9.var_3234 || _loc38_ == class_102.var_4827)
               {
            ...
            if(class_94.var_4652.indexOf(_loc39_) != -class_33.var_3679)
            {
         ...
         while(++_loc20_ < _loc19_)
         {
            ...
            {
               _loc17_ = class_146.var_6117;
               _loc45_.attributes.L = class_146.var_6117;
            }
            if(_loc18_ < class_146.var_6117)
            {
               _loc18_ = class_146.var_6117;
               _loc45_.attributes.H = class_146.var_6117;
            }
            ...
            {
               _loc46_ = class_58.method_1982(class_312.const_791,_loc17_,_loc18_,false,int(class_181.var_6914 + _loc45_.attributes.o));
            }
            else if(class_312.const_781 == _loc48_)
            {
               _loc46_ = class_58.method_1982(class_312.const_781,_loc17_,class_183.var_7129,false,int(class_181.var_6914 + _loc45_.attributes.o));
            }
            ...
            {
               _loc52_ = new Sprite();
               _loc53_ = _loc45_.attributes.var_7436.split(class_107.var_5062);
               if(class_146.var_6118 <= _loc53_.length)
               {
                  if(!class_94.var_4649)
                  {
                  ...
                  {
                     _loc54_ = class_175.method_2618(_loc53_[class_165.var_6534],class_170.var_6700);
                  }
                  ...
                  {
                     _loc54_ = class_175.method_2618(_loc53_[class_165.var_6534],class_9.var_3268);
                  }
            ...
            _loc49_ = new Sprite();
            _loc49_.graphics.lineStyle(class_33.var_3679,65535,class_33.var_3679);
            _loc50_ = class_170.var_6720;
            _loc49_.graphics.moveTo(-_loc50_,class_183.var_7129);
            _loc49_.graphics.lineTo(_loc50_,class_183.var_7129);
            _loc49_.graphics.moveTo(class_183.var_7129,-_loc50_);
            ...
            if(_loc51_[class_117.var_5287] != class_62.var_4157 && _loc51_[class_117.var_5287] != class_124.var_5665)
            {
               _loc51_[class_117.var_5287] = class_183.var_7129;
            }
            if(_loc51_[class_183.var_7129] != class_62.var_4157 && _loc51_[class_183.var_7129] != class_124.var_5665)
            {
               _loc51_[class_183.var_7129] = class_183.var_7129;
            }
            if(_loc51_[class_183.var_7129] == class_124.var_5665)
            {
               _loc51_[class_33.var_3679] = class_183.var_7129;
               _loc51_[class_117.var_5287] = class_183.var_7129;
               _loc51_[class_9.var_3267] = class_183.var_7129;
               _loc51_[class_92.var_4647] = class_183.var_7129;
            }
            _loc47_.rotation = int(_loc51_[class_121.var_5495]);
            ...
            if(class_94.var_4652.indexOf(_loc45_) != -class_33.var_3679)
            {
         ...
         while(++_loc20_ < _loc19_)
         {
            ...
            if(!class_50.const_249[_loc56_])
            {
               if(_loc16_)
               {
                  ...
                  {
                     _loc57_ = new MovieClip();
                     _loc58_ = class_175.method_2618(class_62.var_4127);
                     _loc58_.x = -class_183.var_7127;
                     _loc58_.y = -class_183.var_7127;
                     _loc57_.addChild(_loc58_);
                     ++class_1.var_2884.x_nombreBonusDefilante;
                  ...
                  {
                     _loc57_ = new MovieClip();
                     _loc58_ = class_175.method_2618(class_117.var_5245);
                     _loc58_.x = -class_183.var_7127;
                     _loc58_.y = -class_183.var_7127;
                     _loc57_.addChild(_loc58_);
                     ++class_1.var_2884.x_nombreBonusDefilante;
               ...
               if(_loc55_.attributes.P)
               {
                  ...
                  _loc57_.rotation = int(_loc59_[class_183.var_7129]);
                  if(_loc59_.length == class_33.var_3679 || _loc59_[class_33.var_3679] != class_62.var_4157 && _loc59_[class_33.var_3679] != class_124.var_5665)
                  {
                  ...
                  else if(_loc59_[class_33.var_3679] == class_62.var_4157)
                  {
                     if(_loc56_ != class_46.const_168)
                     {
                        _loc57_.transform.colorTransform = class_1.var_2884.const_4;
         ...
         param2.addChildAt(_loc5_,class_183.var_7129);
      }
