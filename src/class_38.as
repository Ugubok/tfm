   ...
   public class class_38
   {
      ...
      public static function method_1929() : void
      {
         ...
         if(class_38.var_3738)
         {
            ...
            if(_loc2_ - class_38.var_3736 > class_38.var_3737)
            {
               ...
               class_38.var_3737 = class_4.var_3058 + Math.random() * class_181.var_6922;
               class_38.method_1939();
            }
         }
         var _loc1_:int = class_183.var_7129;
         while(_loc1_ < class_165.var_6534)
         {
            _loc3_ = new class_27(class_1.var_2884.var_156[class_38.var_3739 == class_183.var_7129 ? class_56.const_333 : class_56.const_330],false);
            ...
            _loc3_.var_309 = Math.random() * class_33.var_3675 + class_146.var_6117;
            _loc3_.var_304 = int(Math.random() * class_107.var_5074);
      ...
      public static function method_1932() : void
      {
         ...
         if(class_38.var_3731)
         {
            ...
            if(class_38.var_2001)
            {
               class_1.var_2884.addChildAt(class_38.var_3730,class_117.var_5287);
            }
         }
         else
         {
      ...
      public static function method_1935(param1:Boolean, param2:Number = 0, param3:Boolean = false) : void
      {
         if(param1)
         {
            ...
            if(param3)
            {
               ...
               class_38.var_3737 = class_146.var_6087 + Math.random() * class_146.var_6087;
            }
         }
         else
         {
      ...
      public static function method_1936(param1:int = 0, param2:int = 800, param3:int = -10) : class_27
      {
         ...
         _loc4_.var_308 = Math.random() - class_92.var_4648;
         _loc4_.var_309 = Math.random() + class_4.var_3040;
         _loc4_.var_304 = int(param1 + Math.random() * (param2 - param1));
         _loc4_.var_315 = class_99.var_4682;
         _loc4_.method_271(class_183.var_7129);
         return _loc4_;
      }
      ...
      {
         class_38.var_3728 = new class_116(class_183.var_7129,class_183.var_7129,class_107.var_5074,class_89.var_4432,class_38.method_1940);
         ...
         class_38.var_3729.var_658 = new ColorTransform(class_33.var_3679,class_33.var_3679,class_33.var_3679,class_107.var_5029);
         class_38.var_3735 = class_175.method_118(class_89.var_4319);
         class_38.var_3735.gotoAndStop(class_33.var_3679);
         class_38.var_3730 = new class_116(class_183.var_7129,class_183.var_7129,class_107.var_5074,class_89.var_4432,class_38.method_1940);
         class_38.var_3741 = new class_75(class_175.method_118(class_107.var_4934));
         class_38.var_3742 = new class_75(class_175.method_118(class_9.var_3136));
      }
      ...
      public static function method_1939(param1:Function = null) : void
      {
         ...
         class_38.var_3735.x = -class_1.var_2884.var_50.x + (Math.random() * class_60.var_3979 - class_124.var_5657);
         var _loc2_:* = Math.random() < class_92.var_4648;
         if(!_loc2_)
         {
            class_38.var_3735.x += class_107.var_5074;
         }
         class_38.var_3735.scaleX = !!_loc2_ ? Number(class_33.var_3679) : Number(-class_33.var_3679);
         if(param1 != null)
         {
      ...
      public static function method_1940(param1:class_27) : void
      {
         ...
         else if(param1.var_304 < class_183.var_7127)
         {
            param1.var_304 = class_107.var_5074;
         }
         if(class_102.var_4855 < param1.var_305)
         {
      ...
      public static function method_1941(param1:class_147) : void
      {
         ...
         if(param1.var_768 != -class_33.var_3679 && class_1.var_2884.var_146.indexOf(param1.var_768) == -class_33.var_3679)
         {
            ...
            _loc3_ = param1.var_742.position.var_305 * class_162.var_6351;
            class_1.var_2884.method_2(_loc2_,_loc3_,class_38.var_3740,class_165.var_6506,true,class_33.var_3679);
