package
{
   ...
   public class class_244 extends class_23
   {
      ...
      public function class_244(param1:int = 100, param2:int = 20, param3:Boolean = true)
      {
         ...
         super(param1,param2);
         this.var_1226 = new class_220(class_9.var_3268,class_33.var_3679,class_33.var_3679,var_180.var_1067);
      ...
      public function method_938(param1:int, param2:Number = 1) : void
      {
         ...
         if(!this.var_337)
         {
            ...
            this.var_337.graphics.drawRoundRect(class_183.var_7129,class_183.var_7129,name_5,var_206 + class_33.var_3679,class_9.var_3267);
      ...
      public function method_941(param1:String, param2:Boolean = true, param3:Boolean = true) : class_244
      {
         ...
         else
         {
            ...
            if(!this.var_1227)
            {
               this.var_1227 = new class_220(class_9.var_3268,class_33.var_3679,class_33.var_3679);
               this.var_1227.mouseEnabled = class_99.var_4682;
            }
            _loc4_ = this.var_1226.defaultTextFormat;
            _loc4_.color = class_54.method_1970(int(_loc4_.color),class_183.var_7129,class_33.var_3630,class_107.var_5029);
            ...
            addChildAt(this.var_1227,this.var_1226.parent.getChildIndex(this.var_1226) + class_33.var_3679);
         }
         if(param3)
         {
      ...
      {
         if(this.var_1226.length == class_183.var_7129)
         {
      ...
      public function method_951(param1:Sprite) : class_244
      {
         ...
         var _loc2_:int = var_206 - class_121.var_5495;
