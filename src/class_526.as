package
{
   ...
   public class class_526 extends class_24
   {
      ...
      {
         this.var_363 = class_73.method_2111(class_9.var_3268);
         ...
         super(class_73.method_2108(class_146.var_6053),class_124.var_5657);
         ...
         method_239(class_26.method_1668(class_73.method_2111(class_162.var_6298)),class_526.method_439);
         method_188();
         this.var_2067 = new class_24(name_5 * class_121.var_5495 / class_73.method_2108(class_117.var_5287) - method_220() / class_165.var_6534,var_206);
         ...
         this.var_2068.method_216(new class_245(class_243.const_642,class_73.method_2108(class_165.var_6534)));
      ...
      public static function method_427(param1:Boolean = true, param2:String = "") : void
      {
         if(param1)
         {
            if(param2 == class_73.method_2111(class_9.var_3268))
            {
            ...
            if(!class_526.var_2884)
            {
               ...
               class_526.var_2884.x = (class_107.var_5074 - class_526.var_2884.name_5) / class_73.method_2108(class_165.var_6534);
               class_526.var_2884.y = class_73.method_2108(class_33.var_3675) + class_183.var_7127 + (class_73.method_2108(class_183.var_7096) - class_526.var_2884.var_206) / class_165.var_6534;
            }
      ...
      public function method_1533(param1:int) : class_23
      {
         ...
         var _loc4_:int = _loc3_ * class_526.const_1182 + (_loc3_ - class_73.method_2108(class_33.var_3679)) * this.var_2067.method_220();
         if(_loc4_ >= this.var_2067.var_206)
         {
            _loc2_ -= class_73.method_2108(class_9.var_3267);
         }
         var _loc5_:class_24 = new class_24(_loc2_,class_73.method_2108(class_165.var_6506));
      ...
      public function method_1336() : void
      {
         ...
         _loc4_.method_866();
         _loc4_.htmlText = class_26.method_1668(class_60.var_3907,class_73.method_2111(class_127.var_5831) + this.var_2069 + class_73.method_2111(class_92.var_4585));
         ...
         _loc5_.method_866();
         _loc5_.htmlText = class_26.method_1668(class_73.method_2111(class_102.var_4791),class_127.var_5831 + this.var_2070.length + class_73.method_2111(class_92.var_4585));
         _loc5_.method_856(TextFormatAlign.CENTER).autoSize = TextFieldAutoSize.CENTER;
         this.var_2068.method_136(_loc5_);
         var _loc6_:class_220 = new class_220(class_73.method_2111(class_9.var_3268),this.var_2068.name_5,class_183.var_7129);
         _loc6_.method_866();
         _loc6_.htmlText = class_26.method_1668(class_73.method_2111(class_124.var_5593),class_73.method_2111(class_127.var_5831) + this.var_2071 + class_73.method_2111(class_92.var_4585));
         _loc6_.method_856(TextFormatAlign.CENTER).autoSize = TextFieldAutoSize.CENTER;
         this.var_2068.method_136(_loc6_);
         var _loc7_:class_220 = new class_220(class_73.method_2111(class_9.var_3268),this.var_2068.name_5,class_73.method_2108(class_183.var_7129));
         _loc7_.method_866();
         _loc7_.htmlText = class_26.method_1668(class_107.var_5002,class_73.method_2111(class_127.var_5831) + this.var_2072 + class_92.var_4585);
