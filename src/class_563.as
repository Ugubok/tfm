package
{
   ...
   public class class_563 extends class_166
   {
      ...
      public function class_563(param1:class_255)
      {
         ...
         this.var_2181 = class_9.var_3268;
      ...
      override public function name_2(param1:int) : void
      {
         ...
         if(this.var_2178)
         {
            if(this.var_2187 && this.var_2188 >= class_183.var_7129 && this.var_2188 <= class_33.var_3679)
            {
               _loc2_ = class_146.var_6118;
               this.var_2187.x = Math.random() * _loc2_ - _loc2_ / class_165.var_6534;
               this.var_2187.y = Math.random() * _loc2_ - _loc2_ / class_165.var_6534;
            }
         }
      }
      ...
      override public function method_656(param1:class_58) : void
      {
         ...
         var_873 = class_563.const_1200.indexOf(_loc2_) != -class_33.var_3679;
      ...
      public function method_1590(param1:String, param2:String) : void
      {
         if(!this.var_2184)
         {
            this.var_2184 = new class_24(class_89.var_4432,class_124.var_5657);
            this.var_2184.method_227(class_243.const_642,class_183.var_7129);
            this.var_2183 = new class_220(param1,this.var_2184.name_5 - class_146.var_6117,class_183.var_7129);
            ...
            this.var_2184.y = class_102.var_4859;
         }
         this.var_2184.clear();
         var _loc3_:class_250 = new class_250(class_146.var_5954 + param2 + class_89.var_4385,class_62.var_4130,class_102.var_4742);
         _loc3_.filters = new Array(new DropShadowFilter(class_121.var_5495,class_165.var_6498,class_183.var_7129,class_33.var_3679,class_117.var_5287,class_117.var_5287,class_33.var_3679,class_146.var_6118));
         this.var_2184.method_136(_loc3_);
         _loc3_.x = class_165.var_6506;
         this.var_2184.method_221(class_146.var_6118);
         this.var_2184.method_136(this.var_2183);
         this.var_2183.x = class_117.var_5287;
         this.var_2183.text = param1;
         this.var_2184.graphics.clear();
         this.var_2184.graphics.beginFill(class_183.var_7129,class_102.var_4801);
         this.var_2184.graphics.drawRoundRect(class_183.var_7129,this.var_2183.y - class_146.var_6118,this.var_2184.name_5,this.var_2183.height + class_170.var_6731,class_146.var_6117);
      ...
      override public function method_666(param1:class_501) : void
      {
         ...
         switch(param1.var_574)
         {
            case class_33.var_3679:
               ...
               _loc3_ = param1.method_1477(class_33.var_3679) + class_33.var_3679;
               _loc4_ = _loc2_ * _loc3_;
               _loc9_ = class_183.var_7129;
               while(_loc9_ < _loc4_)
               {
                  _loc10_ = param1.method_1477(class_165.var_6534 + class_165.var_6534 * _loc9_);
                  _loc11_ = param1.method_1476(class_165.var_6534 + class_165.var_6534 * _loc9_ + class_33.var_3679);
                  ...
                  if(!_loc11_)
                  {
                     ...
                     if(class_563.const_1211.indexOf(_loc10_) == -class_33.var_3679)
                     {
                        _loc14_ = class_183.var_6996;
                        _loc15_ = class_146.var_6065.charCodeAt(class_183.var_7129) + (_loc10_ - _loc14_) / _loc3_;
                        _loc16_ = (_loc10_ - _loc14_) % _loc3_ + class_33.var_3679;
                        _loc13_ = new class_220(class_9.var_3268,class_16.var_3473,class_183.var_7127);
               ...
               this.var_2179.y = class_60.var_3972;
            ...
            case class_165.var_6534:
               ...
               _loc12_ = this.var_2180[_loc5_][class_183.var_7129] as class_250;
               ...
               _loc6_ = this.var_2180[_loc5_][class_33.var_3679];
            ...
            case class_146.var_6118:
               ...
               while(class_33.var_3679 < class_48.var_3753.length)
               {
            ...
            case class_121.var_5495:
               ...
               this.var_2186 = new class_250(class_146.var_5954 + param1.method_1478(class_183.var_7129) + class_89.var_4385,class_92.var_4519,class_107.var_4879);
            ...
            case class_117.var_5287:
               ...
               {
                  this.var_2187 = new class_250(class_183.var_6969 + _loc9_ + class_117.var_5274,class_107.var_5074,class_89.var_4432);
               ...
               this.method_1591(class_183.var_7129);
         }
      }
      ...
      override public function method_661(param1:class_168, param2:int) : void
      {
         if(this.var_2178)
         {
            this.method_1590(class_26.method_1668(class_9.var_3256 + this.var_2182),this.var_2181);
         }
      }
