package
{
   ...
   public class class_299
   {
      ...
      public static function method_2870(param1:class_168, param2:int, param3:Boolean) : void
      {
         ...
         if(param3)
         {
            if(_loc6_ == class_296.const_733 || _loc6_ == class_296.const_742)
            {
               ...
               while(++_loc9_ < class_121.var_5493)
               {
                  _loc4_ = new class_27(_loc7_,false);
                  _loc4_.var_308 = (Math.sin(-class_165.var_6506 + _loc9_) + Math.cos(_loc9_ - class_165.var_6506)) * _loc8_;
                  _loc4_.var_309 = _loc8_ * (Math.cos(_loc9_ - class_165.var_6506) - Math.sin(-class_165.var_6506 + _loc9_));
            ...
            if(_loc6_ == class_296.const_737)
            {
               ...
               _loc11_.x = param1.x;
               _loc11_.y = -class_33.var_3675 + param1.y;
               class_58.var_3803.var_545.addChildAt(_loc11_,class_183.var_7129);
               return;
            }
            if(class_296.const_752 == _loc6_)
            {
               param1.method_708();
               _loc12_ = class_58.var_3803.var_545.getChildByName(class_4.var_2899 + param1.var_363);
               if(_loc12_)
               {
            ...
            if(_loc6_ == class_296.const_739)
            {
               ...
               if(!_loc14_)
               {
                  ...
                  _loc14_.name = class_16.var_3272;
                  class_58.var_3803.var_545.addChildAt(_loc14_,class_183.var_7129);
               }
               _loc14_.x = param1.x;
               _loc14_.y = -class_9.var_3243 + param1.y;
               return;
            }
            if(class_296.const_740 == _loc6_)
            {
               param1.var_901.method_1484(class_181.var_6922);
               return;
            }
            if(_loc6_ == class_296.const_225)
            {
               ...
               class_58.var_3803.var_545.addChildAt(_loc15_,class_183.var_7129);
               _loc15_.x = param1.x;
               _loc15_.y = param1.y + class_121.var_5494;
               return;
            }
            ...
            {
               param1.var_901.method_1481(class_181.var_6922);
               return;
            }
            if(class_296.const_749 == _loc6_)
            {
               param1.var_901.method_1483(class_181.var_6922);
               return;
            }
      ...
      {
         param1.method_709();
         class_39.var_3745.method_313(new class_389(class_165.var_6534));
      ...
      public static function method_2873(param1:class_168, param2:Sprite, param3:String, param4:int) : void
      {
         ...
         var _loc6_:class_220 = new class_220(param3,class_183.var_7129,class_92.var_4628,new TextFormat(class_60.var_3917,class_162.var_6346,param4));
         _loc6_.x = -_loc6_.width / class_165.var_6534;
         _loc6_.y = -class_117.var_5287;
         _loc5_.addChild(_loc6_);
         _loc6_.filters = new Array(new GlowFilter(class_183.var_7129,class_33.var_3679,class_146.var_6118,class_146.var_6118,class_117.var_5287,class_33.var_3679));
         _loc5_.x = param1.x;
         _loc5_.y = -class_162.var_6351 + param1.y;
         class_233.method_2810(_loc5_,class_117.var_5288,class_398.method_2931,class_183.var_7129,class_299.method_2872,_loc5_).method_1267(_loc5_.y,_loc5_.y - class_89.var_4436);
      ...
      public static function method_2876(param1:String, param2:Boolean = false) : Sprite
      {
         ...
         _loc3_.htmlText = class_92.var_4475 + param1;
         _loc3_.x = -_loc3_.width / class_165.var_6534;
         ...
         if(class_96.const_485 || class_96.const_486 || class_96.const_484 || class_96.const_482 || !class_31.method_1914() || param2)
         {
            ...
            {
               _loc6_ = class_117.var_5115;
               _loc7_ = class_170.var_6690;
      ...
      public static function method_2877(param1:class_168, param2:int, param3:int) : void
      {
         ...
         class_299.method_2873(param1,_loc4_,class_26.method_1668(class_165.var_6357,param2,param3),class_54.const_285);
      }
   }
}
