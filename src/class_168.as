package
{
   ...
   public class class_168 extends Sprite
   {
      ...
      public function class_168(param1:String, param2:String = "0", param3:Boolean = false, param4:Boolean = false, param5:int = -1, param6:int = -1, param7:Boolean = false)
      {
         ...
         this.var_888 = class_33.var_3679;
         this.var_890 = class_33.var_3679;
         this.var_898 = new class_172(class_165.var_6534);
         this.var_155 = new class_116(-class_165.var_6506,-class_170.var_6714,class_121.var_5493,class_165.var_6492);
         this.var_904 = class_183.var_7129;
         this.var_910 = class_183.var_7129;
         this.var_911 = class_183.var_7129;
         this.var_917 = class_183.var_7129;
         this.var_918 = -class_33.var_3679;
         this.var_919 = class_1.method_1816();
         this.var_368 = class_183.var_7129;
         this.var_921 = class_183.var_7129;
         this.var_922 = class_183.var_7129;
         this.var_923 = class_121.var_5450;
         this.var_931 = class_33.var_3679;
         this.var_372 = class_124.var_5665;
         this.var_937 = new Dictionary();
         this.var_944 = class_183.var_7129;
         this.var_947 = -class_33.var_3679;
         super();
         if((class_168.var_6538 || !class_17.var_3475 || class_91.var_4451 > class_183.var_7129) && param1 != class_111.var_363 && param1 != class_146.var_5998)
         {
            param2 = class_92.var_4530;
            param5 = -class_33.var_3679;
            param6 = -class_33.var_3679;
         }
         ...
         if(class_91.var_4463 > class_183.var_7129 && param1 == class_111.var_363)
         {
            param5 = 14670030;
         }
         this.var_609.method_123(param2,null,true,false,true);
         if(param5 > class_183.var_7129 && param5 != class_11.const_55 && this.var_609.method_120() == class_33.var_3679)
         {
         ...
         var _loc8_:Boolean = class_184.var_2341.var_968;
      ...
      {
         class_180.method_2675(class_16.var_3337,class_92.var_4648);
      }
      
      public function method_685() : void
      {
         this.var_896 = class_175.method_118(class_124.var_5547);
         this.var_896.x = -class_162.var_6351;
         this.var_896.y = -class_102.var_4822;
      ...
      public function method_686(param1:Boolean, param2:Boolean = false) : void
      {
         ...
         {
            if(this.var_155.var_659[class_183.var_7129].var_298 < class_170.var_6731)
            {
               return;
            }
         }
         if(this.var_902 && this.var_155.var_659[class_183.var_7129] != this.var_894.var_798 && this.var_155.var_659[class_183.var_7129] != this.var_894.var_804)
         {
            this.var_887 = class_33.var_3679;
         }
         else
         {
            if(this.var_924)
            ...
            this.var_155.var_659[class_183.var_7129] = _loc3_;
      ...
      public function x_finAnimConfetti() : void
      {
         ...
         if(this.var_905)
         {
            class_285.method_2847(!!this.var_912 ? int(x + class_33.var_3675) : int(x - class_33.var_3675),y - class_117.var_5287,this.var_912);
            class_180.method_2675(class_181.var_6837,class_1.var_2878.method_168(x,y) * (!!this.var_773 ? class_33.var_3679 : class_92.var_4648));
         }
      ...
      {
         if(class_183.var_7129 == this.var_155.var_659.length)
         {
            return false;
         }
      ...
      public function method_689(param1:Boolean) : void
      {
         ...
         class_1.var_2884.method_33(class_56.const_193,this[class_89.var_4424],this[class_107.var_5063],class_146.var_6117,class_165.var_6534,false);
      }
      ...
      public function method_691() : void
      {
         ...
         if(this.var_927)
         {
            _loc1_ = class_175.method_118(class_92.var_4531,true);
            ...
            addChild(_loc1_);
            addChild(_loc2_);
            _loc2_.scaleX = -class_33.var_3679;
            _loc1_.x = -int(this.var_927.width / class_165.var_6534);
            _loc1_.y = -class_89.var_4436;
            _loc2_.x = int(this.var_927.width / class_165.var_6534);
            _loc2_.y = -class_89.var_4436;
         }
      }
      ...
      public function method_692(param1:int, param2:String = null, param3:Boolean = false) : void
      {
         ...
         if(_loc4_.var_1410)
         {
            this.var_940.addFrameScript(this.var_940.totalFrames - class_33.var_3679,this.method_726);
         }
         else if(_loc4_ == class_288.const_714)
         {
            _loc5_ = class_175.method_2618(class_60.var_3866 + param2.toUpperCase() + class_89.var_4385);
            _loc5_.y = -class_4.var_3042;
      ...
      public function method_693(param1:int, param2:int, param3:String = null, param4:String = null, param5:int = 1) : void
      {
         ...
         if(param1 == class_358.const_879 && param2 == class_162.var_6226)
         {
            return;
         }
         ...
         switch(param1)
         {
            ...
            case class_358.const_876:
               ...
               if(param1 == class_358.const_875 || param1 == class_358.const_883)
               {
                  ...
                  {
                     _loc14_ = new class_250(class_107.var_4930,class_102.var_4859,class_102.var_4859);
                     _loc14_.method_973(class_33.var_3675,class_33.var_3675);
               ...
               {
                  _loc6_ = class_21.method_1889(_loc7_[class_183.var_7129],_loc7_[class_33.var_3679]);
               }
               break;
            case class_358.const_877:
               if(class_183.var_7129 == param2)
               {
                  _loc6_ = class_175.method_118(class_89.var_4407);
               }
            ...
            case class_358.const_880:
               ...
               _loc10_.y = -class_33.var_3675;
               _loc6_.addChild(_loc10_);
               break;
            case class_358.const_881:
               _loc6_ = new MovieClip();
               _loc11_ = class_175.method_118(class_127.var_5833 + param2,true);
      ...
      public function method_694() : void
      {
         ...
         this.var_940.gotoAndPlay(class_165.var_6534);
         this.var_940.addFrameScript(class_162.var_6346,this.method_696);
         if(this.var_30)
         {
            this.var_940.scaleX = !!this.var_912 ? Number(class_184.var_2341.var_987) : Number(-class_184.var_2341.var_987);
         }
      ...
      {
         if(class_150.var_6133 == null || class_150.var_6133.length == class_183.var_7129)
         {
            return;
         }
         var _loc2_:class_27 = class_150.var_6133[param1].method_126();
         _loc2_.var_293 = class_99.var_4682;
         _loc2_.method_268(class_183.var_7129,_loc2_.var_297);
      ...
      public function method_697(param1:Boolean) : void
      {
         ...
         var _loc2_:Function = this.method_689;
         if(this.var_906)
         {
            _loc2_(class_183.var_7129);
         }
         this.method_701(false);
         if(this.var_155.var_659[class_183.var_7129] != this.var_894.var_805 && this.var_155.var_659[class_183.var_7129] != this.var_894.var_801)
         {
            _loc3_ = !!this.var_368 ? this.var_894.var_805 : this.var_894.var_801;
            this.var_155.var_659[class_183.var_7129] = _loc3_;
            _loc3_.method_268(class_183.var_7129,class_92.var_4647);
            this.name_25(param1);
         }
         if(this.var_30)
         {
            ...
            if(class_183.var_7129 < class_184.var_2341.var_984)
            {
         ...
         if(param1)
         {
            ...
            if(!this.var_902)
            {
               ...
               if(this.var_155.var_659.length)
               {
                  ...
                  this.var_926 = this.var_155.var_659[class_183.var_7129].var_298;
               }
         ...
         else if(this.var_902)
         {
            ...
            if(!this.var_889)
            {
               if(_loc3_ != this.var_894.var_798 && _loc3_ != this.var_894.var_804 && _loc3_ != this.var_894.var_805 && _loc3_ != this.var_894.var_801)
               {
                  ...
                  else if(class_33.var_3679 == this.var_887)
                  {
                     this.method_686(this.var_912);
                  }
                  else
      ...
      public function method_700() : void
      {
         ...
         this.method_701(false);
         var _loc1_:class_27 = this.var_894.method_578(class_33.var_3679,class_121.var_5372);
         this.var_155.var_659[class_183.var_7129] = _loc1_;
         _loc1_.method_268(class_183.var_7129,class_181.var_6939,this.method_714);
         this.var_155.var_660 = class_99.var_4681;
         if(this.var_912)
         {
            this.var_912 = class_99.var_4681;
            this.var_155.scaleX = class_33.var_3679;
            this.var_155.x = -class_165.var_6506;
         }
         else
         {
         ...
         if(this.var_912)
         {
            class_129.method_2427(class_56.const_309,x + class_117.var_5264,y - class_117.var_5287,class_33.var_3679,class_165.var_6534,false,class_183.var_7129);
         }
         else
         {
            class_129.method_2427(class_56.const_309,x - class_117.var_5264,y - class_117.var_5287,class_33.var_3679,-class_165.var_6534,false,class_183.var_7129);
      ...
      public function method_701(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            addChildAt(this.var_940,class_183.var_7129);
            if(this.var_930)
            {
               addChildAt(this.var_930,class_183.var_7129);
            }
         }
         else
         {
      ...
      public function method_581(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            class_1.var_2884.method_33(class_56.const_193,x - class_146.var_6117,y - class_146.var_6117,class_146.var_6117,class_165.var_6534,false);
            this.var_368 = class_183.var_7129;
      ...
      public function method_702(param1:String, param2:int = 0, param3:int = 0, param4:int = 1) : void
      {
         if(!this.var_895)
         {
            ...
            if(param1 == null || param1.charAt(class_183.var_7129) == class_33.var_3659)
            {
               return;
            }
      ...
      public function method_705(param1:int) : void
      {
         ...
         if(!this.var_908)
         {
            this.var_908 = class_175.method_118(class_92.var_4529);
         }
         if(class_183.var_7129 == param1)
         {
            if(this.var_908.parent)
            {
               this.var_908.gotoAndPlay(class_117.var_5265);
               return;
            }
         }
         ...
         this.var_908.gotoAndPlay(class_33.var_3679);
      ...
      public function method_706(param1:Boolean) : void
      {
         ...
         {
            this.var_894 = class_150.method_2521(class_124.var_5665,class_33.var_3679,class_150.const_550,new <int>[class_168.const_574,class_183.var_7129]);
         }
      ...
      public function method_707(param1:Boolean) : void
      {
         ...
         if(this.var_902)
         {
            this.var_887 = class_165.var_6534;
         }
         else
         {
      ...
      public function method_708() : void
      {
         ...
         this.method_692(class_102.var_4852);
      }
      ...
      public function transformice(param1:int) : void
      {
         ...
         if(!this.var_950)
         {
            this.var_950 = class_175.method_118(class_92.var_4528);
         }
         this.var_155.scaleX = !!this.var_912 ? Number(class_33.var_3679) : Number(-class_33.var_3679);
         this.var_155.scaleY = class_33.var_3679;
         this.var_155.x = -class_165.var_6506 * this.var_155.scaleX;
         this.var_155.y = -class_165.var_6506;
         this.var_155.var_659[class_183.var_7129] = this.var_894.var_796;
         this.var_894.var_796.method_271(class_183.var_7129);
         this.var_155.var_660 = class_99.var_4681;
         this.var_155.method_476();
         this.var_951 = new Bitmap(class_1.var_2884.var_67[param1],class_183.var_7017,true);
         addChildAt(this.var_951,class_183.var_7129);
         this.var_951.y = -int(this.var_951.height / class_165.var_6534);
         this.var_951.scaleX = this.var_155.scaleX;
         this.var_951.x = -(int(this.var_951.width / class_165.var_6534) * this.var_951.scaleX);
         ...
         else if(class_46.const_185 == param1)
         {
            ...
            this.var_155.y -= class_92.var_4628;
         }
         ...
         if(param1 == class_46.const_187 || param1 == class_46.const_188)
         {
            ...
            _loc3_ = new class_167(_loc2_.position.var_304,class_9.var_3254 + _loc2_.position.var_305);
            this.var_925.method_556(_loc3_,class_121.method_2361());
            y += class_146.var_6117;
         }
         ...
         this.var_950.y = this.var_155.y + class_117.var_5280;
      ...
      public function method_710(param1:Boolean) : void
      {
         if(!this.var_881)
         {
            this.var_881 = class_175.method_118(class_124.var_5661);
            this.var_881.x_texte.text = class_26.method_1668(class_124.var_5661);
      ...
      public function method_711(param1:int) : void
      {
         ...
         class_180.method_2675(class_9.var_3132,class_1.var_2878.method_168(x,y) * (!!this.var_773 ? class_33.var_3679 : class_92.var_4648));
      }
      ...
      public function method_713(param1:Event) : void
      {
         ...
         if(_loc4_ < class_121.var_5493)
         {
            ...
            transform.colorTransform = new ColorTransform(class_168.var_6540.redMultiplier * class_16.var_3435,class_168.var_6540.greenMultiplier * class_16.var_3435,class_168.var_6540.blueMultiplier * class_16.var_3435);
      ...
      public function method_715() : void
      {
         ...
         {
            _loc1_ = class_175.method_118(class_183.var_7019);
         }
         else if(class_33.var_3679 == this.var_954)
         {
            _loc1_ = class_175.method_118(class_183.var_7018);
         }
         else if(this.var_954 == class_165.var_6534)
         {
            _loc1_ = class_175.method_118(class_170.var_6614);
         }
         if(_loc1_)
         {
            _loc1_.y = -class_107.var_5038;
            addChild(_loc1_);
            this.var_954 = -class_33.var_3679;
         }
      }
      
      public function method_716() : Boolean
      {
         return this.var_155.var_659.length && (this.var_155.var_659[class_183.var_7129] == this.var_894.var_801 || this.var_155.var_659[class_183.var_7129] == this.var_894.var_805);
      }
      ...
      public function method_717(param1:int, param2:int) : void
      {
         ...
         if(class_503.const_1164 == param1)
         {
            ...
            this.var_916.y = -class_181.var_6939;
         }
         if(this.var_916)
         {
            this.var_915 = class_99.var_4681;
            ...
            this.var_911 = class_1.method_1816() + param2 * class_4.var_3058;
            class_1.var_2884.method_98();
      ...
      public function method_721() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(this.var_368 == class_33.var_3679)
            {
               ...
               {
                  this.var_155.var_659[class_183.var_7129] = this.var_894.var_804;
               }
               else if(_loc1_ == this.var_894.var_799)
               {
                  this.var_155.var_659[class_183.var_7129] = this.var_894.var_800;
               }
            }
            ...
            {
               this.var_155.var_659[class_183.var_7129] = this.var_894.var_797;
               this.var_894.var_797.method_268(_loc2_);
            }
            else if(this.var_894.var_804 == _loc1_)
            {
               this.var_155.var_659[class_183.var_7129] = this.var_894.var_798;
            }
            else if(this.var_894.var_800 == _loc1_)
            {
               this.var_155.var_659[class_183.var_7129] = this.var_894.var_799;
            }
      ...
      public function method_723(param1:int) : void
      {
         ...
         if(var_7519 >= class_181.var_6939)
         {
            this.var_949 = new Sprite();
            this.var_949.addChild(new class_250(class_60.var_3865 + var_7519 + class_89.var_4385,class_183.var_7129,class_183.var_7129,-class_183.var_7127,-class_183.var_7127));
         }
         else
         {
         ...
         this.var_949.x = this[class_89.var_4424];
      ...
      public function method_724(param1:Event) : void
      {
         ...
         {
            if(this.var_940.currentFrame == this.var_940.totalFrames - class_33.var_3679)
            {
               class_502.name_6();
      ...
      public function method_725(param1:Boolean) : void
      {
         ...
         if(this.var_155.var_659.length && (this.var_155.var_659[class_183.var_7129] == this.var_894.var_805 || this.var_155.var_659[class_183.var_7129] == this.var_894.var_801))
         {
            ...
            this.var_155.var_659[class_183.var_7129] = _loc2_;
            _loc2_.method_268(class_92.var_4647,class_146.var_6117,this.method_686,param1);
            this.name_25(param1);
         }
         if(this.var_773)
         {
            if(this.var_879 && this.var_30 && class_184.var_2341.var_984 > class_183.var_7129)
            {
               _loc3_ = getTimer() - this.var_944;
               if(_loc3_ > class_4.var_3058)
               {
                  _loc4_ = _loc3_ / class_146.var_6087;
                  if(class_33.var_3679 < _loc4_)
                  {
                     _loc4_ = class_33.var_3679;
                  }
                  _loc5_ = _loc4_ * class_184.var_2341.var_984;
                  this.var_925.var_756.var_305 = -((_loc5_ + class_183.var_7129) * class_146.var_6118);
                  class_68.var_4230 = class_99.var_4682;
                  this.var_925.var_756.var_304 += Math.random() * class_146.var_6117 - class_117.var_5287;
                  class_1.var_2884.method_98();
               }
            }
         }
      ...
      public function name_25(param1:Boolean) : Boolean
      {
         ...
         if(param1)
         {
            if(class_183.var_7129 > this.var_155.scaleX)
            {
               ...
               if(this.var_877)
               {
                  this.var_877.scaleX = class_33.var_3679;
                  this.var_930.scaleX = class_33.var_3679;
               }
               return true;
            }
         }
         else if(this.var_155.scaleX > class_183.var_7129)
         {
            this.var_155.scaleX = -this.var_155.scaleX;
            this.var_155.x = -class_165.var_6506 * this.var_155.scaleX;
            if(this.var_877)
      ...
      public function method_727(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            this.var_893.graphics.drawRect(-class_33.var_3675,class_183.var_7127,class_102.var_4859,-class_89.var_4436);
      ...
      public function method_65(param1:Boolean, param2:int = 0) : void
      {
         ...
         if(this.var_30)
         {
            ...
            if(this.var_773)
            {
               ...
               this.var_900.x = -class_162.var_6351;
               this.var_900.y = class_146.var_6117;
            }
            if(!_loc3_)
            {
      ...
      public function method_729(param1:Number = 1.0) : void
      {
         ...
         if(!this.var_127)
         {
            ...
            this.var_155.scaleY = this.var_923;
            this.var_155.x = -class_165.var_6506 * this.var_155.scaleX;
            this.var_155.y = -class_170.var_6714 * this.var_923;
            if(param1 < class_33.var_3679)
            {
               if(param1 * class_146.var_6117 % class_165.var_6534 == class_183.var_7129)
               {
                  this.var_155.y = Math.ceil(this.var_155.y);
               }
               this.var_155.y += class_89.var_4430 / param1 * class_9.var_3254;
            }
            class_182.method_2693(this,class_183.var_7129,this.var_923);
         }
         else
         {
            class_1.var_2884.method_33(class_56.const_193,x,y,class_146.var_6117,class_165.var_6534,false);
         }
      }
      ...
      {
         if(this.var_894.var_798 == null || this.var_894.var_804 == null || this.var_155.var_659.length == class_183.var_7129)
         {
            return false;
         }
         var _loc1_:class_27 = this.var_155.var_659[class_183.var_7129];
      ...
      {
         if(this.var_155.var_659.length == class_183.var_7129)
         {
            return false;
         }
         var _loc1_:class_27 = this.var_155.var_659[class_183.var_7129];
