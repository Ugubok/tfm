package
{
   ...
   public class class_298 extends Sprite
   {
      ...
      public function class_298()
      {
         ...
         _loc1_.x = class_73.method_2108(class_89.var_4432) - _loc1_.width / class_165.var_6534 - class_298.name_75;
         ...
         this.var_1436.x = class_73.method_2108(class_183.var_7129);
         this.var_1436.y = class_73.method_2108(class_183.var_7129);
         addChild(this.var_1436);
         this.var_1437 = class_175.method_118(class_73.method_2111(class_4.var_2971));
         ...
         this.var_1437.y = class_73.method_2108(class_183.var_7129);
         ...
         this.var_1425.y = class_298.const_768 - class_73.method_2108(class_165.var_6534);
         addChild(this.var_1425);
         this.var_1430 = new class_30(class_298.const_769 - class_73.method_2108(class_165.var_6534) * class_298.const_768 - class_165.var_6534,class_298.const_770 - class_73.method_2108(class_165.var_6534) * class_298.const_768,class_300.const_772,false,class_298.const_767);
         ...
         class_298.var_7209 = new class_88(_loc1_.x + class_73.method_2108(class_102.var_4852),_loc1_.y + class_73.method_2108(class_102.var_4852),class_26.method_1668(class_107.var_5045),this.method_429,null,class_73.method_2108(class_107.var_5037),class_84.var_4254);
         addChild(class_298.var_7209);
         var _loc2_:class_88 = new class_88(_loc1_.x + class_102.var_4852,_loc1_.y + class_102.var_4852 + class_73.method_2108(class_9.var_3259),class_26.method_1668(class_73.method_2111(class_183.var_7052)),class_298.method_2868,null,class_107.var_5037,class_84.var_4254);
         addChild(_loc2_);
      }
      ...
      public static function name_6(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            class_298.var_2884.addEventListener(class_73.method_2111(class_124.var_5632),class_298.var_2884.name_2);
         }
         else if(class_298.var_2884)
         {
            class_298.var_2884.removeEventListener(class_73.method_2111(class_124.var_5632),class_298.var_2884.name_2);
      ...
      public static function method_2862(param1:String, param2:int) : void
      {
         ...
         if(param1 != class_168.var_6539.var_363 || param2 == class_73.method_2108(class_92.var_4647))
         {
      ...
      public static function method_2863(param1:String, param2:int) : void
      {
         ...
         else if(class_73.method_2108(class_165.var_6534) == param2)
         {
            _loc3_ = class_26.method_1668(class_102.var_4698,param1);
         }
         else if(param2 == class_146.var_6118)
         {
            _loc3_ = class_26.method_1668(class_73.method_2111(class_181.var_6798),param1);
         }
         else if(class_73.method_2108(class_121.var_5495) == param2)
         {
            _loc3_ = class_26.method_1668(class_73.method_2111(class_162.var_6183));
         }
         else if(param2 == class_117.var_5287)
         {
            _loc3_ = class_26.method_1668(class_181.var_6797,param1);
         }
         else if(class_73.method_2108(class_9.var_3267) == param2)
         {
            _loc3_ = class_26.method_1668(class_183.var_7032,param1);
         }
         else if(param2 == class_73.method_2108(class_92.var_4647))
         {
         ...
         class_298.var_7215.method_967(class_183.var_7129,class_73.method_2108(class_33.var_3675),class_73.method_2108(class_107.var_5074),class_73.method_2108(class_183.var_7096));
      ...
      public static function method_2866(param1:String) : void
      {
         ...
         _loc2_.push(class_26.method_1668(class_73.method_2111(class_117.var_5173)),class_298.method_2859,param1);
         _loc2_.push(class_26.method_1668(class_73.method_2111(class_92.var_4548)),class_298.method_2861,param1);
      ...
      public static function method_2867(param1:String) : void
      {
         ...
         if(!class_298.var_7211)
         {
            ...
            class_298.var_7211.method_216(new class_245(class_243.const_642,class_73.method_2108(class_9.var_3267)));
            class_298.var_7212 = new class_220(class_9.var_3268,class_298.var_7211.name_5,class_73.method_2108(class_183.var_7129)).method_864(class_54.const_279).method_856(TextFormatAlign.CENTER);
            class_298.var_7214 = new class_23(class_73.method_2108(class_127.var_5865),class_127.var_5865);
            _loc2_ = class_175.method_118(class_73.method_2111(class_92.var_4591));
            ...
            class_298.var_7213 = new class_246(class_26.method_1668(class_73.method_2111(class_181.var_6854)),(_loc3_.name_5 - _loc3_.method_220()) / class_165.var_6534,class_298.method_2864,param1);
            _loc4_ = new class_246(class_26.method_1668(class_73.method_2111(class_181.var_6933)),_loc3_.name_5 / class_73.method_2108(class_165.var_6534) - class_146.var_6118 * _loc3_.method_220() / class_165.var_6534 - class_298.var_7214.name_5,class_298.method_2860,param1);
            _loc3_.method_136(class_298.var_7213);
            _loc3_.method_136(_loc4_);
            _loc3_.method_136(class_298.var_7214);
            class_298.var_7211.method_221(class_73.method_2108(class_9.var_3267));
            class_298.var_7211.method_136(class_298.var_7212);
            class_298.var_7211.method_136(_loc3_);
            class_298.var_7211.x = (class_107.var_5074 - class_298.var_7211.name_5) / class_73.method_2108(class_165.var_6534);
         ...
         class_298.var_7212.htmlText = class_26.method_1668(class_73.method_2111(class_62.var_3999),param1);
         class_298.var_7211.method_228();
         class_298.var_7211.method_241(class_298.var_7211.name_5,class_121.var_5495 + class_298.var_7212.textHeight + class_298.var_7211.method_220() + class_127.var_5865 + class_73.method_2108(class_117.var_5287));
      ...
      public function method_142(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            while(_loc4_ < _loc5_)
            {
               ...
               _loc3_ = this.var_1427[_loc6_][class_73.method_2108(class_33.var_3679)];
               ...
               else
               {
                  ...
                  _loc2_.x = class_73.method_2108(class_33.var_3679);
         ...
         else
         {
            ...
            while(_loc4_ < _loc5_)
            {
               ...
               _loc3_ = this.var_1432[_loc6_][class_73.method_2108(class_33.var_3679)];
               _loc3_.method_1075(this.var_1432[_loc6_][class_73.method_2108(class_183.var_7129)]);
               if(_loc3_.parent)
               {
      ...
      {
         class_298.var_7209.method_452(!!this.var_1428 ? class_26.method_1668(class_73.method_2111(class_181.var_6933)) : class_26.method_1668(class_107.var_5045));
      }
      ...
      public function method_1067(param1:Boolean, param2:int, param3:int) : void
      {
         ...
         if(param1)
         {
            ...
            if(_loc4_ <= class_183.var_7129)
            {
               ...
               this.var_1426.splice(this.var_1426.indexOf(param2),class_73.method_2108(class_33.var_3679));
            }
            class_41.method_1945(param2,param3,true);
         }
         else
         {
            this.var_1432[param2][class_73.method_2108(class_183.var_7129)] = this.var_1432[param2][class_73.method_2108(class_183.var_7129)] - param3;
      ...
      {
         return !!this.var_1427[param1] ? int(this.var_1427[param1][class_183.var_7129]) : int(class_73.method_2108(class_183.var_7129));
      }
      ...
      public function method_1069(param1:Boolean, param2:int, param3:int) : void
      {
         ...
         if(param1)
         {
            if(this.var_1426.indexOf(param2) > -class_73.method_2108(class_33.var_3679))
            {
               if(this.var_1427[param2][class_73.method_2108(class_183.var_7129)] < class_98.method_2232(param2))
               {
                  this.var_1427[param2][class_183.var_7129] += param3;
                  class_41.method_1945(param2,-param3,true);
               }
      ...
      {
         if(this.var_1435 > class_73.method_2108(class_183.var_7129) && new Date().getTime() - this.var_1435 > class_92.var_4625)
         {
            class_298.var_7209.method_453(true);
            this.var_1435 = -class_73.method_2108(class_33.var_3679);
         }
      }
      ...
      public function method_1070(param1:class_168) : void
      {
         if(!this.var_1429)
         {
            ...
            this.var_1429.gotoAndStop(class_73.method_2108(class_121.var_5493));
            this.var_1429.scaleX = class_33.var_3679;
            this.var_1429.x = class_298.const_769 / class_73.method_2108(class_165.var_6534);
         ...
         this.var_1434.gotoAndStop(class_73.method_2108(class_121.var_5493));
         this.var_1434.scaleX = -class_33.var_3679;
         this.var_1434.x = class_298.const_769 + class_298.name_77 + class_298.const_769 / class_73.method_2108(class_165.var_6534);
         this.var_1434.y = -class_73.method_2108(class_170.var_6720);
      ...
      public function method_1071(param1:Boolean, param2:Boolean) : void
      {
         if(param1)
         {
            if(param2)
            {
               this.var_1425.transform.colorTransform = new ColorTransform(class_9.var_3254,class_62.var_4106,class_73.method_2116(class_16.var_3435));
         ...
         else
         {
            if(param2)
            {
               this.var_1430.transform.colorTransform = new ColorTransform(class_9.var_3254,class_62.var_4106,class_73.method_2116(class_16.var_3435));
