package
{
   ...
   public class class_891 implements class_474, class_733
   {
      ...
      public var var_2821:class_775;
      
      public function class_891(param1:class_484)
      {
         super();
         this.name_10 = param1;
      }
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is class_775)
            {
               this.var_2821 = class_775(_loc2_);
               this.var_2821.var_2632 = this;
            }
         }
      }
