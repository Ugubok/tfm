package
{
   ...
   public class class_418 extends class_24
   {
      ...
      public static const const_1083:String = "Time";
      
      public static const const_1084:String = "Reports";
      ...
      public static var var_7289:String = "Lucida Console";
      ...
      public function class_418()
      {
         ...
         this.var_1841 = class_183.var_7129;
         this.var_1842 = class_183.var_7129;
         this.var_1845 = new Vector.<String>();
         this.var_1846 = new Vector.<String>();
         this.var_1850 = new Vector.<class_745>();
         super(class_146.var_6107 - class_165.var_6534 * class_418.const_1085,class_89.var_4404);
         this.name_9();
         this.method_516();
      }
      ...
      public static function method_2977(param1:String, param2:Vector.<String>, param3:Dictionary) : void
      {
         ...
         class_155.var_2884.method_637(class_382.var_7270,param1 + class_117.var_5192);
         if(class_183.var_7129 < param2.length)
         {
            _loc5_ = class_89.var_4390;
            _loc6_ = class_183.var_7129;
            while(_loc6_ < param2.length)
            {
               _loc7_ = param2[_loc6_].replace(class_165.var_6519,class_4.var_3032).replace(class_4.var_3056,class_89.var_4393);
               _loc8_ = param2[_loc6_ + class_33.var_3679].replace(class_165.var_6519,class_4.var_3032).replace(class_4.var_3056,class_89.var_4393);
               _loc9_ = param2[_loc6_ + class_165.var_6534];
               if(_loc5_ != _loc7_)
               {
                  _loc5_ = _loc7_;
                  class_155.var_2884.method_637(class_382.var_7270,class_4.var_2978 + class_26.method_1668(class_170.var_6658) + class_62.var_4066 + _loc7_ + class_62.var_4120);
               }
               class_155.var_2884.method_637(class_382.var_7270,class_102.var_4834 + class_742.method_3079(new Date(Date.parse(_loc9_))) + class_102.var_4833 + _loc8_,param1);
               _loc6_ += class_146.var_6118;
            }
         }
         for(_loc4_ in param3)
         {
            class_155.var_2884.method_637(class_382.var_7270,class_170.var_6649 + _loc4_ + class_4.var_3010);
      ...
      public static function method_2752() : Boolean
      {
         ...
         class_418.var_2884.y = !!class_1.const_45 ? Number((-class_418.var_2884.var_206 + class_1.var_2882) / class_146.var_6118) : Number(class_33.var_3675 + (class_183.var_7096 - class_418.var_2884.var_206) / class_165.var_6534);
      ...
      {
         if(param1 == class_9.var_3185 && param2 != class_9.var_3185)
         {
            return -class_33.var_3679;
         }
         if(param2 == class_9.var_3185 && param1 != class_9.var_3185)
         {
            return class_33.var_3679;
         }
      ...
      public static function name_6() : void
      {
         ...
         if(class_418.var_2884 && class_418.var_2884.parent)
         {
            ...
            class_418.var_2884.removeEventListener(class_121.var_5402,class_418.var_2884.method_1338);
      ...
      public static function method_2983(param1:String = "", param2:int = 0, param3:int = 20) : class_23
      {
         ...
         _loc6_.transform.colorTransform = new ColorTransform(class_4.var_3040,class_4.var_3040,class_4.var_3040);
         if(class_1.var_2878.var_180.var_1073)
         {
            _loc6_.filters = new Array(new BevelFilter(class_33.var_3679,class_107.var_5038,16777215,class_92.var_4648,class_183.var_7129,class_33.var_3679,class_33.var_3679,class_33.var_3679));
         }
      ...
      {
         if(param1.categorie == class_183.var_7129 || param2.categorie == class_183.var_7129)
         {
            if(param1.categorie == class_183.var_7129 && param2.categorie == class_183.var_7129)
            {
               return param1.var_2050 - param2.var_2050;
            }
            return param1.categorie == class_183.var_7129 ? int(-class_33.var_3679) : int(class_33.var_3679);
         }
      ...
      public function method_1313(param1:class_244) : void
      {
         ...
         {
            this.var_1852.method_1736(parseInt(param1.var_1226.text,class_146.var_6117) != class_183.var_7129,false);
         }
      }
      ...
      public function method_1316() : void
      {
         ...
         if(!this.var_1843)
         {
            this.var_1843 = new class_24(class_124.var_5657,class_124.var_5657);
            this.var_1843.method_216(new class_245(class_243.const_642,class_117.var_5287));
            this.var_1851 = new class_745(class_162.var_6269,this.var_1843.name_5);
            _loc1_ = new class_24();
            _loc1_.method_216(new class_245(class_243.const_639,class_170.var_6731));
            ...
            this.var_1853.var_1226.restrict = class_183.var_7051;
            ...
            _loc2_.method_216(new class_245(class_243.const_642,class_117.var_5287));
            _loc2_.graphics.lineStyle(class_33.var_3679,2105376,class_33.var_3679);
            _loc2_.graphics.beginFill(class_183.var_7129,class_92.var_4648);
            _loc2_.graphics.drawRoundRect(-class_165.var_6534,-class_33.var_3679,_loc2_.name_5 + class_165.var_6534 * class_165.var_6534,_loc2_.var_206 - class_33.var_3679,class_170.var_6731,class_170.var_6731);
            this.var_1847 = new class_745(class_16.var_3376);
            _loc2_.method_136(this.var_1847);
            _loc3_ = new class_24(_loc2_.name_5,class_33.var_3675);
            _loc3_.method_216(new class_245(class_243.const_639,class_117.var_5287));
            _loc4_ = new class_220(class_107.var_4973);
            ...
            this.var_1849 = new class_24(class_127.var_5851,class_183.var_7093);
            this.var_1849.method_216(new class_245(class_243.const_642,class_33.var_3679));
            ...
            for each(_loc9_ in class_418.var_7290)
            {
               ...
               _loc13_.graphics.beginFill(1118481,class_146.var_6103);
               _loc13_.graphics.drawRect(class_183.var_7129,class_183.var_7129,_loc13_.name_5,_loc13_.var_206);
            ...
            this.var_1849.method_221(class_165.var_6534);
            _loc10_ = new class_24(this.var_1849.name_5,class_33.var_3675);
            _loc10_.method_216(new class_245(class_243.const_639,class_183.var_7129));
            _loc10_.method_136(class_418.method_2983(class_162.var_6270,(this.var_1849.name_5 - _loc10_.method_220()) / class_165.var_6534).method_203(this.method_1320,true));
            _loc10_.method_136(class_418.method_2983(class_60.var_3932,(this.var_1849.name_5 - _loc10_.method_220()) / class_165.var_6534).method_203(this.method_1320,false));
            ...
            this.var_1849.graphics.beginFill(class_183.var_7129,class_107.var_5029);
            this.var_1849.graphics.drawRoundRect(-class_165.var_6534,-class_165.var_6534,this.var_1849.name_5 + class_121.var_5495,this.var_1849.var_206 + class_121.var_5495,class_170.var_6731,class_170.var_6731);
            _loc12_ = new class_24(this.var_1843.name_5,class_33.var_3675);
            ...
            this.var_1843.graphics.beginFill(class_183.var_7129,class_170.var_6648);
            this.var_1843.graphics.drawRect(-class_117.var_5287,-class_117.var_5287,this.var_1843.name_5 + class_165.var_6534 * class_117.var_5287,this.var_1843.var_206 + class_165.var_6534 * class_117.var_5287);
      ...
      public function method_1317(param1:String, param2:Vector.<String>) : void
      {
         ...
         if(_loc4_ == class_183.var_7129 || _loc3_.var_2421.length == class_183.var_7129)
         {
      ...
      public function method_1318(param1:class_220) : void
      {
         ...
         this.var_1390 = this.var_1391 != null && this.var_1391.length >= class_33.var_3679;
      ...
      public function method_1324() : void
      {
         ...
         this.var_1839 = this.var_1852.method_1737() && this.var_1853.var_1226.length > class_183.var_7129 && parseInt(this.var_1853.var_1226.text,class_146.var_6117) > class_183.var_7129;
         if(this.var_1839)
         {
            this.var_1840 = parseInt(this.var_1853.var_1226.text,class_146.var_6117);
         }
      ...
      public function method_1325(param1:String, param2:class_220, param3:Boolean) : void
      {
         ...
         if(param3 && _loc4_ != -class_33.var_3679 || !param3 && _loc4_ == -class_33.var_3679)
         {
            return;
         }
         if(param3)
      ...
      public function method_1326() : void
      {
         ...
         else if(class_170.var_6731 >= this.var_1846.length)
         {
            for each(_loc2_ in this.var_1846)
            {
               if(_loc1_.length != class_183.var_7129)
               {
                  _loc1_ += class_183.var_7122;
               }
               _loc1_ += _loc2_;
            }
         }
         else if(this.var_1846.indexOf(class_418.var_7287) != -class_33.var_3679)
         {
            _loc1_ = class_418.var_7288 + class_62.var_4065 + (-class_33.var_3679 + this.var_1846.length) + class_124.var_5572;
         }
         else
         {
      ...
      public function method_1328(param1:Vector.<String>, param2:Dictionary) : void
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            if(_loc4_)
            {
               if(param2[_loc3_])
               {
                  (_loc4_.getChildAt(class_183.var_7129) as class_220).htmlText = _loc3_ + class_60.var_3895 + param2[_loc3_] + class_102.var_4763;
               }
               else
               {
                  (_loc4_.getChildAt(class_183.var_7129) as class_220).htmlText = class_62.var_4107 + _loc3_ + class_102.var_4793;
               }
            }
         }
      }
      ...
      public function method_1330(param1:ByteArray) : void
      {
         ...
         for each(_loc5_ in class_418.var_7291)
         {
            ...
            _loc4_.method_866();
            _loc4_.method_865(class_146.var_6117);
            _loc7_ = new class_23(this.var_1831.name_5,class_33.var_3675);
            _loc7_.graphics.beginFill(2236962);
            _loc7_.graphics.drawRect(class_183.var_7129,class_183.var_7129,_loc7_.name_5,_loc7_.var_206);
      ...
      {
         var_236.transform.colorTransform = !!param1 ? new ColorTransform(class_117.var_5201,class_117.var_5201,class_117.var_5201) : new ColorTransform();
      ...
      public function method_1336() : void
      {
         ...
         for(; _loc1_ < _loc2_; _loc1_++)
         {
            ...
            if(this.var_1390)
            {
               ...
               {
                  if(_loc5_.indexOf(this.var_1391) != -class_33.var_3679)
                  {
               ...
               if(!_loc4_)
               {
                  if(_loc3_.var_2580.toLowerCase().indexOf(this.var_1391) != -class_33.var_3679)
                  {
                     _loc4_ = class_99.var_4681;
                  }
               }
      ...
      public function method_1338(param1:Event) : void
      {
         ...
         {
            if(class_1.method_1816() - this.var_1836 > this.var_1840 * class_89.var_4436 * class_4.var_3058)
            {
               this.var_1836 = class_1.method_1816();
               this.method_1329();
            }
         }
         if(class_183.var_7129 < class_418.var_7293.length)
         {
            ...
            for each(_loc4_ in _loc3_)
            {
               if(!_loc4_.var_1519.parent)
               {
                  if(this.var_1837 != -class_33.var_3679 && this.var_1837 != _loc4_.categorie)
                  {
                     ...
                     this.var_1835.method_221(class_117.var_5287);
      ...
      public function method_1339(param1:class_749, param2:class_749) : int
      {
         if(param1.categorie == class_183.var_7129 || param2.categorie == class_183.var_7129)
         {
            ...
            return class_183.var_7129 == param1.categorie ? int(-class_33.var_3679) : int(class_33.var_3679);
         }
      ...
      public function method_516() : void
      {
         ...
         graphics.clear();
         graphics.lineStyle(class_165.var_6534,class_183.var_7129);
         graphics.beginFill(class_183.var_7129,class_107.var_5029);
         graphics.drawRect(-class_418.const_1085,class_183.var_7129,name_5 + class_165.var_6534 * class_418.const_1085,var_206 + class_418.const_1086);
         graphics.endFill();
         graphics.lineStyle(class_33.var_3679,40349);
         graphics.moveTo(class_183.var_7129,class_183.var_7127);
         graphics.lineTo(name_5,class_183.var_7127);
         graphics.lineStyle(class_33.var_3679,40349);
         graphics.moveTo(class_183.var_7129,class_107.var_5039);
         graphics.lineTo(name_5,class_107.var_5039);
         var _loc1_:class_220 = new class_220(class_16.var_3374,name_5,class_183.var_7129);
         ...
         method_136(_loc2_);
         var _loc3_:class_24 = new class_24(class_89.var_4444,class_33.var_3675);
         ...
         _loc3_.method_136(_loc4_);
         _loc4_.method_858();
         var _loc5_:class_220 = new class_220(class_162.var_6270,class_16.var_3473,_loc3_.var_206);
         ...
         var _loc7_:class_220 = new class_220(class_89.var_4390,class_146.var_6117,_loc3_.var_206).method_864(6316175).method_863(class_418.var_7289);
         _loc7_.selectable = class_99.var_4682;
         _loc7_.mouseEnabled = class_99.var_4681;
         _loc3_.method_136(_loc7_);
         _loc7_.method_858();
         var _loc8_:class_220 = new class_220(class_418.var_7288,class_92.var_4628,_loc3_.var_206);
         ...
         _loc7_ = new class_220(class_89.var_4390,class_146.var_6117,_loc3_.var_206).method_864(6316175).method_863(class_418.var_7289);
         _loc7_.selectable = class_99.var_4682;
         _loc7_.mouseEnabled = class_99.var_4681;
         _loc3_.method_136(_loc7_);
         _loc7_.method_858();
         this.var_1829 = new class_220(class_9.var_3268,class_92.var_4628,_loc3_.var_206);
         ...
         var _loc10_:class_23 = new class_23(class_16.var_3467,class_16.var_3467);
         _loc10_.graphics.beginFill(class_183.var_7129,class_183.var_7129);
         _loc10_.graphics.drawRect(class_183.var_7129,class_183.var_7129,_loc10_.name_5,_loc10_.var_206);
         ...
         this.var_1831.y = _loc10_.y + class_165.var_6534 * _loc10_.var_206 + class_121.var_5495;
         var _loc13_:class_24 = new class_24(class_89.var_4444,class_33.var_3675);
         ...
         while(_loc15_ < class_418.var_7292.length)
         {
            ...
            _loc25_ = new class_220(_loc24_,class_89.var_4444,_loc3_.var_206);
            _loc25_.method_863(class_418.var_7289);
            _loc25_.method_864(class_418.const_1088);
            _loc25_.selectable = class_99.var_4682;
            _loc25_.method_858();
            _loc25_.width = class_146.var_6118 + _loc25_.textWidth;
            ...
            if(_loc15_ != class_418.var_7292.length - class_33.var_3679)
            {
         ...
         _loc13_.x = _loc2_.name_5 / class_165.var_6534 - _loc13_.name_5 / class_165.var_6534;
         var _loc16_:class_244 = new class_244(class_170.var_6717,class_33.var_3675,false);
         ...
         var _loc17_:MovieClip = class_175.method_118(class_170.var_6655,true);
         ...
         var _loc19_:class_24 = new class_24(class_121.var_5493,class_127.var_5865);
         ...
         _loc20_.height = class_127.var_5865;
         _loc20_.transform.colorTransform = new ColorTransform(class_92.var_4648,class_92.var_4648,class_92.var_4648,class_33.var_3679,class_183.var_7129,class_183.var_7129,class_183.var_7129);
         ...
         var _loc22_:class_23 = new class_23(class_127.var_5865,class_127.var_5865);
         var _loc23_:MovieClip = class_175.method_118(class_92.var_4591);
         _loc23_.width += class_33.var_3679;
         _loc23_.height += class_33.var_3679;
         _loc23_.transform.colorTransform = new ColorTransform(class_127.var_5799,class_127.var_5799,class_127.var_5799);
         ...
         _loc2_.method_216(new class_245(class_243.const_639,(_loc2_.name_5 - (_loc3_.name_5 + _loc13_.name_5 + _loc16_.name_5 + _loc19_.name_5)) / class_146.var_6118));
         _loc2_.method_136(_loc3_);
         ...
         _loc19_.y = class_33.var_3679;
         this.var_1835 = new class_24(name_5,var_206 - method_217());
         this.var_1835.method_216(new class_245(class_243.const_642,class_117.var_5287));
      ...
      public function name_9() : void
      {
         ...
         class_418.var_7289 = class_60.var_3893;
         try
         {
            if(Capabilities.os.toLowerCase().indexOf(class_162.var_6300) != -class_33.var_3679)
            {
               class_418.var_7289 = class_117.var_5222;
            }
         ...
         class_155.method_2539(class_124.var_5571,class_418.method_2982);
         class_155.method_2539(class_89.var_4371,class_418.method_2980);
         class_155.method_2539(class_89.var_4350,class_418.method_2978);
         class_155.method_2539(class_16.var_3373,class_418.method_2984);
      }
