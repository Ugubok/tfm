package
{
   public class class_394
   {
      ...
      public function class_394()
      {
         super();
      }
      
      public static function method_2924(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         if(param4 && class_91.var_4456 == class_183.var_7129)
         {
         ...
         _loc6_.var_305 = param2 + class_1.var_2884.var_50.y;
         class_1.var_2884.var_155.var_659.push(_loc6_);
