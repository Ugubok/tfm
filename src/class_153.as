   ...
   public class class_153 extends class_12
   {
      ...
      public function class_153()
      {
         ...
         if(!class_1.const_43)
         {
            ...
            var_173.push(new Array(class_62.var_4147,class_107.var_5001,class_26.method_1903(class_111.var_5092,class_165.var_6458)));
         }
         if(!class_1.const_44)
         {
            var_173.push(new Array(class_170.var_6673,class_33.var_3606,class_26.method_1903(class_111.var_5092,class_102.var_4790)));
            class_1.method_835(var_173);
            class_1.method_835(var_175);
         }
         if(!class_1.const_46)
         {
            class_1.method_835(var_173);
            var_173.push(new Array(class_4.var_3008,class_16.var_3406,class_26.method_1903(class_111.var_5092,class_117.var_5219)));
            class_1.method_835(var_175);
         }
         if(!class_1.const_47)
         {
            class_1.method_835(var_175);
            class_1.method_835(var_173);
            var_173.push(new Array(class_165.var_6457,class_107.var_5000,class_26.method_1903(class_111.var_5092,class_89.var_4369)));
         }
      }
      ...
      public static function name_6(param1:Boolean) : void
      {
         if(param1)
         {
            if(!class_153.var_2884)
            {
               ...
               class_153.var_2884.y = class_117.var_5264;
            }
      ...
      override public function method_141(param1:MouseEvent) : void
      {
         ...
         if(var_172[_loc2_])
         {
            class_18.method_1884(class_9.var_3202 + var_172[_loc2_].toLowerCase() + class_146.var_6052);
         }
      }
   }
}
