package
{
   ...
   public class class_578 extends class_166
   {
      ...
      public function class_578(param1:class_255)
      {
         ...
         this.var_2268 = class_73.method_2108(class_165.var_6361);
         super(param1);
      }
      ...
      override public function name_2(param1:int) : void
      {
         ...
         {
            ++this.var_2268;
            if(_loc2_ % class_73.method_2108(class_146.var_6118) == class_183.var_7129)
            {
               _loc3_ = class_1.var_2884.var_156[class_56.const_345];
               _loc4_ = new class_27(_loc3_,true);
               _loc4_.var_304 = class_73.method_2108(class_162.var_6169);
               _loc4_.var_305 = class_73.method_2108(class_60.var_3972);
               _loc4_.var_308 = class_73.method_2108(class_146.var_6118) + Math.random() * class_146.var_6118;
               _loc4_.var_309 = Math.random() * class_165.var_6534 - class_73.method_2108(class_33.var_3679);
               _loc4_.var_303 = _loc2_ + class_73.method_2108(class_92.var_4625);
         ...
         if(this.var_2263)
         {
            ...
            this.var_2263.y = class_62.var_4130 + Math.sin(_loc5_ / class_73.method_2108(class_117.var_5288)) * class_181.var_6912;
            this.var_2263.x = this.var_2268 + Math.cos(_loc5_ / class_73.method_2108(class_124.var_5657)) * class_73.method_2108(class_33.var_3675);
            this.var_2263.scaleX = class_73.method_2108(class_33.var_3679) + Math.cos(_loc5_ / class_73.method_2108(class_146.var_6117)) / class_73.method_2108(class_121.var_5493);
            ...
            if(this.var_2265 && this.var_2265.parent)
            {
               ...
               _loc6_ = int(class_33.var_3679 + (-this.var_2266 + _loc2_) / class_73.method_2108(class_165.var_6506));
               this.var_2265.gotoAndStop(_loc6_);
               if(class_73.method_2108(class_117.var_5264) < _loc6_)
               {
               ...
               if(!class_168.var_6539.var_366 && _loc6_ > class_73.method_2108(class_33.var_3675) && _loc6_ < class_162.var_6322)
               {
      ...
      override public function method_666(param1:class_501) : void
      {
         switch(param1.var_574)
         {
            case class_73.method_2108(class_165.var_6534):
               ...
               break;
            case class_73.method_2108(class_146.var_6117):
               if(var_873)
               {
                  if(!this.var_2262)
                  {
                     this.var_2262 = new class_814(class_73.method_2108(class_121.var_5493),class_146.var_6117,6086867);
                     this.var_2262.x = class_73.method_2108(class_16.var_3462);
                     this.var_2262.y = class_73.method_2108(class_127.var_5713);
                  }
