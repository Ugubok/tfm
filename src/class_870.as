package
{
   ...
   public class class_870 implements class_474, class_733
   {
      ...
      public var var_2811:class_766;
      
      public function class_870(param1:class_484)
      {
         super();
         this.name_10 = param1;
      }
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is class_766)
            {
               this.var_2811 = class_766(_loc2_);
               this.var_2811.var_2623 = this;
            }
         }
      }
