package
{
   ...
   public class class_59
   {
      ...
      public static const const_375:String = "76561198041382370";
      ...
      public static function method_1988() : Boolean
      {
         ...
         return ExternalInterface.call(class_127.var_5835);
      }
      ...
      public static function method_1989(param1:Boolean) : void
      {
         ...
         ExternalInterface.call(class_9.var_3218,param1);
      }
      ...
      public static function method_1990() : String
      {
         ...
         return ExternalInterface.call(class_16.var_3422);
      }
      ...
      public function method_410() : String
      {
         ...
         if(class_59.var_3819)
         {
            ...
            {
               class_59.var_3820 = class_59.var_3821[class_62.var_4115]();
            }
         }
         return class_59.var_3820;
      }
      ...
      public function method_411() : String
      {
         ...
         if(class_59.var_3814)
         {
            return ExternalInterface.call(class_181.var_6897);
         }
         try
         {
         ...
         if(!class_59.var_3813)
         {
            ...
            try
            {
               ...
               if(_loc1_ != null)
               {
                  class_59.var_3812 = class_99.var_4681;
                  class_59.var_3814 = class_99.var_4681;
                  class_59.var_3820 = _loc1_[class_33.var_3620];
                  class_59.var_3817 = _loc1_[class_181.var_6896];
                  ExternalInterface.call(class_4.var_3025);
               }
            }
            catch(name_86:Error)
            {
      ...
      public function method_415(param1:String) : void
      {
         ...
         if(class_59.var_3814)
         {
            ExternalInterface.call(class_165.var_6470,param1);
            return;
         }
         if(class_59.var_3821)
         {
            class_59.var_3821[class_165.var_6470](param1);
            return;
         }
      }
   }
