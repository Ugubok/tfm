package
{
   ...
   public class class_859 extends class_24
   {
      ...
      {
         super(class_859.const_1342,class_121.var_5493);
      ...
      public function method_1317() : void
      {
         ...
         var _loc1_:String = class_162.var_6311 + this.var_2781.var_2421.join(class_183.var_7122) + class_4.var_3021;
         _loc1_ = _loc1_.replace(class_111.var_363,class_89.var_4372 + class_111.var_363 + class_102.var_4795);
      ...
      public function method_1799() : void
      {
         ...
         this.var_2782 = new class_24(class_859.const_1342,class_170.var_6720);
         this.var_2783 = new class_24(class_859.const_1342,class_170.var_6720);
         this.var_2784 = new class_220().method_866().method_863(class_859.var_7289).method_865(class_162.var_6346);
         var _loc1_:String = this.var_2781.var_1990 == class_418.var_7288 ? class_162.var_6350 : class_170.var_6729;
         this.var_2784.htmlText = class_165.var_6519 + _loc1_ + class_107.var_5006 + this.var_2781.var_1990 + class_127.var_5826 + _loc1_ + class_4.var_3056;
         this.var_2784.x = class_183.var_7129;
         this.var_2784.y = this.var_2782.y;
         this.var_2785 = new class_220().method_866().method_863(class_859.var_7289).method_865(class_162.var_6346);
         ...
         _loc2_.htmlText = class_62.var_4107 + this.var_2781.var_2368 + class_4.var_3011;
         this.var_1007.method_136(_loc2_);
         var _loc3_:class_24 = new class_24(class_165.var_6506,this.var_2782.var_206);
         _loc3_.method_216(new class_245(class_243.const_639,-class_121.var_5495));
         _loc3_.method_136(this.method_1801(class_60.var_3941,class_1.var_2884.method_77,class_124.var_5600 + class_92.var_4590 + class_124.var_5647 + this.var_2781.var_2579,class_162.var_6350));
         _loc3_.method_136(this.method_1801(class_127.var_5859,class_1.var_2884.method_77,class_146.var_6054 + class_33.var_3607 + class_124.var_5599 + class_124.var_5647 + this.var_2781.var_2579,class_162.var_6350));
         _loc3_.method_136(this.method_1801(class_124.var_5666,class_1.var_2884.method_77,class_181.var_6928 + class_9.var_3205 + class_92.var_4589 + class_124.var_5647 + this.var_2781.var_2579,class_162.var_6350));
         ...
         _loc4_.method_865(class_162.var_6346);
         _loc4_.htmlText = class_62.var_4098;
         this.var_1007.method_136(_loc4_);
         this.var_1007.method_221(class_117.var_5287);
         var _loc5_:class_24 = new class_24(class_165.var_6506,this.var_2782.var_206);
         _loc5_.method_216(new class_245(class_243.const_639,class_33.var_3679));
         _loc5_.method_136(this.method_1801(class_124.var_5598,this.method_1794,this.var_2781.var_2579));
         ...
         _loc5_.method_136(this.method_1801(class_124.var_5597,class_418.method_2982,this.var_2781.var_2579));
         _loc5_.method_136(this.method_1801(class_89.var_4371,class_418.method_2980,this.var_2781.var_2579));
         _loc4_ = new class_220();
         _loc4_.method_866();
         _loc4_.method_863(class_859.var_7289);
         _loc4_.method_865(class_102.var_4852);
         ...
         _loc5_.method_136(this.method_1801(class_60.var_3908,this.method_1798,this.var_2781.var_2579));
         _loc4_ = new class_220();
         _loc4_.method_866();
         _loc4_.method_863(class_859.var_7289);
         _loc4_.method_865(class_102.var_4852);
         ...
         this.var_2795.htmlText = class_9.var_3204;
         this.var_2788 = new class_220().method_866().method_863(class_859.var_7289).method_865(class_162.var_6346);
         this.var_2788.mouseEnabled = class_99.var_4681;
         this.var_2789 = new class_220().method_866().method_863(class_859.var_7289).method_865(class_162.var_6346);
         ...
         this.var_2792.htmlText = class_62.var_4098;
         ...
         while(_loc6_ < _loc7_)
         {
            ...
            _loc9_ = new class_220(class_9.var_3268,this.var_2786.name_5,class_183.var_7129);
            _loc9_.method_866();
            _loc9_.method_863(class_859.var_7289);
            _loc9_.method_865(class_162.var_6346);
      ...
      public function method_786(param1:Boolean = false) : void
      {
         ...
         var _loc3_:String = !_loc2_ && this.var_2781.var_1990 == class_418.var_7288 ? class_16.var_3472 : class_170.var_6729;
         this.var_2784.htmlText = class_165.var_6519 + _loc3_ + class_107.var_5006 + this.var_2781.var_1990 + class_127.var_5826 + _loc3_ + class_4.var_3056;
         ...
         if(_loc2_)
         {
            ...
            {
               _loc5_ += class_183.var_7073;
            }
            else if(this.var_2781.var_2591)
            {
               _loc5_ += class_16.var_3408 + this.var_2781.var_2593 + class_16.var_3407 + this.var_2781.var_2592 + class_124.var_5596 + this.var_2781.var_2594 + class_117.var_5263;
            }
            else if(this.var_2781.var_2588)
            {
               _loc5_ += class_62.var_4097 + this.var_2781.var_2589 + class_117.var_5263;
            }
            this.var_2791.htmlText = class_62.var_4107 + _loc5_ + class_102.var_4793;
            this.var_2782.method_136(this.var_2791);
         }
         else
         {
            this.var_2785.htmlText = class_165.var_6521 + this.var_2781.var_2579 + class_181.var_6887;
            this.var_2782.method_136(this.var_2785);
         ...
         while(_loc4_ < this.var_2781.var_2583.length)
         {
            ...
            if(!_loc6_.var_816)
            {
               ...
               _loc6_.var_816.method_865(class_162.var_6346);
            ...
            else if(_loc6_.var_2799 < class_89.var_4436 * class_117.var_5280)
            {
               _loc9_ = String(Math.round(_loc6_.var_2799 / class_89.var_4436));
               _loc10_ = class_89.var_4379;
            }
            else
            {
               _loc9_ = String(Math.round(_loc6_.var_2799 / class_89.var_4436 / class_117.var_5280));
               _loc10_ = class_92.var_4588;
            }
            if(_loc9_.length == class_33.var_3679)
            {
               _loc9_ = class_124.var_5665 + _loc9_;
            }
            if(_loc2_)
            {
               _loc7_.htmlText = class_62.var_4107 + _loc9_ + _loc10_ + class_62.var_4096 + _loc8_ + class_102.var_4833 + _loc6_.var_455 + class_181.var_6886 + _loc6_.var_2798 + class_162.var_6299;
               if(_loc6_.var_2427 && _loc6_.var_2427.length > class_183.var_7129)
               {
                  _loc7_.htmlText += class_62.var_4140 + _loc6_.var_2427;
               }
               _loc7_.htmlText += class_102.var_4793;
            }
            else
            {
               _loc7_.htmlText = class_62.var_4107 + _loc9_ + _loc10_ + class_92.var_4587 + _loc8_ + class_107.var_5005 + _loc6_.var_455 + class_183.var_7072 + _loc6_.var_2798 + class_107.var_5004;
               if(_loc6_.var_2427 && _loc6_.var_2427.length > class_183.var_7129)
               {
                  _loc7_.htmlText += class_62.var_4140 + _loc6_.var_2427;
               }
      ...
      public function method_1800() : void
      {
         ...
         if(_loc1_)
         {
            this.var_2788.htmlText = class_62.var_4107 + this.var_2781.var_2580 + class_102.var_4793;
            this.method_1317();
         }
         else
         {
            if(this.var_2781.var_2580.length > class_165.var_6534 && this.var_2781.var_2580.charCodeAt(class_33.var_3679) == class_146.var_6118)
            {
               this.var_2788.htmlText = class_117.var_5221 + this.var_2781.var_2580 + class_124.var_5595;
            }
            else
            {
               this.var_2788.htmlText = class_102.var_4792 + this.var_2781.var_2580 + class_4.var_3010;
            }
            this.method_1317();
            if(this.var_2781.var_2590)
            {
               this.var_2791.htmlText = class_127.var_5825 + this.var_2781.var_2593 + class_16.var_3407 + this.var_2781.var_2592 + class_124.var_5596 + this.var_2781.var_2594 + class_92.var_4586;
            }
         }
      ...
      public function method_1801(param1:String, param2:Function, param3:Object, param4:String = "R") : class_23
      {
         ...
         _loc5_.htmlText = class_117.var_5220 + param4 + class_4.var_3056 + param1 + class_107.var_5003 + param4 + class_9.var_3203;
      ...
      {
         class_418.method_2982(class_9.var_3268);
      }
