package
{
   ...
   public class class_328
   {
      ...
      {
         super();
         var _loc2_:int = param1.width + class_121.var_5495;
         var _loc3_:int = param1.height + class_121.var_5495;
         var _loc4_:Rectangle = param1.getRect(param1);
         this.var_294 = new BitmapData(_loc2_,_loc3_,true,class_183.var_7129);
         var _loc5_:Matrix = new Matrix();
         _loc5_.translate(class_165.var_6534 - _loc4_.x,class_165.var_6534 - _loc4_.y);
