package
{
   ...
   public class class_63
   {
      ...
      public static function method_2025(param1:Event) : void
      {
         ...
         if(param1.target == class_63.var_4198)
         {
            ...
            if(_loc7_)
            {
               ...
               _loc2_[class_73.method_2108(class_183.var_7129)] = class_63.var_4198.text;
      ...
      public static function method_2027(param1:Array) : void
      {
         ...
         var _loc2_:class_198 = param1[class_73.method_2108(class_183.var_7129)];
         var _loc3_:Boolean = param1[class_73.method_2108(class_33.var_3679)];
         ...
         class_63.var_4188.y = int((-class_63.var_4188.height + class_73.method_2108(class_16.var_3329)) / class_73.method_2108(class_165.var_6534));
      ...
      public static function method_2029() : void
      {
         ...
         while(++_loc3_ < _loc2_)
         {
            ...
            {
               _loc6_ = int(_loc5_.charAt(class_73.method_2108(class_92.var_4647)));
               _loc7_ = _loc1_[_loc6_];
               _loc8_ = _loc7_ >> class_73.method_2108(class_16.var_3467) & 255;
               _loc9_ = _loc7_ >> class_73.method_2108(class_170.var_6731) & 255;
               _loc10_ = _loc7_ & 255;
               _loc4_.transform.colorTransform = new ColorTransform(_loc8_ / class_181.var_6910,_loc9_ / class_73.method_2108(class_181.var_6910),_loc10_ / class_73.method_2108(class_181.var_6910));
            }
         }
      }
      ...
      public static function method_2030(param1:Event) : void
      {
         if(param1.target == class_63.var_4198)
         {
            if(class_63.var_4200)
            {
               ...
               class_63.var_4198.text = class_73.method_2111(class_9.var_3268);
            }
         }
      }
      ...
      public static function method_2031(param1:Array) : void
      {
         ...
         var _loc4_:String = param1[class_73.method_2108(class_165.var_6534)];
         class_39.var_3744.method_313(new class_368(_loc2_,_loc3_ is class_349 ? int(class_73.method_2108(class_33.var_3679)) : int(class_183.var_7129),_loc3_.var_574,_loc4_));
      }
      
      public static function method_2032(param1:int, param2:String) : void
      {
         class_63.var_579.couleur(int(class_73.method_2111(class_181.var_6914) + param2),false);
         class_63.method_2029();
      }
      ...
      public static function method_2033(param1:String, param2:int) : void
      {
         ...
         class_63.var_4177.method_282(class_73.method_2108(class_33.var_3679));
      }
      ...
      public static function method_2036(param1:class_357) : void
      {
         ...
         else if(class_63.var_4193 && class_63.var_4193[(!!param1.var_1663 ? class_73.method_2108(class_33.var_3679) : -class_33.var_3679) * param1.var_1222])
         {
            delete class_63.var_4193[(!!param1.var_1663 ? class_73.method_2108(class_33.var_3679) : -class_33.var_3679) * param1.var_1222];
      ...
      public static function method_2037(param1:int, param2:int, param3:Dictionary, param4:int, param5:int) : void
      {
         ...
         class_63.var_4204.method_216(new class_245(class_243.const_642,class_73.method_2108(class_117.var_5287)));
         var _loc8_:class_220 = new class_220(class_73.method_2111(class_9.var_3268),class_63.var_4204.name_5,class_73.method_2108(class_183.var_7129)).method_856(TextFormatAlign.JUSTIFY).method_866();
         _loc8_.htmlText = class_26.method_1668(class_73.method_2111(class_107.var_4924),class_4.var_2946 + Math.max(param4 - param5,class_183.var_7129) + class_162.var_6209);
         class_63.var_4204.method_136(_loc8_);
         var _loc9_:class_24 = new class_24(class_63.var_4204.name_5 - class_117.var_5287,class_73.method_2108(class_127.var_5851) - _loc8_.height);
         _loc9_.method_216(new class_245(class_243.const_642,class_73.method_2108(class_165.var_6534)));
         ...
         _loc13_ = class_73.method_2108(class_181.var_6912);
         _loc14_ = _loc13_ * class_73.method_2108(class_146.var_6118) / class_73.method_2108(class_117.var_5287) - class_73.method_2108(class_117.var_5287) / class_73.method_2108(class_165.var_6534);
         _loc15_ = -class_73.method_2108(class_170.var_6720) + _loc14_;
         ...
         while(_loc19_ < _loc20_)
         {
            ...
            {
               _loc33_ = new Rectangle(class_183.var_7129,class_183.var_7129,class_127.var_5864,class_73.method_2108(class_162.var_6352));
            }
            else
            {
            ...
            {
               _loc34_ = class_73.method_2116(class_183.var_7006);
               _loc32_.scaleX = _loc34_;
               _loc32_.scaleY = _loc34_;
               _loc33_ = new Rectangle(_loc33_.x * _loc34_,_loc33_.y * _loc34_,_loc33_.width * _loc34_,_loc33_.height * _loc34_);
            }
         ...
         _loc9_.method_221(class_73.method_2108(class_117.var_5287));
         ...
         while(_loc19_ < _loc20_)
         {
            ...
            {
               _loc36_ = param3[-class_73.method_2108(class_33.var_3679)];
            }
            else
            {
            ...
            {
               _loc37_ = new Sprite();
               _loc37_.graphics.lineStyle(class_73.method_2108(class_33.var_3679),16711680);
               _loc37_.graphics.lineTo(class_183.var_7129,class_73.method_2108(class_102.var_4859));
               _loc37_.x = _loc18_ / class_165.var_6534;
               _loc37_.y = class_73.method_2108(class_183.var_7129);
               _loc21_.addChild(_loc37_);
            }
            _loc19_++;
         }
         class_63.var_4204.method_136(_loc9_);
         var _loc22_:class_24 = new class_24(class_146.var_6118 / class_73.method_2108(class_117.var_5287) * class_63.var_4204.name_5,class_73.method_2108(class_33.var_3675));
         _loc22_.method_216(new class_245(class_243.const_639,class_121.var_5495));
         var _loc23_:class_220 = new class_220(class_26.method_1668(class_73.method_2111(class_33.var_3553)));
         ...
         _loc22_.method_221(class_73.method_2108(class_102.var_4859));
         _loc22_.method_136(_loc25_);
         _loc24_.y = -class_73.method_2108(class_146.var_6118);
         _loc25_.y = -class_146.var_6118;
         var _loc26_:MovieClip = class_175.method_118(class_73.method_2111(class_33.var_3552));
         ...
         _loc26_.y = _loc24_.y + _loc24_.height / class_73.method_2108(class_165.var_6534);
         ...
         var _loc27_:class_24 = new class_24(class_73.method_2108(class_121.var_5495) / class_117.var_5287 * class_63.var_4204.name_5,class_33.var_3675);
         _loc27_.method_216(new class_245(class_243.const_639,class_73.method_2108(class_146.var_6117)));
         var _loc28_:MovieClip = class_175.method_118(class_73.method_2111(class_170.var_6605));
         _loc29_ = new class_23(_loc28_.width,_loc28_.height);
         _loc29_.addChild(_loc28_);
         _loc30_ = new class_246(class_26.method_1668(class_181.var_6933),(_loc27_.name_5 - _loc27_.method_220()) / class_73.method_2108(class_165.var_6534),class_63.method_2052);
         _loc27_.addChild(_loc29_);
         _loc27_.addChild(_loc30_);
         _loc29_.x = _loc29_.width / class_165.var_6534;
         _loc29_.y = _loc29_.height / class_73.method_2108(class_165.var_6534) - class_73.method_2108(class_181.var_6939);
         ...
         _loc31_.x = -(class_73.method_2108(class_117.var_5287) + _loc31_.textWidth) / class_165.var_6534;
         _loc31_.y = -(class_165.var_6534 + _loc31_.textHeight) / class_73.method_2108(class_165.var_6534);
         _loc29_.method_203(class_63.method_2066,_loc6_);
         class_63.var_4204.method_136(_loc27_);
         _loc27_.x = (-_loc27_.name_5 + class_63.var_4204.name_5) / class_73.method_2108(class_165.var_6534);
         class_63.var_165.addChild(class_63.var_4204);
         class_63.var_4204.x = class_165.var_6401 + (class_63.var_4177.width - class_63.var_4204.name_5) / class_73.method_2108(class_165.var_6534);
         class_63.var_4204.y = class_73.method_2108(class_146.var_6117);
      ...
      public static function method_2040(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            {
               class_63.var_4180 = class_73.method_2108(class_183.var_7129);
            }
         }
         else
         {
            ...
            class_63.name_37.Texte.text = class_26.method_1668(class_73.method_2111(class_33.var_3551));
         ...
         class_63.method_2054(class_63.var_4180);
         class_63.var_4177.method_282(class_73.method_2108(class_183.var_7129));
      }
      
      public static function method_2041(param1:Array) : void
      {
         class_63.method_2058();
         var _loc2_:class_10 = param1[class_73.method_2108(class_183.var_7129)];
         var _loc3_:int = param1[class_73.method_2108(class_33.var_3679)];
      ...
      public static function method_2044(param1:int, param2:int, param3:Boolean = false) : MovieClip
      {
         ...
         var _loc4_:MovieClip = class_175.method_118(class_73.method_2111(class_4.var_3036));
         ...
         var _loc5_:Bitmap = class_175.method_2618(class_170.var_6604 + param2 + class_73.method_2111(class_89.var_4385));
         _loc4_.addChild(_loc5_);
         _loc5_.x = class_73.method_2108(class_9.var_3267) + _loc4_._T.width;
         _loc5_.y = class_73.method_2108(class_165.var_6534);
         if(param3)
         {
            _loc6_ = new Sprite();
            _loc6_.graphics.beginFill(13325419,class_107.var_4993);
            _loc6_.graphics.lineStyle(class_33.var_3679,class_183.var_7129,class_73.method_2116(class_107.var_4993));
            _loc6_.graphics.drawRoundRect(-_loc4_.width / class_165.var_6534,-class_73.method_2108(class_146.var_6118) / class_165.var_6534,_loc4_.width,class_146.var_6118,class_73.method_2108(class_165.var_6534));
            _loc6_.rotation = -class_146.var_6117;
            _loc6_.y = _loc4_.height / class_165.var_6534 - class_73.method_2108(class_33.var_3679);
      ...
      public static function method_2046(param1:class_10, param2:int, param3:int, param4:Function) : Sprite
      {
         ...
         var _loc7_:TextField = class_175.method_118(class_73.method_2111(class_127.var_5786))._T as TextField;
         _loc7_.height = class_73.method_2108(class_33.var_3675);
         _loc7_.mouseWheelEnabled = class_99.var_4682;
         _loc7_.styleSheet = class_1.var_2884.var_117;
         _loc7_.htmlText = class_73.method_2111(class_92.var_4523) + (!!class_63.var_4184 ? class_26.method_1668(class_33.var_3551) : class_26.method_1668(class_127.var_5757));
         _loc7_.x = class_117.var_5287;
         _loc7_.y = class_73.method_2108(class_9.var_3267);
         _loc7_.width = _loc6_ - class_73.method_2108(class_165.var_6534) * _loc7_.x;
         ...
         if(class_63.var_4184)
         {
            ...
            _loc17_.htmlText = class_117.var_5225 + class_26.method_1668(class_73.method_2111(class_124.var_5582));
            _loc17_.x = class_73.method_2108(class_146.var_6117);
            _loc17_.y = class_73.method_2108(class_117.var_5264);
            ...
            _loc18_.graphics.drawRoundRect(class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),class_63.var_4198.width,class_63.var_4198.height + class_33.var_3679,class_9.var_3267);
            _loc18_.graphics.endFill();
            _loc18_.filters = new Array(new BevelFilter(class_73.method_2108(class_33.var_3679),class_73.method_2108(class_107.var_5038),class_73.method_2108(class_183.var_7129),class_33.var_3679,16777215,class_92.var_4648,class_33.var_3679,class_73.method_2108(class_33.var_3679)));
            _loc18_.x = class_63.var_4198.x - class_33.var_3679;
            _loc18_.y = -class_73.method_2108(class_33.var_3679) + class_63.var_4198.y;
            ...
            class_63.var_4202 = new class_246(class_26.method_1668(class_73.method_2111(class_107.var_4923)),class_73.method_2108(class_89.var_4444),class_63.method_2065);
         ...
         var _loc11_:Number = class_73.method_2108(class_33.var_3679);
         ...
         _loc8_.x = int(_loc6_ / class_165.var_6534 - _loc8_.width / class_73.method_2108(class_165.var_6534) - _loc11_ * _loc12_.x);
         ...
         _loc14_.x = class_73.method_2108(class_9.var_3267) + _loc13_._T.width;
         ...
         _loc13_.x = _loc6_ / class_73.method_2108(class_165.var_6534) - _loc13_.width / class_165.var_6534;
         _loc13_.y = class_73.method_2108(class_124.var_5616);
         _loc5_.addChild(_loc7_);
         _loc5_.addChild(_loc8_);
         _loc5_.addChild(_loc13_);
         class_63.var_4201 = new class_88((-class_73.method_2108(class_183.var_7093) + _loc6_) / class_73.method_2108(class_165.var_6534),_loc13_.y + class_73.method_2108(class_16.var_3473),class_26.method_1668(class_73.method_2111(class_165.var_6480)),param4,!!class_63.var_4184 ? new Array(class_73.method_2111(class_9.var_3268),param1,class_73.method_2111(class_9.var_3268)) : new Array(param1,param3,param2),class_102.var_4859,!class_1.var_2884.var_94);
         ...
         if(class_63.var_4184)
         {
            ...
            _loc8_.y += class_73.method_2108(class_102.var_4859);
            _loc13_.y += class_73.method_2108(class_146.var_6074);
            class_63.var_4201.y += class_107.var_5038;
            class_63.var_4201.x -= class_73.method_2108(class_117.var_5287);
            _loc15_.y += class_73.method_2108(class_107.var_5038);
            _loc15_.x += class_117.var_5287;
            class_63.var_4202.y = _loc15_.y + class_33.var_3675 + class_73.method_2108(class_117.var_5264);
            class_63.var_4199.y = _loc15_.y + class_73.method_2108(class_33.var_3675) + class_183.var_7127;
         }
         var _loc16_:int = !!class_63.var_4184 ? int(class_63.var_4199.y + class_63.var_4199.height + class_73.method_2108(class_146.var_6117)) : int(class_63.var_4201.y + class_162.var_6351);
         _loc5_.graphics.beginFill(4610670,class_73.method_2108(class_33.var_3679));
         _loc5_.graphics.drawRoundRect(class_183.var_7129,class_183.var_7129,_loc6_,_loc16_,class_73.method_2108(class_33.var_3675));
      ...
      public static function method_2047(param1:class_357) : void
      {
         ...
         if(param1.var_1664)
         {
            ...
            class_63.var_4192[(!!param1.var_1663 ? class_33.var_3679 : -class_73.method_2108(class_33.var_3679)) * param1.var_1222] = param1;
            if(class_63.var_165 && class_63.var_165.parent)
            {
               class_63.method_2054(class_63.var_4180);
            }
         ...
         {
            delete class_63.var_4192[(!!param1.var_1663 ? class_73.method_2108(class_33.var_3679) : -class_33.var_3679) * param1.var_1222];
      ...
      public static function method_2048() : void
      {
         ...
         class_180.method_2665(class_62.var_4146,class_170.var_6718 + class_1.var_2878.method_160(),false,false,true,false,class_73.method_2116(class_9.var_3254));
         class_63.method_2052();
      ...
      public static function name_6() : void
      {
         ...
         if(!class_63.var_165)
         {
            class_63.const_378[class_73.method_2108(class_127.var_5865)] = class_99.var_4681;
            ...
            class_63.const_378[class_73.method_2108(class_170.var_6599)] = class_99.var_4681;
            ...
            class_63.const_378[class_73.method_2108(class_33.var_3547)] = class_99.var_4681;
            class_63.const_378[class_73.method_2108(class_183.var_7002)] = class_99.var_4681;
            class_63.const_378[class_73.method_2108(class_162.var_6206)] = class_99.var_4681;
            class_63.const_378[class_73.method_2108(class_62.var_4124)] = class_99.var_4681;
            ...
            class_63.const_378[class_73.method_2108(class_107.var_4917)] = class_99.var_4681;
            class_63.const_378[class_73.method_2108(class_33.var_3546)] = class_99.var_4681;
            ...
            class_63.var_165 = new class_24(class_73.method_2108(class_33.var_3635),class_102.var_4825);
            class_63.var_165.method_251(true);
            var_1142 = new class_246(class_26.method_1668(class_73.method_2111(class_60.var_3934)),class_63.var_165.name_5 - class_73.method_2108(class_102.var_4859),class_63.method_2048);
            var_1142.x = class_73.method_2108(class_33.var_3675);
            var_1142.y = class_63.var_165.var_206 - class_73.method_2108(class_117.var_5264);
         ...
         class_1.var_2884.addEventListener(class_89.var_4389 + class_73.method_2111(class_146.var_6063),class_63.name_2);
         ...
         class_180.method_2666(class_73.method_2111(class_62.var_4146),true);
         setTimeout(function():void
         {
            if(class_63.name_62())
            {
               class_180.method_2665(class_73.method_2111(class_33.var_3550),class_73.method_2111(class_121.var_5360),true,false,true,false,class_9.var_3254);
            }
         },class_73.method_2108(class_4.var_3058));
      }
      ...
      public static function method_2054(param1:int) : void
      {
         ...
         if(class_364.const_888 == _loc2_)
         {
            ...
            if(_loc8_ < class_63.const_380)
            {
               if(class_73.method_2108(class_183.var_7129) == _loc8_)
               {
                  ...
                  _loc11_ = class_73.method_2108(class_117.var_5287);
               }
               else if(_loc8_ == class_73.method_2108(class_33.var_3679))
               {
                  _loc10_ = class_73.method_2108(class_4.var_3058);
                  _loc11_ = class_165.var_6506;
               }
               else if(class_165.var_6534 == _loc8_)
               {
                  _loc10_ = class_117.var_5288;
                  _loc11_ = class_73.method_2108(class_121.var_5493);
               }
               else if(_loc8_ >= class_146.var_6118)
               {
                  _loc10_ = class_73.method_2108(class_146.var_6111);
                  _loc11_ = class_73.method_2108(class_121.var_5493);
               }
         ...
         else
         {
            ...
            for(; _loc13_ < _loc14_; _loc13_++)
            {
               ...
               {
                  if(!(_loc16_.var_720 == class_73.method_2108(class_183.var_7129) && _loc16_.var_719 == class_73.method_2108(class_183.var_7129)))
                  {
                     if(_loc16_.var_1037)
                     {
                     ...
                     if(class_63.var_4184)
                     {
                        if(class_73.method_2108(class_183.var_7129) == _loc16_.var_720)
                        {
                           continue;
                        }
         ...
         class_63.var_4176.text = class_73.method_2111(class_165.var_6521) + class_63.var_4170;
         ...
         while(_loc13_ < _loc14_)
         {
            ...
            if(_loc5_ % class_73.method_2108(class_146.var_6118) == class_183.var_7129)
            {
            ...
            _loc6_.var_165.y = class_73.method_2108(class_165.var_6534);
      ...
      public static function method_2055(param1:Event) : void
      {
         ...
         _loc3_[class_73.method_2108(class_165.var_6534)] = class_63.var_4199.var_1226.text;
      ...
      public static function method_2056(param1:class_24, param2:class_10, param3:class_351, param4:MovieClip, param5:Rectangle, param6:Number, param7:int, param8:int) : void
      {
         ...
         param1.method_216(new class_245(class_243.const_642,class_73.method_2108(class_165.var_6534)));
         var _loc11_:class_24 = new class_24(param1.name_5,param1.var_206 * class_73.method_2108(class_146.var_6118) / class_117.var_5287 - param1.method_220() / class_73.method_2108(class_165.var_6534));
         _loc11_.method_216(new class_245(class_243.const_639,class_73.method_2108(class_165.var_6534)));
         ...
         param4.x = _loc10_ / class_73.method_2108(class_165.var_6534) + (param6 - param5.width) / class_165.var_6534 - param5.x;
         param4.y = (_loc11_.var_206 - param5.height) / class_73.method_2108(class_165.var_6534) - param5.y;
         ...
         {
            _loc23_ = new class_220(class_26.method_1668(class_73.method_2111(class_165.var_6397)),_loc16_).method_856(TextFormatAlign.CENTER).method_864(13325419).method_860();
         ...
         else if(param3.var_1644 == class_351.const_872 || param3.var_1644 == class_351.const_873)
         {
            ...
            _loc24_.y = (-_loc24_.height + _loc11_.var_206) / class_73.method_2108(class_165.var_6534);
            _loc11_.addChild(_loc24_);
            _loc25_ = class_175.method_118(class_73.method_2111(class_33.var_3552));
            ...
            _loc25_.y = class_73.method_2108(class_33.var_3668);
            if(param3.var_1644 == class_351.const_872)
            {
               _loc26_ = class_63.method_2044(param3.var_1646,class_63.const_382,false);
               _loc26_.x = _loc15_ + _loc17_ + _loc14_ + (-_loc26_.width + _loc17_) / class_73.method_2108(class_165.var_6534);
               _loc26_.y = (-_loc26_.height + _loc11_.var_206) / class_73.method_2108(class_165.var_6534);
            ...
            else
            {
               ...
               _loc27_.y = (-_loc27_.height + _loc11_.var_206) / class_73.method_2108(class_165.var_6534) - class_73.method_2108(class_33.var_3679);
         ...
         if(param3.var_1647 != class_351.const_874)
         {
            param1.method_231(class_33.var_3675,_loc12_.y - param1.method_220(),true,param1.name_5 - class_73.method_2108(class_117.var_5287) - class_73.method_2108(class_165.var_6534) * class_33.var_3675,7043199,1060428);
            ...
            _loc28_.x = class_73.method_2108(class_183.var_7129);
            ...
            else if(param3.var_1647 == class_351.const_872 || param3.var_1647 == class_351.const_873)
            {
               ...
               _loc30_.x = _loc15_ + (-_loc30_.width + _loc17_) / class_73.method_2108(class_165.var_6534);
               _loc30_.y = (-_loc30_.height + _loc12_.var_206) / class_165.var_6534;
               _loc12_.addChild(_loc30_);
               _loc31_ = class_175.method_118(class_73.method_2111(class_33.var_3552));
               _loc31_.cacheAsBitmap = class_99.var_4681;
               _loc12_.addChild(_loc31_);
               _loc31_.x = _loc15_ + _loc17_ + _loc14_ / class_73.method_2108(class_165.var_6534) + class_73.method_2108(class_165.var_6534);
               _loc31_.y = class_73.method_2108(class_33.var_3675);
               ...
               {
                  _loc33_ = new class_220(class_26.method_1668(class_73.method_2111(class_4.var_2941)),_loc17_).method_856(TextFormatAlign.CENTER).method_864(13325419).method_860();
                  _loc33_.x = _loc15_ + _loc17_ + _loc14_;
                  _loc33_.y = (-_loc33_.height + _loc12_.var_206) / class_73.method_2108(class_165.var_6534) - class_73.method_2108(class_33.var_3679);
         ...
         _loc20_.graphics.drawRect(class_183.var_7129,class_73.method_2108(class_183.var_7129),_loc18_,_loc19_);
         _loc20_.graphics.endFill();
         param1.addChildAt(_loc20_,class_73.method_2108(class_183.var_7129));
         var _loc21_:Shape = new Shape();
         _loc21_.graphics.lineStyle(class_165.var_6534,11058632,class_73.method_2108(class_33.var_3679),true);
         _loc21_.graphics.drawRoundRect(class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),_loc18_,_loc19_,class_73.method_2108(class_183.var_7127));
         _loc20_.addChild(_loc21_);
         var _loc22_:Shape = new Shape();
         _loc22_.graphics.beginFill(16711680);
         _loc22_.graphics.drawRoundRect(class_183.var_7129,class_73.method_2108(class_183.var_7129),_loc18_,_loc19_,class_73.method_2108(class_183.var_7127));
         _loc20_.addChild(_loc22_);
         _loc20_.mask = _loc22_;
         if(param7 == param8 - class_73.method_2108(class_33.var_3679))
         {
            _loc34_ = new Sprite();
            _loc34_.graphics.lineTo(class_73.method_2108(class_183.var_7129),class_183.var_7129);
            _loc34_.y = class_73.method_2108(class_117.var_5287) + param1.var_206;
      ...
      public static function method_2057(param1:class_10) : void
      {
         ...
         if(param1 is class_349)
         {
            ...
            {
               _loc4_.x = class_73.method_2108(class_146.var_6117) + _loc3_.width;
               _loc2_.addChild(_loc3_);
               _loc2_.addChild(_loc4_);
            }
            _loc5_ = _loc2_.getRect(_loc2_);
            _loc2_.x = class_63.var_4172.width / class_73.method_2108(class_165.var_6534) - _loc2_.width / class_73.method_2108(class_165.var_6534) - _loc5_.x;
            class_63.var_4172.addChild(_loc2_);
         }
         else if(param1 is class_199)
         {
            _loc6_ = param1.var_162 as class_201;
            _loc7_ = class_63.var_609.split(class_73.method_2111(class_121.var_5459));
            _loc8_ = _loc7_[class_33.var_3679].split(class_107.var_5062);
            if(class_34.const_122 == _loc6_.var_1024)
            {
               class_63.method_440(_loc7_[class_73.method_2108(class_183.var_7129)] + class_73.method_2111(class_121.var_5459) + _loc8_.join(class_73.method_2111(class_107.var_5062)),class_11.const_54[_loc6_.var_1023]);
            }
            ...
            else
            {
               ...
               if(_loc9_)
               {
                  _loc10_ = class_73.method_2111(class_9.var_3268);
                  _loc11_ = _loc9_.length;
                  _loc12_ = class_73.method_2108(class_183.var_7129);
                  while(_loc12_ < _loc11_)
                  {
                     _loc10_ += class_16.var_3394 + int(_loc9_[_loc12_]).toString(class_73.method_2108(class_16.var_3467));
                     _loc12_++;
                  }
                  if(_loc10_)
                  {
               ...
               class_63.method_440(_loc7_[class_73.method_2108(class_183.var_7129)] + class_73.method_2111(class_121.var_5459) + _loc8_.join(class_107.var_5062),class_168.var_6539.var_609.method_129());
            }
         }
      ...
      public static function method_302(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            for each(_loc3_ in _loc2_)
            {
               ...
               {
                  class_63.var_4160.splice(_loc4_,class_73.method_2108(class_33.var_3679));
               }
            }
      ...
      public static function method_2060() : void
      {
         ...
         {
            class_1.var_2884.method_97(class_73.method_2111(class_62.var_4020) + class_63.var_4186 + class_16.var_3431 + class_63.var_4161.length);
            _loc1_ = class_63.var_4161[class_63.var_4186];
            _loc2_ = _loc1_.var_165.method_786(class_197.const_606).getChildAt(class_73.method_2108(class_33.var_3679));
            ...
            _loc5_ = new Matrix();
            _loc5_.translate(class_73.method_2108(class_33.var_3679) - _loc3_.x,class_33.var_3679 - _loc3_.y);
            _loc4_.draw(_loc2_,_loc5_);
            _loc6_ = new FileReference();
            _loc6_.addEventListener(Event.COMPLETE,class_63.method_2045);
            _loc6_.save(class_372.method_2900(_loc4_),class_170.var_6597 + _loc1_.var_1024 + class_73.method_2111(class_33.var_3659) + _loc1_.var_1023 + class_89.var_4385);
            ++class_63.var_4186;
         }
      }
      ...
      {
         return class_63.var_4193[(param1 is class_199 ? class_73.method_2108(class_33.var_3679) : -class_33.var_3679) * param1.var_574];
      }
      ...
      public static function method_516() : void
      {
         ...
         class_63.var_4174.scaleX = class_63.var_4174.scaleY = class_73.method_2116(class_124.var_5624);
         class_63.var_4174.x = class_73.method_2108(class_92.var_4628);
         ...
         class_63.var_4176.x = class_73.method_2108(class_162.var_6322) + class_63.var_4174.x;
         class_63.var_4176.y = -class_73.method_2108(class_33.var_3679) + class_63.var_4174.y;
         class_63.var_4173 = class_175.method_118(class_73.method_2111(class_16.var_3327));
         ...
         class_63.var_4173.scaleX = class_63.var_4173.scaleY = class_73.method_2116(class_124.var_5624);
         ...
         class_63.var_4175 = class_175.method_118(class_73.method_2111(class_92.var_4553))._T as TextField;
         ...
         class_63.var_4175.x = class_63.var_4173.x + class_73.method_2108(class_162.var_6322);
         ...
         var _loc2_:MovieClip = class_175.method_118(class_73.method_2111(class_170.var_6596));
         _loc2_.x = _loc1_.x;
         _loc2_.y = _loc1_.y + class_117.var_5264;
         _loc2_.width = _loc1_.width;
         class_63.var_165.addChild(_loc2_);
         var _loc3_:class_88 = new class_88(class_73.method_2108(class_183.var_7127),class_73.method_2108(class_127.var_5864),class_26.method_1668(class_73.method_2111(class_89.var_4307)),class_63.method_2064,null,class_181.var_6913,!class_1.var_2884.var_94);
         ...
         class_63.name_37 = new class_88(class_73.method_2108(class_62.var_4130),class_73.method_2108(class_127.var_5864),class_26.method_1668(class_73.method_2111(class_33.var_3551)),class_63.method_2040,true,class_73.method_2108(class_181.var_6913),!class_1.var_2884.var_94);
         ...
         var _loc4_:int = class_73.method_2108(class_33.var_3675);
         var _loc5_:int = class_73.method_2108(class_33.var_3633);
         ...
         while(_loc7_ < _loc6_)
         {
            ...
            if(!(_loc10_ == class_364.const_890 && !class_63.var_4194))
            {
               ...
               if(_loc5_ > class_73.method_2108(class_60.var_3945) && _loc4_ == class_73.method_2108(class_33.var_3675))
               {
                  _loc5_ = class_73.method_2108(class_9.var_3240);
                  _loc4_ += class_73.method_2108(class_60.var_3972);
               }
               if(class_364.const_889 == _loc10_)
               {
                  _loc11_.x = class_73.method_2108(class_33.var_3675);
                  _loc11_.y = class_73.method_2108(class_33.var_3633);
               }
               else
               {
                  _loc11_.x = _loc4_;
               ...
               if(_loc10_.var_817.charAt(class_73.method_2108(class_183.var_7129)) == class_9.var_3256)
               {
               ...
               else if(_loc10_ == class_364.const_890)
               {
                  ...
                  _loc11_.y += class_73.method_2108(class_33.var_3675);
               }
               ...
               else if(class_63.var_4158 && _loc7_ == _loc6_ - class_73.method_2108(class_33.var_3679))
               {
                  _loc11_._T.textColor = 13325419;
         ...
         var _loc8_:DisplayObject = class_58.method_1982(class_312.const_784,class_170.var_6717,class_73.method_2108(class_162.var_6351));
         ...
         class_63.var_4177 = new class_30(class_73.method_2108(class_60.var_3856) + class_63.const_384,class_63.const_383,class_183.var_7129,false,class_73.method_2108(class_146.var_6117));
         class_63.var_4177.x = class_73.method_2108(class_165.var_6401) - class_63.const_384;
         class_63.var_4177.y = class_73.method_2108(class_146.var_6117);
         class_63.var_165.addChild(class_63.var_4177);
         class_63.var_4177.Ascenseur();
         class_63.var_4177.method_282(class_183.var_7129);
         class_63.var_4197 = new class_250(class_73.method_2111(class_117.var_5154),class_121.var_5470,class_73.method_2108(class_117.var_5264));
         class_63.var_4197.x = class_73.method_2108(class_89.var_4306);
         ...
         class_241.method_208(class_63.var_4197,class_26.method_1668(class_73.method_2111(class_107.var_4916)));
      }
      ...
      public static function method_2063(param1:int, param2:String, param3:int, param4:int) : void
      {
         ...
         {
            _loc5_ = new class_24(class_73.method_2108(class_124.var_5657),class_89.var_4444);
            _loc5_.method_216(class_245.const_647);
            _loc5_.method_221(class_73.method_2108(class_146.var_6117));
            _loc6_ = new class_220(class_26.method_1668(class_73.method_2111(class_92.var_4517),param2),_loc5_.name_5,class_73.method_2108(class_183.var_7129)).method_856(TextFormatAlign.CENTER).method_864(class_54.const_283);
            _loc6_.y = (_loc5_.var_206 - class_33.var_3675 - _loc6_.textHeight) / class_73.method_2108(class_165.var_6534);
         ...
         else if(class_33.var_3679 == param1)
         {
            ...
            _loc6_ = new class_220(class_26.method_1668(class_73.method_2111(class_170.var_6630),param2),_loc5_.name_5,class_183.var_7129).method_856(TextFormatAlign.CENTER).method_864(class_54.const_283);
            _loc6_.y = (_loc5_.var_206 - class_73.method_2108(class_33.var_3675) - _loc6_.textHeight) / class_165.var_6534;
            _loc5_.addChild(_loc6_);
         }
         else if(param1 == class_165.var_6534)
         {
            ...
            _loc5_.method_216(class_245.const_647);
            _loc5_.method_221(class_73.method_2108(class_146.var_6117));
            _loc6_ = new class_220(class_26.method_1668(class_73.method_2111(class_117.var_5153),param2),_loc5_.name_5,class_183.var_7129).method_856(TextFormatAlign.CENTER).method_864(class_54.const_283);
            _loc6_.y = (_loc5_.var_206 - class_33.var_3675 - _loc6_.textHeight) / class_73.method_2108(class_165.var_6534);
            _loc5_.addChild(_loc6_);
         }
         if(_loc5_)
         {
            ...
            _loc7_.y = _loc5_.var_206 - class_73.method_2108(class_170.var_6720) - class_73.method_2108(class_33.var_3675);
            _loc5_.addChild(_loc7_);
            _loc7_.x = (_loc5_.name_5 - _loc7_.width) / class_165.var_6534;
            _loc5_.x = (class_63.var_165.width - _loc5_.width) / class_73.method_2108(class_165.var_6534);
            _loc5_.y = class_73.method_2108(class_107.var_5068);
      ...
      public static function method_440(param1:String, param2:int) : void
      {
         try
         {
            ...
            class_63.var_4172.getChildAt(class_73.method_2108(class_183.var_7129)).visible = class_99.var_4681;
            class_63.var_608 = new class_168(class_73.method_2111(class_146.var_5998),param1,false,false,param2);
            class_63.var_608.x = class_89.var_4436;
            class_63.var_608.y = -class_73.method_2108(class_183.var_7127);
      ...
      public static function method_2068(param1:class_10, param2:int, param3:int, param4:Function, param5:int = -1, param6:int = -1) : void
      {
         ...
         if(param5 == -class_33.var_3679 || class_1.var_2879)
         {
            ...
            _loc7_.y = class_73.method_2108(class_62.var_4130) - _loc7_.height / class_73.method_2108(class_165.var_6534);
         }
         else
         {
            _loc8_ = class_63.method_2046(param1,param5,param6,param4);
            _loc7_.x = -class_73.method_2108(class_33.var_3633) + class_89.var_4432;
            _loc7_.y = class_9.var_3243;
            _loc8_.x = class_73.method_2108(class_33.var_3633) + class_89.var_4432;
            _loc8_.y = class_9.var_3243;
            class_63.var_165.addChild(_loc8_);
            class_63.var_4181.push(_loc8_);
            _loc9_ = new class_88(class_73.method_2108(class_107.var_4920),class_165.var_6487,class_26.method_1668(class_181.var_6825),class_63.method_2022,param1,class_124.var_5657,!class_1.var_2884.var_94);
      ...
      public static function method_2070() : void
      {
         ...
         var _loc3_:Rectangle = null;
         if(class_63.var_4194 && !class_63.var_4196 && class_63.var_4195 != class_73.method_2108(class_183.var_7129))
         {
            class_63.var_4196 = new Sprite();
            class_63.var_4196.graphics.beginFill(3294800);
            class_63.var_4196.graphics.drawCircle(class_183.var_7129,class_183.var_7129,class_73.method_2108(class_89.var_4436));
            class_63.var_4196.graphics.endFill();
            class_63.var_4196.x = class_33.var_3635;
            class_63.var_4196.y = class_62.var_4131;
            class_63.var_165.addChildAt(class_63.var_4196,class_73.method_2108(class_183.var_7129));
            class_63.var_165.x = class_73.method_2108(class_33.var_3675);
            _loc1_ = class_21.method_1886(class_63.var_4195);
            _loc2_ = class_21.method_1891(_loc1_[class_183.var_7129],_loc1_[class_73.method_2108(class_33.var_3679)],class_63.method_2053(class_63.var_4195));
            ...
            _loc3_ = _loc2_.getRect(_loc2_);
            _loc2_.x = int(class_73.method_2108(class_16.var_3473) - _loc2_.width / class_165.var_6534 - _loc3_.x);
      ...
      public static function method_2075(param1:class_365) : void
      {
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            _loc16_ = param1.var_1678[_loc3_ + class_73.method_2108(class_33.var_3679)];
            _loc17_ = param1.var_1678[_loc3_ + class_73.method_2108(class_165.var_6534)];
            ...
            if(_loc18_)
            {
               ...
               if(_loc17_)
               {
                  ...
                  if(_loc17_.length == class_73.method_2108(class_183.var_7129))
                  {
                     _loc18_.method_797();
                  }
                  else
      ...
      public static function method_2077(param1:class_198, param2:Boolean = true) : void
      {
         ...
         if(!class_63.var_4187)
         {
            ...
            class_63.var_4187.graphics.drawRect(class_73.method_2108(class_117.var_5287),class_73.method_2108(class_117.var_5287),class_102.var_4717,class_73.method_2108(class_121.var_5362));
            class_63.var_4187.graphics.endFill();
            class_63.var_579 = new class_355();
            class_63.var_579.y = class_73.method_2108(class_146.var_6117);
            class_63.var_579.x = class_73.method_2108(class_170.var_6653);
            ...
            class_63.var_4188.x = class_73.method_2108(class_89.var_4444);
            class_63.var_4187.addChild(class_63.var_4188);
            class_63.var_4182 = new class_88(class_146.var_6117,class_62.var_4089,class_26.method_1668(class_107.var_5045),class_63.method_2081,param1,class_73.method_2108(class_102.var_4856),!class_1.var_2884.var_94);
            class_63.var_4187.addChild(class_63.var_4182);
            _loc3_ = new class_88(class_146.var_6117,class_73.method_2108(class_170.var_6653),class_26.method_1668(class_181.var_6933),class_63.method_2074,null,class_73.method_2108(class_102.var_4856),!class_1.var_2884.var_94);
            class_63.var_4187.addChild(_loc3_);
            class_63.var_4183 = new class_88(class_73.method_2108(class_146.var_6117),class_16.var_3329,class_26.method_1668(class_183.var_7089),class_63.method_2027,new Array(param1,true),class_62.var_4090,!class_1.var_2884.var_94);
         ...
         if(param1 is class_349)
         {
            ...
            class_63.var_4190.x = class_73.method_2108(class_102.var_4824);
            class_63.var_4190.y = class_183.var_7093;
            _loc4_ = class_73.method_2108(class_9.var_3232);
            if(class_63.var_4190.width < _loc4_ / class_73.method_2108(class_165.var_6534))
            {
               class_63.var_4190.scaleX = class_73.method_2108(class_165.var_6534);
            ...
            class_63.var_4190.gotoAndStop(class_73.method_2108(class_33.var_3679));
            class_63.method_2027(new Array(param1,false));
         }
         else
         {
            _loc5_ = new Array(class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),class_183.var_7129,class_183.var_7129,class_183.var_7129);
            _loc5_[param1.var_1024] = param1.var_1023;
            _loc6_ = class_168.var_6539.var_609.method_120();
            _loc7_ = new class_150(_loc6_ + class_73.method_2111(class_121.var_5459) + _loc5_.join(class_73.method_2111(class_107.var_5062)),_loc6_,class_150.const_550,class_1.var_2884.var_13.var_894.var_790);
            class_63.var_4190 = _loc7_.method_579(class_181.var_6915,false);
            class_63.var_4187.addChild(class_63.var_4190);
            class_63.var_4190.x = class_181.var_6913;
            class_63.var_4190.y = class_73.method_2108(class_183.var_7093);
            class_63.var_4190.scaleX = class_73.method_2108(class_165.var_6534);
            class_63.var_4190.scaleY = class_73.method_2108(class_165.var_6534);
            _loc8_ = new Array();
            class_63.method_2042(class_63.var_4190,class_73.method_2111(class_4.var_2950) + param1.var_574,_loc8_);
         ...
         if(_loc9_ && _loc10_)
         {
            ...
            if(_loc11_ && _loc12_)
            {
               if(_loc11_.var_1665 == _loc12_.var_1665)
               {
                  ...
                  return _loc5_ is class_201 ? Number(-class_73.method_2108(class_33.var_3679)) : Number(class_33.var_3679);
               }
         ...
         if(_loc7_ && _loc8_)
         {
            if(_loc8_.var_1665 == _loc7_.var_1665)
            {
               if(_loc5_.var_1037 == _loc6_.var_1037)
               {
                  ...
                  return _loc5_ is class_201 ? Number(-class_33.var_3679) : Number(class_73.method_2108(class_33.var_3679));
               }
