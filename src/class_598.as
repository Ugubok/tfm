package
{
   ...
   public class class_598 extends class_24
   {
      ...
      public function class_598(param1:int, param2:class_594, param3:Boolean = false)
      {
         ...
         if(class_146.var_6117 <= param2.var_2320)
         {
            this.var_2334 = class_99.var_4681;
         }
         else if(class_117.var_5287 <= param2.var_2320)
         {
         ...
         {
            _loc4_ = new class_23(class_165.var_6506,class_165.var_6506);
         }
         _loc4_.graphics.beginFill(class_1.var_2878.var_180.var_1092);
         _loc4_.graphics.drawRect(class_183.var_7129,class_183.var_7129,class_165.var_6506,class_165.var_6506);
         ...
         this.var_401.x = class_127.var_5864;
         this.var_401.width = param1 - this.var_401.x - class_117.var_5287;
         ...
         _loc6_.height = class_33.var_3675;
         ...
         if(this.var_2331.var_387)
         {
            ...
            _loc7_ = class_92.var_4600 + this.var_2331.var_387 + class_33.var_3617 + _loc7_;
         }
         else
         {
         ...
         _loc6_.text = _loc7_;
         addChild(_loc6_);
         var_206 = class_165.var_6534 + this.var_401.height;
         if(var_206 < class_165.var_6506)
         {
            var_206 = class_165.var_6506;
         }
         if(param3 && this.var_2331.var_2321 == class_183.var_7129)
         {
         ...
         if(this.var_2331.var_2321 == class_33.var_3679)
         {
            ...
            _loc8_.graphics.drawRect(class_183.var_7129,class_183.var_7129,name_5,var_206);
            _loc8_.graphics.endFill();
            addChild(_loc8_);
         }
         if(class_165.var_6534 == this.var_2331.var_2321)
         {
            filters = [class_54.name_53];
            transform.colorTransform = new ColorTransform(class_146.var_6103,class_146.var_6103,class_146.var_6103);
         }
      ...
      public function method_1665(param1:Boolean) : void
      {
         ...
         var _loc2_:int = !!class_284.var_2324 ? int(class_170.var_6713) : int(class_33.var_3679);
         if(param1)
         {
      ...
      public function method_325(param1:Boolean = false) : void
      {
         ...
         _loc2_ = _loc2_.replace(/&/g,class_183.var_7088).replace(/</g,class_4.var_3032);
         _loc2_ = class_53.method_1965(_loc2_,this.var_2331.var_2317);
         _loc2_ = _loc2_.replace(new RegExp(class_33.var_3616,class_146.var_6083),class_60.var_3920);
         _loc2_ = _loc2_.replace(new RegExp(class_9.var_3215,class_146.var_6083),class_165.var_6466);
         _loc2_ = _loc2_.replace(new RegExp(class_124.var_5607,class_146.var_6083),class_4.var_3019);
         _loc2_ = _loc2_.replace(new RegExp(class_117.var_5232,class_146.var_6061),class_16.var_3419);
         _loc2_ = _loc2_.replace(new RegExp(class_107.var_5011,class_146.var_6061),class_121.var_5442);
         ...
         if(this.var_2331.var_2320 > class_33.var_3679 || this.var_2331.var_2320 < -class_33.var_3679 || param1)
         {
            if(class_183.var_7129 > this.var_2331.var_2320)
            {
               _loc3_ += class_16.var_3418 + this.var_2331.var_2320;
            }
            else
            {
               _loc3_ += class_117.var_5231 + this.var_2331.var_2320;
            }
         }
      ...
      public function method_1666() : void
      {
         ...
         if(class_284.var_7196 && class_284.var_7196.parent)
         {
            ...
            _loc1_ = _loc1_.replace(new RegExp(class_62.var_4108,class_146.var_6083),class_9.var_3268);
            _loc1_ = _loc1_.replace(new RegExp(class_4.var_3018,class_146.var_6061),class_89.var_4382);
            class_284.var_7196.method_583(class_33.var_3615 + class_231.method_2802(this.var_2331.var_2317) + class_107.var_5071 + _loc1_ + class_124.var_5608);
         }
      }
      ...
      public function method_310() : void
      {
         ...
         if(class_183.var_7129 == this.var_2331.var_2321)
         {
            ...
            if(this.var_2331.var_2317 != class_111.var_363)
            {
               ...
               var_7599.method_818(class_26.method_1668(class_33.var_3614),this.method_1665,false,false,!this.var_2332);
            }
            var_7599.method_818(class_26.method_1668(class_124.var_5606),this.method_1666);
            ...
            if(this.var_2331.var_2317 != class_111.var_363)
            {
               var_7599.method_818(class_26.method_1668("$bouton.signaler",this.var_2331.var_2317),function():void
               {
                  ...
                  _loc1_.method_818(class_26.method_1668(class_165.var_6480),method_1667);
                  _loc1_.method_818(class_26.method_1668(class_117.var_5241));
                  _loc1_.method_427();
               });
            }
            var_7599.method_427();
