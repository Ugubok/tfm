package
{
   ...
   public class class_555 extends class_24
   {
      ...
      {
         super(class_73.method_2108(class_62.var_4089),class_73.method_2108(class_89.var_4432));
         method_239(class_9.var_3268);
         method_216(new class_245(class_243.const_642,class_117.var_5287));
         method_221(class_73.method_2108(class_146.var_6118));
         var _loc1_:class_220 = new class_220(class_26.method_1668(class_9.var_3192),name_5,class_73.method_2108(class_183.var_7129)).method_856(TextFormatAlign.JUSTIFY);
         method_136(_loc1_);
         method_221(class_73.method_2108(class_146.var_6118));
         this.var_2163 = new class_220(class_73.method_2111(class_9.var_3268),name_5,class_183.var_7129).method_864(class_54.const_284);
         this.var_2163.method_856(TextFormatAlign.CENTER);
         this.var_2163.autoSize = TextFieldAutoSize.CENTER;
         this.var_2163.height = class_73.method_2108(class_183.var_7129);
         method_136(this.var_2163);
         var _loc2_:class_24 = new class_24(name_5,class_33.var_3675);
         method_136(_loc2_);
         var _loc3_:class_220 = new class_220(class_26.method_1668(class_73.method_2111(class_9.var_3198)));
         ...
         var _loc4_:class_24 = new class_24(name_5,class_73.method_2108(class_33.var_3675));
         method_136(_loc4_);
         ...
         var _loc5_:class_246 = new class_246(class_26.method_1668(class_73.method_2111(class_181.var_6933)),(_loc4_.name_5 - _loc4_.method_220()) / class_165.var_6534,this.method_439);
      ...
      public function method_1578(param1:String) : void
      {
         ...
         {
            this.var_2163.text = class_73.method_2111(class_9.var_3268);
      ...
      public function method_1579(param1:String) : void
      {
         ...
         {
            this.var_2156.var_1226.text = class_73.method_2111(class_9.var_3268);
      ...
      public function method_257() : Boolean
      {
         ...
         var _loc1_:String = this.var_2156.var_1226.text;
         _loc1_ = _loc1_.substr(class_73.method_2108(class_183.var_7129),class_33.var_3679).toUpperCase() + _loc1_.substr(class_33.var_3679).toLowerCase();
