package
{
   ...
   public class class_603 extends class_23
   {
      ...
      public function class_603(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int)
      {
         ...
         _loc7_ = new class_23(class_162.var_6351,class_73.method_2108(class_162.var_6351));
         _loc7_.method_213(class_175.method_118(!!this.var_2344 ? class_73.method_2111(class_9.var_3133) : class_73.method_2111(class_89.var_4407)),true,true);
         _loc7_.cacheAsBitmap = class_99.var_4681;
         _loc7_.x = class_117.var_5287;
         _loc7_.y = class_73.method_2108(class_117.var_5287);
         addChild(_loc7_);
         _loc8_ = class_164.method_2574(!!this.var_2344 ? int(this.var_2344) : int(this.var_2343));
         _loc8_.x = _loc7_.name_5 - _loc8_.width - class_73.method_2108(class_165.var_6534);
         ...
         this.var_2277 = new class_814(name_5 - class_73.method_2108(class_117.var_5287) * class_165.var_6534,class_181.var_6939,!!this.var_2344 ? 13716846 : 13737805);
         ...
         this.var_2277.method_583(this.var_2341 + class_73.method_2111(class_16.var_3431) + this.var_2342);
         ...
         graphics.drawRoundRect(class_183.var_7129,class_73.method_2108(class_183.var_7129),name_5,var_206,class_9.var_3267);
         graphics.endFill();
      }
      ...
      public function method_1668() : String
      {
         ...
         if(this.var_2339 == class_73.method_2108(class_165.var_6534))
         {
            _loc1_ = class_73.method_2111(class_4.var_2915) + this.var_2339 + class_73.method_2111(class_33.var_3659) + this.var_2340;
         }
         else
         {
            _loc1_ = class_73.method_2111(class_4.var_2915) + this.var_2339;
         }
         return class_73.method_2111(class_117.var_5225) + class_26.method_1668(_loc1_,class_73.method_2111(class_89.var_4348) + (-this.var_2341 + this.var_2342) + class_117.var_5188);
      }
