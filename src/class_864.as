package
{
   ...
   public class class_864 implements class_474, class_733
   {
      ...
      public var var_2804:class_760;
      
      public function class_864(param1:class_484)
      {
         super();
         this.name_10 = param1;
      }
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is class_760)
            {
               this.var_2804 = class_760(_loc2_);
               this.var_2804.var_2614 = this;
            }
         }
      }
