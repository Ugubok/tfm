package
{
   ...
   public class class_19 extends Sprite
   {
      ...
      public function class_19(param1:int, param2:int, param3:Function = null, param4:Object = null)
      {
         ...
         var _loc6_:class_88 = new class_88(class_146.var_6117,this.var_206 - class_124.var_5641,class_26.method_1668(class_60.var_3934),this.method_174,null,this.name_5 - class_102.var_4859,false);
         addChild(_loc6_);
         x = int((class_107.var_5074 - this.name_5) / class_165.var_6534);
         y = class_33.var_3675 + int((-this.var_206 + class_183.var_7096) / class_165.var_6534);
      }
      ...
      public function method_176(param1:Event) : void
      {
         ...
         this.var_207.y = int((-this.var_207.height + this.var_206) / class_165.var_6534) - class_183.var_7127;
      }
      ...
      public function method_177(param1:String) : void
      {
         ...
         _loc2_.defaultTextFormat = new TextFormat(class_26.var_3500,class_170.var_6720,class_54.const_279);
         _loc2_.multiline = class_99.var_4681;
         _loc2_.wordWrap = class_99.var_4681;
         _loc2_.selectable = class_99.var_4682;
         _loc2_.x = class_146.var_6117;
         _loc2_.y = class_146.var_6117;
         _loc2_.width = -class_33.var_3675 + this.name_5;
         ...
         _loc3_.Rendu_Ascenseur(class_183.var_7129);
