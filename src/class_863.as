package
{
   ...
   public class class_863 implements class_474, class_733
   {
      ...
      public var var_2803:class_759;
      
      public function class_863(param1:class_484)
      {
         super();
         this.name_10 = param1;
      }
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is class_759)
            {
               this.var_2803 = class_759(_loc2_);
               this.var_2803.var_2613 = this;
            }
         }
      }
