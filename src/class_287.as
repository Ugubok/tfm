package
{
   ...
   public class class_287 extends class_24
   {
      ...
      {
         this.var_1386 = class_183.var_7129;
         ...
         this.var_1385.var_1242.push(class_183.var_7129,class_165.var_6534,class_117.var_5265,class_183.var_7129,class_9.var_3233,class_183.var_7129,class_92.var_4566,class_33.var_3679);
         ...
         this.var_1378.x = class_146.var_6117;
         this.var_1378.y = class_146.var_6117;
         addChild(this.var_1378);
         this.var_1382 = new class_24(this.var_1378.name_5,class_33.var_3675);
         this.var_1382.method_216(this.var_1385);
         this.var_1382.method_136(null,new class_220(class_26.method_1668(class_127.var_5807)),new class_220(class_26.method_1668(class_162.var_6279)));
         this.var_1382.method_231(class_33.var_3675,this.var_1382.var_206,true,this.var_1382.name_5 - class_102.var_4859);
         this.var_1378.method_136(this.var_1382);
         this.var_1378.method_221(class_165.var_6534);
         this.var_1383 = new class_24(this.var_1378.name_5,this.var_1378.var_206 - class_165.var_6506);
         ...
         this.var_1389 = new class_244(this.var_1378.name_5,class_33.var_3675).method_941(class_26.method_1668(class_121.var_5412));
         this.var_1389.method_951(class_175.method_118(class_170.var_6655,true));
         ...
         this.var_1381.method_216(new class_245(class_243.const_642,class_117.var_5287));
         this.var_1381.x = this.var_1378.x + this.var_1378.name_5 + class_146.var_6117;
      ...
      public static function name_6(param1:Boolean) : void
      {
         if(param1)
         {
            if(!class_287.var_2884)
            {
               ...
               class_287.var_2884.x = int((class_107.var_5074 - class_287.var_2884.name_5) / class_165.var_6534);
               class_287.var_2884.y = class_102.var_4859;
            }
      ...
      public function method_1049(param1:String, param2:class_24, param3:Function, param4:Boolean = false) : class_244
      {
         ...
         var var_1492:class_24 = var_7555.method_249(var_7555.name_5,class_117.var_5280);
      ...
      public function method_1050() : void
      {
         ...
         while(++_loc1_ < _loc2_)
         {
            ...
            if(!(this.var_1390 && _loc3_.var_2347.indexOf(this.var_1391) == -class_33.var_3679))
            {
               ...
               _loc5_ = class_141.method_92(_loc3_.var_1214,class_117.var_5280);
               _loc4_.method_136(_loc5_);
               _loc5_.y -= class_121.var_5495;
               _loc6_ = new class_220(_loc3_.var_2346,class_4.var_2992);
               if(_loc3_.var_2350)
               {
               ...
               else if(_loc3_.var_2349 <= class_121.var_5493 && _loc3_.var_2349 > class_183.var_7129)
               {
               ...
               _loc4_.method_136(new class_220(_loc7_,class_89.var_4436,class_33.var_3675,this.var_1393));
               if(_loc3_.var_1399)
               {
                  _loc8_ = new class_250(class_107.var_4983,class_33.var_3675,class_117.var_5280);
         ...
         if(param1.var_2350 && param1.var_2351 == class_165.var_6444)
         {
            ...
            while(_loc6_ < _loc5_)
            {
               ...
               if(_loc7_)
               {
                  ...
                  _loc10_ = _loc8_[class_33.var_3679];
      ...
      public function method_1053(param1:Vector.<int>) : void
      {
         ...
         while(++_loc2_ < _loc3_)
         {
            ...
            {
               this.var_1388.htmlText = class_183.var_7128 + class_26.var_3500 + class_181.var_6873 + (class_165.var_6534 + class_1.var_2878.var_180.var_1065) + class_117.var_5204 + class_26.method_1668(class_127.var_5827 + _loc4_) + class_121.var_5411 + class_1.var_2878.var_180.var_1065 + class_117.var_5203 + class_26.method_1903(class_111.var_5092,class_162.var_6278 + _loc4_);
            }
         }
      }
      ...
      public function method_1054() : void
      {
         ...
         this.var_1407 = class_9.var_3268;
         this.var_1399 = new class_195();
         this.var_1397 = new class_24(class_162.var_6327,class_92.var_4616);
         this.var_1397.method_227(class_243.const_639,class_146.var_6117);
         ...
         var_7557[class_117.var_5287] = class_99.var_4681;
         var_7557[class_9.var_3267] = class_99.var_4681;
         var_7557[class_92.var_4647] = class_99.var_4681;
         ...
         var var_1492:class_24 = this.var_1398.method_249(this.var_1398.name_5,class_117.var_5280);
         this.var_1403 = new class_220(class_26.method_1668(class_127.var_5807));
         this.var_1402 = new class_220(class_9.var_3268);
         ...
         {
            var_1407 = class_121.var_5423;
            var_1401.method_583(class_62.var_4075);
            var_1399.var_1005 = null;
            method_1058();
         },null);
         this.var_1406.method_818("Racing",function():*
         {
            ...
            var_1401.method_583(class_60.var_3898);
            var_1399.var_1005 = null;
            method_1058();
         },null);
         ...
         this.var_1401 = this.method_1049(class_26.method_1668("$RotationCartes"),this.var_1398,function(param1:String, param2:class_244):*
         {
            ...
            var _loc3_:* = param1.replace(class_124.var_5647,class_9.var_3268).split(class_107.var_5062);
            var _loc4_:* = new Vector.<int>();
            var _loc5_:* = class_183.var_7129;
         ...
         },true).method_583(class_9.var_3178);
         ...
         this.method_1049(class_26.method_1668("$SalonDuréePartie","(%)"),this.var_1398,function(param1:String, param2:class_244):*
         {
            ...
            _loc3_ = Math.min(Math.max(_loc3_,class_165.var_6506),class_121.var_5493);
         ...
         this.var_1397.x = int((name_5 - this.var_1397.name_5) / class_165.var_6534);
         this.var_1397.y = int((-this.var_1397.var_206 + var_206) / class_165.var_6534);
      ...
      public function method_1055(param1:class_606, param2:class_606) : Number
      {
         ...
         if(this.var_1386 == class_92.var_4628)
         {
            ...
            if(param2.var_11 == class_183.var_7129)
            {
               return -class_33.var_3679;
            }
      ...
      public function method_1057(param1:Event) : void
      {
         ...
         this.var_1390 = this.var_1391 != null && this.var_1391.length >= class_165.var_6534;
         this.method_1050();
      }
      
      public function method_1058() : void
      {
         var _loc1_:* = class_9.var_3268;
         ...
         if(this.var_1407)
         {
            _loc1_ = _loc1_ + this.var_1407 + class_124.var_5647;
         }
