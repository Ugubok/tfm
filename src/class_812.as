package
{
   public class class_812 extends class_23
   {
      ...
      public function class_812()
      {
         ...
         graphics.drawRoundRect(class_183.var_7129,class_183.var_7129,class_812.name_38,class_812.name_58,class_165.var_6534,class_165.var_6534);
         graphics.endFill();
         graphics.beginFill(4411778);
         graphics.drawRoundRect(class_812.const_1327,class_812.const_1327,class_812.name_38 - class_165.var_6534 * class_812.const_1327,class_812.name_58 - class_165.var_6534 * class_812.const_1327,class_165.var_6534,class_165.var_6534);
         graphics.endFill();
         _loc1_ = new class_250(class_102.var_4782,class_812.const_1328,class_812.const_1328).method_965(class_812.const_1328,class_812.const_1328);
         addChild(_loc1_);
         _loc1_.x = class_812.const_1327 + class_33.var_3679;
         _loc1_.y = class_33.var_3679 + class_812.const_1327;
         this.var_2697 = new class_220(class_26.method_1668(class_117.var_5213),class_812.name_38 - class_812.const_1328 - class_165.var_6534 * (class_812.const_1327 + class_812.const_1329) - class_165.var_6534,class_812.name_58 - class_812.const_1327);
         ...
         this.var_2697.x = _loc1_.x + class_812.const_1328 + class_812.const_1329 + class_33.var_3679;
      ...
      {
         this.var_2697.text = class_26.method_1668(class_117.var_5213);
      }
   }
}
