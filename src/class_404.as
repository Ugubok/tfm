package
{
   ...
   public class class_404 extends class_24
   {
      ...
      {
         super(class_165.var_6438,class_127.var_5850);
         method_251(true,class_146.var_6117);
         method_188();
         method_216(class_245.const_647);
         method_136(new class_220(class_26.method_1668(class_4.var_2979),name_5,class_16.var_3473).method_856(TextFormatAlign.CENTER).method_865(class_183.var_7127));
         method_231(class_117.var_5287,method_217(true) + class_165.var_6534,true,name_5 - class_146.var_6117);
         method_221(class_92.var_4628);
         this.var_1723 = new class_387(name_5 * class_146.var_6118 / class_121.var_5495,class_121.var_5493);
         ...
         var _loc3_:class_24 = new class_24(name_5,class_33.var_3675);
         this.var_1777 = new class_246(class_26.method_1668(class_107.var_5045),(name_5 - class_165.var_6534) / class_165.var_6534,this.method_1271);
         _loc3_.method_136(this.var_1777);
         _loc3_.method_136(new class_246(class_26.method_1668(class_183.var_7052),(-class_165.var_6534 + name_5) / class_165.var_6534,this.method_439));
         method_136(_loc3_);
      ...
      public static function name_6(param1:String = null) : void
      {
         ...
         class_115.method_388(class_404.var_2884,class_33.var_3679);
      }
      ...
      public static function method_2752() : void
      {
         ...
         {
            class_404.var_2884.x = (-class_404.var_2884.name_5 + class_107.var_5074) / class_165.var_6534;
            class_404.var_2884.y = class_33.var_3675 + (class_183.var_7096 - class_404.var_2884.var_206) / class_165.var_6534;
         }
      }
      ...
      public function method_1271() : void
      {
         ...
         if(_loc1_)
         {
            class_39.var_3744.method_313(new class_71(this.var_1775,_loc1_.var_1722 as int,!!this.var_1776.method_940() ? class_9.var_3268 : this.var_1776.var_1226.text));
            this.method_439();
         }
      }
      ...
      {
         this.var_1723.method_1261(class_183.var_7129);
         this.var_1776.method_941(class_26.method_1668(class_127.var_5801));
      }
   }
}
