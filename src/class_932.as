package
{
   ...
   public class class_932 implements class_474, class_733
   {
      ...
      public var var_2848:class_780;
      
      public function class_932(param1:class_484)
      {
         super();
         this.name_10 = param1;
      }
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is class_780)
            {
               this.var_2848 = class_780(_loc2_);
               this.var_2848.var_2642 = this;
            }
         }
      }
