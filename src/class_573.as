package
{
   ...
   public class class_573 extends class_166
   {
      ...
      
      {
         ...
         class_573.const_1262[class_121.var_5463] = class_573.const_1243;
         class_573.const_1262[class_121.var_5470] = class_573.const_1244;
         class_573.const_1262[class_170.var_6714] = class_573.const_1245;
         class_573.const_1262[class_165.var_6506] = class_573.const_1246;
         class_573.const_1262[class_107.var_5050] = class_573.const_1246;
         class_573.const_1262[class_127.var_5864] = class_573.const_1247;
         class_573.const_1262[class_62.var_4136] = class_573.const_1248;
         class_573.const_1262[class_162.var_6352] = class_573.const_1249;
         class_573.const_1262[class_89.var_4402] = class_573.const_1250;
      }
      ...
      override public function name_23(param1:class_281) : Boolean
      {
         ...
         if(var_873)
         {
            if(this.var_2246 != -class_33.var_3679 && class_573.const_1262[param1.var_1354] !== null)
            {
      ...
      override public function name_2(param1:int) : void
      {
         ...
         if(var_873 && !class_168.var_6539.var_366 && this.var_2246 != -class_33.var_3679)
         {
      ...
      override public function method_666(param1:class_501) : void
      {
         ...
         switch(param1.var_574)
         {
            case class_33.var_3679:
               ...
               _loc4_ = param1.method_1477(class_33.var_3679);
               ...
               while(_loc7_ < _loc4_)
               {
                  ...
                  {
                     if(!this.var_2245[_loc12_ * class_33.var_3668 + _loc13_])
                     {
                        _loc16_ = new class_24(class_170.var_6705,class_33.var_3675);
                        _loc16_.method_216(new class_245(class_243.const_642));
                        _loc16_.alpha = class_170.var_6648;
                        this.var_2245[_loc12_ * class_33.var_3668 + _loc13_] = _loc16_;
                     }
                     else
                     {
                        _loc16_ = this.var_2245[_loc12_ * class_33.var_3668 + _loc13_];
                     }
                     _loc17_ = new class_24(_loc16_.name_5,class_33.var_3675);
                     _loc18_ = new class_250(class_62.var_4114 + class_573.const_1260[_loc8_] + class_89.var_4385,class_33.var_3675,class_33.var_3675).method_965(class_33.var_3675,class_33.var_3675);
                     _loc17_.method_136(_loc18_);
                     _loc15_ = new class_814(_loc16_.name_5,class_181.var_6939);
                     ...
                     _loc16_.y = _loc13_ - _loc16_.var_206 / class_165.var_6534;
                  }
                  else
                  {
                  ...
                  if(_loc10_ > class_183.var_7129)
                  {
                     ...
                     _loc15_.method_583(this.method_1624(_loc9_) + class_165.var_6512 + this.method_1624(_loc10_));
                  }
                  else
                  {
            ...
            case class_165.var_6534:
               ...
               if(_loc2_)
               {
                  class_1.var_2884.method_33(class_56.const_193,_loc2_.x,_loc2_.y - class_146.var_6117,class_146.var_6117,class_165.var_6534,false);
                  if(_loc2_.var_773)
                  {
                     this.var_2246 = param1.method_1477(class_33.var_3679);
                  }
               }
               break;
            case class_146.var_6118:
               ...
               if(_loc2_ && var_873)
               {
                  _loc19_ = class_146.var_6118;
                  _loc20_ = class_165.var_6534;
                  ...
                  class_1.var_2884.method_33(class_56.const_334,_loc2_.x,_loc2_.y,_loc19_,_loc20_ + class_33.var_3679,false,class_183.var_7129);
               }
         }
      }
      ...
      {
         param1.alpha = class_33.var_3679;
      ...
      public function method_1624(param1:int) : String
      {
         ...
         return _loc2_.replace(new RegExp(class_127.var_5711,class_146.var_6083),class_124.var_5647);
      }
   }
}
