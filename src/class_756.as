package
{
   ...
   public class class_756 extends class_755
   {
      ...
      public function method_1748() : void
      {
         ...
         var _loc10_:* = false;
         var _loc1_:class_315 = new class_315(class_124.var_5657,class_26.method_1668(class_121.var_5408,class_231.method_2798(this.var_2605.var_817)),true);
         ...
         _loc3_.method_216(new class_245(class_243.const_642,class_121.var_5495));
         ...
         _loc3_.method_244(true,class_162.var_6351);
         _loc3_.method_219();
         _loc1_.clear();
      ...
      public function method_1750() : void
      {
         ...
         if(this.var_2605.var_817.toLowerCase() != class_111.var_5079)
         {
            ...
            {
               _loc1_.method_818(class_207.const_619,class_26.method_1668(class_102.var_4768),this.method_1748);
            }
            if(_loc3_.var_2051 && !this.var_2605.var_1933.var_2051 && !class_154.var_6147.var_1952)
            {
               _loc1_.method_818(class_207.const_619,class_26.method_1668(class_124.var_5576),this.method_1754);
            }
      ...
      override public function method_431() : void
      {
         ...
         if(_loc4_ != class_306.var_7228)
         {
            ...
            {
               var_2597 = new class_250(class_117.var_5199,class_170.var_6720,const_1320);
            }
            ...
            if(var_2597)
            {
               _loc3_.method_221((const_1319 - var_2597.name_5) / class_165.var_6534);
               _loc3_.method_136(var_2597);
               var_2597.y = (-const_1320 + _loc3_.var_206) / class_165.var_6534;
               var_2597.y -= class_146.var_6118;
            }
         }
         ...
         var _loc6_:class_220 = new class_220(this.var_2605.var_1933.var_817,_loc5_.name_5,class_92.var_4628).method_864(class_54.const_283);
         _loc5_.method_136(_loc6_);
         _loc6_.method_865(class_162.var_6346);
         _loc6_.y = -class_165.var_6534;
         var _loc7_:class_24 = new class_24(var_2596.name_5,_loc2_);
         _loc7_.method_216(new class_245(class_243.const_639,class_117.var_5287));
         var _loc8_:int = class_165.var_6534;
         var_2598 = new class_220(var_1931.method_1443(),_loc7_.name_5 - var_1214.name_5 - _loc8_ - const_1319 - class_165.var_6534 * _loc7_.method_220() - const_1322,class_33.var_3675);
         var_2598.method_864(class_54.const_280).method_865(class_162.var_6346);
         var _loc9_:int = var_2598.getCharIndexAtPoint(var_2598.width - var_2598.method_867() / class_165.var_6534,var_2598.height / class_165.var_6534);
         ...
         var_2600 = new class_220(class_742.method_3077(var_2000.method_1380()),_loc7_.name_5,class_183.var_7129);
         ...
         else if(var_2000.method_1380().getTime() != class_183.var_7129)
         {
            _loc7_.method_136(var_2600);
            var_2600.y = -class_33.var_3679;
         }
      ...
      {
         var _loc1_:class_315 = new class_315(class_124.var_5657,class_26.method_1668(class_102.var_4767,class_231.method_2798(this.var_2605.var_817)),true);
         _loc1_.method_239(class_26.method_1668(class_89.var_4356),_loc1_.method_439);
         _loc1_.method_1100(class_26.method_1668(class_107.var_5045),class_154.var_6147.method_1431,this.var_2605.var_817);
         _loc1_.method_1107(class_26.method_1668(class_181.var_6933));
         _loc1_.method_1111();
         _loc1_.method_967(class_183.var_7129,class_33.var_3675,class_107.var_5074,class_183.var_7096);
         class_115.method_388(_loc1_);
      ...
      public function method_1752() : void
      {
         if(class_154.method_2530(this.var_2605))
         {
            class_1.var_2884.method_77(class_102.var_4847 + this.var_2605.var_1931.method_1443());
         }
      }
      ...
      public function method_1753(param1:class_523, param2:class_24) : void
      {
         ...
         this.var_2607.transform.colorTransform = new ColorTransform(class_165.var_6534,class_165.var_6534,class_165.var_6534);
      }
      ...
      public function method_1754() : void
      {
         ...
         _loc1_.method_1100(class_26.method_1668(class_107.var_5045),class_154.var_6147.method_1408,this.var_2605.var_817);
         _loc1_.method_1107(class_26.method_1668(class_181.var_6933));
         _loc1_.method_1111();
         _loc1_.method_967(class_183.var_7129,class_33.var_3675,class_107.var_5074,class_183.var_7096);
         class_115.method_388(_loc1_);
