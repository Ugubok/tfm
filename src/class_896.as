package
{
   ...
   public class class_896 implements class_474
   {
      ...
      public var var_2021:String;
      
      public var var_2358:String;
      
      public function class_896(param1:class_484)
      {
         super();
         this.name_10 = param1;
      }
      ...
      {
         return class_73.method_2108(class_146.var_6117) + this.var_2317.length + this.var_2021.length + this.var_2358.length;
      }
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         this.var_2021 = param1.readUTFBytes(_loc3_);
      ...
      {
         return class_73.method_2108(class_124.var_5616);
      }
   }
}
