package
{
   public class class_231
   {
      ...
      public static function method_2796(param1:String) : String
      {
         ...
         if(_loc2_ == class_89.var_4425 || _loc2_ == class_16.var_3394)
         {
            return param1.substr(class_183.var_7129,class_165.var_6534).toUpperCase() + param1.substr(class_165.var_6534);
         }
         return param1.substr(class_183.var_7129,class_33.var_3679).toUpperCase() + param1.substr(class_33.var_3679);
      }
      ...
      public static function method_2798(param1:String, param2:Boolean = true, param3:int = 12, param4:Boolean = true, param5:int = 0) : String
      {
         ...
         var _loc9_:int = 0;
         var _loc6_:int = param1.indexOf(class_165.var_6522);
         if(_loc6_ == -class_33.var_3679)
         {
            return param1;
         }
         _loc7_ = param1.substr(class_183.var_7129,_loc6_);
         _loc8_ = param1.substr(class_33.var_3679 + _loc6_);
         _loc9_ = -(class_165.var_6534 + int(param3 / class_170.var_6731));
         if(param4)
         {
            return _loc7_ + class_9.var_3214 + class_54.const_289.toString(class_16.var_3467) + class_60.var_3892 + class_4.var_2975 + _loc9_ + class_33.var_3677 + (!!param2 ? class_124.var_5647 : class_9.var_3268) + class_165.var_6522 + _loc8_ + class_162.var_6345;
         }
         return _loc7_ + class_183.var_7043 + _loc9_ + class_33.var_3677 + (!!param2 ? class_124.var_5647 : class_9.var_3268) + class_165.var_6522 + _loc8_ + class_162.var_6345;
      }
      ...
      public static function method_2801(param1:String, param2:String, param3:Boolean = false) : String
      {
         if(param1)
         {
            ...
            if(param3)
            {
               return class_9.var_3166 + param2 + class_33.var_3677 + class_231.method_2798(param1,false) + class_102.var_4795;
            }
            return class_9.var_3166 + param2 + class_33.var_3677 + param1 + class_102.var_4795;
         }
         return class_4.var_3000;
      }
