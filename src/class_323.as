package
{
   ...
   public class class_323 extends Sprite
   {
      ...
      public function class_323(param1:Boolean)
      {
         ...
         this.var_1546 = class_73.method_2108(class_183.var_7129);
         this.var_1547 = class_73.method_2108(class_183.var_7129);
         super();
         ...
         if(param1)
         {
            ...
            this.var_1544.graphics.drawCircle(class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),class_121.var_5493);
            this.var_1544.graphics.endFill();
            addChild(this.var_1544);
            _loc2_ = new Sprite();
            _loc2_.graphics.beginFill(65535,class_107.var_5060);
            _loc2_.graphics.drawCircle(class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),class_73.method_2108(class_89.var_4444));
            _loc2_.graphics.drawCircle(class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),class_73.method_2108(class_121.var_5493));
      ...
      public function method_1125() : String
      {
         ...
         {
            _loc1_ += class_73.method_2111(class_121.var_5459) + this.var_1548.getChildAt(_loc2_).x + class_107.var_5062 + this.var_1548.getChildAt(_loc2_).y;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      public function name_5() : int
      {
         ...
         if(class_73.method_2108(class_33.var_3679) == _loc1_)
         {
            return class_162.var_6351;
         }
         if(_loc1_ == class_73.method_2108(class_165.var_6534))
         {
            return class_89.var_4436;
         }
         if(class_73.method_2108(class_146.var_6118) == _loc1_)
         {
            return class_73.method_2108(class_121.var_5493);
         }
         if(class_121.var_5495 == _loc1_)
         {
            return class_73.method_2108(class_89.var_4444);
         }
         if(this.var_1548)
         {
      ...
      public function method_1126(param1:Event) : void
      {
         ...
         rotation = this.var_1547 + (_loc2_ - this.var_1546) * class_73.method_2116(class_183.var_6961);
      }
      ...
      public function method_1127(param1:int, param2:Boolean = false, param3:String = null) : void
      {
         ...
         if(this.var_1545)
         {
            ...
            _loc10_ = (class_170.var_6720 - _loc9_) / class_73.method_2108(class_170.var_6720);
            _loc11_ = class_183.var_7129;
            while(_loc11_ < _loc9_)
            {
               if(!_loc8_ || _loc8_.length == class_73.method_2108(class_33.var_3679))
               {
                  _loc12_ = new Point(int(Math.random() * class_89.var_4436 - class_162.var_6351),int(Math.random() * class_89.var_4436 - class_73.method_2108(class_162.var_6351)));
               ...
               {
                  _loc12_ = new Point(int(_loc8_[class_33.var_3679 + _loc11_].split(class_73.method_2111(class_107.var_5062))[class_73.method_2108(class_183.var_7129)]),int(_loc8_[class_73.method_2108(class_33.var_3679) + _loc11_].split(class_73.method_2111(class_107.var_5062))[class_73.method_2108(class_33.var_3679)]));
               }
               if(param1 > class_73.method_2108(class_170.var_6695))
               {
                  ...
                  {
                     _loc13_ = class_21.method_1889(param1,class_73.method_2108(class_183.var_7129));
                  }
               }
               else
               {
         ...
         else if(class_170.var_6695 < param1)
         {
            if(_loc4_ && _loc4_.length > class_183.var_7129)
            {
               this.var_1548 = class_21.method_1889(param1,class_73.method_2108(class_183.var_7129),_loc4_);
            }
            else
            {
         ...
         {
            this.var_1548 = class_175.method_118(class_73.method_2111(class_16.var_3449) + param1);
         }
         if(!this.var_1548)
         {
            this.var_1548 = new MovieClip();
            this.var_1548.graphics.beginFill(Math.random() * 16777215);
            this.var_1548.graphics.drawRect(-class_73.method_2108(class_183.var_7127),-class_183.var_7127,class_162.var_6351,class_162.var_6351);
         ...
         addChildAt(this.var_1548,class_73.method_2108(class_183.var_7129));
         class_282.name_6();
      }
      
      public function method_1128(param1:Event) : void
      {
         removeEventListener(class_73.method_2111(class_124.var_5632),this.method_1126);
         removeEventListener(MouseEvent.MOUSE_UP,this.method_1128);
      }
      
      public function method_1129() : Number
      {
         if(this.var_1545 && this.var_1548.numChildren > class_73.method_2108(class_183.var_7129))
         {
            return this.var_1548.getChildAt(class_73.method_2108(class_183.var_7129)).rotation;
         }
         return rotation;
      }
