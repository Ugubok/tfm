package
{
   ...
   public class class_528 extends class_24
   {
      ...
      public function class_528(param1:ByteArray)
      {
         ...
         super(class_1.var_2884.var_19.stageWidth - class_102.var_4859,class_1.var_2884.var_19.stageHeight - class_102.var_4859);
         ...
         graphics.drawRect(-class_117.var_5288,-class_117.var_5288,class_146.var_6087,class_146.var_6087);
         graphics.endFill();
         var _loc2_:TextFormat = new TextFormat(class_26.var_3500,class_170.var_6720,class_54.const_291);
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            _loc9_ = class_141.method_92(_loc7_,class_117.var_5280);
            _loc8_.method_136(_loc9_);
            _loc10_ = new class_220(_loc6_,class_183.var_7129,class_162.var_6351,_loc2_);
