package
{
   ...
   public class class_408
   {
      ...
      public static function method_2958(param1:int) : void
      {
         ...
         {
            class_408.method_2959(class_26.method_1668(class_121.var_5346));
            class_408.var_2115.x = class_121.var_5361;
         ...
         else if(class_33.var_3679 == param1)
         {
            ...
            class_408.var_2115.x = class_170.var_6717;
            class_408.var_2115.y = class_102.var_4786;
         }
      ...
      public static function method_2959(param1:String) : void
      {
         ...
         class_1.var_2884.addEventListener(class_89.var_4409 + class_121.var_5345,class_408.name_2);
      }
      ...
      public static function name_9() : void
      {
         ...
         class_408.var_7277 = class_58.var_3803.method_372(class_4.var_2928) as MovieClip;
         ...
         class_408.var_7277.addChild(new class_88(class_181.var_6920 * class_33.var_3679 * class_33.var_3679,class_9.var_3240,class_26.method_1668(class_89.var_4295),class_408.method_2960,null,class_4.var_2943,!class_1.var_2884.var_94));
      ...
      {
         class_408.var_2723 += class_165.var_6534;
         if(class_26.var_3497)
         {
            class_408.var_7278.htmlText = class_102.var_4858 + class_408.var_7279.substr(class_183.var_7129,class_408.var_2723);
         }
         else
         {
         ...
         {
            class_1.var_2884.removeEventListener(class_89.var_4294 + class_89.var_4409,class_408.name_2);
         }
      }
