package
{
   ...
   public class class_828 extends class_24
   {
      ...
      public function class_828(param1:int, param2:int, param3:int, param4:int = 0)
      {
         ...
         super(class_124.var_5657,class_165.var_6493);
         ...
         {
            class_828.name_56 = new ColorMatrixFilter(new Array(class_33.var_3679 / class_146.var_6118,class_33.var_3679 / class_146.var_6118,class_33.var_3679 / class_146.var_6118,class_183.var_7129,class_183.var_7129,class_33.var_3679 / class_146.var_6118,class_33.var_3679 / class_146.var_6118,class_33.var_3679 / class_146.var_6118,class_183.var_7129,class_183.var_7129,class_33.var_3679 / class_146.var_6118,class_33.var_3679 / class_146.var_6118,class_33.var_3679 / class_146.var_6118,class_183.var_7129,class_183.var_7129,class_183.var_7129,class_183.var_7129,class_183.var_7129,class_33.var_3679,class_183.var_7129));
            class_828.var_7395 = new Array(new GlowFilter(16777215,class_33.var_3679,class_146.var_6118,class_183.var_7129,class_146.var_6118,class_146.var_6118));
            class_828.var_7396 = new ColorTransform(class_107.var_5060,class_107.var_5060,class_107.var_5060);
         }
         this.var_1654 = new Sprite();
         this.var_1654.graphics.lineStyle(class_33.var_3679,16777215,class_33.var_3679,false,class_33.var_3676,CapsStyle.NONE);
         this.var_1654.graphics.lineTo(class_183.var_7129,class_162.var_6351);
         this.var_1654.filters = class_828.var_7395;
         this.var_1654.y = class_33.var_3675;
         ...
         if(_loc5_)
         {
            _loc6_ = class_117.var_5225 + class_26.method_1668(class_9.var_3208 + param1,class_121.var_5462 + param2 + class_117.var_5225);
         }
         else
         {
            _loc6_ = class_117.var_5225 + class_26.method_1668(class_9.var_3208 + param1,class_121.var_5462 + param2 + class_92.var_4592 + param3 + class_117.var_5225);
         }
         _loc6_ = _loc6_.replace(new RegExp(class_16.var_3410),class_16.var_3409);
         this.var_2738.htmlText = _loc6_;
         this.var_2738.height = class_92.var_4628;
         this.var_2738.autoSize = class_60.var_3974;
         addChild(this.var_2738);
         this.var_2737 = class_175.method_2618(class_146.var_6057);
         this.var_2737.x = class_146.var_6117;
         this.var_2737.y = class_121.var_5494;
         ...
         this.var_2733 = class_175.method_2618(class_102.var_4796 + param1 + class_117.var_5274);
      ...
      public function method_1781(param1:Event) : void
      {
         ...
         _loc2_.width = class_162.var_6351;
      ...
      public function method_1782() : void
      {
         ...
         this.var_2733.y = class_33.var_3675;
         ...
         this.var_2736.graphics.drawRect(class_183.var_7129,class_183.var_7129,_loc1_,var_206);
