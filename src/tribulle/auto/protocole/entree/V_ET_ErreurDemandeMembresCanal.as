package tribulle.auto.protocole.entree
{
   ...
   public class V_ET_ErreurDemandeMembresCanal implements _IPaquetEntrant, _IPaquetSequenciel
   {
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is V_ST_DemandeMembresCanal)
            {
               this.precedentDemandeMembresCanal = V_ST_DemandeMembresCanal(_loc2_);
