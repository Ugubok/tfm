package tribulle.auto.protocole.entree
{
   ...
   public class V_ET_ResultatSupprimerRang implements _IPaquetEntrant, _IPaquetSequenciel
   {
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is V_ST_SupprimerRang)
            {
               this.precedentSupprimerRang = V_ST_SupprimerRang(_loc2_);
