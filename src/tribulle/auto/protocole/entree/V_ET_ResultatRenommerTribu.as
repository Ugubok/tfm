package tribulle.auto.protocole.entree
{
   ...
   public class V_ET_ResultatRenommerTribu implements _IPaquetEntrant, _IPaquetSequenciel
   {
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is V_ST_RenommerTribu)
            {
               this.precedentRenommerTribu = V_ST_RenommerTribu(_loc2_);
