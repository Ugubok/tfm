package tribulle.auto.protocole.entree
{
   ...
   public class V_ET_ResultatExclureMembre implements _IPaquetEntrant, _IPaquetSequenciel
   {
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is V_ST_ExclureMembre)
            {
               this.precedentExclureMembre = V_ST_ExclureMembre(_loc2_);
