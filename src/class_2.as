   ...
   public class class_2
   {
      ...
      public static function name_2(param1:Event) : void
      {
         ...
         if(class_2.var_2895 && _loc2_ > class_2.var_1443)
         {
            ...
            _loc4_ = class_2.var_2894[class_165.var_6533];
            _loc5_ = class_114.method_2312(class_183.var_7129,class_183.var_7129,_loc3_,_loc4_);
            ...
            _loc6_ = int((_loc3_ + class_168.var_6539[class_89.var_4424]) * class_146.var_6117) / class_146.var_6117;
            _loc7_ = int((_loc4_ + class_168.var_6539[class_107.var_5063]) * class_146.var_6117) / class_146.var_6117;
            ...
            if(class_2.const_50 < _loc8_)
            {
               ...
               class_39.var_3745.method_313(class_191.method_2733(class_2.var_2896 * class_146.var_6117,class_2.var_2897 * class_146.var_6117,_loc6_ * class_146.var_6117,_loc7_ * class_146.var_6117));
               class_2.var_2896 = _loc6_;
               class_2.var_2897 = _loc7_;
               class_2.var_2893 -= _loc8_;
               if(class_2.var_2893 <= class_183.var_7129)
               {
                  class_2.method_1820();
               }
            }
      ...
      public static function method_1819(param1:class_168, param2:int, param3:int, param4:int, param5:int, param6:int) : void
      {
         ...
         _loc7_.graphics.lineStyle(class_33.var_3679,param2);
      ...
      {
         class_1.var_2884.method_97(class_183.var_6960 + param1 + class_121.var_5331);
      ...
      public static function method_1825(param1:int, param2:int) : void
      {
         ...
         class_2.var_2894.graphics.lineStyle(class_33.var_3679,param2,class_92.var_4648);
         class_2.var_2894.graphics.beginFill(class_183.var_7129,class_183.var_7129);
         class_2.var_2894.graphics.drawCircle(class_183.var_7129,class_183.var_7129,class_2.const_51);
         ...
         class_1.var_2884.addEventListener(class_124.var_5632,class_2.name_2);
         ...
         var _loc3_:MovieClip = MovieClip(class_192.method_2748(class_127.var_5705));
         var _loc4_:DisplayObject = DisplayObjectContainer(_loc3_.getChildAt(class_33.var_3679)).getChildAt(class_183.var_7129);
