package
{
   ...
   public class class_223 extends Sprite
   {
      ...
      public function class_223()
      {
         ...
         super();
         this.var_1146 = new class_24(class_73.method_2108(class_16.var_3416),class_73.method_2108(class_170.var_6653));
         ...
         this.var_1146.y = class_73.method_2108(class_146.var_6117);
         graphics.beginFill(3294800);
         graphics.drawRoundRect(class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),class_73.method_2108(class_60.var_3979),class_73.method_2108(class_89.var_4404),class_33.var_3675);
         graphics.endFill();
      ...
      public function method_876() : void
      {
         ...
         this.method_877(class_73.method_2108(class_33.var_3679),class_17.var_3474);
         this.method_877(class_73.method_2108(class_146.var_6118),class_17.var_3476);
         if(class_1.const_43)
         {
            this.method_877(class_73.method_2108(class_165.var_6534),class_17.var_3475);
         }
         if(class_1.const_43 || class_1.const_44)
         {
            this.method_877(class_73.method_2108(class_92.var_4647),class_17.var_3478);
         }
         if(class_1.const_43)
         {
            this.method_877(class_73.method_2108(class_121.var_5495),class_17.name_13);
         }
         this.method_877(class_170.var_6731,class_17.var_3479);
         this.method_877(class_73.method_2108(class_117.var_5287),class_17.var_3477);
         this.method_877(class_170.var_6720,class_17.var_3482);
         this.method_877(class_73.method_2108(class_117.var_5279),class_17.var_3480);
         if(class_1.const_43)
         {
            this.method_877(class_73.method_2108(class_181.var_6939),class_17.var_3481);
         ...
         if(class_546.method_2252())
         {
            ...
            this.method_877(class_73.method_2108(class_92.var_4628),class_17.var_3486);
         }
      }
      ...
      public function method_877(param1:int, param2:Boolean) : void
      {
         ...
         this.var_1147 += class_73.method_2108(class_33.var_3675);
      }
      ...
      public function method_878(param1:Boolean, param2:int) : void
      {
         ...
         else if(param2 == class_73.method_2108(class_146.var_6118))
         {
         ...
         else if(class_73.method_2108(class_117.var_5287) == param2)
         {
         ...
         else if(param2 == class_73.method_2108(class_102.var_4852))
         {
            class_180.method_831(param1);
         }
         else if(class_73.method_2108(class_146.var_6117) == param2)
         {
            class_180.method_2672(param1);
         }
         else if(class_73.method_2108(class_162.var_6346) == param2)
         {
            class_180.method_2679(param1);
         }
         else if(param2 == class_73.method_2108(class_170.var_6720))
         {
         ...
         else if(class_73.method_2108(class_121.var_5494) == param2)
         {
