package
{
   ...
   public class class_217 extends Sprite
   {
      ...
      public const name_38:int = class_117.var_5206;
      ...
      public function class_217()
      {
         ...
         super();
         this.method_516();
         x = (-this.name_38 + class_107.var_5074) / class_165.var_6534;
         y = class_9.var_3259 + (class_183.var_7096 - Math.min(height,class_183.var_7096)) / class_165.var_6534;
      }
      ...
      public static function method_2786() : void
      {
         ...
         if(!class_217.var_7160)
         {
            ...
            class_217.var_7160.addChildAt(class_175.method_2618(class_107.var_4893),class_183.var_7129);
      ...
      public static function name_6(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            class_115.method_388(class_217.var_2884,class_33.var_3679);
      ...
      public function method_852() : void
      {
         ...
         _loc1_.push(class_121.var_5462 + class_26.method_1668(class_170.var_6565),null,null);
         _loc1_.push(class_26.method_1668(class_181.var_6933),this.method_835,null);
         _loc1_.push(class_26.method_1668(class_124.var_5518,class_170.var_6564),this.method_854,null);
      ...
      public function method_516() : void
      {
         ...
         _loc1_.height = class_16.var_3462;
         addChild(_loc1_);
         this.var_1137 = new Sprite();
         this.var_1137.x = class_165.var_6370;
         this.var_1137.y = class_162.var_6351;
         addChild(this.var_1137);
         _loc2_ = class_175.method_2618(class_146.var_5960);
         _loc2_.x = this.var_1137.x - class_117.var_5244;
         _loc2_.y = -class_183.var_7127 + this.var_1137.y;
         addChild(_loc2_);
         this.var_1138 = new class_220();
         this.var_1138.method_865(class_162.var_6346);
         this.var_1138.method_864(5691068);
         this.var_1138.y = -class_117.var_5287 + this.var_1137.y;
         this.var_1138.filters = new Array(new GlowFilter(class_183.var_7129,class_33.var_3679,class_121.var_5495,class_121.var_5495,class_9.var_3267));
         addChild(this.var_1138);
         this.var_1128 = class_84.method_2131();
         var _loc3_:TextFormat = this.var_1128.defaultTextFormat;
         _loc3_.size = class_9.var_3266;
         ...
         this.var_1129.text = class_26.method_1668(class_60.var_3838,class_183.var_7129);
         this.var_1129.x = _loc1_.width / class_165.var_6534 - class_121.var_5493;
         ...
         var _loc4_:int = class_121.var_5456 * class_117.var_5287 + class_124.var_5641 + class_183.var_7127;
         var _loc5_:int = (_loc1_.height - _loc4_) / class_165.var_6534;
         var _loc6_:int = _loc4_ * class_146.var_6118 / class_117.var_5287;
         ...
         this.var_1136 = new class_88(_loc1_.width / class_121.var_5495 - class_107.var_5037,_loc1_.height - class_33.var_3675 - class_183.var_7127,class_26.method_1668(class_170.var_6565),this.method_852,null,class_183.var_7093,!class_1.var_2884.var_94);
         addChild(this.var_1136);
         var _loc9_:class_88 = new class_88(_loc1_.width * class_146.var_6118 / class_121.var_5495 - class_107.var_5037,_loc1_.height - class_33.var_3675 - class_183.var_7127,class_26.method_1668(class_60.var_3934),this.method_143,null,class_183.var_7093,!class_1.var_2884.var_94);
         addChild(_loc9_);
      }
      ...
      public function method_853(param1:int) : void
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:int = class_121.var_5456 * class_165.var_6534 + class_124.var_5641;
         if(param1 >= class_33.var_3675 || class_111.var_5102)
         {
         ...
         else
         {
            if(this.var_1133.parent)
            {
               removeChild(this.var_1135[class_165.var_6534]);
               removeChild(this.var_1135[class_146.var_6118]);
               removeChild(this.var_1133);
               removeChild(this.var_1134);
            }
            _loc2_ = class_146.var_6118;
            _loc3_ = class_170.var_6717;
         }
         this.var_1130.x = (this.name_38 - (_loc2_ * _loc4_ + (-class_33.var_3679 + _loc2_) * _loc3_)) / class_165.var_6534;
         this.var_1135[class_183.var_7129].x = int(this.var_1130.x + _loc4_ + _loc3_ / class_165.var_6534);
         this.var_1131.x = int(this.var_1130.x + _loc4_ + _loc3_);
         this.var_1135[class_33.var_3679].x = int(this.var_1131.x + _loc4_ + _loc3_ / class_165.var_6534);
         ...
         this.var_1135[class_146.var_6118].x = int(this.var_1133.x + _loc4_ + _loc3_ / class_165.var_6534);
      ...
      public function method_855() : void
      {
         ...
         this.var_1137.graphics.drawRect(class_183.var_7129,class_183.var_7129,class_539.var_7325 == class_183.var_7129 ? Number(class_124.var_5517) : Number(Math.min(class_124.var_5517,int(class_539.var_7326 * class_124.var_5517 / class_539.var_7325))),class_170.var_6731);
         this.var_1137.graphics.endFill();
         this.var_1138.text = class_539.var_7326 + class_16.var_3431 + class_539.var_7325;
         this.var_1138.x = (this.name_38 - this.var_1138.width) / class_165.var_6534;
         this.var_1128.text = String(_loc1_);
         this.method_853(_loc1_);
         while(this.var_1130.numChildren)
         {
            this.var_1130.removeChildAt(class_183.var_7129);
         }
         ...
         {
            this.var_1132.removeChildAt(class_183.var_7129);
         }
         ...
         {
            this.var_1134.removeChildAt(class_183.var_7129);
         }
         ...
         {
            _loc4_ = class_33.var_3525;
         }
         class_217.var_7161 = -_loc2_ + _loc4_;
         this.var_1123 = new class_538(class_183.var_7129,class_26.method_1668(class_60.var_3837));
         this.var_1124 = new class_538(class_33.var_3679,class_26.method_1668(class_33.var_3524));
         this.var_1125 = new class_538(class_165.var_6534,class_26.method_1668(class_183.var_6977));
         this.var_1126 = new class_538(class_146.var_6118,class_26.method_1668(class_92.var_4491));
         this.var_1127 = new class_538(class_121.var_5495,class_26.method_1668(class_181.var_6793));
         ...
         this.var_1129.text = class_26.method_1668(class_60.var_3838,class_217.var_7161);
