package
{
   ...
   public class class_582 extends class_166
   {
      ...
      {
         class_582.const_1279.push(new <Point>[new Point(class_117.var_5287,-class_73.method_2108(class_107.var_5040)),new Point(class_92.var_4614,class_9.var_3234),new Point(-class_73.method_2108(class_89.var_4402),-class_73.method_2108(class_146.var_6118)),new Point(class_4.var_3043,class_162.var_6351),new Point(-class_16.var_3473,class_73.method_2108(class_162.var_6352)),new Point(-class_73.method_2108(class_102.var_4859),class_107.var_5033),new Point(class_73.method_2108(class_33.var_3633),class_107.var_5033)]);
         class_582.const_1279.push(new <Point>[new Point(class_102.var_4859,-class_73.method_2108(class_16.var_3467)),new Point(class_73.method_2108(class_107.var_5036),class_124.var_5618),new Point(-class_73.method_2108(class_162.var_6351),-class_117.var_5279),new Point(-class_73.method_2108(class_117.var_5264),class_73.method_2108(class_60.var_3939)),new Point(class_33.var_3675,class_92.var_4637),new Point(-class_117.var_5264,class_73.method_2108(class_9.var_3227)),new Point(class_107.var_5068,class_9.var_3227)]);
         class_582.const_1279.push(new <Point>[new Point(class_102.var_4859,-class_73.method_2108(class_33.var_3668)),new Point(class_73.method_2108(class_9.var_3243),class_73.method_2108(class_102.var_4859)),new Point(-class_92.var_4615,-class_73.method_2108(class_117.var_5287)),new Point(class_73.method_2108(class_92.var_4628),class_73.method_2108(class_102.var_4822)),new Point(-class_73.method_2108(class_92.var_4628),class_16.var_3467),new Point(-class_89.var_4402,class_73.method_2108(class_165.var_6490)),new Point(class_73.method_2108(class_89.var_4436),class_165.var_6490)]);
      }
      
      public const const_35:int = class_73.method_2108(class_183.var_7127);
      ...
      public function method_1635(param1:int, param2:Boolean) : class_147
      {
         ...
         _loc3_.var_682 = class_73.method_2108(class_183.var_7129);
         ...
         {
            _loc4_ = new class_446(class_16.var_3328,class_73.method_2108(class_183.var_6966));
         }
         if(param2)
         {
            this.var_2274[class_73.method_2108(class_165.var_6534)] = param1;
         }
         else
         {
            ...
            else if(class_73.method_2108(class_165.var_6534) == _loc9_)
            {
               this.var_2274[class_33.var_3679] = param1;
            }
            else if(_loc9_ == class_73.method_2108(class_33.var_3679))
            {
               _loc4_.delta(class_73.method_2108(class_183.var_7129),-this.const_35);
               this.var_2274[class_73.method_2108(class_165.var_6534)] = param1;
            }
         }
         _loc5_ = new MovieClip();
         _loc6_ = class_175.method_2618(class_73.method_2111(class_124.var_5503) + (param1 + class_33.var_3679) + class_73.method_2111(class_89.var_4385));
         _loc6_.x = -_loc4_.x / class_73.method_2108(class_165.var_6534);
         _loc6_.y = -_loc4_.y / class_73.method_2108(class_165.var_6534);
         ...
         _loc8_.var_413 = class_73.method_2116(class_4.var_3035);
         _loc8_.var_414 = class_107.var_5060;
         _loc8_.var_417.var_1467 = class_73.method_2108(class_170.var_6731);
         _loc8_.var_417.var_1468 = class_73.method_2108(class_121.var_5495);
         _loc8_.method_1197(_loc4_.x / class_73.method_2116(class_162.var_6249),_loc4_.y / class_73.method_2116(class_162.var_6249));
      ...
      public function method_1636(param1:class_168, param2:int, param3:int) : void
      {
         ...
         {
            _loc5_ = class_446.method_3026(class_445.method_3022(class_582.const_1279[param2][class_117.var_5287],class_582.const_1279[param2][class_73.method_2108(class_9.var_3267)]));
         }
         ...
         if(_loc6_ != -class_73.method_2108(class_33.var_3679))
         {
            ...
            {
               _loc5_.delta(class_73.method_2108(class_183.var_7129),-this.const_35 / class_73.method_2108(class_165.var_6534));
            }
         ...
         _loc7_.var_651 = class_73.method_2108(class_183.var_7129);
         _loc7_.var_588 = param1.var_925;
         _loc7_.var_589 = _loc4_;
         _loc7_.var_648 = class_73.method_2108(class_183.var_7129);
         _loc7_.var_591 = new class_167(class_183.var_7129,class_183.var_7129);
         _loc7_.var_592 = new class_167(_loc5_.x / class_73.method_2116(class_181.var_6937),_loc5_.y / class_73.method_2116(class_181.var_6937));
      ...
      override public function method_667(param1:int) : Boolean
      {
         if(var_873)
         {
            if(this.var_2259 && this.var_2272 != -class_73.method_2108(class_33.var_3679))
            {
               ...
               {
                  if(this.var_2253.length == class_183.var_7129 || this.var_2253[this.var_2253.length - class_73.method_2108(class_33.var_3679)] == false)
                  {
         ...
         if(this.var_2273 && param1 >= class_183.var_7129 && param1 < this.var_2273.length)
         {
            ...
            while(_loc3_ < param2.length)
            {
               ...
               if(class_168.var_6539 == _loc4_)
               {
                  ...
                  this.var_2275 = _loc3_ == class_73.method_2108(class_183.var_7129);
      ...
      override public function method_656(param1:class_58) : void
      {
         ...
         if(var_873)
         {
            ...
            _loc2_.scaleX = class_73.method_2116(class_146.var_6072);
            _loc2_.scaleY = class_146.var_6072;
            _loc2_.x = class_165.var_6506;
            _loc2_.y = class_73.method_2108(class_107.var_5038);
            class_58.var_3803.method_388(_loc2_);
            this.var_2272 = -class_73.method_2108(class_33.var_3679);
            ...
            {
               this.var_2274[_loc3_] = -class_73.method_2108(class_33.var_3679);
               _loc3_++;
            }
            this.var_2253 = new Vector.<Boolean>();
      ...
      {
         if(!this.var_2275 || this.var_2272 == -class_73.method_2108(class_33.var_3679) || this.var_2276)
         {
            return;
         }
      ...
      override public function name_2(param1:int) : void
      {
         ...
         if(var_873)
         {
            if(this.var_2275)
            {
               if(param1 - this.var_2251 > class_73.method_2108(class_124.var_5662))
               {
                  this.method_1638();
                  this.var_2251 = param1;
               }
               _loc2_ = this.var_2273[this.var_2272];
               if(_loc2_.var_756.var_304 < -class_73.method_2116(class_16.var_3463))
               {
                  _loc2_.var_756.var_304 = class_73.method_2108(class_183.var_7129);
                  this.method_1638();
               }
               if(_loc2_.method_555().var_304 * class_162.var_6351 > class_582.const_1278 && !this.var_2276)
               {
                  ...
                  this.method_1638();
                  class_39.var_3745.method_313(method_660(class_73.method_2108(class_121.var_5495)));
               }
            }
         }
      }
      ...
      override public function method_666(param1:class_501) : void
      {
         ...
         switch(param1.var_574)
         {
            ...
            case class_33.var_3679:
               ...
               {
                  _loc2_ = param1.method_1477(class_73.method_2108(class_183.var_7129));
                  if(this.var_2273 && _loc2_ >= class_73.method_2108(class_183.var_7129) && _loc2_ < this.var_2273.length)
                  {
                     _loc5_ = param1.method_1477(class_73.method_2108(class_33.var_3679));
                     _loc6_ = new Vector.<class_168>();
                     _loc7_ = class_73.method_2108(class_183.var_7129);
                     while(_loc7_ < _loc5_)
                     {
                        _loc8_ = class_1.var_2884.var_85[param1.method_1477(_loc7_ + class_73.method_2108(class_165.var_6534))];
                        if(_loc8_)
                        {
                           _loc6_.push(_loc8_);
                        }
            ...
            case class_146.var_6118:
               if(var_873)
               {
                  ...
                  if(this.var_2273 && this.var_2273[_loc2_])
                  {
                     ...
                     _loc3_.method_556(new class_167(param1.method_1477(class_33.var_3679) / class_73.method_2116(class_117.var_5286),param1.method_1477(class_165.var_6534) / class_73.method_2116(class_117.var_5286)),class_73.method_2108(class_183.var_7129));
                     _loc3_.var_756 = new class_167(param1.method_1477(class_146.var_6118) / class_73.method_2116(class_117.var_5286),class_73.method_2108(class_183.var_7129));
                  }
               }
               break;
