package
{
   ...
   public class class_516 extends Sprite
   {
      ...
      public function class_516(param1:Function = null, param2:Object = null)
      {
         ...
         this.var_1719.y = class_73.method_2108(class_146.var_6118);
         ...
         this.var_1719.filters = new Array(new BevelFilter(class_33.var_3679,class_73.method_2108(class_107.var_5038),class_73.method_2108(class_183.var_7129),class_33.var_3679,6325657,class_73.method_2108(class_33.var_3679),class_73.method_2108(class_33.var_3679),class_33.var_3679,class_73.method_2108(class_33.var_3679),class_146.var_6118));
         this.var_1655 = new Sprite();
         this.var_1655.graphics.beginFill(11059144);
         this.var_1655.graphics.drawCircle(class_9.var_3267,class_9.var_3267,class_73.method_2108(class_146.var_6118));
         this.var_1655.y = class_146.var_6118;
         addChild(this.var_1719);
         graphics.beginFill(class_183.var_7129,class_183.var_7129);
         graphics.drawRect(class_183.var_7129,class_73.method_2108(class_183.var_7129),class_73.method_2108(class_102.var_4859),class_92.var_4628);
         graphics.endFill();
