package
{
   ...
   public class class_25 extends class_24
   {
      ...
      public function class_25()
      {
         ...
         graphics.endFill();
         addChild(new class_250(class_16.var_3401,class_107.var_5074,class_60.var_3979));
         ...
         this.var_285.x = class_89.var_4432;
         this.var_285.y = class_183.var_7096;
         ...
         _loc4_.y = int((this.var_285.var_206 - _loc4_.height) / class_165.var_6534);
         ...
         var _loc5_:class_250 = new class_250(class_102.var_4781,class_181.var_6910,class_102.var_4837);
         ...
         this.var_286.y = class_16.var_3416 - this.var_286.var_206;
         _loc6_ = new class_220(class_26.method_1668(class_16.var_3399),this.var_286.name_5 - class_9.var_3267,class_183.var_7129,new TextFormat(class_26.var_3500,class_170.var_6720,15918288,true,null,null,null,null,class_181.var_6903));
         _loc6_.x = class_146.var_6118;
         _loc6_.y = class_170.var_6731;
         _loc6_.filters = new Array(new GlowFilter(class_183.var_7129,class_33.var_3679,class_165.var_6534,class_165.var_6534,class_121.var_5495,class_33.var_3679));
      ...
      public static function name_6(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            class_249.name_6(class_25.var_2884,class_181.var_6881,class_33.var_3675,class_107.var_4993,false);
      ...
      public function method_264() : void
      {
         ...
         if(!this.var_287)
         {
            ...
            _loc1_ = new class_220(class_26.method_1668(class_117.var_5212),this.var_287.name_5,class_183.var_7129).method_856(TextFormatAlign.JUSTIFY);
         ...
         this.var_290.method_961(false);
         this.var_287.x = (name_5 - this.var_287.name_5) / class_165.var_6534;
         this.var_287.y = (-this.var_287.var_206 + var_206) / class_165.var_6534;
