package
{
   ...
   public class class_40 extends class_24
   {
      ...
      public function class_40()
      {
         ...
         super(class_60.var_3945,class_9.var_3232);
         method_251(true);
         this.method_323();
         ...
         this.var_402 = new class_246(class_26.method_1668(class_162.var_6293),name_5 - class_33.var_3675,this.method_324);
         this.var_402.x = class_146.var_6117;
         this.var_402.y = var_206 - class_33.var_3675 - class_170.var_6720;
         addChild(this.var_402);
         method_196(class_92.var_4648,class_146.var_6072);
      }
      ...
      public static function method_1942(param1:String) : void
      {
         ...
         {
            class_40.var_2884.method_325(class_40.var_2884.name_11 + class_107.var_5071 + param1);
         }
      }
      ...
      public static function name_6(param1:String, param2:Boolean = false) : void
      {
         ...
         {
            class_1.var_2884.removeChildAt(class_183.var_7129);
         }
      ...
      {
         class_18.method_1883(class_62.var_4093);
      }
      ...
      public function method_36() : void
      {
         ...
         {
            this.var_401.width = class_33.var_3635;
            name_5 = Math.min(class_33.var_3635,this.var_401.textWidth + class_102.var_4859);
            this.var_401.width = name_5 - class_33.var_3675;
            var_206 = class_102.var_4859 + this.var_401.textHeight;
            this.var_401.y = (var_206 - class_33.var_3675 - this.var_401.height) / class_165.var_6534;
            class_40.var_2884.method_196(class_92.var_4648,class_146.var_6072);
            class_40.var_2884.method_251(true);
            class_40.var_2884.addChildAt(class_40.var_2884.var_403,class_183.var_7129);
         }
      }
   }
}
