   ...
   public class class_617
   {
      ...
      public static function method_666(param1:ByteArray, param2:int) : void
      {
         ...
         if(param2 == class_170.var_6730)
         {
            ...
            if(_loc5_ && _loc6_)
            {
               class_617.var_7356.unshift((_loc7_ == class_183.var_7129 ? class_117.var_5225 : class_60.var_3846) + (!!_loc5_.var_773 ? class_165.var_6521 : class_9.var_3268) + _loc5_.var_363 + class_183.var_6994 + (_loc8_ == class_183.var_7129 ? class_117.var_5225 : class_60.var_3846) + (!!_loc6_.var_773 ? class_165.var_6521 : class_9.var_3268) + _loc6_.var_363);
               if(class_121.var_5493 < class_617.var_7356.length)
               {
                  class_617.var_7356.splice(class_165.var_6506,class_165.var_6506);
               }
               class_1.var_2884.var_121.htmlText = class_170.var_6608 + class_617.var_7356.join(class_107.var_5071);
            }
            _loc9_ = param1.readByte();
            _loc10_ = param1.readByte();
            class_541.var_7335[_loc9_ * class_146.var_6117 + _loc10_] = _loc8_ == class_183.var_7129 ? class_33.var_3679 : class_165.var_6534;
            return;
         }
         if(param2 == class_33.var_3675)
         {
            class_540.var_3803.method_1553(param1.readByte(),param1.readByte());
            return;
         }
         if(class_127.var_5865 == param2)
         {
         ...
         if(param2 == class_107.var_5038)
         {
            if(class_540.var_3803)
            {
               ...
               {
                  class_1.var_2884.method_97(class_165.var_6521 + class_26.method_1668(class_92.var_4537,class_117.var_5225 + class_26.method_1668(class_127.var_5743) + class_165.var_6521));
               }
               else if(class_33.var_3679 == _loc12_)
               {
                  class_1.var_2884.method_97(class_165.var_6521 + class_26.method_1668(class_92.var_4537,class_117.var_5225 + class_26.method_1668(class_4.var_2935) + class_165.var_6521));
               }
               else
               {
                  class_1.var_2884.method_97(class_165.var_6521 + class_26.method_1668(class_117.var_5149));
               }
            }
            return;
         }
         if(class_165.var_6506 == param2)
         {
            class_214.method_2784(new class_530(param1));
            class_42.var_2884.method_333();
            class_1.var_2884.var_16.method_282(class_183.var_7129);
            return;
         }
         ...
         if(class_127.var_5864 == param2)
         {
            class_214.method_2785(param1.readShort());
            class_42.var_2884.method_333();
            return;
         }
         throw new Error(class_181.var_6819 + param2);
      }
   }
}
