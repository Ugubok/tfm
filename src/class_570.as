   ...
   public class class_570 extends class_166
   {
      ...
      override public function method_666(param1:class_501) : void
      {
         switch(param1.var_574)
         {
            ...
            case const_1241:
               ...
               class_38.method_1935(true,class_73.method_2108(class_33.var_3679) * (-class_146.var_6117 + class_73.method_2108(class_183.var_7129)));
               class_58.var_3803.method_386(class_170.var_6731);
               break;
            case const_470:
               if(class_73.method_2116(class_146.var_6103) == class_58.var_3803.var_519)
               {
                  class_58.var_3803.var_519 = class_73.method_2116(class_16.var_3435);
               }
               else
               {
      ...
      override public function name_2(param1:int) : void
      {
         if(var_873 && this.var_716)
         {
            ...
            {
               class_73.method_2115(class_73.method_2115(this.var_716.method_556))(new class_167(class_570.const_1210.x / class_165.method_2587(),this.var_716.var_742.position.var_305),this.var_716.method_559());
      ...
      public function method_1613() : void
      {
         ...
         _loc1_ = class_125.method_2392(class_46.const_164,class_570.const_1210.x - class_73.method_2108(class_9.var_3240),class_570.const_1210.y,class_183.var_7129,class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),false,-class_73.method_2108(class_33.var_3679),false,new MovieClip());
         _loc2_ = class_125.method_2392(class_46.const_164,class_570.const_1210.x + class_73.method_2108(class_9.var_3240),class_570.const_1210.y,class_183.var_7129,class_73.method_2108(class_183.var_7129),class_73.method_2108(class_183.var_7129),false,-class_73.method_2108(class_33.var_3679),false,new MovieClip());
         _loc1_.var_759 = NaN;
         _loc2_.var_759 = NaN;
         _loc3_ = new class_348();
         _loc3_.var_415 = class_73.method_2108(class_165.var_6506);
         ...
         _loc5_.y = -class_73.method_2108(class_4.var_2940);
         _loc4_.addChild(_loc5_);
         _loc3_.userData = _loc4_;
         class_58.var_3803.var_540.addChild(_loc4_);
         var _loc6_:class_118 = new class_118(false);
         _loc6_.position.method_105(class_570.const_1210.x / class_73.method_2116(class_181.var_6937),class_570.const_1210.y / class_73.method_2116(class_181.var_6937));
         _loc6_.var_682 = class_183.var_7129;
         this.var_716 = class_58.var_3803.var_504.method_1168(_loc6_);
         _loc7_ = new Vector.<Number>();
         _loc7_.push(class_73.method_2116(class_107.var_4885),-class_170.var_6555);
         _loc7_.push(class_73.method_2116(class_170.var_6554),-class_73.method_2116(class_165.var_6366));
         _loc7_.push(class_107.var_4884,-class_73.method_2116(class_146.var_5956));
         _loc7_.push(class_127.var_5717,-class_170.var_6553);
         _loc7_.push(class_165.var_6365,-class_124.var_5510);
         _loc7_.push(class_73.method_2116(class_127.var_5716),class_73.method_2116(class_4.var_3035));
         _loc7_.push(class_62.var_4106,class_170.var_6678);
         _loc3_.method_1200(_loc7_);
         this.var_716.method_549(_loc3_);
         _loc7_ = new Vector.<Number>();
         _loc7_.push(class_73.method_2116(class_107.var_4885),-class_73.method_2116(class_170.var_6555));
         _loc7_.push(class_73.method_2116(class_62.var_4106),class_73.method_2116(class_170.var_6678));
         _loc7_.push(class_33.var_3578,class_73.method_2116(class_89.var_4267));
         _loc7_.push(class_73.method_2116(class_4.var_3035),class_124.var_5509);
         _loc7_.push(-class_107.var_4885,class_165.var_6499);
         _loc7_.push(-class_73.method_2116(class_165.var_6364),class_73.method_2116(class_33.var_3630));
         _loc7_.push(-class_62.var_3995,-class_73.method_2116(class_16.var_3279));
         ...
         _loc7_.push(-class_73.method_2116(class_124.var_5508),-class_127.var_5844);
         _loc7_.push(-class_107.var_4883,-class_73.method_2116(class_183.var_6970));
         _loc3_.method_1200(_loc7_);
         this.var_716.method_549(_loc3_);
         _loc7_ = new Vector.<Number>();
         _loc7_.push(-class_107.var_4883,-class_73.method_2116(class_183.var_6970));
         _loc7_.push(-class_73.method_2116(class_62.var_3994),-class_127.var_5844);
         _loc7_.push(-class_89.var_4266,-class_107.var_4882);
         _loc7_.push(-class_73.method_2116(class_146.var_5955),-class_121.var_5316);
         _loc7_.push(-class_102.var_4690,-class_124.var_5624);
         _loc7_.push(-class_73.method_2116(class_124.var_5562),-class_107.var_4881);
         _loc7_.push(-class_107.var_4880,-class_9.var_3087);
         _loc7_.push(-class_73.method_2116(class_127.var_5715),-class_73.method_2116(class_170.var_6553));
         _loc3_.method_1200(_loc7_);
         this.var_716.method_549(_loc3_);
         _loc7_ = new Vector.<Number>();
         _loc7_.push(-class_73.method_2116(class_62.var_3994),-class_127.var_5844);
         _loc7_.push(-class_73.method_2116(class_89.var_4265),class_165.var_6499);
      ...
      override public function method_656(param1:class_58) : void
      {
         ...
         if(var_873)
         {
            ...
            class_38.method_1938(true,class_73.method_2116(class_16.var_3463));
            this.method_1613();
         }
      }
