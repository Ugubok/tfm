   ...
   public class class_845 extends class_844
   {
      ...
      override public function method_118() : class_24
      {
         ...
         if(!var_1519)
         {
            ...
            _loc1_ = new Sprite();
            _loc1_.graphics.beginFill(65280,class_73.method_2116(class_92.var_4648));
            _loc1_.graphics.drawRect(class_183.var_7129,class_183.var_7129,class_73.method_2108(class_33.var_3675),class_73.method_2108(class_33.var_3675));
            _loc1_.graphics.endFill();
            _loc2_ = var_2766.method_1132();
            _loc3_ = new class_220(class_73.method_2111(class_127.var_5834) + this.var_2490).method_864(class_54.const_282);
