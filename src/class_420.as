package
{
   ...
   public class class_420 extends class_24
   {
      ...
      public function class_420()
      {
         ...
         super(class_170.var_6653,class_162.var_6327);
         ...
         this.var_1006 = new class_24(name_5,var_206 - method_220() - class_33.var_3675);
         this.var_1006.method_216(new class_245(class_243.const_642,class_121.var_5495));
         ...
         class_241.method_208(this.var_1869,class_26.method_1668(class_124.var_5577));
         ...
         class_241.method_208(this.var_1870,class_26.method_1668(class_117.var_5200));
         ...
         _loc2_ = new class_250(class_107.var_4981,class_420.const_1090,class_420.const_1091);
         ...
         _loc2_ = new class_250(class_16.var_3383,class_420.const_1090,class_420.const_1091);
         ...
         class_241.method_208(this.var_1872,class_26.method_1668(class_62.var_4073));
         this.var_1873 = new class_244(name_5,class_33.var_3675);
         this.var_1873.method_951(class_175.method_118(class_170.var_6655,true));
         this.var_1873.method_941(class_26.method_1668(class_121.var_5412),false);
      ...
      public static function method_2752() : Boolean
      {
         ...
         class_420.var_2884.x = (class_107.var_5074 - class_420.var_2884.name_5) / class_165.var_6534;
         class_420.var_2884.y = class_33.var_3675 + class_183.var_7127 + int((-class_420.var_2884.var_206 + class_183.var_7096) / class_165.var_6534);
      ...
      public static function method_2986(param1:String) : void
      {
         ...
         {
            class_420.var_7298 = new class_314(class_60.var_3945).method_1100(class_26.method_1668(class_170.var_6707));
            class_420.var_7298.method_967(class_183.var_7129,class_33.var_3675,class_107.var_5074,class_183.var_7096);
         }
      ...
      public static function method_2988(param1:Boolean) : void
      {
         ...
         if(param1 && class_420.var_2884.var_1862.indexOf(class_9.var_3268) != -class_33.var_3679)
         {
            class_420.var_2884.var_1862.splice(class_420.var_2884.var_1862.indexOf(class_9.var_3268),class_33.var_3679);
         }
      ...
      public static function method_427(param1:Boolean = true) : void
      {
         if(param1)
         {
            if(!class_420.var_2884)
            {
               ...
               class_420.var_2884.x = (class_107.var_5074 - class_420.var_2884.name_5) / class_165.var_6534;
               class_420.var_2884.y = class_33.var_3675 + class_183.var_7127 + int((class_183.var_7096 - class_420.var_2884.var_206) / class_165.var_6534);
            }
            if(class_420.var_7296)
            {
      ...
      public function method_1348(param1:KeyboardEvent) : void
      {
         ...
         if(param1.keyCode == class_392.const_906 && _loc2_.text.length > class_183.var_7129)
         {
            ...
            else
            {
               ...
               {
                  class_154.method_2532(class_26.method_1668(class_146.var_6033));
                  return;
               }
         ...
         else if(param1.keyCode == class_392.const_910)
         {
            if(!this.var_1859)
            {
               ...
               {
                  this.var_1860.splice(_loc4_,class_33.var_3679);
               }
            }
            else
            {
               ...
               while(_loc5_ < _loc6_)
               {
                  if(this.var_1862[_loc5_].length == class_183.var_7129)
                  {
                     this.var_1862.splice(_loc5_,class_33.var_3679);
                     break;
                  }
                  _loc5_++;
               }
      ...
      public function method_1349() : void
      {
         ...
         _loc3_.push(class_9.var_3268);
         _loc3_.push(class_16.var_3397);
         _loc3_.push(class_124.var_5588);
         _loc3_.push(class_102.var_4779);
         var _loc4_:Dictionary = new Dictionary();
         _loc4_[class_33.var_3679] = class_33.var_3679;
         _loc4_[class_165.var_6534] = class_60.var_3897;
         _loc4_[class_146.var_6118] = class_107.var_4982;
         _loc4_[class_121.var_5495] = class_165.var_6534;
         _loc4_[class_117.var_5287] = class_146.var_6118;
         ...
         while(_loc5_ < class_420.var_7294)
         {
            ...
            class_420.var_7295.push(new class_483(_loc5_ + class_33.var_3679,class_62.var_4074 + (_loc5_ + class_33.var_3679),_loc2_[int(Math.random() * _loc2_.length)],!!_loc4_[_loc5_] ? int(_loc4_[_loc5_]) : int(class_183.var_7129),Math.random() > class_117.var_5201,_loc6_.method_1439(),_loc6_,_loc7_.getTime() / class_146.var_6075));
            _loc5_++;
         }
         this.method_1360();
      }
      ...
      public function method_1351() : void
      {
         ...
         {
            this.var_1860.splice(this.var_1860.length > class_183.var_7129 && this.var_1860[class_183.var_7129].name_47 ? Number(class_33.var_3679) : Number(class_183.var_7129),class_183.var_7129,class_420.const_1093);
            this.method_1318();
         }
      ...
      public function method_1318(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               if(_loc4_.length == class_183.var_7129 || _loc4_.toLowerCase().indexOf(_loc2_) != -class_33.var_3679)
               {
      ...
      public function method_1353(param1:Boolean) : void
      {
         ...
         if(this.var_1868.visible)
         {
            ...
            this.var_1872.y += class_183.var_7127 + class_420.const_1091;
         }
         this.var_1873.var_1226.text = class_9.var_3268;
         if(!param1)
         {
            class_241.method_208(this.var_1871,class_26.method_1668(class_16.var_3384));
            method_239(class_26.method_1668(class_89.var_4358),class_420.method_439);
            this.method_1306();
            ...
            if(class_154.var_6144.method_1444())
            {
               ...
               if(class_420.var_7296)
               {
                  _loc2_ = class_420.var_7295[class_33.var_3679];
               ...
               this.var_1860.splice(class_183.var_7129,class_183.var_7129,_loc2_);
            }
         }
         else
         {
      ...
      public function method_1354(param1:int) : DisplayObject
      {
         ...
         if(class_183.var_7129 == _loc2_.length)
         {
            ...
            this.var_1866.method_941(class_26.method_1668(class_9.var_3198),false);
      ...
      public function method_1356(param1:class_483) : void
      {
         ...
         else if(_loc2_ != -class_33.var_3679)
         {
            ...
            {
               this.var_1860.splice(_loc2_ + class_33.var_3679,class_183.var_7129,param1);
            }
         }
         else
         {
            this.var_1860.splice(this.var_1860.length > class_183.var_7129 && this.var_1860[class_183.var_7129].name_47 ? Number(class_33.var_3679) : Number(class_183.var_7129),class_183.var_7129,param1);
         }
         this.method_1318();
      }
      ...
      public function method_1336() : void
      {
         ...
         {
            this.var_1006.method_224(class_33.var_3675,this.var_1863.length,this.method_1354);
         }
      }
      ...
      public function method_1357(param1:class_483) : void
      {
         if(!param1.name_47)
         {
            this.var_1860.splice(this.var_1860.indexOf(param1),class_33.var_3679);
         }
         this.method_1318();
      }
      ...
      public function method_1359(param1:class_483, param2:class_483) : int
      {
         ...
         {
            return param1 == class_420.const_1093 ? int(-class_33.var_3679) : int(class_33.var_3679);
         }
         if(param1.method_1381() != param2.method_1381())
         {
            return !!param1.method_1381() ? int(-class_33.var_3679) : int(class_33.var_3679);
         }
         ...
         return param1.var_817 < param2.var_817 ? int(-class_33.var_3679) : int(class_33.var_3679);
      }
      ...
      public function method_1361(param1:int) : class_24
      {
         ...
         _loc2_.graphics.drawRect(class_183.var_7129,class_183.var_7129,_loc2_.name_5,_loc2_.var_206);
         _loc2_.graphics.endFill();
         _loc2_.graphics.lineStyle(class_33.var_3679,10785079);
         _loc2_.graphics.moveTo(-class_33.var_3679,-class_33.var_3679);
         ...
         _loc2_.graphics.lineTo(-class_33.var_3679,-class_33.var_3679);
         _loc2_.graphics.lineStyle(class_183.var_7129);
         var _loc3_:MovieClip = class_175.method_118(class_16.var_3382);
         ...
         this.var_1867 = new class_244(_loc2_.name_5 - _loc2_.method_217(true),_loc2_.var_206 - class_33.var_3679,false);
         this.var_1867.var_1226.restrict = class_248.const_651;
         this.var_1867.var_1226.y += class_165.var_6534;
      ...
      {
         var _loc1_:class_640 = new class_640(class_124.var_5657,class_26.method_1903(class_111.var_5092,class_146.var_6031));
      ...
      {
         this.var_1860.splice(this.var_1860.indexOf(param1),class_33.var_3679,param2);
         this.method_1318();
      }
      
      public function method_1364(param1:Event) : void
      {
         if(this.var_1867 && this.var_1867.var_1226.length == class_183.var_7129)
         {
            this.var_1867.method_941(class_26.method_1668(class_9.var_3198),false);
         }
         if(this.var_1866 && this.var_1866.var_1226.length == class_183.var_7129)
         {
            this.var_1866.method_941(class_26.method_1668(class_9.var_3198),false);
         }
      }
