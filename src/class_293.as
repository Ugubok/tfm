package
{
   ...
   public class class_293 extends Sprite
   {
      ...
      public function class_293()
      {
         ...
         this.var_180.setStyle(class_146.var_6112,{"color":"#ED67EA"});
         this.var_180.setStyle(class_89.var_4440,{"color":"#ED67EA"});
         this.var_1412 = new Sprite();
         addChild(this.var_1412);
         var _loc1_:BevelFilter = new BevelFilter(class_33.var_3679,class_107.var_5038,class_183.var_7129,class_33.var_3679,16777215,class_146.var_6103,class_33.var_3679,class_33.var_3679,class_33.var_3679,class_146.var_6118);
         this.var_1412.filters = new Array(_loc1_);
         var _loc2_:String = class_60.var_3893;
         try
         {
            if(class_101.method_2253())
            {
               _loc2_ = class_117.var_5222;
            }
            else if(class_101.method_2250())
            {
               _loc2_ = class_62.var_4099;
            }
         }
         catch(E:Error)
         {
         ...
         if(class_1.const_46)
         {
            ...
            this.var_1413 = class_62.var_4089;
         ...
         else if(class_1.const_47)
         {
            ...
            _loc3_.y = -class_33.var_3675;
            this.var_1413 = class_60.var_3945;
      ...
      public static function method_2855(param1:String) : void
      {
         ...
         param1 = class_127.var_5753 + param1;
      ...
      public static function name_6(param1:Boolean, param2:Boolean = false) : void
      {
         if(param1)
         {
            ...
            if(param2)
            {
               ...
               class_293.var_2884.graphics.drawRect(class_183.var_7129,class_183.var_7129,class_107.var_5074,class_60.var_3979);
      ...
      public static function method_2856(param1:String) : void
      {
         ...
         var _loc2_:String = class_293.var_7206[class_293.var_7206.length - class_33.var_3679];
         var _loc3_:Array = class_293.var_2884.var_1100.text.split(class_33.var_3678);
         var _loc4_:int = _loc3_[_loc3_.length - class_33.var_3679].length;
         ...
         if(param1 == class_16.var_3375)
         {
            _loc5_ += class_62.var_4018;
         }
         else if(param1 == class_117.var_5170)
         {
      ...
      public function method_1063() : void
      {
         ...
         class_293.method_2855(class_89.var_4362 + class_1.var_2878.var_179 + class_107.var_4915 + class_102.var_4860 + class_1.var_2884.var_1 + class_162.var_6345);
         class_293.method_2855(class_183.var_7001 + _loc1_);
         if(Capabilities.playerType != class_121.var_5469)
         {
            _loc2_ = class_99.var_4682;
            _loc3_ = Capabilities.version.split(class_124.var_5647)[class_33.var_3679].split(class_107.var_5062);
            _loc4_ = int(_loc3_[class_183.var_7129]);
            _loc5_ = int(_loc3_[class_183.var_7129]);
            ...
            else if(_loc5_ < class_117.var_5287)
            {
               _loc2_ = class_99.var_4681;
            }
            if(_loc2_)
      ...
      public function method_1064() : void
      {
         ...
         this.var_1412.graphics.drawRoundRect(this.var_1100.x - class_117.var_5287,this.var_1100.y - class_165.var_6534,this.var_1100.width + class_170.var_6731,this.var_1100.height + class_121.var_5495,class_183.var_7127);
