package
{
   public class class_280
   {
      ...
      public static function method_2833(param1:Number) : Boolean
      {
         ...
         if(param1 > class_121.var_5493 || param1 < -class_121.var_5493)
         {
      ...
      {
         if(class_280.method_2836(class_165.var_6534,class_33.var_3679))
         {
         ...
         if(class_280.method_2837(class_117.var_5287,class_92.var_4647))
         {
            class_68.method_2102(class_121.method_2363() + class_121.method_2361());
         }
         if(class_280.method_2834(class_92.var_4647))
         {
            class_68.method_2102(class_121.method_2363() + class_121.method_2361());
         }
         if(class_280.method_2837(class_170.var_6709,class_121.var_5465))
         {
            class_68.method_2102(class_60.method_2002() * class_121.method_2363());
         }
         if(class_280.method_2834(class_170.var_6709))
         {
            class_68.method_2102(class_121.method_2363() * class_60.method_2002() + class_121.method_2361());
         }
         if(!class_280.method_2833(class_121.var_5465))
         {
            class_68.method_2102(class_121.method_2363());
         }
         if(!class_280.method_2837(class_170.var_6731,class_170.var_6731))
         {
            class_68.method_2102(class_121.method_2363() + class_121.method_2361());
         }
         var _loc1_:class_172 = new class_172(class_170.var_6731);
         _loc1_.method_733(class_170.var_6731);
