package
{
   ...
   public class class_1 extends MovieClip
   {
      ...
      public static var var_2881:String = "A" + "C" + class_51.name_40;
      ...
      public static var var_2891:Boolean = Capabilities.playerType == "Desktop";
      ...
      public const const_1:String = class_102.var_4860 + this.var_1;
      ...
      public const const_3:class_167 = new class_167(class_183.var_7129,class_183.var_7129);
      ...
      public const const_4:ColorTransform = new ColorTransform(class_33.var_3679,class_33.var_3679,class_33.var_3679,class_92.var_4648,class_183.var_7129,class_102.var_4859,class_102.var_4859);
      ...
      public function class_1()
      {
         ...
         this.var_118 = -class_33.var_3679;
         ...
         this.var_135 = class_183.var_7129;
         ...
         this.var_153 = new Timer(class_124.var_5662,class_33.var_3679);
         this.Fx = class_89.var_4430;
         this.Fy = class_183.var_7129;
         this.var_154 = class_89.var_4430;
         this.var_155 = new class_116(class_183.var_7129,class_183.var_7129,class_107.var_5074,class_89.var_4432,this.method_69);
         this.var_156 = new Array();
         this.var_157 = new Array();
         this.var_158 = class_33.var_3679;
         super();
         ...
         else if(class_1.const_45)
         {
            ...
            class_1.var_2864 += int(new Date().getTime() / (class_117.var_5280 * class_89.var_4433));
         }
         ...
         try
         {
            loaderInfo[class_181.var_6944].addEventListener(class_33.var_3667,this.method_99);
         }
         catch(E:Error)
         {
         }
         ...
         try
         {
            ...
            {
               name_81 = ExternalInterface.call(class_4.var_3061) as String;
               if(name_81)
               {
                  this.var_145 = new Dictionary();
                  name_82 = name_81.split(class_60.var_3967);
                  if(class_33.var_3679 < name_82.length)
                  {
                     name_83 = name_82[class_33.var_3679].split(class_170.var_6721);
                     var_7436 = class_183.var_7129;
                     while(var_7436 < name_83.length)
                     {
                        name_84 = name_83[var_7436].split(class_9.var_3258);
                        this.var_145[name_84[class_183.var_7129]] = name_84.length > class_33.var_3679 ? name_84[class_33.var_3679] : true;
                        var_7436++;
                     }
                  }
                  if(this.var_145[class_33.var_3666])
                  {
         ...
         if(name_80)
         {
            class_24.var_3495 = class_146.var_6117;
         }
         try
         {
            if(ExternalInterface.available)
      ...
      public static function method_1810() : void
      {
         ...
         {
            ExternalInterface.call(class_121.var_5492);
         }
      }
      ...
      {
         if(class_111.var_5079 && (class_111.var_5079 == class_33.var_3669 || class_111.var_5079 == class_121.var_5481 || class_111.var_5079.indexOf(class_89.var_4431) == class_183.var_7129))
         {
      ...
      public function method_1() : void
      {
         ...
         this.var_119 = new Timer(class_117.var_5288);
      ...
      public function method_2(param1:int, param2:int, param3:int, param4:int, param5:Boolean = false, param6:int = 0) : void
      {
         if(class_152.var_6142)
         {
            if(param5)
            {
               this.method_58(class_51.const_258 + class_51.const_263 + class_51.name_40 + param1 + class_51.name_40 + param2 + class_51.name_40 + param3 + class_51.name_40 + param4 + class_51.name_40 + class_33.var_3679 + class_51.name_40 + param6);
            }
            else
            {
               this.method_58(class_51.const_258 + class_51.const_263 + class_51.name_40 + param1 + class_51.name_40 + param2 + class_51.name_40 + param3 + class_51.name_40 + param4 + class_51.name_40 + class_183.var_7129 + class_51.name_40 + param6);
            }
         }
      }
      ...
      public function method_3(param1:Array) : void
      {
         ...
         while(this.var_96.numChildren != class_183.var_7129)
         {
         ...
         while(_loc7_ < _loc3_)
         {
            _loc11_ = class_175.method_118(class_107.var_5076);
            ...
            if(_loc13_ != null)
            {
               ...
               _loc11_.var_612 = _loc2_[_loc7_ + class_165.var_6534];
         ...
         this.var_96.graphics.lineStyle(class_146.var_6118,class_183.var_7129,class_33.var_3679,true,class_33.var_3676,null,JointStyle.MITER);
         this.var_96.graphics.beginFill(3294800);
         this.var_96.graphics.drawRect(class_183.var_7129,class_183.var_7129,_loc5_ + class_33.var_3675,this.var_96.height + class_146.var_6117);
         ...
         while(_loc10_ < _loc9_)
         {
            ...
            _loc14_.graphics.lineStyle(class_165.var_6534,class_183.var_7129,class_33.var_3679,true);
            _loc14_.graphics.beginFill(2635840);
            _loc14_.graphics.drawRect(-class_92.var_4647,class_183.var_7129,_loc8_ - class_121.var_5495,class_170.var_6730);
            _loc14_.graphics.endFill();
            class_1.method_835(class_162.var_6352);
            _loc10_++;
         }
         this.var_96.x = this[class_107.var_5075] - class_16.var_3473;
         this.var_96.y = this[class_165.var_6533] - class_121.var_5494;
         ...
         {
            this.var_96.x = class_107.var_5074 - _loc8_;
         }
         if(this.var_96.y + this.var_96.height > class_60.var_3979)
         {
            this.var_96.y = class_60.var_3979 - this.var_96.height;
         }
      ...
      public function method_4(param1:class_168, param2:int) : void
      {
         ...
         {
            _loc3_.var_737 *= class_91.var_4471 / class_117.var_5286;
         }
      ...
      public function method_6(param1:int, param2:int, param3:class_168, param4:int) : void
      {
         ...
         if(!_loc5_.var_366 && _loc5_ != param3)
         {
            ...
            if(_loc10_ < class_121.var_5493)
            {
               ...
               _loc12_.var_304 += _loc13_ + class_183.var_7129;
               this.method_98();
            }
         }
      }
      ...
      public function method_8(param1:class_168, param2:int = 0, param3:Number = 1) : void
      {
         ...
         _loc7_.var_592 = new class_167(class_183.var_7129,class_33.var_3675 / class_162.var_6351);
         _loc7_.length = class_102.var_4859 / class_162.var_6351;
         _loc7_.var_593 = class_183.var_7129;
      ...
      public function method_9(param1:MouseEvent) : void
      {
         ...
         if(class_26.var_3501)
         {
            _loc6_ = class_183.var_7128 + class_26.var_3500 + class_33.var_3677 + _loc6_;
         }
         ...
         this.var_29.graphics.lineStyle(class_146.var_6118,class_183.var_7129,class_33.var_3679,true,class_33.var_3676,null,JointStyle.MITER);
         this.var_29.graphics.drawRect(class_183.var_7129,class_183.var_7129,_loc3_,_loc4_);
         this.var_29.graphics.endFill();
         if(class_183.var_7129 == _loc2_)
         {
            this.var_29.x = class_1.var_2884[class_107.var_5075];
            this.var_29.y = class_9.var_3266 + mouseY;
         ...
         else if(_loc2_ == class_33.var_3679)
         {
         ...
         else if(class_146.var_6118 == _loc2_)
         {
            this.var_29.x = int(-this.var_29.width + this.var_152.var_360);
            this.var_29.y = int(this.var_152.var_361 - this.var_29.height);
         }
         else if(class_146.var_6117 == _loc2_)
         {
            this.var_29.x = class_1.var_2884[class_107.var_5075];
      ...
      public function method_17(param1:Boolean) : void
      {
         if(param1)
         {
            class_155.var_2884.method_475(class_89.var_4444,class_89.var_4444);
         }
         else
         {
            class_155.var_2884.method_475(class_62.var_4156,class_89.var_4444);
         }
      }
      ...
      public function method_18() : void
      {
         ...
         var _loc2_:BitmapData = new BitmapData(class_121.var_5493,class_121.var_5493,false,class_1.var_2878.var_180.var_1061);
         var _loc3_:* = new Bitmap(_loc2_);
         _loc3_.width = class_9.var_3265;
         ...
         _loc5_.height = class_117.var_5285;
         _loc5_.x = -class_117.var_5288;
         _loc5_.y = -class_117.var_5287;
         var _loc6_:* = new Bitmap(_loc2_);
         _loc6_.width = class_9.var_3265;
         _loc6_.height = class_117.var_5288;
         _loc6_.x = -class_117.var_5287;
         _loc6_.y = -class_117.var_5288;
         var _loc7_:* = new Bitmap(_loc2_);
         _loc7_.width = class_9.var_3265;
         _loc7_.height = class_117.var_5288;
         ...
         this.var_117.setStyle(class_121.var_5491,{"color":class_62.var_4154});
         this.var_117.setStyle(class_121.var_5490,{"color":class_62.var_4153});
         this.var_117.setStyle(class_121.var_5489,{"color":class_181.var_6953});
         this.var_117.setStyle(class_165.var_6532,{"color":class_117.var_5284});
         this.var_117.setStyle(class_170.var_6729,{"color":class_62.var_4152});
         this.var_117.setStyle(class_162.var_6350,{"color":class_165.var_6531});
         this.var_117.setStyle(class_89.var_4443,{"color":class_117.var_5283});
         this.var_117.setStyle(class_170.var_6728,{"color":class_60.var_3978});
         this.var_117.setStyle(class_16.var_3472,{"color":class_4.var_3067});
         this.var_117.setStyle(class_165.var_6530,{"color":class_9.var_3263});
         this.var_117.setStyle(class_127.var_5882,{"color":class_146.var_6114});
         this.var_117.setStyle(class_89.var_4442,{"color":class_60.var_3977});
         this.var_117.setStyle(class_165.var_6529,{"color":class_124.var_5667});
         this.var_117.setStyle(class_181.var_6952,{"color":class_60.var_3976});
         this.var_117.setStyle(class_33.var_3674,{"fontSize":class_121.var_5488});
         this.var_117.setStyle(class_170.var_6727,{"color":class_181.var_6951});
         this.var_117.setStyle(class_124.var_5666,{"color":class_117.var_5282});
         this.var_117.setStyle(class_181.var_6950,{"color":class_146.var_6113});
         this.var_117.setStyle(class_9.var_3262,{"color":class_33.var_3673});
         this.var_117.setStyle(class_170.var_6726,{"color":class_127.var_5881});
         this.var_117.setStyle(class_89.var_4441,{"color":class_60.var_3975});
         this.var_117.setStyle(class_102.var_4857,{"color":class_92.var_4646});
         this.var_117.setStyle(class_183.var_7126,{"textAlign":class_162.var_6349});
         this.var_117.setStyle(class_4.var_3066,{"textAlign":class_60.var_3974});
         this.var_117.setStyle(class_146.var_6112,{"color":class_4.var_3067});
         ...
         this.var_117.setStyle(class_170.var_6724,{
            ...
            "\b\x02\x07\x07\x06\x01\b\x05\b\x01\x03":class_124.var_5665
         });
         ...
         this.var_106 = class_175.method_118(class_4.var_3065);
         this.var_106.mouseChildren = class_99.var_4682;
         this.var_106.mouseEnabled = class_99.var_4682;
         class_88.var_4259 = class_175.method_2303(class_121.var_5487);
         addChildAt(this.const_7,class_183.var_7129);
         this.var_96 = class_175.method_118(class_89.var_4439);
         this.var_96.x = this.var_96.y = -class_121.var_5493;
         class_143.method_955(class_16.var_3471);
         this._I = class_175.method_118(class_4.var_3064);
         class_143.method_955(class_121.var_5486);
         this.var_26 = new class_32(this);
         this._I.I(this.var_26);
         class_143.method_955(class_117.var_5281);
         this.var_29 = class_175.method_118(class_60.var_3973);
         this.var_29.x = this.var_29.y = -class_121.var_5493;
         this.var_74 = this.var_29;
         this.var_50 = class_175.method_118(class_16.var_3470);
         ...
         if(class_1.const_43)
         {
            addChildAt(this.var_46,class_183.var_7129);
         ...
         {
            this.var_121.x = class_102.var_4856;
            this.var_121.y = class_121.var_5485;
            this.var_121.width = class_16.var_3469;
         ...
         if(!class_1.const_43)
         {
            this.var_16 = new class_30(class_107.var_5072,class_183.var_7124,class_170.var_6730,false);
            this.var_16.x = class_89.var_4438;
            this.var_16.y = class_92.var_4645;
         }
         else
         {
            this.var_16 = new class_30(class_107.var_5072,class_89.var_4437,class_170.var_6730,false);
            this.var_16.x = class_170.var_6723;
            this.var_16.y = class_162.var_6347;
         }
         ...
         if(class_1.const_43)
         {
            ...
            class_91.var_4459.y = class_9.var_3260;
            class_91.var_4459.Ascenseur(class_89.var_4436);
         ...
         _loc16_.graphics.drawRect(class_183.var_7129,class_183.var_7129,class_165.var_6534,class_165.var_6534);
         _loc16_.graphics.endFill();
         addChild(_loc16_);
         _loc16_.x = class_146.var_6111;
         _loc16_.y = class_146.var_6111;
         var _loc17_:Shape = new Shape();
         _loc17_.graphics.beginFill(class_183.var_7129);
         _loc17_.graphics.drawRect(class_183.var_7129,class_183.var_7129,class_165.var_6534,class_165.var_6534);
         _loc17_.graphics.endFill();
         addChild(_loc17_);
         _loc17_.x = -class_146.var_6111;
         _loc17_.y = -class_146.var_6111;
      ...
      public function method_19(param1:Event, param2:String = null, param3:Boolean = false) : void
      {
         ...
         {
            _loc6_ = class_165.var_6527;
         }
         else
         {
            _loc6_ = class_26.method_1668(class_33.var_3672);
         }
         ...
         if(this.var_68)
         {
            class_40.method_1942(class_107.var_5071 + class_26.method_1668(class_165.var_6526) + class_107.var_5071 + this.var_53._Editeur[class_124.var_5663].toString());
         }
      ...
      {
         class_143.method_955(class_165.var_6525);
         this.var_14 = this;
         this.var_110 = class_183.var_7129;
         try
         {
            if(this.var_14[class_181.var_6949] && this.var_14[class_181.var_6949][class_107.var_5070])
            {
               while(this.var_14)
               {
                  if(String(this.var_14).indexOf(class_165.var_6524 + class_60.var_3971 + class_181.var_6948) != -class_60.method_2002())
                  {
                     ++this.var_28;
                  ...
                  this.var_110 = this.var_14[class_181.var_6949][class_107.var_5070][class_92.var_4643];
         ...
         this.method_76();
         class_143.method_955(class_33.var_3670);
         this.var_53.Init();
         if(this.var_94)
         {
      ...
      public function x_moletteTransformice(param1:int) : void
      {
         ...
         var _loc2_:Array = this.var_19.getObjectsUnderPoint(new Point(this.var_19[class_107.var_5075],this.var_19[class_165.var_6533]));
         while(_loc2_.length)
         {
      ...
      public function method_30(param1:class_35, param2:Boolean = false, param3:Boolean = false) : class_168
      {
         ...
         if(class_183.var_7129 > param1.var_364)
         {
            _loc4_ = this.var_17--;
         }
         if(param3)
         ...
         if(_loc5_.var_773)
         {
            ...
            class_180.method_2675(class_16.var_3468,class_92.var_4648,true);
            ...
            _loc5_.var_931 = class_33.var_3679;
            if(param1.var_30)
            {
               class_86.method_2141(param1.var_376);
            }
            if(class_111.var_5091 && class_111.var_5090 < class_60.var_3970 && this.var_132 != class_89.var_4435)
            {
               if(_loc5_.var_366)
               {
                  class_151.method_2525(class_183.var_7123);
                  class_151.method_2523(class_181.var_6946,class_124.var_5662,class_9.var_3259).method_583(class_26.method_1668(class_165.var_6523)).method_585(class_165.var_6534,class_165.var_6534);
               }
               else
               {
                  class_151.method_2525(class_181.var_6946);
                  class_151.method_2523(class_183.var_7123,class_107.var_5068).method_583(class_26.method_1668(class_124.var_5661)).method_586(_loc5_,class_183.var_7129,-class_146.var_6117);
               }
            }
            else
            {
            ...
            _loc10_ = _loc5_.var_609.method_122(false) + class_165.var_6522 + _loc5_.var_609.method_120() + class_165.var_6522 + _loc5_.var_890 + class_165.var_6522 + _loc5_.var_609.method_129();
         ...
         if(_loc5_.var_363 && param1.var_378 >= class_183.var_7129)
         {
         ...
         if(class_68.var_776)
         {
            if(_loc5_.var_363 == class_33.var_3669)
            {
      ...
      public function method_31(param1:MouseEvent) : void
      {
         ...
         this.method_93(class_51.const_254 + class_51.const_258 + class_51.name_40 + int(this.var_42[class_107.var_5075]) + class_51.name_40 + int(this.var_42[class_165.var_6533]));
      }
      ...
      public function method_32(param1:String, param2:String, param3:String, param4:String) : ByteArray
      {
         ...
         if(param4)
         {
            param4 = param4.split(class_183.var_7121).join(class_9.var_3268);
         }
         var _loc5_:ByteArray = new ByteArray();
         while(_loc5_.length % class_121.var_5495 != class_183.var_7129)
         {
      ...
      public function method_33(param1:int, param2:int, param3:int, param4:int, param5:int, param6:Boolean = true, param7:Number = 0, param8:class_116 = null) : void
      {
         ...
         {
            param4 = Math.ceil(param4 / class_124.var_5660);
         }
         if(param8)
         {
            _loc9_ = param8;
         ...
         param3 += -class_146.var_6118 + this.var_50.y;
         ...
         while(_loc11_ < param4)
         {
            ...
            _loc13_ = Math.random() * class_146.var_6110 - class_89.var_4434;
      ...
      public function method_34(param1:Boolean, param2:int, param3:int) : void
      {
         ...
         _loc4_.y = param3 - class_33.var_3668;
      }
      ...
      public function method_35(param1:Event) : void
      {
         ...
         if(class_96.const_481)
         {
            ...
            if(_loc6_)
            {
               if(_loc2_.var_773)
               {
                  this.method_3(new Array(class_26.method_1668(class_102.var_4853,_loc6_),class_160.method_2547,class_111.var_363));
               }
               else
               {
                  this.method_3(new Array(class_26.method_1668(class_4.var_3060,_loc2_.var_363,_loc6_),class_160.method_2547,_loc2_.var_363));
               }
            }
         }
      }
      ...
      public function method_36(param1:Event) : void
      {
         ...
         {
            class_1.var_2888 = int(class_1.var_2880 / class_165.var_6534);
      ...
      public function method_39(param1:String) : String
      {
         ...
         {
            _loc2_ = class_79.method_2122(param1.substr(class_33.var_3679));
      ...
      public function method_40(param1:class_168) : void
      {
         ...
         if(param1 && param1.var_30)
         {
            ...
            _loc2_.method_65(false);
            class_182.method_2693(param1,class_183.var_7129,_loc2_.var_923,true);
         }
      }
      ...
      public function method_41(param1:String, param2:String = null) : void
      {
         ...
         if(param2)
         {
            _loc3_ = class_92.var_4641 + param2 + class_124.var_5656 + param2 + class_146.var_6108 + param1;
         }
         else
         {
            _loc3_ = class_181.var_6942 + param1;
         }
      ...
      public function method_42() : String
      {
         ...
         try
         {
            if(ExternalInterface.available)
            {
               _loc1_ = ExternalInterface.call(class_181.var_6941) as String;
            }
         }
         catch(E:Error)
         {
      ...
      public function method_43(param1:int, param2:int, param3:int) : void
      {
         ...
         if(param3 > class_89.var_4432)
         {
            param3 = class_89.var_4432;
         }
         ...
         _loc5_.var_311 = class_89.var_4430;
      ...
      public function class_790(param1:Event) : void
      {
         ...
         var var_7437:String = class_9.var_3268;
         try
         {
         ...
         if(!var_7437)
         {
            var_7437 = class_9.var_3268;
         }
         if(class_1.const_43 && class_59.var_3812)
         {
            this.var_48 = class_92.var_4640;
         }
         var var_7438:String = class_9.var_3268;
         ...
         try
         {
            ...
            {
               var_7441 = class_60.var_3965;
            }
            else if(class_169.var_6541)
            {
               var_7441 = class_127.var_5875;
            }
            else if(class_185.var_7132)
            {
               var_7441 = class_181.var_6940;
            }
         ...
         {
            if(stage.stageWidth < class_107.var_5074 || stage.stageHeight < class_60.var_3979)
            {
      ...
      {
         class_1.var_2878.method_155(class_60.var_3964);
         if(param1)
         {
      ...
      {
         this.var_29.x = this[class_107.var_5075];
         if(this.var_29.x > this.var_150)
         {
            this.var_29.x = this.var_150;
         }
         this.var_29.y = this[class_165.var_6533] + class_9.var_3266;
         if(this.var_151 < this.var_29.y)
         {
            this.var_29.y = this.var_151;
         }
      ...
      public function method_50(param1:Event = null) : void
      {
         ...
         this.var_9 = Capabilities.version.indexOf(class_146.var_6105) == class_183.var_7129 || Capabilities.version.indexOf(class_62.var_4150) == class_183.var_7129;
         ...
         try
         {
            class_1.var_2873 = class_1.var_2884.parent.loaderInfo.loaderURL.toLowerCase().indexOf(class_33.var_3664) == class_183.var_7129;
         }
         catch(name_85:Error)
         {
         }
         ...
         class_1.method_835();
         class_143.name_6(true);
         class_143.method_955(class_1.var_2878.var_179);
         class_143.method_955(class_165.var_6521 + class_1.var_2878.var_179 + class_124.var_5654 + this.var_2);
         ...
         class_143.method_955(class_117.var_5278 + Capabilities.version);
         if(this.var_9)
         {
         ...
         this.var_19[class_165.var_6520 + class_124.var_5653] = class_127.var_5873;
         ...
         try
         {
            if(ExternalInterface.available)
            {
               ExternalInterface.addCallback(class_89.var_4428,this.x_moletteTransformice);
            }
         }
         catch(name_85:Error)
         {
         ...
         if(!class_1.const_42)
         {
            if(this[class_4.var_3059][class_62.var_4149](this.var_103(class_146.var_6104)[class_89.var_4427]) || this[class_4.var_3059][class_62.var_4149](this.var_103(class_146.var_6104)[class_92.var_4638]))
            {
               this.var_155 = null;
               return;
            }
         ...
         try
         {
            ...
            this.var_44 = stage.getChildAt(class_33.var_3679).loaderInfo.width;
         }
         catch(name_85:Error)
         {
         ...
         try
         {
            ...
            while(var_7436 < var_731)
            {
               ...
               if(var_1519 is TextField && var_1519.name != class_170.var_6719 && !(var_1519 is class_90))
               {
                  ...
                  if(var_401.text && var_401.text.charAt(class_183.var_7129) == class_9.var_3256 || var_2491)
                  {
                     try
                     {
                        couleur = var_401.textColor;
                        var_1539 = !!var_2491 ? var_2491 : var_401.text.split(class_107.var_5064);
                        ...
                        if(class_26.var_3501)
                        {
                           var_401.htmlText = class_183.var_7128 + class_26.var_3500 + class_33.var_3677 + class_26.method_1668.apply(null,var_1539) + class_162.var_6345;
                        }
                        ...
                        if(var_1539[class_183.var_7129].charAt(class_165.var_6519) != -class_33.var_3679)
                        {
      ...
      public function method_55(param1:int, param2:int, param3:int, param4:class_147 = null, param5:Boolean = false, param6:Number = 0, param7:Number = 0, param8:Boolean = false) : void
      {
         ...
         while(_loc17_ < this.var_49.length)
         {
            ...
            if(_loc21_)
            {
               ...
               {
                  _loc23_ = _loc11_[class_89.var_4424];
                  class_1.method_835(_loc21_);
                  _loc24_ = _loc11_[class_107.var_5063];
                  _loc25_ = param8 && _loc22_.numChildren == class_165.var_6534 && !_loc22_.getChildAt(class_183.var_7129).visible ? _loc22_.getChildAt(class_33.var_3679) : null;
                  if(_loc25_)
                  {
         ...
         if(!_loc9_)
         {
            ...
            _loc20_ = _loc10_[class_183.var_7129];
         ...
         if(_loc18_)
         {
            ...
            while(_loc30_ < _loc18_)
            {
               ...
               _loc33_ = int(_loc32_.var_304 * class_4.var_3058) / class_4.var_3057;
               _loc34_ = int(class_4.var_3058 * _loc32_.var_305) / class_4.var_3057;
               _loc35_ = int(_loc31_.method_559() * class_4.var_3058) / class_4.var_3057;
               ...
               _loc38_ = int(_loc37_.var_304 * class_4.var_3058) / class_4.var_3057;
               _loc39_ = int(_loc37_.var_305 * class_4.var_3058) / class_4.var_3057;
               _loc40_ = int(_loc20_.method_559() * class_4.var_3058) / class_4.var_3057;
               ...
               _loc28_ += class_51.name_40 + param1 + class_107.var_5062 + _loc36_ + class_107.var_5062 + _loc33_ + class_107.var_5062 + _loc34_ + class_107.var_5062 + _loc35_ + class_107.var_5062 + _loc41_ + class_107.var_5062 + _loc38_ + class_107.var_5062 + _loc39_ + class_107.var_5062 + _loc40_ + class_107.var_5062 + param6 + class_107.var_5062 + param7;
               _loc20_ = _loc31_;
               _loc30_++;
            }
            if(param5)
      ...
      public function method_57(param1:int, param2:int = 0, param3:int = 0, param4:Boolean = false, param5:Boolean = true) : void
      {
         ...
         if(class_184.var_2341.name_31)
         {
            ...
            {
               class_184.var_2341.var_964 = class_89.var_4444;
            }
         }
         ...
         if(_loc6_)
         {
            ...
            if(_loc6_.var_773)
            {
               ...
               {
                  this.method_97(class_26.method_1668(class_16.var_3464));
               }
            ...
            while(++_loc10_ < _loc9_)
            {
               ...
               {
                  this.var_107.splice(_loc10_,class_33.var_3679);
                  _loc10_--;
                  _loc9_--;
               }
            }
            ...
            while(++_loc10_ < _loc9_)
            {
               ...
               if(_loc11_.var_690 == _loc6_.var_925 || _loc11_.var_691 == _loc6_.var_925)
               {
                  this.var_63.splice(_loc10_,class_33.var_3679);
                  _loc10_--;
                  _loc9_--;
               }
            }
            if(_loc7_)
            {
               if(!_loc8_ || _loc6_.var_773)
               {
                  if(param4)
                  {
                     this.method_33(class_56.const_311,_loc6_.x,_loc6_.y,class_121.var_5495,class_165.var_6534,false,-class_89.var_4430);
                  }
                  else
                  {
                     _loc12_ = _loc6_.y;
                     _loc13_ = _loc6_.x;
                     if(class_183.var_7129 > _loc12_)
                     {
                     ...
                     this.method_33(class_56.const_312,_loc13_,_loc12_,class_121.var_5495,class_165.var_6534,false,-class_89.var_4430);
                     this.method_33(class_56.const_313,_loc13_,_loc12_,class_121.var_5495,class_165.var_6534,false,-class_89.var_4430);
                     this.method_33(class_56.const_314,_loc13_,_loc12_,class_121.var_5495,class_165.var_6534,false,-class_89.var_4430);
                  }
               }
            }
         }
      ...
      public function method_60() : void
      {
         if(this.var_147)
         {
            ...
            this.method_100(class_168.var_6539);
      ...
      public function method_61(param1:int, param2:int, param3:int, param4:int, param5:Boolean = false, param6:Boolean = true, param7:int = 0) : void
      {
         ...
         if(param6)
         {
            if(param7 == class_183.var_7129)
            {
               ...
               this.method_33(class_56.const_308,param1 - class_146.var_6117,param2 - class_146.var_6117,class_33.var_3675,class_165.var_6534,false);
               this.method_33(class_56.const_309,param1 - class_146.var_6117,param2 - class_146.var_6117,class_33.var_3675,class_165.var_6534,false);
               this.method_33(class_56.const_307,param1 - class_146.var_6117,param2 - class_146.var_6117,class_33.var_3675,class_165.var_6534,false);
            }
            else if(param7 == class_33.var_3679)
            {
               class_96.method_2223(class_56.const_307,param1,param2,class_33.var_3675,class_165.var_6534);
            }
         }
            ...
            while(_loc17_ < _loc16_)
            {
               ...
               if(_loc18_)
               {
                  ...
                  if(_loc19_ && _loc19_.CodeObjet)
                  {
                     ...
                     _loc9_ = _loc20_.position.var_304 * class_162.var_6351 - param1;
      ...
      public function method_62() : void
      {
         ...
         class_143.method_955(class_107.var_5061);
      ...
      public function method_63() : void
      {
         ...
         this.var_42.graphics.lineStyle(class_165.var_6534,3225412);
      ...
      {
         this.var_139 = new class_116(class_183.var_7129,class_183.var_7129,class_92.var_4637,class_92.var_4637);
         this.var_57 = new class_116(class_183.var_7129,class_183.var_7129,class_92.var_4637,class_92.var_4637);
         var _loc1_:class_27 = new class_27(new class_75(class_175.method_118(class_121.var_5479)));
      ...
      public function method_65(param1:class_168, param2:Boolean, param3:int, param4:int, param5:int) : void
      {
         ...
         if(param1)
         {
            ...
            if(_loc6_.var_773)
            {
               ...
               class_180.method_2675(class_60.var_3960);
            }
            ...
            if(param2)
            {
               ...
               if(param1.var_773)
               {
                  class_125.var_5670 = class_117.var_5288;
               }
            }
            else
            {
               ...
               if(param1.var_773)
               {
                  class_125.var_5670 = class_4.var_3058;
               }
            }
            ...
            if(_loc9_.var_430 && _loc9_.var_459)
            {
               if(param2)
               {
                  _loc8_.method_556(new class_167(_loc9_.var_459[class_89.var_4424] / class_165.method_2587(),_loc9_.var_459[class_107.var_5063] / class_165.method_2587()),class_121.method_2361());
               }
               else
               {
                  _loc8_.method_556(new class_167(_loc9_.var_440[class_89.var_4424] / class_165.method_2587(),_loc9_.var_440[class_107.var_5063] / class_165.method_2587()),class_121.method_2361());
               }
            }
            ...
            else if(_loc9_.var_430)
            {
               ...
               {
                  _loc8_.method_556(new class_167(_loc9_.var_458[class_127.method_2412()] / class_165.method_2587(),_loc9_.var_458[class_89.method_2153()] / class_165.method_2587()),class_121.method_2361());
               }
               else if(class_183.var_7129 < _loc9_.var_458.length)
               {
                  _loc8_.method_556(new class_167(_loc9_.var_458[class_60.method_2002()] / class_165.method_2587(),_loc9_.var_458[class_4.method_1841()] / class_165.method_2587()),class_121.method_2361());
               }
               else
               {
            ...
            if(param1.var_773)
            {
               ...
               if(!_loc7_)
               {
                  this.method_97(class_26.method_1668(class_124.var_5652));
               }
            ...
            else
            {
               ...
               {
                  this.method_97(class_26.method_1668(class_165.var_6518 + class_117.var_5276,class_161.method_2554(param1.var_363,true,false)));
               }
               class_188.method_1971().method_455(true);
               class_1.method_835(class_89.var_4430);
            }
            _loc6_.method_65(true,param5);
            if(class_127.var_5872 > class_184.var_2341.var_987)
            {
               class_182.method_2693(param1,class_183.var_7129 + class_183.var_7129,class_184.var_2341.var_987,false);
            }
         }
      }
      ...
      public function method_67(param1:Event = null) : void
      {
         if(this.var_145)
         {
            ...
            {
               this.var_60 = this.var_145[class_33.var_3661].toLowerCase();
            }
            if(this.var_145[class_165.var_6517])
            {
               class_8.method_1852(this.var_145[class_165.var_6517]);
               if(this.var_145[class_117.var_5275])
               {
                  class_135.method_2441(class_175.method_2618(this.var_145[class_117.var_5275] + class_117.var_5274,class_127.var_5871));
               }
            }
         }
         else
         ...
         this.var_60 = this.var_60.split(class_165.var_6519).join(class_9.var_3268).split(class_4.var_3056).join(class_9.var_3268).split(class_170.var_6721).join(class_9.var_3268).split(class_165.var_6522).join(class_9.var_3268);
         this.method_62();
      }
      ...
      public function method_72() : Boolean
      {
         ...
         this.method_97(class_60.var_3959 + (!!this.var_39 ? class_9.var_3255 : class_181.var_6936));
      ...
      public function method_73(param1:class_27) : void
      {
         param1.var_304 += param1.var_308;
         param1.var_305 += param1.var_309;
         if(param1.var_305 > class_162.var_6343 || param1.var_304 < -class_33.var_3675 || param1.var_304 > class_33.var_3660)
         {
      ...
      public function method_74(param1:class_172, param2:String = null, param3:String = null, param4:int = 0, param5:int = 0, param6:Boolean = false) : void
      {
         ...
         var var_7453:Boolean = var_7449 && (var_7449 == class_146.var_6102 || var_7449 == class_62.var_4147 || var_7449.charAt(class_183.var_7129) == class_33.var_3659);
         ...
         --class_91.var_4467;
         --class_91.var_4458;
         class_68.var_4217 = class_183.var_7129;
         ...
         if(this.var_111 == class_146.var_6118 && class_1.var_2878.var_183 && !class_111.name_71)
         {
            var_7456 = class_17.var_2884.lecture(class_89.var_4422);
            false;
            false;
            if(var_7456 != class_1.var_2878.var_183)
            {
               ...
               {
                  var_7457 = new class_19(class_102.var_4856,class_102.var_4850,class_18.method_1884,class_1.var_2878.var_184);
               }
               else
               {
                  var_7457 = new class_19(class_102.var_4856,class_102.var_4850,class_1.var_2878.method_149);
               }
         ...
         if(this.var_111 == class_121.var_5495 && class_111.var_5093 == class_157.const_562)
         {
            ...
            if(!var_7458)
            {
               ...
               var_7459.method_179(class_92.var_4636);
         ...
         var var_7454:Boolean = var_7447.var_956 > class_4.var_3058 && var_7448 == null;
         if(var_7454)
         {
         ...
         this.var_131 = var_7447.var_956 == class_9.var_3253;
         ...
         this.var_108 = class_183.var_7129;
         this.var_63 = new Vector.<class_159>();
         this.var_107.length = class_183.var_7129;
         this.var_52 = new Vector.<class_123>();
         ...
         if(var_7448)
         {
            ...
            {
               var_132 = class_121.method_2361() + class_121.method_2361();
               new class_58(class_50.method_1959(class_175.method_118(class_117.var_5273 + var_132),var_7452));
         ...
         this.var_114 = (class_170.var_6717 + class_58.var_426) / class_181.var_6937;
         this.var_69 = (class_58.var_420 + class_124.var_5662) / class_181.var_6937;
         ...
         if(this.var_92)
         {
            ...
            var_7462.gotoAndStop(class_33.var_3679);
         ...
         if(!this.var_62)
         {
            this.var_62 = new class_88(class_33.var_3675,class_16.var_3462,class_26.method_1668(class_181.var_6934),class_86.method_2144,null,class_121.var_5493,!this.var_94);
            this.var_55 = new class_88(class_60.var_3972,class_16.var_3462,class_26.method_1668(class_89.var_4421),class_86.method_2146,null,class_121.var_5493,!this.var_94);
            this.var_78 = new class_88(class_124.var_5657,class_16.var_3462,class_26.method_1668(class_181.var_6933),class_86.method_2143,null,class_121.var_5493,!this.var_94);
         }
         if(class_9.var_3253 == var_7447.var_956)
         {
         ...
         if(class_58.var_3803.var_506.var_461)
         {
            ...
            this.var_4.graphics.drawRect(-class_117.var_5288,-class_117.var_5288,class_181.var_6932,class_121.var_5478);
            this.var_4.graphics.drawRect(class_183.var_7129,class_183.var_7129,class_107.var_5074,class_60.var_3979);
         ...
         class_125.method_2395();
         class_1.method_835(class_165.var_6534);
         class_125.method_2381();
      }
      ...
      public function method_76() : void
      {
         ...
         addChildAt(this.var_155,class_146.var_6118);
         class_38.name_9();
         class_134.name_9();
         var var_7436:int = class_183.var_7129;
         while(true)
      ...
      public function method_77(param1:String) : void
      {
         ...
         if(!class_1.var_2877)
         {
            ...
            class_1.var_2877[class_4.var_3055] = class_99.var_4681;
            class_1.var_2877[class_124.var_5650] = class_99.var_4681;
            class_1.var_2877[class_146.var_6101] = class_99.var_4681;
            class_1.var_2877[class_92.var_4635] = class_99.var_4681;
            class_1.var_2877[class_124.var_5649] = class_99.var_4681;
            class_1.var_2877[class_124.var_5648 + class_181.var_6954 + class_107.var_5059] = class_99.var_4681;
            class_1.var_2877[class_183.var_7118] = class_99.var_4681;
            class_1.var_2877[class_60.var_3958 + class_92.var_4634] = class_99.var_4681;
         ...
         var _loc5_:String = _loc4_[class_183.var_7129].toLowerCase();
         var _loc6_:String = class_9.var_3268;
         if(_loc5_ == class_162.var_6341)
         {
            _loc2_ = class_99.var_4681;
         }
         if(_loc5_ == class_117.var_5275)
         {
            class_58.var_3811 = 7042452;
            class_58.var_3803.method_374(7042452);
            return;
         }
         if(_loc5_ == class_102.var_4848)
         {
         ...
         if(class_1.const_43)
         {
            if(!!_loc5_ == class_146.var_6096)
            {
               class_12.name_6(true);
               return;
            }
            if(!_loc5_ != class_117.var_5271)
            {
               class_41.name_6(true);
               return;
            }
            if(_loc5_ == class_121.var_5476 + _loc6_ + class_121.var_5475)
            {
               class_1.method_835(_loc6_);
               class_1.method_835(_loc5_);
               class_28.method_1253(true);
               return;
            }
            if(_loc5_ == class_4.var_3053 && class_111.var_5100)
            {
               this.x_proxySteam.method_415(_loc4_[class_33.var_3679]);
               return;
            }
            if((_loc5_ == class_62.var_4146 || _loc5_ == class_183.var_7117) && _loc4_.length == class_33.var_3679)
            {
               class_180.method_2660();
               return;
            }
         }
         if(_loc5_ == class_121.var_5474)
         {
            this.method_77(class_102.var_4847 + class_26.method_1668(class_4.var_3052) + class_124.var_5647 + class_111.var_363);
            return;
         }
         if(_loc5_ == _loc6_ + class_127.var_5869 + _loc6_ + class_162.var_6340)
         {
            class_153.name_6(true);
            class_1.method_835(_loc5_);
            return;
         }
         if(_loc5_ == class_181.var_6931 + _loc6_ + class_181.var_6930 + class_162.var_6339)
         {
         ...
         if(_loc5_ == class_183.var_7116)
         {
            class_91.var_4463 = class_183.var_7129;
            class_91.var_4451 = class_183.var_7129;
            class_91.var_4458 = class_183.var_7129;
            class_91.var_4467 = class_183.var_7129;
            class_111.var_5091 = class_99.var_4682;
            this.method_97(class_117.var_5270);
            return;
         }
         if(_loc5_ == class_60.var_3957 || _loc5_ == class_33.var_3657)
         {
         }
         if(class_111.var_5100)
         {
            ...
            if(_loc5_ == class_124.var_5645)
            {
               _loc8_ = class_111.var_5102;
               if(_loc8_)
               {
         ...
         if(_loc7_ || _loc5_ == class_33.var_3661 || _loc5_ == class_117.var_5269 || _loc5_ == class_89.var_4418 || _loc5_ == class_127.var_5868 || _loc5_ == class_9.var_3252 || _loc5_ == class_89.var_4417)
         {
            _loc4_.shift();
            _loc10_ = _loc4_.join(class_124.var_5647);
            if(class_89.var_4444 < _loc10_.length)
            {
               _loc10_ = _loc10_.substr(class_183.var_7129,class_89.var_4444);
            }
            class_39.var_3744.method_313(new class_6(class_9.var_3268,_loc10_,_loc7_));
            return;
         }
         if(_loc5_ == class_183.var_7115 && class_111.var_5100)
         {
            _loc11_ = int(_loc4_[class_33.var_3679]);
            if(_loc11_ < class_183.var_7127)
            {
               _loc11_ = class_183.var_7127;
            }
            else if(class_170.var_6717 < _loc11_)
            {
               _loc11_ = class_170.var_6717;
            }
            this.var_115[class_146.var_6094] = _loc11_;
            return;
         }
         if(_loc5_ == class_92.var_4634 + class_181.var_6928)
         {
         ...
         if(_loc5_ == class_102.var_4846 + class_4.var_3051)
         {
            class_140.name_6(!!class_140.var_4683 ? null : this.var_19);
            return;
         }
         if(_loc5_ == class_124.var_5644 + class_60.var_3955)
         {
            class_58.var_3802 = !class_58.var_3802;
            if(class_58.var_3802)
            {
               this.method_97(class_170.var_6716);
            }
            else
            {
               this.method_97(class_60.var_3954);
            }
            return;
         }
         if(_loc5_ == class_117.var_5268)
         {
            class_119.var_5299 = !class_119.var_5299;
            if(class_119.var_5299)
            {
               this.method_97(class_92.var_4633);
            }
            else
            {
               this.method_97(class_165.var_6514);
            }
            return;
         }
         if(_loc5_ == class_60.var_3953 + _loc6_ + class_165.var_6513)
         {
            this.var_115[class_121.var_5473] = StageScaleMode.SHOW_ALL;
            return;
         }
         if(_loc5_ == class_89.var_4416)
         {
            class_168.var_6538 = !class_168.var_6538;
            return;
         }
         if(_loc5_ == class_107.var_5054 + _loc6_ + class_16.var_3459)
         {
            class_52.var_2884.method_350();
            return;
         }
         if(_loc3_.indexOf(class_62.var_4143) == class_183.var_7129)
         {
            _loc12_ = param1.split(class_124.var_5647);
            _loc13_ = _loc12_[class_165.var_6534];
            _loc12_[class_165.var_6534] = class_13.method_1866(_loc13_);
         ...
         else if(!(_loc5_ == class_89.var_4415 && class_68.var_776))
         {
            ...
            else if(_loc5_ == class_62.var_4141 + class_62.var_4141)
            {
               class_1.method_835(class_121.var_5495);
               this.method_97(class_16.var_3455);
               _loc16_ = class_1.method_1816();
               this.method_97(class_4.var_3048 + class_59.var_2884.method_410() + class_165.var_6512 + class_59.var_2884.method_411());
               this.method_97(class_9.var_3268 + this.var_112);
               ...
               this.method_97(class_124.var_5643 + Capabilities[class_33.var_3654]);
               this.method_97(class_89.var_4414);
               _loc17_ = class_33.var_3679;
               _loc18_ = this;
               while(_loc18_)
               {
                  this.method_97(_loc17_ + class_62.var_4140 + _loc18_ + class_165.var_6512 + _loc18_[class_181.var_6949][class_107.var_5070][class_92.var_4643]);
               ...
               while(null != _loc19_)
               {
                  this.method_97(class_162.var_6337 + _loc19_.name + class_62.var_4140 + _loc19_.loaderInfo.url);
                  _loc19_ = _loc19_.parent;
               }
               this.method_97(class_62.var_4139 + loaderInfo.loaderURL);
               this.method_97(class_170.var_6715 + stage.loaderInfo.loaderURL);
            ...
            {
               _loc20_ = _loc3_.substr(class_183.var_7129,class_165.var_6534);
               if(_loc20_ == class_146.var_6093 || _loc20_ == class_16.var_3454 || _loc5_ == class_4.var_3047 || _loc5_ == class_33.var_3653)
               {
               ...
               {
                  if(_loc4_.length == class_33.var_3679 || _loc4_[_loc4_.length - class_33.var_3679].charAt(class_183.var_7129) != class_107.var_5053)
                  {
                     if(!this.var_102)
                     {
                        return;
               ...
               else if(_loc5_.charAt(class_183.var_7129) == class_60.var_3951 || class_1.var_2877[_loc5_])
               {
                  class_39.var_3745.method_313(new class_171(param1));
               }
               else
      ...
      {
         this.method_97(class_117.var_5267 + param1 + class_4.var_3046);
      }
      ...
      public function method_80() : void
      {
         ...
         this.var_10[class_165.var_6534] = class_26.method_1668(class_9.var_3245);
         this.var_10[class_146.var_6118] = class_26.method_1668(class_183.var_7110);
         this.var_10[class_121.var_5495] = class_26.method_1668(class_62.var_4138);
         this.var_10[class_117.var_5287] = class_26.method_1668(class_4.var_3045);
         ...
         this.var_10[class_170.var_6731] = class_181.var_6925;
         this.var_10[class_102.var_4852] = class_121.var_5471;
         this.var_10[class_146.var_6117] = class_26.method_1668(class_92.var_4629);
         this.var_10[class_162.var_6346] = class_26.method_1668(class_181.var_6924);
         this.var_10[class_170.var_6720] = class_26.method_1668(class_124.var_5642);
         this.var_10[class_117.var_5279] = class_26.method_1668(class_62.var_4137);
         this.var_10[class_181.var_6939] = class_26.method_1668(class_16.var_3452);
         this.var_10[class_183.var_7127] = class_26.method_1668(class_183.var_7109);
         this.var_10[class_16.var_3467] = class_26.method_1668(class_107.var_5051);
         this.var_10[class_121.var_5494] = class_26.method_1668(class_183.var_7108);
         this.var_10[class_92.var_4628] = class_26.method_1668(class_183.var_7108);
         this.var_10[class_170.var_6730] = class_26.method_1668(class_183.var_7108);
         this.var_10[class_33.var_3675] = class_26.method_1668(class_183.var_7108);
         this.var_10[class_127.var_5865] = class_181.var_6923;
         this.var_10[class_9.var_3266] = class_26.method_1668(class_183.var_7107);
         this.var_10[class_9.var_3259] = class_33.var_3652;
         ...
         this.var_10[class_117.var_5265] = class_26.method_1668(class_102.var_4842);
         this.var_10[class_4.var_3043] = class_26.method_1668(class_4.var_3044);
         this.var_10[class_4.var_3042] = class_26.method_1668(class_9.var_3244);
         this.var_10[class_124.var_5641] = class_26.method_1668(class_33.var_3651);
         ...
         this.var_10[class_170.var_6714] = class_26.method_1668(class_9.var_3245);
         this.var_10[class_165.var_6506] = class_26.method_1668(class_92.var_4629);
         this.var_10[class_107.var_5050] = class_26.method_1668(class_183.var_7110);
         this.var_10[class_127.var_5864] = class_26.method_1668(class_62.var_4138);
         ...
         this.var_10[class_102.var_4839] = class_26.method_1668(class_102.var_4840);
      }
      ...
      {
         class_143.method_955(class_107.var_5049);
         class_128.var_50 = this.var_50;
         if(!class_1.const_43)
         {
         }
         class_128.var_79 = this.var_79 = this._I[class_162.var_6334];
         class_128.var_53 = this.var_53 = this._I;
         class_128.var_125 = this.var_125 = this._I[class_127.var_5863];
      ...
      public function method_84() : void
      {
         ...
         {
            class_115.method_388(class_155.method_2540(),class_183.var_7129);
         }
         class_1.var_2884.var_53.addChild(new class_37());
         class_180.method_2666(class_107.var_5048,true);
         ...
         if(!class_1.var_2884.var_9)
         {
            class_155.method_2539(class_60.var_3948,class_42.var_2884.method_331);
         }
         if(class_111.var_5100)
         {
            class_155.var_2884.method_631(class_165.var_6505);
         }
         else if(class_111.var_5084 < class_33.var_3675 && !class_111.var_5109)
         {
            class_155.var_2884.method_631(class_9.var_3243);
         }
      ...
      {
         this.var_42.graphics.moveTo(int(this.var_42[class_107.var_5075]),int(this.var_42[class_165.var_6533]));
      ...
      {
         param1.currentTarget.gotoAndStop(class_33.var_3679);
      }
      ...
      public function method_91(param1:Event = null) : void
      {
         ...
         class_154.name_9();
         class_164.name_9();
         var _loc2_:MovieClip = class_175.method_118(class_127.var_5862);
         _loc2_.mouseEnabled = class_99.var_4682;
         _loc2_.mouseChildren = class_99.var_4682;
         _loc2_.cacheAsBitmap = class_99.var_4681;
         this.var_50.addChildAt(_loc2_,class_183.var_7129);
         var _loc3_:int = class_183.var_7129;
         while(_loc3_ < class_146.var_6117)
         {
         ...
         {
            _loc5_ = class_175.method_118(class_16.var_3449 + _loc4_);
            _loc6_ = _loc5_.width + class_165.var_6534;
            _loc7_ = _loc5_.height + class_165.var_6534;
            _loc8_ = new BitmapData(_loc6_,_loc7_,true,class_183.var_7129);
            _loc9_ = new Matrix();
            _loc9_.translate(_loc6_ / class_165.var_6534,_loc7_ / class_165.var_6534);
      ...
      public function method_92(param1:String) : Sprite
      {
         ...
         if(param1.charAt(class_183.var_7129) == class_89.var_4425)
         {
            _loc2_ = class_175.method_118(class_92.var_4626);
         }
         else
         {
            _loc2_ = class_175.method_118(class_9.var_3256 + param1.substr(class_183.var_7129,class_165.var_6534).toUpperCase());
         }
         if(null == _loc2_)
         {
            _loc2_ = class_175.method_118(class_92.var_4626);
      ...
      public function method_94(param1:int, param2:int, param3:Number, param4:Number, param5:Number, param6:int, param7:Number, param8:Number, param9:Number, param10:Number = 0, param11:Number = 0) : void
      {
         ...
         {
            if(this.var_108 > class_146.var_6117 && this.var_132 != class_92.var_4637)
            {
               return;
            }
            ++this.var_108;
         ...
         if(_loc13_ && _loc14_)
         {
            if(param1 == class_46.const_201)
            {
               ...
               _loc15_.var_592 = new class_167(class_183.var_7129,class_33.var_3675 / class_162.var_6351);
               _loc15_.length = class_9.var_3243 / class_162.var_6351;
               _loc15_.var_593 = class_183.var_7129;
            ...
            else
            {
               ...
               if(param2 != -class_165.var_6534 && param6 != -class_165.var_6534 && _loc12_ || param1 == class_46.const_158)
               {
                  ...
                  {
                     _loc16_.var_650 = -class_89.var_4430;
                     _loc16_.var_651 = class_89.var_4430;
                  }
                  else
                  {
                     _loc16_.var_650 = class_183.var_7129;
                     _loc16_.var_651 = class_183.var_7129;
                  }
               }
               ...
               {
                  _loc16_.var_652 = class_99.var_4681;
                  _loc16_.var_653 = -class_4.var_3040;
            ...
            if(!_loc13_.var_695.name_87)
            {
               ...
               {
                  if(class_1.method_1816() - this.tempsPartieZero < class_146.var_6087)
                  {
               ...
               if(_loc17_)
               {
                  _loc18_ = class_175.method_118(class_16.var_3449 + param1);
                  if(_loc12_)
                  {
                     _loc13_.var_695.name_87 = class_99.var_4681;
                  }
                  _loc13_.var_695.addChild(_loc18_);
                  _loc18_.x = class_162.var_6351 * param3;
                  _loc18_.y = param4 * class_162.var_6351;
                  if(param1 != class_102.var_4837 && this.var_52.length > class_183.var_7129)
                  {
                     (this.var_52[this.var_52.length - class_33.var_3679] as class_122).var_695 = _loc18_;
                  }
               }
            }
            _loc13_.method_547();
      ...
      public function method_95() : void
      {
         ...
         if(class_59.var_3814)
         {
            ...
            {
               this.var_99 = class_33.var_3679;
               class_59.method_1989(true);
            }
            return;
         }
         this.var_99 = (class_33.var_3679 + this.var_99) % class_146.var_6118;
         if(Capabilities.playerType == class_121.var_5469 || Capabilities.playerType == class_146.var_6116)
         {
            if(this.var_99 == class_183.var_7129)
            {
               stage.displayState = StageDisplayState.NORMAL;
               stage.scaleMode = StageScaleMode.NO_SCALE;
            }
            else if(this.var_99 == class_33.var_3679)
            {
               stage.displayState = StageDisplayState.FULL_SCREEN_INTERACTIVE;
            }
            else if(this.var_99 == class_165.var_6534)
            {
               stage.scaleMode = StageScaleMode.SHOW_ALL;
            }
         }
         else
         {
            try
            {
               if(ExternalInterface.available)
               {
                  if(class_183.var_7129 == this.var_99)
                  {
                     ExternalInterface.call(class_4.var_3039,false);
                     stage.scaleMode = StageScaleMode.NO_SCALE;
                  }
                  else if(this.var_99 == class_33.var_3679)
                  {
                  ...
                  {
                     ExternalInterface.call(class_4.var_3039,class_165.var_6534);
                     stage.scaleMode = StageScaleMode.SHOW_ALL;
                  }
               }
            }
      ...
      public function method_98(param1:Event = null, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         if(!this.var_13.var_366 && !this.var_144)
         {
            if(null == param1)
            {
               ...
               if(class_33.var_3679 < class_68.var_4231.var_956)
               {
      ...
      public function method_100(param1:class_168) : void
      {
         ...
         while(++_loc3_ < _loc2_)
         {
            ...
            {
               this.var_63.splice(_loc3_,class_33.var_3679);
               _loc3_--;
               _loc2_--;
      ...
      public function method_101() : void
      {
         ...
         if(class_152.var_6142)
         {
            ...
            while(++_loc3_ < _loc2_)
            {
               ...
               if(_loc4_)
               {
                  if(_loc4_.var_774 != class_117.var_5262)
                  {
                     if(_loc4_.var_770)
                     {
                        if(!(class_91.var_4450 == class_80.const_438 && class_176.method_2630(_loc4_.var_760) == class_46.const_157))
                        {
                           ...
                           if(_loc4_.var_754)
                           {
                              ...
                              this.var_49.splice(_loc3_,class_33.var_3679);
                              _loc3_--;
                              _loc2_--;
                           }
                           else
                           {
                              ...
                              if(!_loc4_.var_745 && (-class_121.var_5495 > _loc7_ || _loc7_ > this.var_114 || _loc8_ > this.var_69 || -class_162.var_6351 > _loc8_))
                              {
                              ...
                              else
                              {
                                 ...
                                 _loc1_.method_464(_loc4_.var_768,_loc10_,int(_loc7_ * class_121.var_5493),int(class_121.var_5493 * _loc8_),int(class_121.var_5493 * _loc9_.var_304),int(_loc9_.var_305 * class_121.var_5493),int(_loc4_.method_559() * class_121.var_5493),int(_loc4_.method_557() * class_121.var_5493),_loc4_.var_695.Dur,_loc4_.method_553());
                              }
                           }
                        }
                     }
