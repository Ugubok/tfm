package
{
   ...
   public class class_191
   {
      ...
      {
         return new class_5(class_121.var_5493,class_165.var_6506).writeByte(class_165.var_6534).writeInt(param1).writeBool(param2);
      }
      
      public static function method_2733(param1:int, param2:int, param3:int, param4:int) : class_5
      {
         return new class_5(class_121.var_5493,class_102.var_4859).writeByte(class_165.var_6534).writeInt(param1).writeInt(param2).writeInt(param3).writeInt(param4);
      }
      
      public static function method_2734(param1:Boolean) : class_5
      {
         return new class_5(class_89.var_4436,class_121.var_5495).writeBool(param1);
      }
      
      public static function method_2735(param1:String, param2:int, param3:Boolean, param4:Boolean, param5:Boolean) : class_5
      {
         return new class_5(class_121.var_5493,class_165.var_6506).writeByte(class_33.var_3679).writeUTF(param1).writeInt(param2).writeBool(param3).writeBool(param4).writeBool(param5);
      }
      ...
      {
         var _loc3_:class_5 = new class_5(class_121.var_5493,class_9.var_3243);
      ...
      {
         return new class_5(class_121.var_5493,class_107.var_5037).writeByte(class_121.var_5495).writeUTF(param1);
      }
      ...
      {
         return new class_5(class_121.var_5493,class_102.var_4859).writeByte(class_146.var_6118).writeUTF(param1);
      }
      ...
      {
         return new class_5(class_121.var_5493,class_107.var_5037).writeByte(class_146.var_6117).writeByte(param1);
      }
      
      public static function method_2742() : class_5
      {
         return new class_5(class_121.var_5493,class_146.var_6117);
      }
