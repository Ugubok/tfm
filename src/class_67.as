package
{
   ...
   public class class_67 extends class_66
   {
      ...
      public function class_67(param1:int, param2:Function, param3:Function = null, param4:Boolean = false, param5:Boolean = false, param6:String = null, param7:String = null, param8:Boolean = false)
      {
         ...
         super(class_165.var_6486,(!!param5 ? class_73.method_2108(class_121.var_5366) : class_73.method_2108(class_162.var_6217)) + (param6 != null && param6.length > class_73.method_2108(class_183.var_7129) ? class_73.method_2108(class_33.var_3675) : class_183.var_7129));
         method_216(new class_245(class_243.const_642,class_9.var_3267));
         method_221(class_121.var_5495);
         method_188();
         this.var_575 = new class_373();
         this.var_583 = new class_24(class_73.method_2108(class_62.var_4027),class_73.method_2108(class_183.var_7129));
         method_136(this.var_583);
         this.var_583.x = class_73.method_2108(class_121.var_5495);
         this.var_579 = this.var_575.method_1227();
         method_136(this.var_579);
         this.var_579.x = class_73.method_2108(class_121.var_5495);
         ...
         if(param5)
         {
            ...
            _loc9_.method_216(new class_245(class_243.const_639,class_73.method_2108(class_117.var_5287)));
            method_136(_loc9_);
            _loc9_.x = class_73.method_2108(class_121.var_5495);
            _loc9_.method_136(new class_220(class_26.method_1668(class_73.method_2111(class_170.var_6609))));
            _loc9_.method_136(this.var_580);
            this.var_580.y = -class_33.var_3679;
            _loc9_.method_221(class_162.var_6346);
            this.var_581 = new class_24(class_73.method_2108(class_121.var_5493),class_124.var_5657);
         ...
         this.var_582.method_216(new class_245(class_243.const_639,class_73.method_2108(class_16.var_3467)));
         method_136(this.var_582);
         this.var_582.x = class_73.method_2108(class_121.var_5495);
         if(param4)
         {
            this.var_582.method_136(this.var_575.method_1225(new class_246(class_26.method_1668(class_73.method_2111(class_107.var_5045)),(this.var_582.name_5 - this.var_582.method_220()) / class_165.var_6534),this.method_429));
            this.var_582.method_136(this.var_575.method_1226(new class_246(class_26.method_1668(class_73.method_2111(class_181.var_6933)),(this.var_582.name_5 - this.var_582.method_220()) / class_73.method_2108(class_165.var_6534)),this.method_143));
         }
         else
         {
            this.var_582.method_136(this.var_575.method_1225(new class_246(class_26.method_1668(class_73.method_2111(class_107.var_5045)),this.var_582.name_5),this.method_429));
         }
      }
      ...
      public static function name_6(param1:int, param2:Function, param3:Function = null, param4:Boolean = false, param5:Boolean = false, param6:String = null, param7:String = null, param8:Boolean = false) : class_67
      {
         ...
         _loc9_.x = (class_73.method_2108(class_107.var_5074) - _loc9_.name_5) / class_165.var_6534;
         _loc9_.y = class_73.method_2108(class_33.var_3675) + (-_loc9_.var_206 + class_73.method_2108(class_183.var_7096)) / class_165.var_6534;
         if(param7 != null)
         {
      ...
      public function name_13(param1:String) : void
      {
         ...
         if(param1 != null && param1.length > class_73.method_2108(class_183.var_7129))
         {
            ...
            method_241(name_5,(!!this.var_578 ? class_121.var_5366 : class_73.method_2108(class_162.var_6217)) + class_73.method_2108(class_33.var_3675));
         }
         else
         {
            this.var_583.method_241(this.var_583.name_5,class_73.method_2108(class_183.var_7129));
            method_241(name_5,!!this.var_578 ? int(class_73.method_2108(class_121.var_5366)) : int(class_162.var_6217));
         }
         method_228();
      }
      ...
      public function method_143(param1:Vector.<int>) : void
      {
         ...
         {
            this.var_577(-class_73.method_2108(class_33.var_3679));
         }
      }
      
      public function method_428(param1:int) : void
      {
         if(this.var_574 == null || this.var_574.indexOf(class_73.method_2111(class_162.var_6232)) != class_183.var_7129)
         {
            return;
         }
      ...
      public function method_429(param1:Vector.<int>) : void
      {
         ...
         if(this.var_577 != null)
         {
            this.var_577(param1[class_73.method_2108(class_183.var_7129)]);
         }
      }
      ...
      public function method_430() : void
      {
         if(parent)
         {
            ...
            class_67.var_4215.splice(class_67.var_4215.indexOf(this),class_73.method_2108(class_33.var_3679));
         }
      }
   }
}
