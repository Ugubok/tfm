package
{
   ...
   public class class_866 implements class_474, class_733
   {
      ...
      public var var_2806:Vector.<String>;
      
      public var var_2807:class_762;
      
      public function class_866(param1:class_484)
      {
         super();
         this.name_10 = param1;
      }
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         this.var_2806 = new Vector.<String>(_loc2_);
         var _loc3_:int = class_183.var_7129;
         while(_loc3_ < _loc2_)
         {
            _loc5_ = param1.readShort();
            this.var_2806[_loc3_] = param1.readUTFBytes(_loc5_);
            _loc3_++;
         }
         var _loc4_:class_487 = this.name_10.recupereSequence(this.idSequence);
         if(_loc4_ != null)
         {
            if(_loc4_ is class_762)
            {
               this.var_2807 = class_762(_loc4_);
               this.var_2807.var_2616 = this;
            }
         }
      }
