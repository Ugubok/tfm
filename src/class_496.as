package
{
   ...
   public class class_496 extends class_24
   {
      ...
      public function class_496()
      {
         ...
         super(class_9.var_3233,class_89.var_4432);
         method_251(true);
         this.var_1541 = new class_24(name_5 - class_162.var_6351,var_206 - class_33.var_3675);
         this.var_1541.method_216(new class_245(class_243.const_640,class_146.var_6117));
         this.var_1541.x = class_146.var_6117;
         this.var_1541.y = class_146.var_6117;
         addChild(this.var_1541);
         if(!class_111.name_71)
         {
            this.method_1470(class_170.var_6660,class_26.method_1668(class_170.var_6658),this.method_300);
            this.method_1470(class_117.var_5205,class_26.method_1668(class_127.var_5824),this.method_1469);
            this.method_1470(class_92.var_4574,class_26.method_1668(class_89.var_4358),this.method_641);
            this.method_1470(class_127.var_5817,class_26.method_1668(class_33.var_3597),this.method_605);
            this.method_1467(class_33.var_3595,this.method_1471);
            this.method_1467(class_33.var_3595,this.method_1474);
            this.method_1467(class_33.var_3595,this.method_1473);
         }
         this.method_1467(class_162.var_6280,this.method_1472);
         this.method_1467(class_102.var_4773,this.method_594);
         this.method_1467(class_92.var_4591,this.method_1468);
         _loc1_ = class_175.method_118(class_60.var_3934);
         _loc1_.x = -class_4.var_3042 + name_5;
         _loc1_.y = -class_181.var_6939;
         _loc1_.scaleX = _loc1_.scaleY = class_165.var_6534;
      ...
      public static function name_6(param1:Boolean) : void
      {
         if(param1)
         {
            if(!class_496.var_2884)
            {
               ...
               class_496.var_2884.x = int((-class_496.var_2884.name_5 + class_107.var_5074) / class_165.var_6534);
               class_496.var_2884.y = class_102.var_4859;
            }
      ...
      public function method_1470(param1:String, param2:String, param3:Function) : void
      {
         ...
         var _loc4_:class_246 = new class_246(param2,name_5 - class_33.var_3675,param3,null,class_165.var_6506,class_117.var_5280);
         _loc5_ = class_175.method_118(param1);
         _loc5_.scaleX = _loc5_.scaleY = class_165.var_6534;
