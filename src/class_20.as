package
{
   ...
   public class class_20
   {
      ...
      public function class_20(param1:MovieClip)
      {
         ...
         class_20.var_1519 = class_20.var_3490[class_181.var_6830 + class_92.var_4525];
         class_20.var_1519[class_89.var_4336][class_170.var_6645](class_102.var_4723,this.method_181);
         ...
         if(_loc3_)
         {
            ...
            if(class_170.var_6720 == class_20.var_3491)
            {
               class_20.var_3491 = class_183.var_7129;
            }
            class_20.var_1519._Taille.text = _loc3_;
         }
         else
         {
            class_20.var_1519._Taille.text = class_165.var_6420;
         }
         ...
         this.method_183();
         var _loc4_:class_88 = new class_88(class_121.var_5466,class_62.var_4089,class_26.method_1668(class_183.var_7089),this.method_180,null,class_9.var_3243);
         class_20.var_1519.addChild(_loc4_);
         class_20.var_1519._TTaille.text = class_26.method_1668(class_33.var_3556);
      }
      ...
      public function method_180() : void
      {
         ...
         this.method_183();
         class_1.var_2884.method_97(class_102.var_4722 + class_26.var_3500 + class_121.var_5367);
      ...
      public function method_182(param1:Boolean = false) : void
      {
         ...
         while(_loc6_ < _loc4_)
         {
            ...
            if(_loc7_.indexOf(class_62.var_4117) == -class_33.var_3679)
            {
               if(class_20.var_3492 && _loc7_ == class_20.var_3492)
               {
                  _loc2_ += class_165.var_6521;
               }
               _loc2_ += class_170.var_6610 + _loc7_ + class_33.var_3677 + _loc7_ + class_89.var_4311;
            }
            _loc6_++;
         }
         ...
         {
            class_20.var_1519.Ascenseur.Rendu_Ascenseur(class_183.var_7129);
         }
      }
      ...
      public function method_183() : void
      {
         ...
         {
            ProxyTribulle.x_policeSpecialeChat = class_183.var_7128 + class_20.var_3492 + class_181.var_6873 + class_20.var_3491 + class_33.var_3677;
         }
         else if(class_20.var_3491)
         {
            ProxyTribulle.x_policeSpecialeChat = class_183.var_7043 + class_20.var_3491 + class_33.var_3677;
         }
         else if(class_20.var_3492)
         {
            ProxyTribulle.x_policeSpecialeChat = class_183.var_7128 + class_20.var_3492 + class_33.var_3677;
         }
         else
         {
            ProxyTribulle.x_policeSpecialeChat = class_9.var_3268;
         }
      }
      ...
      public function method_184(param1:Event) : void
      {
         ...
         if(_loc2_ != class_183.var_7129 && _loc2_ != class_170.var_6720)
         {
