package
{
   ...
   public class class_673 extends Sprite
   {
      ...
      public function class_673(param1:Boolean)
      {
         ...
         class_673.var_2884.x = int((class_107.var_5074 - class_673.name_38) / class_165.var_6534);
         class_673.var_2884.y = class_162.var_6351;
         var _loc2_:Sprite = new Sprite();
         _loc2_.graphics.beginFill(class_54.const_295,class_33.var_3679);
         ...
         _loc3_.text = class_121.var_5327;
         ...
         _loc4_.height = class_117.var_5287 * class_127.var_5864;
         addChild(_loc4_);
         var _loc5_:int = class_183.var_7129;
         while(_loc5_ < class_146.var_6117)
         {
            _loc6_ = new class_842(class_673.name_38 / class_165.var_6534 - class_673.name_77 * class_165.var_6534,_loc5_ < class_117.var_5287 ? 3289680 : 5255731);
            this.var_2475.push(_loc6_);
            addChild(_loc6_);
            if(class_117.var_5287 > _loc5_)
            {
               _loc6_.x = class_673.name_77;
               _loc6_.y = class_102.var_4859 + class_127.var_5864 * _loc5_;
               _loc6_.var_2762 = class_183.var_7129;
               _loc6_.var_2763 = _loc5_;
            }
            else
            {
               _loc6_.x = class_673.name_38 / class_165.var_6534 + class_673.name_77;
               _loc6_.y = class_102.var_4859 + class_127.var_5864 * (-class_117.var_5287 + _loc5_);
         ...
         if(this.var_2477)
         {
            _loc7_ = new class_88(class_146.var_6117,class_673.name_58 - class_92.var_4613,class_26.method_1668(class_107.var_4895),this.method_1704,null,class_673.name_38 - class_102.var_4859,false);
            addChild(_loc7_);
            _loc8_ = new class_88(class_146.var_6117,class_673.name_58 - class_4.var_3042,class_26.method_1668(class_181.var_6933),this.method_174,null,class_673.name_38 - class_102.var_4859,false);
            addChild(_loc8_);
         }
         else
         {
            _loc9_ = new class_88(class_146.var_6117,class_673.name_58 - class_4.var_3042,class_26.method_1668(class_60.var_3934),this.method_174,null,class_673.name_38 - class_102.var_4859,false);
            addChild(_loc9_);
         }
      ...
      {
         var _loc3_:class_842 = this.var_2475[class_117.var_5287 * param1 + param2];
         _loc3_.method_1789();
      }
      ...
      public function method_988(param1:Event) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            {
               this.var_2476.splice(_loc4_,class_33.var_3679);
               _loc3_--;
               _loc4_--;
            ...
            _loc5_.transform.colorTransform = new ColorTransform(class_33.var_3679 + _loc7_,class_33.var_3679 + _loc7_,class_33.var_3679 + _loc7_);
            _loc4_++;
         }
      }
