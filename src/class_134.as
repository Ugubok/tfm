package
{
   ...
   public class class_134
   {
      ...
      public static function method_2437(param1:Number, param2:Number) : void
      {
         ...
         while(_loc7_ < class_146.var_6118 * Math.PI)
         {
            _loc5_++;
            _loc8_ = new class_446(class_16.var_3467 * Math.pow(Math.sin(_loc7_),class_146.var_6118),-(class_117.var_5279 * Math.cos(_loc7_) - class_117.var_5287 * Math.cos(class_165.var_6534 * _loc7_) - class_165.var_6534 * Math.cos(_loc7_ * class_146.var_6118) - Math.cos(class_121.var_5495 * _loc7_)));
      ...
      public static function method_2438(param1:Number, param2:Number) : void
      {
         ...
         var _loc5_:Number = _loc4_ / class_165.var_6534 * Math.tan(Math.PI / class_9.var_3267);
         var _loc6_:Number = _loc4_ / class_165.var_6534 * Math.tan(Math.PI / class_146.var_6118) - _loc5_;
         var _loc7_:Point = new Point(-_loc4_ / class_165.var_6534,_loc5_);
         ...
         var _loc12_:Number = class_183.var_7129;
         ...
         while(_loc15_ <= _loc3_)
         {
            ...
            while(_loc20_ <= _loc13_.length - class_33.var_3679)
            {
               _loc7_ = _loc13_[_loc20_];
               _loc8_ = _loc13_[_loc20_ + class_33.var_3679];
               if(_loc20_ == _loc13_.length - class_33.var_3679)
               {
                  _loc8_ = _loc13_[class_183.var_7129];
               }
               ...
               _loc12_ -= class_165.var_6534 * Math.PI / class_146.var_6118;
         ...
         while(_loc19_ < _loc13_.length)
         {
            ...
            _loc16_.var_308 = _loc18_ * Math.cos(-class_117.var_5287 * Math.PI / class_9.var_3267 + _loc19_ * class_165.var_6534 * Math.PI / _loc13_.length);
            _loc16_.var_309 = -_loc18_ * Math.sin(-class_117.var_5287 * Math.PI / class_9.var_3267 + _loc19_ * class_165.var_6534 * Math.PI / _loc13_.length);
            _loc16_.var_304 = param1 + class_1.var_2884.var_50.x + _loc13_[_loc19_].x - _loc16_.var_308 * class_16.var_3473;
            _loc16_.var_305 = param2 - class_170.var_6717 + class_1.var_2884.var_50.y + _loc13_[_loc19_].y - _loc16_.var_309 * class_16.var_3473;
            _loc16_.var_312 = class_4.var_3035;
            _loc16_.var_313 = class_4.var_3035;
      ...
      public static function name_9() : void
      {
         ...
         {
            class_134.var_5904 = new Vector.<class_75>(class_146.var_6118,true);
         }
         var _loc1_:int = class_183.var_7129;
         while(_loc1_ < class_134.var_5904.length)
         {
            class_134.var_5904[_loc1_] = new class_75(class_175.method_118(class_92.var_4502 + (class_33.var_3679 + _loc1_)));
            _loc1_++;
         }
      }
      ...
      {
         param1 += Math.random() * class_162.var_6351 - class_183.var_7127;
         ...
         _loc4_.var_308 = Math.random() * class_165.var_6534 - class_33.var_3679;
         _loc4_.var_309 = -class_165.var_6534;
