package
{
   ...
   public class class_300 extends class_23
   {
      ...
      public function class_300(param1:int, param2:int = 0, param3:Boolean = false)
      {
         ...
         if(this.var_1438 < class_4.var_3058)
         {
         ...
         if(this.var_1439 == class_300.const_773)
         {
            ...
            this.var_1440.y = class_33.var_3679;
         }
         addChild(this.var_1440);
         this.var_1441 = class_164.method_2574(this.var_1416);
         this.var_1441.x = -this.var_1441.width + this.var_1439;
         this.var_1441.y = -class_102.var_4852 + this.var_1439;
         addChild(this.var_1441);
         var _loc4_:String = this.var_1438.toString();
         if(this.var_1438 > class_4.var_3058 && this.var_1438 < class_117.var_5288 || this.var_1438 > class_102.var_4715 && this.var_1438 < class_165.var_6393 || this.var_1438 >= class_9.var_3113 && this.var_1438 <= class_162.var_6203 || this.var_1438 >= class_124.var_5540 && this.var_1438 <= class_183.var_6997 || this.var_1438 >= class_183.var_6996 && this.var_1438 <= class_162.var_6202)
         {
            if(this.var_1438 > class_4.var_3058 && this.var_1438 < class_117.var_5288)
            {
               _loc4_ = String.fromCharCode(class_92.var_4615 + (-class_4.var_3058 + this.var_1438) / class_121.var_5493).toString().toUpperCase() + this.var_1438 % class_121.var_5493;
            }
            else if(this.var_1438 > class_102.var_4715 && this.var_1438 < class_165.var_6393)
            {
               if(class_162.var_6201 > this.var_1438)
               {
                  _loc4_ = String.fromCharCode(class_92.var_4615 + (this.var_1438 - class_121.var_5355) / class_92.var_4647).toString().toUpperCase() + ((-class_121.var_5355 + this.var_1438) % class_92.var_4647 + class_33.var_3679);
               }
               else
               {
                  _loc4_ = String.fromCharCode(class_92.var_4615 + (-class_162.var_6201 + this.var_1438)).toString().toUpperCase() + class_92.var_4647;
               }
            }
            else if(this.var_1438 >= class_9.var_3113 && this.var_1438 <= class_162.var_6203)
            {
               _loc6_ = class_146.var_6065.charCodeAt(class_183.var_7129) + (-class_9.var_3113 + this.var_1438) / class_162.var_6346;
               _loc7_ = (-class_9.var_3113 + this.var_1438) % class_162.var_6346 + class_33.var_3679;
            ...
            {
               _loc6_ = class_162.var_6312.charCodeAt(class_183.var_7129) + (this.var_1438 - class_124.var_5540) / class_162.var_6346;
               _loc7_ = (this.var_1438 - class_124.var_5540) % class_162.var_6346 + class_33.var_3679;
               _loc4_ = _loc7_ != class_162.var_6346 ? String.fromCharCode(_loc6_) + _loc7_ : String.fromCharCode(_loc6_);
            }
            else if(this.var_1438 >= class_183.var_6996 && this.var_1438 <= class_162.var_6202)
            {
               _loc8_ = class_183.var_6996;
               _loc9_ = class_9.var_3267;
               _loc6_ = class_146.var_6065.charCodeAt(class_183.var_7129) + (this.var_1438 - _loc8_) / _loc9_;
               _loc7_ = (this.var_1438 - _loc8_) % _loc9_ + class_33.var_3679;
               _loc4_ = _loc7_ != _loc9_ ? String.fromCharCode(_loc6_) + _loc7_ : String.fromCharCode(_loc6_);
            }
            _loc5_ = new TextField();
            _loc5_.defaultTextFormat = new TextFormat(class_26.var_3500,class_102.var_4852,15575397);
            _loc5_.width = class_16.var_3473;
            _loc5_.height = class_183.var_7127;
            _loc5_.mouseEnabled = class_99.var_4682;
            _loc5_.filters = class_300.var_7224;
            _loc5_.x = class_33.var_3679;
      ...
      public function method_1074(param1:Number) : class_300
      {
         ...
         this.var_1441.x = Math.min(this.var_1416 > class_102.var_4852 ? Number(_loc2_ - class_16.var_3467) : Number(_loc2_ - class_102.var_4852),_loc2_ - this.var_1441.width - class_33.var_3679);
         this.var_1441.y = -class_102.var_4852 + _loc2_;
         return this;
      }
      ...
      public function method_1075(param1:int, param2:Boolean = false) : int
      {
         ...
         if(class_183.var_7129 > this.var_1416)
         {
            this.var_1416 = class_183.var_7129;
         }
         mouseEnabled = class_183.var_7129 < this.var_1416;
         visible = this.var_1416 > class_183.var_7129;
         this.var_1441.bitmapData = class_164.method_2574(this.var_1416).bitmapData;
         this.var_1441.x = this.var_1439 - (class_102.var_4852 + class_102.var_4852 * (String(this.var_1416).length - class_33.var_3679));
