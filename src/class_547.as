package
{
   ...
   public class class_547 extends class_66
   {
      ...
      {
         super(class_170.var_6568,class_181.var_6929);
         method_188(true);
         method_216(new class_245(class_243.const_642,class_117.var_5287));
         this.var_2133 = class_168.var_6539.var_609.method_126();
         var _loc1_:class_24 = new class_24(name_5,var_206 - class_165.var_6534 * (method_220() + class_33.var_3675));
         _loc1_.method_216(new class_245(class_243.const_639,class_117.var_5287));
         method_136(_loc1_);
         this.var_2137 = new class_24(class_124.var_5662,_loc1_.var_206);
         _loc1_.method_136(this.var_2137);
         _loc1_.method_231(this.var_2137.name_5 + _loc1_.method_220() / class_165.var_6534,class_183.var_7129,false,this.var_2137.var_206);
         ...
         this.var_2135 = new class_387(this.var_2138.name_5,class_89.var_4436);
         this.var_2135.method_216(new class_245(class_243.const_640,class_183.var_7129));
         ...
         var _loc6_:class_245 = new class_245(class_243.const_640,class_165.var_6534);
         ...
         this.var_2144 = new class_24(_loc8_.name_5 - _loc8_.method_220() - class_4.var_2909,_loc8_.var_206);
         this.var_2144.method_216(new class_245(class_243.const_642));
         this.var_2142 = new class_24(this.var_2144.name_5,this.var_2144.var_206 - (this.var_2144.method_220() + class_9.var_3266));
         this.var_2142.method_216(new class_245(class_243.const_642));
         var _loc9_:class_246 = new class_246(class_26.method_1668(class_183.var_7089),this.var_2144.name_5,this.method_1558);
         this.var_2144.method_136(this.var_2142,_loc9_);
         _loc8_.method_136(this.var_2144);
         _loc8_.method_136(_loc7_);
         _loc9_.x = (this.var_2144.name_5 - _loc9_.width) / class_165.var_6534;
         var _loc10_:class_24 = new class_24(this.var_2139.name_5,class_9.var_3266);
         _loc10_.method_216(new class_245(class_243.const_639,class_117.var_5287));
         var _loc11_:int = class_183.var_7093;
         var _loc12_:class_246 = new class_246(class_26.method_1668(class_107.var_5045),_loc11_);
         var _loc13_:class_246 = new class_246(class_26.method_1668(class_181.var_6933),_loc11_);
         this.var_581 = new class_24(class_547.const_1196 * class_9.var_3266 + (class_547.const_1196 - class_33.var_3679) * class_165.var_6534,class_9.var_3266);
         ...
         var _loc15_:class_24 = new class_24(name_5,class_9.var_3266);
         var _loc16_:class_246 = new class_246(class_26.method_1668(class_9.var_3093),this.var_2140.name_5,this.method_1480);
         var _loc17_:class_246 = new class_246(class_26.method_1668(class_92.var_4493),((_loc15_.name_5 - _loc16_.width) / class_16.var_3465 - _loc15_.method_220()) / class_165.var_6534,this.method_1561);
         var _loc18_:class_246 = new class_246(class_26.method_1668(class_181.var_6934),((_loc15_.name_5 - _loc16_.width) / class_16.var_3465 - _loc15_.method_220()) / class_165.var_6534,this.method_1562);
         this.var_2141 = new class_244(_loc15_.name_5 - class_165.var_6534 - class_146.var_6118 * _loc15_.method_220() - class_165.var_6534 * _loc17_.width - _loc16_.width);
         ...
         method_136(_loc15_);
         method_136(new class_246(class_26.method_1668(class_60.var_3934),name_5,class_547.name_6,false));
      ...
      {
         this.var_2135.method_1261(-class_33.var_3679);
      ...
      public function method_1560(param1:class_364) : void
      {
         ...
         for(; _loc4_ < _loc5_; _loc4_++)
         {
            ...
            if(!_loc2_ && !(_loc7_.var_162 as class_201).var_1037)
            {
               ...
               {
                  if((_loc7_.var_162 as class_201).var_719 <= class_165.var_6506 || (_loc7_.var_162 as class_201).var_719 >= class_92.var_4625)
                  {
                     continue;
                  }
               }
            ...
            {
               if(param1.var_1024 == _loc7_.var_1024 || param1.var_1024 == class_364.name_57.var_1024 && _loc7_.var_1024 == class_127.var_5865)
               {
                  _loc3_.push(_loc7_);
               }
            }
         ...
         while(_loc4_ < _loc5_)
         {
            ...
            if(class_547.var_2742[_loc7_.var_574])
            {
               ...
               if(_loc9_ > class_183.var_7129)
               {
                  ...
                  _loc11_ = _loc10_.getUTCDate() < class_146.var_6117 ? class_124.var_5665 + _loc10_.getUTCDate() : String(_loc10_.getUTCDate());
                  _loc12_ = _loc10_.getUTCMonth() + class_33.var_3679 < class_146.var_6117 ? class_124.var_5665 + (_loc10_.getUTCMonth() + class_33.var_3679) : String(_loc10_.getUTCMonth() + class_33.var_3679);
      ...
      public function method_1480() : void
      {
         ...
         _loc4_.save(class_372.method_2900(_loc2_),class_162.var_6184 + class_33.var_3659 + this.var_2133.method_122() + class_89.var_4385);
      }
      ...
      public function method_1565(param1:class_199) : void
      {
         ...
         this.var_2142.x = (this.var_2144.name_5 - this.var_2142.var_242) / class_165.var_6534;
         this.var_2137.clear();
