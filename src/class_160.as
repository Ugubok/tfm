   ...
   public class class_160
   {
      ...
      public static function method_2545(param1:String = null, param2:int = 0) : void
      {
         ...
         if(param1)
         {
            ...
            class_160.var_6156 = int(_loc4_[class_183.var_7129]);
            _loc3_ = int(_loc4_[class_33.var_3679]);
            class_160.var_6157 = int(_loc4_[class_165.var_6534]);
            class_160.var_6159 = int(_loc4_[class_146.var_6118]);
            class_160.var_6158 = int(_loc4_[class_121.var_5495]);
         }
         class_498.name_6(class_62.var_4121 + class_160.var_6156 + (!!_loc3_ ? class_16.var_3394 + _loc3_ : class_9.var_3268) + class_89.var_4320 + class_160.var_6157 + class_162.var_6220 + class_160.var_6158);
      }
      ...
      public static function method_2548() : void
      {
         ...
         class_58.var_3803.method_386(-class_33.var_3679);
         ...
         while(_loc4_ < _loc2_.length)
         {
            ...
            {
               _loc6_ = _loc5_.name;
               if(_loc6_.charAt(class_183.var_7129) == class_9.var_3256)
               {
                  _loc7_ = _loc5_.x;
                  _loc8_ = _loc5_.y;
                  ...
                  if(_loc9_)
                  {
                     ...
                     _loc5_.alpha = class_183.var_7129;
                  ...
                  else
                  {
                     if(_loc6_ == class_183.var_7014)
                     {
                        ...
                        _loc1_ = new TextFormat(class_89.var_4426,class_102.var_4859,4800820,null,null,null,null,null,TextFormatAlign.CENTER);
                        class_160.var_6153.defaultTextFormat = _loc1_;
                        class_160.var_6153.width = class_107.var_5068;
                        class_160.var_6153.height = class_89.var_4436;
                     ...
                     if(_loc6_.substr(class_183.var_7129,class_165.var_6534) == class_181.var_6831)
                     {
                        _loc10_ = int(_loc6_.substr(class_165.var_6534));
                        if(_loc10_)
                        {
                           _loc11_ = class_175.method_118(class_92.var_4553)._T as TextField;
                           _loc1_ = new TextFormat(class_89.var_4426,class_170.var_6720,12763866);
                           ...
                           _loc11_.filters = new Array(new GlowFilter(class_183.var_7129,class_33.var_3679,class_165.var_6534,class_165.var_6534,class_146.var_6118,class_146.var_6118));
                        }
                     }
