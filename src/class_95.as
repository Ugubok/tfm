   ...
   public class class_95
   {
      ...
      public static function method_2214(param1:int) : Sprite
      {
         ...
         if(!_loc2_)
         {
            ...
            _loc4_ = new TextFormat(class_26.var_3500,class_73.method_2108(class_170.var_6720),3811100);
            _loc4_.align = TextFormatAlign.CENTER;
            _loc4_[class_73.method_2111(class_60.var_3884)] = class_73.method_2108(class_183.var_7129);
            ...
            _loc5_.height = _loc3_.height + class_73.method_2108(class_107.var_5039);
            _loc2_.addChild(_loc5_);
            _loc2_.addChild(_loc3_);
            _loc6_ = _loc2_.width / class_165.var_6534;
            _loc7_ = _loc2_.height / class_73.method_2108(class_165.var_6534);
            _loc5_.x -= _loc6_;
            _loc5_.y -= _loc7_;
            _loc3_.x -= _loc6_;
            _loc3_.y -= _loc7_;
      ...
      public static function name_9() : void
      {
         ...
         while(_loc1_ < class_92.var_4647)
         {
            ...
            _loc2_ = new class_23(class_183.var_7129,class_73.method_2108(class_183.var_7129));
            _loc2_.addChild(class_175.method_118(class_73.method_2111(class_124.var_5500) + _loc1_));
      ...
      public static function method_2215(param1:int) : void
      {
         ...
         class_95.var_4661.alpha = class_73.method_2116(class_92.var_4648);
      ...
      public static function method_2217(param1:int, param2:int) : void
      {
         ...
         class_115.method_388(class_95.var_3490,class_73.method_2108(class_183.var_7129));
         var _loc3_:Number = class_73.method_2108(class_183.var_7129);
         var _loc4_:int = class_73.method_2108(class_9.var_3243);
         ...
         while(++_loc5_ < _loc6_)
         {
            ...
            class_233.method_2810(_loc7_,class_124.var_5657,class_398.method_2931,_loc5_ * class_162.var_6351).method_1270(class_183.var_7129,Math.cos(_loc3_) * _loc4_).method_1267(class_73.method_2108(class_183.var_7129),Math.sin(_loc3_) * _loc4_);
