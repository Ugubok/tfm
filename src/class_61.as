   ...
   public class class_61
   {
      ...
      public static function method_2008(param1:Event = null) : void
      {
         ...
         if(class_61.var_3980)
         {
            ...
            class_61.var_3980.graphics.drawRect(class_183.var_7129,class_183.var_7129,class_1.var_2880,class_1.var_2882);
            class_61.var_3980.graphics.endFill();
            if(class_1.method_1811())
            {
               class_61.var_3981.x = int((class_1.var_2880 - class_61.var_3981.width) / class_165.var_6534);
               class_61.var_3981.y = int((-class_61.var_3981.height + class_1.var_2882) / class_165.var_6534) - class_165.var_6506;
            }
            else
            {
               class_61.var_3981.x = int((class_1.var_2880 - class_61.var_3981.width) / class_165.var_6534);
               class_61.var_3981.y = int((class_1.var_2882 - class_61.var_3981.height) / class_165.var_6534) - class_165.var_6506;
            }
         }
      }
      ...
      public static function name_6(param1:Boolean) : void
      {
         if(param1)
         {
            if(!class_61.var_3980)
            {
               ...
               class_61.var_3980.graphics.drawRect(class_183.var_7129,class_183.var_7129,class_1.var_2880,class_1.var_2882);
               class_61.var_3980.graphics.endFill();
               class_61.var_3981 = class_175.method_118(class_127.var_5808);
               if(class_1.method_1811())
               {
                  class_61.var_3981.x = int((class_1.var_2880 - class_61.var_3981.width) / class_165.var_6534);
                  class_61.var_3981.y = int((class_1.var_2882 - class_61.var_3981.height) / class_165.var_6534) - class_165.var_6506;
               ...
               {
                  class_61.var_3981.x = int((-class_61.var_3981.width + class_1.var_2880) / class_165.var_6534);
                  class_61.var_3981.y = int((-class_61.var_3981.height + class_1.var_2882) / class_165.var_6534) - class_165.var_6506;
               }
            ...
            class_1.var_2884.addEventListener(class_124.var_5632,class_61.method_2009);
            class_61.var_666 = class_1.method_1816();
            class_61.var_3982 = class_183.var_7129;
      ...
      public static function method_2009(param1:Event) : void
      {
         ...
         var _loc4_:int = class_89.var_4436 * (_loc3_ / class_4.var_3058);
         if(class_190.var_7138)
         {
            if(class_170.var_6705 <= _loc4_)
            {
               if(class_61.var_3985)
               {
                  class_61.var_3985 = class_99.var_4682;
                  class_52.name_6(class_165.var_6534);
               }
               class_61.method_2010();
            }
            return;
         ...
         if(_loc4_ >= class_170.var_6705)
         {
            ...
            class_61.var_3981.gotoAndStop(class_170.var_6705);
            if(class_183.var_7129 == class_61.var_3982)
            {
      ...
      public static function method_2010() : void
      {
         ...
         class_1.var_2884.removeEventListener(class_124.var_5632,class_61.method_2009);
