package
{
   ...
   public class class_903 implements class_474, class_733
   {
      ...
      public var var_2827:class_781;
      
      public function class_903(param1:class_484)
      {
         super();
         this.name_10 = param1;
      }
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is class_781)
            {
               this.var_2827 = class_781(_loc2_);
               this.var_2827.var_2644 = this;
            }
         }
      }
