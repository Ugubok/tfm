package
{
   ...
   public class class_86 extends class_24
   {
      ...
      public function class_86()
      {
         ...
         super(class_124.var_5657,class_62.var_4089);
         ...
         this.var_606 = new class_387(name_5,class_121.var_5493);
         this.var_606.method_216(new class_245(class_243.const_639,class_86.var_4256));
         var _loc1_:class_386 = this.method_442(class_158.NORMAL,class_60.var_3836,class_4.var_2907);
         var _loc2_:class_386 = this.method_442(class_158.const_569,class_181.var_6792,class_89.var_4274);
         this.var_605 = this.method_442(class_158.const_570,class_92.var_4490,class_117.var_5133);
         var _loc3_:Number = Math.max(_loc1_.name_5,_loc2_.name_5,this.var_605.name_5);
         var _loc4_:Number = class_170.var_6690;
         this.var_606.method_221((-_loc1_.name_5 + _loc3_) / class_165.var_6534 * _loc4_);
         this.var_606.method_1257(_loc1_);
         this.var_606.method_221((class_165.var_6534 * _loc3_ - _loc1_.name_5 - _loc2_.name_5) / class_165.var_6534 * _loc4_);
         this.var_606.method_1257(_loc2_);
         this.var_606.method_221((class_165.var_6534 * _loc3_ - _loc2_.name_5 - this.var_605.name_5) / class_165.var_6534 * _loc4_);
         ...
         this.var_606.x = (name_5 - this.var_606.name_5) / class_165.var_6534;
         _loc5_ = new class_24(name_5,class_9.var_3243);
         _loc5_.method_216(new class_245(class_243.const_639,class_165.var_6534));
         this.var_607 = new class_24(class_121.var_5493,_loc5_.var_206);
         this.var_607.mouseChildren = class_99.var_4682;
         this.var_607.mouseEnabled = class_99.var_4682;
         _loc5_.method_136(this.var_607);
         this.var_610 = new class_67(class_86.var_4258 >= class_183.var_7129 ? int(class_86.var_4258) : int(class_183.var_7129),null,this.method_436,true,true);
         this.var_610.x = (-this.var_610.name_5 + class_107.var_5074) / class_165.var_6534;
         this.var_610.y = class_33.var_3675 + (-this.var_610.var_206 + class_183.var_7096) / class_165.var_6534;
         ...
         var _loc7_:class_246 = new class_246(class_26.method_1668(class_16.var_3289),name_5 - class_183.var_7129,this.method_438);
         method_136(_loc7_);
         _loc7_.x = (-_loc7_.name_5 + name_5) / class_165.var_6534;
         var _loc8_:class_246 = new class_246(class_26.method_1668(class_107.var_5045),name_5 - class_183.var_7129,this.method_441);
         method_136(_loc8_);
      ...
      public static function name_6(param1:Boolean) : void
      {
         if(param1)
         {
            if(!class_86.var_2884)
            {
               ...
               class_86.var_2884.x = (-class_86.var_2884.name_5 + class_107.var_5074) / class_165.var_6534;
               class_86.var_2884.y = class_33.var_3675 + (class_183.var_7096 - class_86.var_2884.var_206) / class_165.var_6534;
            }
      ...
      public static function method_2144() : void
      {
         ...
         class_1.var_2884.method_77(class_4.var_3055);
      }
      ...
      {
         class_1.var_2884.method_77(class_89.var_4420);
      }
      ...
      public function method_438() : void
      {
         ...
         class_1.var_2884.method_77(class_89.var_4273);
      }
      ...
      public function method_142() : void
      {
         if(class_86.var_2884 && class_86.var_2884.parent)
         {
            ...
            if(this.var_609)
            {
               ...
               this.var_608.y = this.var_607.var_206 * class_146.var_6118 / class_117.var_5287;
      ...
      public function method_442(param1:int, param2:String, param3:String) : class_386
      {
         ...
         _loc4_ = new class_24((name_5 - class_165.var_6534 * class_86.var_4255 - class_165.var_6534 * class_86.var_4256) / class_146.var_6118,this.var_606.var_206);
         _loc4_.method_216(new class_245(class_243.const_642,class_165.var_6534));
         var _loc5_:class_220 = new class_220(class_26.method_1903(class_111.var_5092,param2),class_89.var_4444);
         ...
         var _loc7_:class_250 = new class_250(null,class_89.var_4436,class_89.var_4436);
         _loc7_.method_964(class_175.method_2618(class_107.var_4892 + param1 + class_117.var_5274));
         _loc4_.method_136(_loc7_);
         _loc7_.x = (_loc4_.name_5 - _loc7_.name_5) / class_165.var_6534;
         ...
         _loc8_.var_206 = _loc4_.var_206 + class_170.var_6731 + class_170.var_6720 + class_146.var_6118;
         _loc8_.graphics.beginFill(class_183.var_7129,class_183.var_7129);
         _loc8_.graphics.drawRect(class_183.var_7129,class_183.var_7129,_loc8_.width,_loc8_.height);
