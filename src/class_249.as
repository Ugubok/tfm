package
{
   ...
   public class class_249 extends Sprite
   {
      ...
      {
         super();
         this.var_1247 = class_175.method_118(class_162.var_6211);
         ...
         this.var_1248 = class_175.method_118(class_127.var_5758);
         this.var_1248.mouseChildren = class_99.var_4682;
         addChild(this.var_1248);
         this.var_1248.x = class_107.var_5038;
         ...
         this.var_1249 = class_175.method_118(class_162.var_6210);
         this.var_1249.mouseChildren = class_99.var_4682;
         addChild(this.var_1249);
         this.var_1249.x = class_9.var_3240;
         ...
         graphics.drawRoundRect(-class_165.var_6534,-class_165.var_6534,class_170.var_6694,class_124.var_5640,class_162.var_6351);
         graphics.endFill();
