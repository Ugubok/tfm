package
{
   ...
   public class class_568 extends class_166
   {
         ...
         switch(param1.var_574)
         {
            case class_165.var_6534:
               ...
               if(_loc3_ && !_loc3_.var_366)
               {
                  ...
                  _loc9_ = param1.method_1476(class_165.var_6534);
                  if(_loc8_ && this.var_2211.indexOf(_loc2_) == -class_33.var_3679)
                  {
                     this.var_2211.push(_loc2_);
                  }
                  else if(!_loc8_ && this.var_2211.indexOf(_loc2_) != -class_33.var_3679)
                  {
            ...
            case class_146.var_6118:
               ...
               {
                  _loc4_.var_925.var_765 = param1.method_1477(class_33.var_3679) / class_4.var_3057;
               }
               break;
         ...
         if(var_873)
         {
            if(this.var_2204)
            {
               if(!class_168.var_6539.var_366)
               {
                  ...
                  {
                     _loc5_ = (class_168.var_6539.var_925.method_559() * class_170.var_6705 / Math.PI % class_89.var_4404 + class_89.var_4404) % class_89.var_4404;
                     if(class_170.var_6705 < _loc5_)
                     {
                        _loc5_ -= class_89.var_4404;
                     }
                     _loc6_ = Math.abs(_loc5_ - class_183.var_7127);
                     if(_loc6_ < class_92.var_4628)
                     {
                        _loc7_ = this.var_2209 + class_162.var_6346;
                     ...
                     else if(class_16.var_3473 > _loc6_)
                     {
                     ...
                     if(_loc6_ > class_170.var_6717)
                     {
                        this.method_1605();
                     }
                  }
                  if(_loc4_ > class_16.var_3438)
                  {
                     if(class_183.var_7129 > class_168.var_6539.var_925.var_756.var_304)
                     {
                        this.method_1605();
                     }
                     if(this.var_2213 % class_16.var_3473 == class_183.var_7129)
                     {
                        if(!this.method_1607())
                        {
                           this.method_1605();
         ...
         if(var_873)
         {
            if(this.var_2204)
            {
               ...
               for each(_loc2_ in param1)
               {
                  ...
                  {
                     _loc2_.var_925.method_556(_loc2_.var_925.method_555(),class_568.const_1227 * Math.PI / class_170.var_6705);
                     _loc2_.var_925.var_779.var_1345 = class_121.var_5493;
                     _loc3_ = new class_348();
                     _loc4_ = new Vector.<Number>();
                     _loc4_.push(-class_162.var_6351 / class_162.var_6351,class_117.var_5287 / class_162.var_6351);
                     _loc4_.push(class_162.var_6351 / class_162.var_6351,class_117.var_5287 / class_162.var_6351);
                     _loc4_.push(class_33.var_3675 / class_162.var_6351,class_121.var_5494 / class_162.var_6351);
                     _loc4_.push(-class_33.var_3675 / class_162.var_6351,class_121.var_5494 / class_162.var_6351);
                     _loc3_.method_1200(_loc4_);
                     _loc3_.var_413 = class_183.var_7129;
      ...
      {
         var _loc1_:int = int(class_4.var_3058 * class_168.var_6539.var_925.var_765);
      ...
      {
         class_39.var_3745.method_313(method_660(class_165.var_6534,this.var_2207,this.var_2206));
         class_1.var_2884.method_98();
      }
      
      override public function method_656(param1:class_58) : void
      {
         var_873 = class_568.name_79.indexOf(param1.var_531.var_956) != -class_33.var_3679;
         ...
         if(var_873)
         {
            if(this.var_2204)
            {
               ...
               param1.var_539.graphics.drawRect(class_183.var_7129,class_183.var_7129,param1.var_506.var_426,param1.var_506.var_420);
         ...
         if(var_873)
         {
            if(this.var_2204)
            {
               if(!class_168.var_6539.var_366)
               {
                  ...
                  {
                     class_168.var_6539.var_925.var_751 = Math.random() * class_170.var_6720 - class_9.var_3267;
                     return false;
                  }
               }
            }
      ...
      public function method_1607() : Boolean
      {
         ...
         return _loc3_ < class_102.var_4850;
      }
