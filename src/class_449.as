package
{
   ...
   public class class_449 extends class_24
   {
      ...
      public function class_449(param1:String, param2:String)
      {
         ...
         super(class_124.var_5657,class_62.var_4130);
         method_239(param1,this.method_439);
         _loc3_ = new TextField();
         _loc3_.defaultTextFormat = new TextFormat(class_26.var_3500,class_170.var_6720,class_54.const_279,null,null,null,null,null,class_181.var_6903);
         _loc3_.styleSheet = class_1.var_2884.var_117;
         _loc3_.width = name_5;
         _loc3_.height = var_206;
         _loc3_.autoSize = class_60.var_3974;
         ...
         _loc3_.y = int((-_loc3_.height + var_206) * class_4.var_3040);
         addChild(_loc3_);
         method_203(this.method_439);
         x = int(class_1.var_2888 - name_5 / class_165.var_6534);
         y = int((class_1.var_2875 - var_206 / class_165.var_6534) * class_146.var_6103);
      }
