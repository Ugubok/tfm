package
{
   ...
   public class class_621 extends class_24
   {
      ...
      public function class_621()
      {
         ...
         var _loc1_:class_24 = new class_24(class_621.name_38 - class_165.var_6534 * class_621.var_7360,class_621.name_58 - class_33.var_3675);
         _loc1_.method_251(true,class_146.var_6117);
         _loc1_.x = class_621.var_7360;
         _loc1_.y = class_33.var_3675;
         _loc1_.method_216(new class_245(class_243.const_642,class_117.var_5287));
         addChild(_loc1_);
         ...
         _loc3_.method_251(true,class_146.var_6117);
         ...
         this.var_2376 = class_84.method_2132(class_170.var_6573,_loc4_.name_5 - class_146.var_6117,class_107.var_5040);
         ...
         this.var_2382 = new class_387(class_62.var_4130,class_33.var_3675);
         var _loc5_:class_386 = new class_386(class_306.var_7228,class_26.method_1668(class_162.var_6187));
         var _loc6_:class_386 = new class_386(class_306.var_7229,class_181.var_6804 + class_26.method_1668(class_107.var_4896));
         var _loc7_:class_386 = new class_386(class_306.var_7227,class_181.var_6803 + class_26.method_1668(class_183.var_6982));
         (_loc5_.var_1720 as class_220).method_865(class_162.var_6346).method_868(class_183.var_7129,class_33.var_3679);
         (_loc6_.var_1720 as class_220).method_865(class_162.var_6346).method_868(class_183.var_7129,class_33.var_3679);
         (_loc7_.var_1720 as class_220).method_865(class_162.var_6346).method_868(class_183.var_7129,class_33.var_3679);
         ...
         _loc4_.method_221(class_170.var_6731);
         _loc4_.method_136(this.var_2376,this.var_2382);
         var _loc8_:int = class_621.var_7361 - class_621.var_7358 - class_9.var_3267;
         ...
         this.var_1309.method_221(class_121.var_5495);
         this.var_1309.method_136(this.var_2374,this.var_2375);
         this.var_2381 = new Sprite();
         this.var_2381.x = class_62.var_4090;
         this.var_2381.y = -class_117.var_5287;
      ...
      public static function name_6(param1:Boolean) : void
      {
         if(param1)
         {
            if(!class_621.var_2884)
            {
               ...
               class_621.var_2884.x = int((class_107.var_5074 - class_621.name_38) / class_165.var_6534);
               class_621.var_2884.y = class_9.var_3266;
            }
      ...
      public function method_1675(param1:class_659) : void
      {
         ...
         this.var_2384.htmlText = class_117.var_5225 + class_26.method_1668(class_4.var_2914,class_165.var_6521 + param1.var_2452 + class_181.var_6887) + class_162.var_6188;
         ...
         if(param1.var_2457)
         {
            if(!this.var_2395)
            {
               this.var_2395 = new class_23(class_146.var_5965,class_9.var_3234);
               ...
               this.var_2396.y = class_16.var_3467;
               this.var_2395.addChild(new class_250(class_117.var_5139,class_146.var_5965,class_121.var_5470));
               this.var_2395.addChild(this.var_2396);
               this.var_2395.method_208(class_26.method_1668(class_16.var_3299));
            }
         ...
         _loc2_ += class_89.var_4279 + class_26.method_1668(class_4.var_2913) + class_127.var_5730 + param1.var_2449[class_183.var_7129] + class_117.var_5138 + param1.var_2449[class_121.var_5495] + class_127.var_5729 + param1.var_2449[class_9.var_3267] + class_4.var_2912;
         _loc2_ += class_89.var_4279 + class_26.method_1668(class_117.var_5137) + class_62.var_4001 + param1.var_2449[class_33.var_3679] + class_121.var_5331;
         _loc2_ += class_124.var_5608;
         _loc2_ += class_26.method_1668(class_170.var_6574);
         _loc2_ += class_89.var_4279 + class_26.method_1668(class_181.var_6805) + class_62.var_4001 + param1.var_2449[class_165.var_6534] + class_121.var_5331;
         _loc2_ += class_89.var_4279 + class_26.method_1668(class_33.var_3531) + class_62.var_4001 + param1.var_2449[class_146.var_6118] + class_121.var_5331;
         _loc2_ += class_89.var_4279 + class_16.var_3298 + param1.var_2449[class_117.var_5287] + class_121.var_5331;
         ...
         if(!this.var_2388)
         {
            ...
            _loc12_.htmlText = class_26.method_1668(class_121.var_5330);
            this.var_2389 = new class_24(class_181.var_6929,class_121.var_5493);
            ...
            this.var_2389.x = class_146.var_6117;
         }
         this.var_2389.clear();
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            _loc14_ = param1.var_2453[_loc3_ + class_33.var_3679];
            _loc15_ = new class_250(class_33.var_3619 + _loc13_ + class_89.var_4385,class_102.var_4859,class_102.var_4859);
            ...
            {
               _loc15_.method_208(class_165.var_6521 + _loc16_ + class_181.var_6887);
            }
         ...
         if(!this.var_2392)
         {
            this.var_2392 = new class_24(class_102.var_4850,class_183.var_7129);
            this.var_2392.x = class_146.var_6117;
            this.var_2392.method_216(new class_245(class_243.const_642,class_165.var_6534));
         }
         this.var_2392.clear();
         var _loc5_:int = class_183.var_7129;
         while(_loc5_ < param1.var_2454.length)
         {
            if(_loc5_ != class_183.var_7129 && _loc5_ % class_121.var_5495 == class_183.var_7129)
            {
         ...
         if(!this.var_2387)
         {
            this.var_2387 = new class_24(this.var_2375.name_5,class_121.var_5493);
            ...
            _loc20_.method_216(new class_245(class_243.const_639,class_146.var_6117));
            _loc21_ = new class_220(class_26.method_1668(class_16.var_3296),class_183.var_7129,class_33.var_3675,class_621.var_7362,true);
            _loc20_.method_136(_loc21_);
            _loc21_.y += class_33.var_3679;
            this.var_2390 = new class_244(_loc20_.name_5 * class_165.var_6534 / class_117.var_5287,class_33.var_3675);
            this.var_2390.method_951(class_175.method_118(class_170.var_6655,true));
            this.var_2390.method_941(class_26.method_1668(class_121.var_5412),false);
            this.var_2390.var_1226.addEventListener(Event.CHANGE,this.method_1686);
            _loc20_.method_221(_loc20_.name_5 - _loc20_.method_217() - this.var_2390.name_5 - class_9.var_3259);
         ...
         while(_loc7_ < _loc8_)
         {
            ...
            _loc23_ = int(_loc22_);
            _loc24_ = class_26.method_1903(true,class_89.var_4303 + _loc23_).replace(_loc6_,class_9.var_3268);
            _loc25_ = class_26.method_1903(false,class_89.var_4303 + _loc23_).replace(_loc6_,class_9.var_3268);
            this.var_2393.push(new Array(_loc22_,_loc24_,_loc25_));
            _loc7_++;
         }
         this.var_2390.var_1226.text = class_9.var_3268;
         this.var_2390.visible = this.var_773;
         this.method_1686();
         this.var_2375.method_136(this.var_2387);
         var _loc9_:class_11 = new class_11(new class_133(class_183.var_7129,param1.var_609)).method_137();
         var _loc10_:MovieClip = _loc9_.method_118();
         _loc10_.gotoAndStop(class_33.var_3679);
         _loc10_.scaleX = class_124.var_5624;
         ...
         this.var_1148.y = class_102.var_4822;
         ...
         if(this.var_2394.var_2739)
         {
            ...
            this.var_2394.y = (-this.var_2394.var_206 + var_206) / class_165.var_6534 + class_170.var_6731;
         }
      }
      ...
      public function method_1677() : void
      {
         if(this.var_2386)
         {
            this.var_2386.htmlText = class_117.var_5225 + class_26.method_1668(class_183.var_6981) + class_127.var_5728 + class_26.method_1903(this.var_371 == class_306.var_7229,class_89.var_4303 + this.var_2385) + class_62.var_4000;
         }
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:String = class_124.var_5523;
         if(param1.text.indexOf(_loc2_) == class_183.var_7129)
         {
            _loc3_ = int(param1.text.substr(_loc2_.length));
            class_1.var_2884.method_77(class_162.var_6186 + class_124.var_5647 + _loc3_);
         }
      }
      ...
      public function method_1679(param1:class_658) : void
      {
         ...
         this.var_2376.htmlText = class_9.var_3214 + _loc3_.toString(class_16.var_3467) + class_33.var_3677 + class_231.method_2798(param1.var_363,true,this.var_2376.method_867()) + class_162.var_6345;
         ...
         if(this.var_2376.textWidth > this.var_2376.width - class_121.var_5495)
         {
            ...
            {
               _loc4_++;
               if(_loc4_ % class_165.var_6534 == class_183.var_7129 && !this.var_773)
               {
                  ++this.var_2376.y;
               }
               this.var_2376.method_865(this.var_2376.method_867() - class_33.var_3679);
            }
            this.var_2376.htmlText = class_9.var_3214 + _loc3_.toString(class_16.var_3467) + class_33.var_3677 + class_231.method_2798(param1.var_363,true,this.var_2376.method_867()) + class_162.var_6345;
         }
         this.var_2374.clear();
         ...
         if(class_183.var_7129 < param1.var_2448.length)
         {
            ...
            this.var_2378.htmlText = class_117.var_5225 + class_26.method_1668(class_33.var_3530) + class_9.var_3096 + class_231.method_2796(param1.var_2448) + class_62.var_4120;
            if(this.var_2378.width > this.var_2381.x - class_170.var_6731)
            {
               this.var_2378.width = -class_170.var_6731 + this.var_2381.x;
         ...
         this.var_2379.htmlText = class_26.method_1668(class_89.var_4278,class_62.var_4121 + (_loc6_ < class_146.var_6117 ? class_124.var_5665 + _loc6_ : _loc6_) + class_16.var_3431 + (_loc7_ < class_146.var_6117 ? class_124.var_5665 + _loc7_ : _loc7_) + class_16.var_3431 + _loc5_.fullYearUTC + class_62.var_4120);
         this.var_2374.method_221(-class_9.var_3267);
         ...
         if(class_183.var_7129 < param1.var_1941.length)
         {
            ...
            this.var_2380.height = class_33.var_3675;
            this.var_2380.width = class_183.var_7129;
            this.var_2380.htmlText = class_26.method_1668(class_33.var_3597) + class_165.var_6376 + param1.var_1941 + class_181.var_6887;
         ...
         this.var_2374.method_241(this.var_2374.name_5,this.var_2374.method_217(false));
         if(param1.var_2445 != class_183.var_7129)
         {
            this.var_2381.addChild(new class_250(class_162.var_6274 + param1.var_2445 % class_181.var_6922 + class_16.var_3431 + param1.var_2445 + class_117.var_5274,class_165.var_6506,class_165.var_6506));
         }
      ...
      public function method_1680(param1:class_671) : void
      {
         ...
         while(_loc3_ < param1.var_2449.length)
         {
            ...
            {
               _loc2_ += class_107.var_5071;
            }
            _loc2_ += class_9.var_3124 + class_26.method_1668(class_9.var_3208 + param1.var_2449[_loc3_]) + class_62.var_4001 + param1.var_2449[_loc3_ + class_33.var_3679] + class_124.var_5627;
            _loc3_ += class_165.var_6534;
         }
      ...
      public function method_1681() : void
      {
         ...
         {
            this.var_2377.htmlText = class_117.var_5225 + class_26.method_1668(class_121.var_5329) + class_9.var_3095;
            if(this.var_371 == class_33.var_3679)
            {
               this.var_2377.htmlText += class_170.var_6572 + class_26.method_1668(class_107.var_4896) + class_89.var_4277;
            }
            else if(class_165.var_6534 == this.var_371)
            {
               this.var_2377.htmlText += class_102.var_4734 + class_26.method_1668(class_183.var_6982) + class_107.var_4940;
            }
         }
         else
         {
      ...
      public function method_1682(param1:class_386) : void
      {
         ...
         else if(GestionnaireDonneesUtilisateurVieux.getInstance()[class_170.var_6571] != _loc2_)
         {
      ...
      public function method_1686(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               _loc5_ = _loc6_[class_33.var_3679].toLowerCase() + class_89.var_4384 + _loc6_[class_165.var_6534].toLowerCase();
               if(_loc5_.indexOf(_loc2_) != -class_33.var_3679)
               {
                  _loc3_.push(_loc6_);
               }
            }
         ...
         if(_loc3_.length > class_183.var_7129)
         {
            ...
            while(_loc7_ < _loc8_)
            {
               _loc9_ = _loc3_[_loc7_][class_183.var_7129];
               _loc10_ = int(_loc9_);
               _loc11_ = Math.round(class_146.var_6117 * (_loc9_ - _loc10_));
               ...
               if(this.var_773)
               {
                  _loc4_ += class_146.var_5964 + _loc10_ + class_33.var_3677 + class_81.method_2123(_loc10_,_loc11_,this.var_371) + class_102.var_4702;
               }
               else
               {
                  _loc4_ += class_127.var_5726 + class_81.method_2123(_loc10_,_loc11_,this.var_371) + class_33.var_3528;
               }
               _loc7_++;
            }
            _loc4_ += class_62.var_4120;
         }
