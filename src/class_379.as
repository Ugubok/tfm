package
{
   ...
   public class class_379
   {
      ...
      public function class_379(param1:String, param2:String)
      {
         ...
         if(_loc3_ && _loc3_.length >= class_165.var_6534)
         {
            this.var_1695 = int(_loc3_[class_33.var_3679]);
            if(class_183.var_7129 < this.var_1695)
            {
               this.var_1696 = class_99.var_4681;
               this.var_1697 = this.var_1693.substr(-class_121.var_5495 + this.var_1693.length).toLowerCase() == class_4.var_2916;
            }
         }
      }
      ...
      public function method_1238(param1:int, param2:int) : class_24
      {
         ...
         _loc4_ = new class_24(_loc3_.name_5 - class_146.var_6117);
         _loc4_.method_227(class_243.const_642,class_117.var_5287);
         _loc4_.mouseChildren = class_99.var_4681;
         _loc3_.method_136(_loc4_);
         _loc4_.x += class_117.var_5287;
         _loc4_.y += class_117.var_5287;
         if(this.var_1694.indexOf(class_60.var_3842) == class_183.var_7129)
         {
            _loc6_ = this.var_1694.match(new RegExp(class_107.var_4899));
            if(_loc6_)
            {
               _loc10_ = _loc6_[class_33.var_3679];
               if(_loc10_)
               {
            ...
            _loc8_ = this.var_1694.match(new RegExp(class_33.var_3532));
            if(_loc8_)
            {
               this.var_1699 = _loc8_[class_33.var_3679];
            }
            _loc9_ = this.var_1694.match(new RegExp(class_9.var_3097,class_181.var_6928));
            if(_loc9_)
            {
         ...
         else
         {
            ...
            _loc6_ = _loc12_.match(new RegExp(class_170.var_6575));
            if(_loc6_)
            {
               _loc10_ = _loc6_[class_33.var_3679];
               if(_loc10_)
         ...
         if(this.var_1471)
         {
            _loc14_ = new class_220(this.var_1471,_loc4_.name_5,class_183.var_7129);
            _loc14_.method_865(class_33.var_3675);
            _loc14_.method_860();
         ...
         if(this.var_1699)
         {
            ...
            _loc15_.method_865(class_162.var_6346);
         ...
         if(this.var_1700)
         {
            _loc16_ = new class_220(class_9.var_3268,_loc4_.name_5,class_183.var_7129);
            _loc16_.method_866();
         ...
         if(param2 % class_165.var_6534 == class_183.var_7129)
         {
            _loc5_.graphics.beginFill(16777215,class_89.var_4430);
         }
         else
         {
            _loc5_.graphics.beginFill(class_183.var_7129,class_107.var_5060);
         }
         _loc5_.graphics.drawRoundRect(class_183.var_7129,class_183.var_7129,_loc3_.name_5,_loc3_.var_206,class_146.var_6117,class_146.var_6117);
