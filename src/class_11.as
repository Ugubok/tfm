package
{
   ...
   public class class_11 extends class_10
   {
      ...
      public function class_11(param1:class_133 = null)
      {
         ...
         super(!!param1 ? param1 : new class_133(class_183.var_7129,class_9.var_3268));
      ...
      public function method_121() : int
      {
         ...
         while(_loc2_ < _loc3_)
         {
            ...
            _loc1_ = class_92.var_4647 * _loc1_ + (!!_loc4_ ? _loc4_.var_1023 : class_183.var_7129);
            _loc2_++;
         }
      ...
      public function method_122(param1:Boolean = true, param2:Boolean = false, param3:Boolean = false, param4:Boolean = false) : String
      {
         ...
         var _loc15_:int = 0;
         var _loc5_:String = class_9.var_3268;
         ...
         while(_loc7_ < _loc8_)
         {
            ...
            {
               _loc5_ += class_107.var_5062;
            }
            _loc13_ = _loc6_[_loc7_];
            _loc14_ = this.var_168[_loc13_] as class_199;
            _loc5_ += String(!!_loc14_ ? _loc14_.var_1023 : class_183.var_7129);
            if(_loc14_ && (_loc14_.var_162 as class_200).var_1029 > class_183.var_7129 && _loc14_.var_1026)
            {
               _loc5_ += class_33.var_3659 + _loc14_.var_790[class_183.var_7129].toString(class_16.var_3467);
               _loc15_ = class_33.var_3679;
               while(_loc15_ < (_loc14_.var_162 as class_200).var_1029)
               {
                  _loc5_ += class_16.var_3394 + _loc14_.var_790[_loc15_].toString(class_16.var_3467);
                  _loc15_++;
               }
            }
            _loc7_++;
         ...
         var _loc10_:String = this.method_129().toString(class_16.var_3467);
         var _loc11_:String = this.method_139().toString(class_16.var_3467);
         if(param3)
         {
            _loc12_ = _loc9_ + class_121.var_5459 + _loc5_ + class_121.var_5459 + _loc10_ + class_121.var_5459 + _loc11_;
         }
         else if(param2)
         {
            _loc12_ = _loc9_ + class_121.var_5459 + _loc5_ + class_121.var_5459 + _loc10_;
         }
         else if(param1)
         {
            _loc12_ = _loc9_ + class_121.var_5459 + _loc5_;
         }
         else
         {
            _loc12_ = _loc5_;
      ...
      override public function method_118() : MovieClip
      {
         ...
         return class_21.method_1890(class_33.var_3679,this.method_120(),class_150.const_550,class_181.var_6915,this.method_122(false),new <int>[this.method_129(),this.var_170]);
      }
      ...
      public function method_125(param1:*) : void
      {
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            {
               this.var_166.splice(_loc3_,class_33.var_3679);
               _loc2_ = _loc5_;
               break;
            }
            _loc3_++;
      ...
      public function method_129() : int
      {
         if(this.couleur)
         {
            if(this.couleur.var_1023 >= class_183.var_7129 && this.couleur.var_1023 <= class_11.const_54.length - class_33.var_3679)
            {
      ...
      public function method_130() : Vector.<class_199>
      {
         ...
         while(_loc2_ < _loc3_)
         {
            if(!(this.var_166[_loc2_].var_1024 == class_34.name_57 && this.var_166[_loc2_].var_1023 == class_33.var_3679))
            {
      ...
      public function method_131(param1:class_199) : void
      {
         ...
         if(class_34.const_125.indexOf(param1.var_1024) != -class_33.var_3679)
         {
         ...
         this.var_166.splice(_loc2_,class_33.var_3679);
      ...
      {
         return !!var_162 ? class_175.method_2618(class_117.var_5129 + (var_162 as class_133).var_722 + class_117.var_5274) : null;
      }
      ...
      public function clear() : void
      {
         ...
         {
            this.method_131(this.var_166[this.var_166.length - class_33.var_3679]);
         }
         this.var_167 = new Dictionary();
      ...
      {
         return this.var_166.length == class_183.var_7129;
      }
      ...
      public function method_136(param1:class_199) : class_11
      {
         ...
         else if(param1.var_1024 == class_34.const_122 || param1.var_1024 == class_34.name_57)
         {
            ...
            {
               if(class_183.var_7129 > param1.var_1023)
               {
                  return this;
               }
               this.couleur = param1;
      ...
      public function method_137(param1:Dictionary = null, param2:Boolean = true, param3:Boolean = true, param4:Boolean = false) : class_11
      {
         ...
         if(class_165.var_6534 > _loc6_.length)
         {
            return this;
         }
         ...
         var _loc8_:Array = _loc6_[class_33.var_3679].split(class_107.var_5062);
         ...
         while(_loc10_ < _loc11_)
         {
            ...
            _loc13_ = _loc8_[_loc12_] && _loc8_[_loc12_] != class_124.var_5665 ? _loc8_[_loc12_] : null;
            if(_loc13_ !== null)
            {
               _loc15_ = new Vector.<int>();
               if(class_34.const_123.indexOf(_loc12_) != -class_33.var_3679 && _loc13_.indexOf(class_33.var_3659) != -class_33.var_3679)
               {
                  ...
                  {
                     _loc15_.push(int(class_181.var_6914 + _loc18_[_loc19_]));
                     _loc19_++;
                  }
               }
               else
         ...
         if(_loc6_.length > class_146.var_6118 && param3)
         {
            _loc23_ = parseInt(_loc6_[class_146.var_6118],class_16.var_3467);
      ...
      public function method_138(param1:int, param2:int) : class_11
      {
         if(class_34.const_122 == param1)
         {
            ...
            if(class_11.const_54.indexOf(param2) != -class_33.var_3679)
            {
