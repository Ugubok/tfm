package
{
   ...
   public class class_894 implements class_474, class_733
   {
      ...
      public var var_2822:class_788;
      
      public function class_894(param1:class_484)
      {
         super();
         this.name_10 = param1;
      }
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is class_788)
            {
               this.var_2822 = class_788(_loc2_);
               this.var_2822.var_2653 = this;
            }
         }
      }
