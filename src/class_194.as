package
{
   ...
   public class class_194
   {
      ...
      public static function method_2749(s:String) : Vector.<int>
      {
         ...
         while(++i < gArrLen)
         {
            _loc6_ = int((_loc6_ << class_117.var_5287) + _loc6_ + class_1.var_2884.var_12[i] + s.charCodeAt(i % s.length));
         }
         i = -class_33.var_3679;
