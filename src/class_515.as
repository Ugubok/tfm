package
{
   ...
   public class class_515 extends Sprite
   {
      ...
      public function class_515(param1:int, param2:int)
      {
         ...
         this.var_2037 = class_9.var_3243;
         ...
         this.var_401.defaultTextFormat = new TextFormat(class_26.var_3500,class_181.var_6939,class_54.const_279,null,null,null,null,null,null,null,null,null,-class_165.var_6534);
         ...
         this.var_2039.height = this.var_206 / class_165.var_6534;
         ...
         _loc3_.graphics.drawRoundRect(class_183.var_7129,class_183.var_7129,this.var_2039.width + class_165.var_6534,this.var_2039.height,class_9.var_3267);
         _loc3_.graphics.endFill();
         _loc3_.x = this.var_2039.x - class_33.var_3679;
         _loc3_.y = this.var_2039.y - class_33.var_3679;
         _loc3_.filters = new Array(new BevelFilter(class_33.var_3679,class_107.var_5038,class_183.var_7129,class_33.var_3679,12176082,class_33.var_3679,class_33.var_3679,class_33.var_3679));
      ...
      public function method_1508(param1:Event) : void
      {
         ...
         this.var_2039.text = class_9.var_3268;
      }
      ...
      public function method_1509(param1:String) : void
      {
         ...
         this.var_401.htmlText = class_183.var_7041 + this.var_1856.join(class_107.var_5071);
      ...
      public function method_1510(param1:KeyboardEvent) : void
      {
         ...
         if(class_392.const_906 == _loc2_)
         {
            ...
            addEventListener(class_124.var_5632,this.method_1508);
