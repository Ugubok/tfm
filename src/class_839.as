package
{
   ...
   public class class_839
   {
      ...
      public static function method_3087(param1:int, param2:int, param3:int, param4:String, param5:String) : class_315
      {
         ...
         var _loc6_:* = class_73.method_2108(class_33.var_3679) == param2;
         var _loc7_:int = class_176.method_2643(param3)[class_73.method_2108(class_183.var_7129)];
         var _loc8_:int = class_176.method_2643(param3)[class_73.method_2108(class_33.var_3679)];
         ...
         var _loc11_:int = class_73.method_2108(class_183.var_7093);
         ...
         _loc9_.x = (_loc13_.name_5 - _loc9_.width) / class_73.method_2108(class_165.var_6534) - _loc14_.x * _loc12_;
         _loc9_.y -= _loc14_.y * _loc12_;
         _loc13_.method_1100(class_26.method_1668(class_73.method_2111(class_165.var_6480)),class_39.var_3744.method_313,class_191.method_2732(param1,true));
         ...
         _loc13_.method_967(class_183.var_7129,class_33.var_3675,class_107.var_5074,class_73.method_2108(class_183.var_7096));
         return _loc13_;
      }
      ...
      public static function method_3088(param1:String, param2:int, param3:Boolean, param4:Boolean, param5:String) : class_315
      {
         ...
         var _loc7_:int = class_176.method_2643(param2)[class_73.method_2108(class_33.var_3679)];
         _loc8_ = class_198(!!param3 ? new class_349(new class_363(_loc6_,_loc7_)) : new class_199(new class_201(_loc6_,_loc7_))).method_118();
         var _loc9_:int = class_73.method_2108(class_107.var_5038);
         var _loc10_:int = class_73.method_2108(class_183.var_7093);
         ...
         _loc12_.method_1100(class_26.method_1668(class_73.method_2111(class_165.var_6480)),class_39.var_3744.method_313,class_191.method_2735(param1,param2,param3,param4,true));
         _loc12_.method_1107(class_26.method_1668(class_73.method_2111(class_117.var_5241)),class_39.var_3744.method_313,class_191.method_2735(param1,param2,param3,param4,false));
