package
{
   public class class_471 extends class_5
   {
      ...
      {
         super(class_73.method_2108(class_165.var_6490),class_33.var_3679);
      ...
      public function method_1372(param1:Object) : void
      {
         ...
         {
            var_159.writeByte(class_73.method_2108(class_33.var_3679));
         ...
         else if(param1 is int)
         {
            ...
            if(class_73.method_2108(class_183.var_7129) > _loc2_)
            {
               if(-_loc2_ <= 127)
               {
                  var_159.writeByte(class_73.method_2108(class_165.var_6534));
                  var_159.writeByte(_loc2_);
               }
               else if(-_loc2_ <= 32767)
               {
                  var_159.writeByte(class_73.method_2108(class_121.var_5495));
                  var_159.writeShort(_loc2_);
               }
               else
               {
                  var_159.writeByte(class_73.method_2108(class_9.var_3267));
            ...
            {
               var_159.writeByte(class_73.method_2108(class_117.var_5287));
               var_159.writeShort(_loc2_);
            }
            else
            {
         ...
         else if(param1 is uint)
         {
            ...
            if(255 >= _loc2_)
            {
               var_159.writeByte(class_73.method_2108(class_146.var_6118));
               var_159.writeByte(_loc2_);
            }
            ...
            {
               var_159.writeByte(class_73.method_2108(class_92.var_4647));
               var_159.writeDouble(_loc2_);
            }
         }
         else if(param1 is Number)
         {
            var_159.writeByte(class_73.method_2108(class_170.var_6731));
            var_159.writeDouble(param1 as Number);
         }
         else if(param1 is Array)
         {
            var_159.writeByte(class_73.method_2108(class_102.var_4852));
