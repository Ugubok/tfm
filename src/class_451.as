package
{
   public class class_451 extends class_24
   {
      ...
      {
         super(class_124.var_5662,class_181.var_6799);
         ...
         this.var_1903.method_216(new class_245(class_243.const_642,class_117.var_5287));
      ...
      public static function name_6(param1:class_303) : void
      {
         ...
         class_451.var_2884.x = int((-class_451.var_2884.name_5 + class_107.var_5074) / class_165.var_6534);
      ...
      public function name_9(param1:class_303) : void
      {
         ...
         while(var_7436 < var_7502)
         {
            ...
            var_2765.visible = class_165.var_6534 == var_1734;
            ...
            var_7585 = new class_220(var_7582,class_181.var_6913,var_1492.var_206);
            ...
            else if(class_165.var_6534 == var_1734)
            {
            ...
            else if(var_1734 == class_165.var_6534)
            {
            ...
            var_7588 = new class_220(var_7584 + class_89.var_4376,class_181.var_6913,var_1492.var_206);
         ...
         var_7578 = new class_244(class_121.var_5493).method_941(class_121.var_5325);
         var_7579 = new class_244(class_121.var_5493).method_941(class_92.var_4492);
         var_7580 = new class_244(class_121.var_5493).method_941(class_165.var_6372);
         ...
         var var_7570:class_246 = new class_246(class_165.var_6371,class_9.var_3243,var_1520);
