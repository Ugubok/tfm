package
{
   ...
   public class class_26
   {
      ...
      public static const const_104:RegExp = new RegExp("[-\\/\\\\^$*+?.()|[\\]{}]","g");
      
      public static const const_105:RegExp = /\$(\{[^(){}[\]<>$\s,]+\}|[^(){}[\]<>$\s,]+)/g;
      
      public static const const_106:RegExp = new RegExp("\\{|\\}|\\$|trad#","g");
      
      public static const const_107:RegExp = new RegExp("\\((.*?)\\|(.*?)\\)","g");
      
      public static const const_108:RegExp = new RegExp("%\\d+","g");
      
      public static const const_109:Array = new Array();
      
      public static var var_3496:String = "xx";
      
      public static var var_3497:Boolean = false;
      
      public static var var_3498:String = "<p align=\'right\'>";
      ...
      {
         return param1.indexOf(class_89.var_4384) != -class_33.var_3679 ? param1.replace(class_26.const_107,!!param2 ? class_181.var_6855 : class_102.var_4760) : param1;
      }
      ...
      public static function method_1899(param1:class_251, param2:int, param3:String, ... rest) : String
      {
         ...
         var var_7474:String = name_74.var_1261 + class_33.var_3659 + var_7471 + class_33.var_3659 + var_7472;
         ...
         if(var_7472.lastIndexOf(class_9.var_3256) == class_183.var_7129 && var_7472.indexOf(class_124.var_5647) == -class_33.var_3679 && var_7472.indexOf(class_107.var_5071) == -class_33.var_3679)
         {
            var_1100 = name_74.var_1262[var_7472.substr(class_33.var_3679)];
            if(!var_1100)
            {
               var_1100 = var_7472;
            }
            ...
            {
               var_1100 = var_1100.split(class_89.var_4376 + (class_33.var_3679 + var_7436)).join(var_7473[var_7436]);
            }
            var_7472 = var_1100;
         }
         else
         {
            ...
            if(var_7477 && var_7477.length > class_183.var_7129)
            {
               var_7436 = -class_33.var_3679;
               ...
               while(++var_7436 < var_731)
               {
                  try
                  {
                     ...
                     if(var_7480 && var_7481)
                     {
                        ...
                        {
                           var_1100 = var_1100.split(class_89.var_4376 + (var_7482 + class_33.var_3679)).join(var_7473[var_7482]);
                           var_7482++;
                        }
                        var_7473.splice(class_183.var_7129,var_7480);
                     }
                     if(var_7475)
                     {
            ...
            if(var_7480 && var_7481)
            {
               ...
               while(var_7482 < var_7480 && var_7482 < var_7481)
               {
                  var_7472 = var_7472.split(class_89.var_4376 + (var_7482 + class_33.var_3679)).join(var_7473[var_7482]);
                  var_7482++;
               }
               var_7473.splice(class_183.var_7129,var_7480);
            }
      ...
      public static function method_1902(param1:Boolean) : void
      {
         if(!class_26.var_3508)
         {
            ...
            class_26.var_3508.graphics.beginFill(class_183.var_7129,class_92.var_4648);
            class_26.var_3508.graphics.drawRect(class_183.var_7129,class_183.var_7129,class_107.var_5074,class_60.var_3979);
         ...
         if(param1)
         {
            if(class_61.name_62)
            {
               class_1.var_2884.stage.addChildAt(class_26.var_3508,class_1.var_2884.stage.numChildren - class_33.var_3679);
            }
            else
            {
      ...
      {
         return class_26.method_1899.apply(null,new Array(class_26.var_3499,!!param1 ? class_165.var_6534 : class_33.var_3679,param2).concat(rest));
      }
      
      public static function method_1904() : void
      {
         if(class_26.var_3507.length == class_183.var_7129)
         {
         ...
         if(class_1.const_45)
         {
            class_26.var_3505.load(new URLRequest((!!class_1.var_2873 ? class_33.var_3664 : class_162.var_6250) + class_124.var_5564 + _loc2_ + class_92.var_4554 + _loc1_));
         }
         else
         {
            class_26.var_3505.load(new URLRequest((!!class_1.var_2873 ? class_33.var_3664 : class_162.var_6250) + class_62.var_4055 + _loc2_ + class_92.var_4554 + _loc1_));
         }
      }
      ...
      public static function method_1905(param1:String, param2:Boolean = false, param3:Boolean = true, param4:String = "") : void
      {
         ...
         class_1.var_2878.method_155(class_33.var_3580 + param1);
         if(class_26.name_9)
         {
         ...
         else
         {
            ...
            class_1.var_2884.var_26[class_33.var_3579] = class_99.var_4682;
         }
         if(param4)
         {
      ...
      public static function method_1906(param1:Event) : void
      {
         ...
         _loc3_.uncompress(class_60.var_3885);
         ...
         if(class_26.var_3506[class_33.var_3679])
         {
            if(class_26.var_3506[class_165.var_6534] !== undefined)
            {
      ...
      {
         return class_26.method_1899.apply(null,new Array(class_26.var_3499,class_183.var_7129,param1).concat(rest));
      }
      
      public static function method_1907(param1:class_251) : void
      {
         class_26.var_3499 = param1;
         if(class_1.var_2884.var_158 < class_183.var_7129)
         {
