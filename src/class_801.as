package
{
   ...
   public class class_801
   {
      ...
      public function method_118(param1:int, param2:int) : class_24
      {
         ...
         if(!this.var_1519)
         {
            this.var_1519 = new class_24(param1,param2 + class_73.method_2108(class_9.var_3267));
            this.var_1519.method_216(new class_245(class_243.const_642,class_9.var_3267));
            _loc3_ = new class_24(this.var_1519.name_5,this.var_1519.var_206 - class_73.method_2108(class_9.var_3267));
            _loc3_.method_216(new class_245(class_243.const_642,class_73.method_2108(class_9.var_3267)));
            this.var_1519.addChild(_loc3_);
            _loc3_.x = class_73.method_2108(class_183.var_7129);
            ...
            _loc3_.graphics.drawRoundRect(class_183.var_7129,class_73.method_2108(class_183.var_7129),_loc3_.name_5,_loc3_.var_206,class_165.var_6534);
            _loc3_.graphics.endFill();
            _loc4_ = new class_24(this.var_1519.name_5,class_73.method_2108(class_162.var_6351));
            ...
            _loc5_.x = class_73.method_2116(class_92.var_4648);
            ...
            _loc8_ = new class_220(String(this.var_2546),class_801.const_1325 + class_73.method_2108(class_165.var_6534) * class_801.const_1326,class_73.method_2108(class_33.var_3675));
            _loc8_.method_856(TextFormatAlign.CENTER);
            _loc8_.method_864(class_1.var_2878.var_180.var_1091);
            _loc8_.method_860();
            _loc8_.method_865(this.var_2546 >= class_121.var_5493 ? int(class_73.method_2108(class_181.var_6939)) : int(class_73.method_2108(class_16.var_3467)));
            _loc7_.addChild(_loc8_);
            _loc8_.x = _loc5_.name_5 - _loc8_.width + class_92.var_4648 + class_801.const_1326;
            _loc8_.y = (_loc5_.var_206 - _loc8_.height) / class_73.method_2108(class_165.var_6534) - class_73.method_2108(class_33.var_3679);
            _loc9_ = class_742.method_3078(this.var_2676);
            _loc10_ = new class_220(_loc9_,class_73.method_2108(class_183.var_7129),_loc4_.var_206 - _loc7_.var_206 - _loc4_.method_220());
            _loc10_.method_865(class_146.var_6117);
            _loc11_ = new GlowFilter(class_73.method_2108(class_183.var_7129),class_73.method_2116(class_121.var_5450),class_9.var_3217,class_9.var_3217,class_146.var_6117,BitmapFilterQuality.LOW);
            _loc10_.filters = new Array(_loc11_);
            _loc4_.method_136(_loc7_,_loc10_);
            _loc10_.y -= class_165.var_6534;
            _loc12_ = new class_24(this.var_1519.name_5,class_73.method_2108(class_117.var_5265));
            ...
            for each(_loc15_ in this.var_2678)
            {
               ...
               _loc28_.x += (-_loc28_.var_242 + _loc28_.name_5) / class_73.method_2108(class_165.var_6534);
               _loc28_.y = (-_loc28_.var_206 + _loc12_.var_206) / class_165.var_6534;
            }
            _loc3_.method_136(_loc12_);
            _loc16_ = new class_24(this.var_1519.name_5,class_73.method_2108(class_89.var_4436));
            _loc16_.method_216(new class_245(class_243.const_642,class_183.var_7129));
            _loc17_ = class_73.method_2108(class_117.var_5287);
            _loc16_.graphics.beginFill(class_73.method_2108(class_183.var_7129),class_9.var_3254);
            _loc16_.graphics.drawRoundRect(_loc17_,class_73.method_2108(class_183.var_7129),_loc16_.name_5 - class_165.var_6534 * _loc17_,_loc16_.var_206,class_117.var_5287);
            _loc16_.graphics.endFill();
            _loc18_ = this.var_2679.length;
            _loc19_ = _loc18_ > class_165.var_6534 ? int(class_165.var_6534) : int(class_73.method_2108(class_33.var_3679));
            _loc20_ = _loc18_ > class_121.var_5495 ? int(class_146.var_6118) : int(class_73.method_2108(class_165.var_6534));
            _loc21_ = class_73.method_2108(class_107.var_5038);
            _loc22_ = (_loc16_.name_5 - _loc20_ * _loc21_) / (class_33.var_3679 + _loc20_);
            _loc23_ = new <int>[class_183.var_7129,class_73.method_2108(class_183.var_7129),class_183.var_7129];
            _loc24_ = class_73.method_2108(class_183.var_7129);
            ...
            while(_loc24_ < _loc18_)
            {
               ...
               if(class_73.method_2108(class_183.var_7129) == _loc29_)
               {
                  if(_loc26_)
                  {
            ...
            if(class_183.var_7129 < _loc18_)
            {
               ...
               {
                  _loc26_.method_241(_loc26_.var_242,_loc26_.var_206);
                  if(class_73.method_2108(class_165.var_6534) == _loc19_)
                  {
                     _loc26_.x = _loc27_;
                  }
                  else
            ...
            if(this.var_2677)
            {
               _loc30_ = new class_250(class_165.var_6469,class_73.method_2108(class_33.var_3668),class_102.var_4826);
               _loc3_.addChild(_loc30_);
               _loc30_.x = _loc3_.name_5 - _loc30_.name_5 + class_146.var_6117;
               _loc30_.y = _loc3_.var_206 - _loc30_.var_206 + class_73.method_2108(class_170.var_6731);
            }
         }
