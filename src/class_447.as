package
{
   ...
   public class class_447 extends class_24
   {
      ...
      public static function method_3027(param1:String) : *
      {
         ...
         class_447.var_7306 = new class_24(class_89.var_4432,class_183.var_7129).method_216(new class_245(class_243.const_642,class_117.var_5287));
         class_447.var_7306.method_239(class_26.method_1668(class_4.var_2977));
         _loc2_ = new class_220(class_26.method_1668(class_124.var_5570,class_1.var_2878.var_179),class_447.var_7306.name_5,class_183.var_7129);
         ...
         _loc3_ = new class_220(class_9.var_3268,class_447.var_7306.name_5,class_183.var_7129);
         _loc3_.method_866();
         _loc3_.method_864(class_54.const_291);
         _loc3_.htmlText = class_26.method_1668(class_162.var_6266,class_1.var_2878.var_179,class_89.var_4348 + class_111.var_363 + class_117.var_5188);
         ...
         class_447.var_1539 = new class_220(class_9.var_3268,class_447.var_7306.name_5,class_102.var_4859);
         ...
         class_447.var_725 = new class_246(class_26.method_1668(class_107.var_5045),class_447.var_7306.name_5,class_447.method_3028);
         class_447.var_7306.method_136(class_447.var_725);
         class_115.method_388(class_447.var_7306,class_33.var_3679);
         class_447.var_7306.method_196(class_92.var_4648,class_92.var_4648);
         ...
         _loc7_.graphics.drawRect(-class_447.var_7306.x,-class_447.var_7306.y,class_117.var_5288,class_117.var_5288);
      ...
      public static function method_1122(param1:Event = null) : Boolean
      {
         ...
         if(param1 == null || param1.currentTarget == class_447.var_1533.var_1226 || param1.currentTarget == class_447.var_1534.var_1226)
         {
            ...
            {
               class_447.method_1121(class_26.method_1668(class_117.var_5215));
               return false;
            }
         }
         if(param1 == null || param1.currentTarget == class_447.var_1534.var_1226)
         {
            if(_loc3_ != _loc4_)
            {
               class_447.method_1121(class_26.method_1668(class_170.var_6670));
               return false;
            }
         }
         if(class_447.var_7307)
         {
            if(param1 == null || param1.currentTarget == class_447.var_1535.var_1226)
            {
               if(class_1.var_2871)
               {
                  ...
                  if(_loc6_.indexOf(class_146.var_6071) == -class_33.var_3679 || _loc6_.length < class_121.var_5495)
                  {
                     class_447.method_1121(class_26.method_1668(class_124.var_5591));
                     return false;
                  }
      ...
      public static function method_3029(param1:String) : *
      {
         ...
         class_447.var_7305 = new class_24(class_124.var_5662,class_60.var_3945);
         class_447.var_7305.method_239(class_62.var_4147,class_447.method_439);
         class_447.var_7305.method_216(new class_245(class_243.const_639,class_117.var_5287));
         class_447.var_7303 = new class_24(class_447.var_7305.name_5 * class_92.var_4648 - class_117.var_5287,class_447.var_7305.var_206).method_216(new class_245(class_243.const_642,class_117.var_5287));
         class_447.var_7304 = new class_24(class_447.var_7305.name_5 * class_92.var_4648 - class_117.var_5287,class_447.var_7305.var_206).method_216(new class_245(class_243.const_642,class_117.var_5287));
         var _loc2_:class_250 = new class_250(class_146.var_6024);
         ...
         var _loc4_:class_220 = new class_220(class_26.method_1668(class_121.var_5399,class_1.var_2878.var_179),class_447.var_7304.name_5,class_183.var_7129);
         ...
         var _loc6_:class_246 = new class_246(class_26.method_1668(class_4.var_2991),class_447.var_7304.name_5,class_447.method_439);
         ...
         class_447.var_7305.x = int((-class_447.var_7305.name_5 + class_107.var_5074) / class_165.var_6534);
         class_447.var_7305.y = class_9.var_3243;
         class_115.method_388(class_447.var_7305,class_33.var_3679);
      }
      
      public static function name_6(param1:String) : void
      {
         if(param1 == class_146.var_6023 || param1 == class_165.var_6436 || param1 == class_162.var_6265 || param1 == class_33.var_3583)
         {
            class_447.var_7307 = param1 == class_146.var_6023 || param1 == class_165.var_6436 || param1 == class_162.var_6265;
      ...
      {
         if(class_1.var_2878.var_179 == class_62.var_4147)
         {
            class_18.method_1884(class_165.var_6435);
         }
         else if(class_1.var_2878.var_179 == class_146.var_6022)
         {
            class_18.method_1884(class_127.var_5797);
         }
         else if(class_1.var_2878.var_179 != class_4.var_3008)
         {
            if(class_1.var_2878.var_179 == class_170.var_6673)
            {
            }
         }
      }
