package
{
   public class class_173 extends class_5
   {
      ...
      public function class_173(param1:int, param2:Boolean, param3:Boolean, param4:int, param5:int, param6:int, param7:int, param8:Boolean, param9:int, param10:int, param11:Number = NaN, param12:int = 0, param13:Boolean = true)
      {
         ...
         var_159.writeInt(param4);
         var_159.writeInt(param5);
         var_159.writeShort(param6);
         var_159.writeShort(param7);
         var_159.writeBoolean(param8);
         var_159.writeByte(param9);
         var_159.writeByte(param10);
         if(!isNaN(param11))
         {
            var_159.writeShort(int(param11));
            var_159.writeShort(param12);
            var_159.writeBoolean(param13);
         }
      }
   }
}
