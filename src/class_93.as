package
{
   ...
   public class class_93 extends class_66
   {
      ...
      public function class_93()
      {
         ...
         this.var_631 = new class_24(name_5,var_206 - class_16.var_3473);
         this.var_631.method_216(new class_245(class_243.const_642,class_121.var_5495));
      ...
      public static function name_6(param1:class_396) : void
      {
         ...
         class_93.var_2884.y = class_9.var_3243;
      ...
      public function method_461(param1:class_396) : void
      {
         ...
         while(++_loc4_ < _loc5_)
         {
            ...
            if(class_165.var_6534 == _loc6_.var_1734)
            {
               _loc3_.push(_loc6_);
            }
            else
         ...
         while(++_loc4_ < _loc5_)
         {
            ...
            _loc7_ = _loc6_.var_1734 == class_165.var_6534;
            _loc8_ = class_33.var_3679 == _loc6_.var_1734;
            ...
            _loc11_.graphics.drawRect(class_165.var_6534,class_165.var_6534,_loc9_.name_5 - class_121.var_5495,_loc9_.var_206 - class_121.var_5495);
            _loc11_.graphics.endFill();
            _loc11_.filters = new Array(new BevelFilter(class_33.var_3679,class_107.var_5038,16777215,class_92.var_4648,class_183.var_7129,class_33.var_3679,class_33.var_3679,class_33.var_3679));
            ...
            if(_loc6_.var_1738 == class_397.const_879 && !_loc7_)
            {
               ...
               _loc15_.x = -class_146.var_6074 + _loc9_.name_5;
               _loc15_.y = class_165.var_6534;
               _loc9_.addChild(_loc15_);
               if(_loc8_)
               {
                  _loc15_.filters = new Array(class_54.name_53);
               }
               _loc13_ = -class_102.var_4859 + _loc9_.name_5;
            }
            else
            {
            ...
            {
               _loc16_ = new class_220(class_16.var_3303 + class_26.method_1903(class_111.var_5092,class_89.var_4303 + _loc6_.var_1736) + class_107.var_4900,class_183.var_7129,class_33.var_3675).method_864(class_54.const_285).method_856(TextFormatAlign.CENTER);
               _loc16_.x = _loc12_ + int((_loc13_ - _loc16_.width) / class_165.var_6534);
               _loc16_.y = int((_loc14_ - _loc16_.height) / class_165.var_6534);
               _loc9_.addChild(_loc16_);
               _loc10_ = 31743;
            }
            else if(class_397.const_878 == _loc6_.var_1735)
            {
               _loc17_ = new class_250(class_33.var_3619 + _loc6_.var_1736 + class_89.var_4385,class_102.var_4859,class_102.var_4859);
            ...
            else if(_loc6_.var_1735 == class_397.const_879)
            {
               ...
               _loc18_.y = int((-class_102.var_4859 + _loc14_) / class_165.var_6534);
               _loc9_.addChild(_loc18_);
               _loc10_ = 65442;
            }
            else if(_loc6_.var_1735 == class_397.const_881)
            {
               _loc19_ = class_175.method_118(class_127.var_5833 + _loc6_.var_1736,true);
               _loc20_ = new class_23(class_102.var_4859,class_102.var_4859);
               _loc20_.method_213(_loc19_,true);
               _loc20_.x = _loc12_ + int((-_loc20_.name_5 + _loc13_) / class_165.var_6534);
               _loc20_.y = int((_loc14_ - _loc20_.height) / class_165.var_6534);
            ...
            else if(class_397.const_1047 == _loc6_.var_1735)
            {
               ...
               _loc22_.method_213(class_21.method_1891(_loc21_[class_183.var_7129],_loc21_[class_33.var_3679]),true);
      ...
      {
         var _loc3_:int = param1.var_1734 == class_165.var_6534 ? int(class_165.var_6534) : int(class_183.var_7129);
         var _loc4_:int = param2.var_1734 == class_165.var_6534 ? int(class_165.var_6534) : int(class_183.var_7129);
         if(_loc3_ == _loc4_)
         {
