package
{
   public class class_82 extends class_24
   {
      ...
      {
         super(class_4.var_2908,class_73.method_2108(class_162.var_6327));
         ...
         this.var_597.method_216(new class_245(class_243.const_642,class_73.method_2108(class_117.var_5287)));
      ...
      public static function method_2124(param1:Boolean) : void
      {
         ...
         if(!var_7464 && class_111.var_5090 < class_117.var_5287 * class_73.method_2108(class_89.var_4436) * class_89.var_4436 * class_4.var_3058)
         {
            return;
         }
         if(!class_82.var_4251)
         {
            ...
            {
               var_7498 = new class_379(var_2406[var_7436],var_2406[var_7436 + class_73.method_2108(class_33.var_3679)]);
         ...
         if(class_82.var_4251.length)
         {
            ...
            var_7500 = class_17.var_2884.lecture(class_73.method_2111(class_146.var_5961));
            if(var_7500 != class_73.method_2111(class_121.var_5489) + var_7499.var_1695 || var_7464)
            {
               class_17.var_2884.method_173(class_73.method_2111(class_146.var_5961),class_73.method_2111(class_121.var_5489) + var_7499.var_1695);
      ...
      public static function name_6(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            class_82.var_2884.x = int((-class_82.var_2884.name_5 + class_73.method_2108(class_107.var_5074)) / class_165.var_6534);
            class_82.var_2884.y = class_73.method_2108(class_89.var_4436);
         }
      ...
      public function method_431() : void
      {
         ...
         while(_loc1_ < class_82.var_4251.length)
         {
            ...
            _loc3_ = _loc2_.method_1238(this.var_597.name_5 - class_73.method_2108(class_183.var_7127),_loc1_);
