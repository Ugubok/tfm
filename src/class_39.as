package
{
   ...
   public class class_39
   {
      ...
      public function class_39(param1:String, param2:Boolean, param3:class_5 = null)
      {
         ...
         var var_2425:String = var_7483.length > class_33.var_3679 ? var_7483[class_33.var_3679] : class_127.var_5779;
         if(var_2425.length == class_183.var_7129)
         {
            var_2425 = class_127.var_5779;
         }
         try
         {
            this.var_395 = class_1.var_2884[class_9.var_3151 + class_62.var_4047 + class_89.var_4409][class_33.var_3574 + class_92.var_4588 + class_121.var_5382 + class_107.var_4947][class_170.var_6626 + class_146.var_6009 + class_181.var_6928][class_181.var_6845 + class_62.var_4046 + class_60.var_3878 + class_89.var_4379];
      ...
      {
         class_1.var_2884.removeEventListener(class_124.var_5632,this.method_314);
      ...
      public function method_317(param1:ByteArray) : void
      {
         ...
         if(this._socket.connected)
         {
            ...
            if(_loc2_ <= 255)
            {
               this._socket.writeByte(class_33.var_3679);
               this._socket.writeByte(_loc2_);
            }
            else if(65535 >= _loc2_)
            {
               this._socket.writeByte(class_165.var_6534);
            ...
            this.var_388 = (this.var_388 + class_33.var_3679) % class_121.var_5493;
      ...
      public function method_320(param1:ProgressEvent = null, param2:Boolean = false) : void
      {
         ...
         if(!this.var_400)
         {
            while(this._socket.bytesAvailable)
            {
               ...
               this.var_398 |= (var_956 & 127) << this.var_399 * class_92.var_4647;
               ++this.var_399;
               if((var_956 & 128) == 128 && this.var_399 < class_117.var_5287)
               {
                  continue;
               }
         ...
         if(this.var_400 && this._socket.bytesAvailable >= this.var_398)
         {
            ...
            {
               if(name_85.errorID == class_183.var_7026)
               {
                  class_291.method_2853();
               }
               else if(class_291.name_40 == class_89.var_4436 && class_291.name_41 == class_33.var_3679)
               {
                  class_39.var_3744.method_313(new class_292(class_291.name_40,class_291.name_41,class_128.name_40,class_128.name_41,class_102.var_4834 + ProxyTribulle.x_infoException + class_60.var_3877 + name_85[class_146.var_6086]));
               }
               else if(class_291.name_40 == class_89.var_4436 && class_291.name_41 == class_146.var_6118)
               {
                  class_39.var_3744.method_313(new class_292(class_291.name_40,class_291.name_41,class_128.name_40,class_128.name_41,class_102.var_4834 + name_85[class_62.var_4045] + class_60.var_3877 + name_85[class_146.var_6086]));
               }
               else
               {
                  class_39.var_3744.method_313(new class_292(class_291.name_40,class_291.name_41,class_128.name_40,class_128.name_41,class_107.var_4946 + class_291.var_7204 + class_9.var_3150 + class_1.var_2884.var_132 + class_107.var_4955 + class_291.var_6732 + class_170.var_6625 + class_291.var_7201 + class_89.var_4330 + name_85[class_146.var_6086]));
               }
            }
            ...
            {
               if(class_89.var_4444 > this.var_397)
               {
      ...
      public function name_10(param1:String = null) : void
      {
         ...
         if(class_183.var_7129 == this.var_392.length)
         {
            if(!this.var_393)
            {
               class_143.method_955(class_102.var_4741);
            }
            return;
         }
         ...
         if(this.var_393)
         {
            ...
            {
               class_293.method_2855(class_162.var_6237 + _loc2_ + class_89.var_4412 + _loc3_ + class_162.var_6236);
            }
            else
            {
         ...
         {
            class_143.method_955(class_9.var_3149 + _loc3_ + class_60.var_3876);
         }
      ...
      public function method_321(param1:String) : void
      {
         ...
         while(_loc3_.length)
         {
            ...
            _loc3_.splice(_loc5_,class_33.var_3679);
         }
      }
   }
}
