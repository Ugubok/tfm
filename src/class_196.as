package
{
   ...
   public class class_196 extends class_66
   {
      ...
      public static const const_602:RegExp = new RegExp("^(?:\\d{1,3}|@\\d{4,})$");
      ...
      public function class_196()
      {
         ...
         method_216(new class_245(class_243.const_642,class_92.var_4647));
         method_188(true);
         ...
         if(class_1.const_43)
         {
            ...
            this.var_1012.var_401.text = class_26.method_1668(class_146.var_6026);
            ...
            this.var_1013.var_401.text = class_26.method_1668(class_33.var_3585);
            ...
            _loc11_ = new class_24(this.var_1007.name_5,class_165.var_6506);
            _loc11_.method_216(class_245.const_647);
            _loc12_ = new class_246(class_26.method_1668(class_102.var_4761),this.var_1007.name_5,this.method_764,null,class_117.var_5264);
            _loc13_ = new class_24(_loc11_.name_5,class_33.var_3675);
            _loc14_ = new class_246(class_26.method_1668(class_107.var_5045),_loc13_.name_5 * class_121.var_5495 / class_33.var_3584,this.method_778);
         ...
         var _loc2_:class_220 = new class_220(class_9.var_3268,this.var_1007.name_5,class_183.var_7129).method_857(class_1.var_2884.var_117);
         _loc2_.htmlText = class_121.var_5462 + class_26.method_1668(class_162.var_6267,class_9.var_3268) + class_124.var_5627;
         _loc3_ = new class_24(name_5,class_33.var_3675);
         this.var_1011 = new class_244(_loc3_.name_5 - class_33.var_3675 - class_165.var_6534).method_583(class_8.method_1845()).method_864(class_54.const_285);
         this.var_1011.var_1226.type = TextFieldType.DYNAMIC;
         this.var_1011.addEventListener(FocusEvent.FOCUS_IN,this.method_776);
         _loc4_ = class_175.method_118(class_92.var_4591);
         ...
         x = class_16.var_3473;
         y = class_33.var_3675 + (-var_206 + class_183.var_7096) / class_165.var_6534;
         this.var_1008 = new class_66(class_62.var_4130,class_89.var_4444);
         this.var_1008.method_216(new class_245(class_243.const_642));
         this.var_1008.method_188();
         this.var_1006 = new class_24(this.var_1008.name_5,this.var_1008.var_206 - class_33.var_3675 - class_117.var_5287);
         ...
         this.var_1009 = new class_66(class_60.var_3945,class_121.var_5493);
         this.var_1009.method_216(new class_245(class_243.const_642,class_117.var_5287));
         this.var_1009.method_188();
         var _loc5_:class_24 = new class_24(this.var_1009.name_5,this.var_1009.var_206 - class_33.var_3675 - class_117.var_5287);
         _loc5_.method_216(new class_245(class_243.const_642));
         var _loc6_:class_220 = new class_220(class_9.var_3268,_loc5_.name_5,class_183.var_7129).method_857(class_1.var_2884.var_117).method_856(TextFormatAlign.JUSTIFY);
         ...
         this.var_1010.method_941(class_26.method_1668(class_102.var_4762));
         ...
         _loc7_.method_136(new class_246(class_26.method_1668(class_107.var_5045),this.var_1009.name_5 / class_165.var_6534 - class_33.var_3679,this.method_770));
         _loc7_.method_136(new class_246(class_26.method_1668(class_183.var_7052),this.var_1009.name_5 / class_165.var_6534 - class_33.var_3679,this.method_774,this.var_1009));
      ...
      public static function method_2752() : void
      {
         ...
         {
            class_196.var_2884.x = (class_107.var_5074 - class_196.var_2884.name_5) / class_165.var_6534;
            class_196.var_2884.y = class_33.var_3675 + (-class_196.var_2884.var_206 + class_183.var_7096) / class_165.var_6534;
            class_196.var_2884.var_1008.x = class_183.var_7129;
            class_196.var_2884.var_1008.y = class_183.var_7129;
            class_196.var_2884.method_769(class_196.var_2884.var_1008);
            class_196.var_2884.var_1009.x = class_183.var_7129;
      ...
      {
         if(param1.text == class_33.var_3587)
         {
      ...
      {
         if(param1.x != class_183.var_7129 && param1.y != class_183.var_7129)
         {
            return;
         }
         var _loc2_:class_66 = this.var_1009 == param1 ? this.var_1008 : this.var_1009;
         var _loc3_:int = x + name_5 / class_165.var_6534;
         if(class_89.var_4432 < _loc3_)
         {
            if(_loc3_ > class_60.var_3979 && (_loc2_.parent && _loc2_.x < x))
            {
               param1.x = _loc2_.x - param1.name_5 - class_165.var_6506;
            }
            else if(_loc2_.parent && _loc2_.x < x)
            {
               param1.x = x + name_5 + class_165.var_6506;
            }
            else
            {
         ...
         param1.y = y + (-param1.var_206 + var_206) / class_165.var_6534;
      }
      ...
      public function method_775(param1:Array) : void
      {
         ...
         while(++_loc2_ < _loc3_)
         {
            ...
            _loc6_.height = class_183.var_7127;
      ...
      public function method_777(param1:String) : void
      {
         ...
         _loc2_.push(class_26.method_1668(class_165.var_6437),class_1.var_2884.method_77,class_146.var_6025 + param1);
      ...
      public function method_778() : void
      {
         ...
         {
            class_1.var_2884.method_77(class_181.var_6867 + class_124.var_5647 + class_121.var_5400);
         }
         else
         {
            class_1.var_2884.method_77(class_181.var_6867 + class_124.var_5647 + this.var_1014.var_1226.text + class_124.var_5647 + class_121.var_5400);
         }
      }
