   ...
   public class class_507
   {
      ...
      public function method_1493(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            if(!this.var_2000.var_894.var_807)
            {
               ...
               {
                  this.var_2000.var_875 = class_175.method_118(class_127.var_5765);
                  this.var_2000.var_875.x = class_117.var_5287;
                  _loc2_ = this.var_2000.var_875[class_124.var_5543];
                  _loc3_ = this.var_2000.var_609.method_139() >> class_16.var_3467 & 255;
                  _loc4_ = this.var_2000.var_609.method_139() >> class_170.var_6731 & 255;
                  _loc5_ = this.var_2000.var_609.method_139() & 255;
                  _loc2_.transform.colorTransform = new ColorTransform(_loc3_ / class_181.var_6910,_loc4_ / class_181.var_6910,_loc5_ / class_181.var_6910);
               }
      ...
      public function name_2() : void
      {
         if(this.var_2020)
         {
            ...
            class_1.var_2884.method_33(class_1.method_1816() % class_165.var_6534 == class_183.var_7129 ? int(class_56.const_307) : int(class_56.const_315),this.var_2000.x,this.var_2000.y,class_33.var_3679,class_33.var_3679,false);
         }
      }
   }
}
