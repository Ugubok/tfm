package
{
   ...
   public class WingLeg implements UnitAdmire, CrashPlan
   {
      ...
      public var warlikeHeal:RequestInexpensive;
      
      public function WingLeg(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is RequestInexpensive)
            {
               this.warlikeHeal = RequestInexpensive(_loc2_);
               this.warlikeHeal.hangingAbaft = this;
            }
         }
      }
