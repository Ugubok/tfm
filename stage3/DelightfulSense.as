package
{
   ...
   public class DelightfulSense extends StupidDildo implements KotskyTasteless
   {
       
      
      public var idSequence:int;
      
      public var bagAbaft:LamentableEntertaining;
      
      public function DelightfulSense(param1:int)
      {
         super();
