package
{
   ...
   public class RequestJoyous implements RayChickens, KotskyTasteless
   {
      ...
      public var prepareComplex:CrownClub;
      
      public function RequestJoyous(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is CrownClub)
            {
               this.prepareComplex = CrownClub(_loc2_);
               this.prepareComplex.mouseWhisper = this;
            }
         }
      }
      ...
      {
         return LaborerChop.uncleRobin(NotebookJumbled.gapingHalf);
      }
   }
}
