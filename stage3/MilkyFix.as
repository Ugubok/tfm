package
{
   ...
   public class MilkyFix implements UnitAdmire, CrashPlan
   {
      ...
      public var chivalrousOrder:SqueamishDeadpan;
      
      public function MilkyFix(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is SqueamishDeadpan)
            {
               this.chivalrousOrder = SqueamishDeadpan(_loc2_);
               this.chivalrousOrder.thickFrail = this;
            }
         }
      }
