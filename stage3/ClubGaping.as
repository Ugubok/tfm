package
{
   ...
   public class ClubGaping implements RayChickens, KotskyTasteless
   {
      ...
      public var whistleOrder:NoxiousFour;
      
      public function ClubGaping(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is NoxiousFour)
            {
               this.whistleOrder = NoxiousFour(_loc2_);
               this.whistleOrder.inexpensiveCrown = this;
            }
         }
      }
      ...
      {
         return LaborerChop.uncleRobin(FlowerAnus.entertainingDeadpan);
      }
   }
}
