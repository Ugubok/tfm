package
{
   ...
   public class ApatheticDeliver implements UnitAdmire, CrashPlan
   {
      ...
      public var instructChicken:BagCompetition;
      
      public function ApatheticDeliver(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is BagCompetition)
            {
               this.instructChicken = BagCompetition(_loc2_);
               this.instructChicken.adviseApathetic = this;
            }
         }
      }
      ...
      {
         return GateStupid.waitingStupid(PatWhistle.chickenFix);
      }
   }
}
