package
{
   ...
   public class PanoramicZonked implements UnitAdmire, CrashPlan
   {
      ...
      public var agreeGrate:MarkSubdued;
      
      public function PanoramicZonked(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is MarkSubdued)
            {
               this.agreeGrate = MarkSubdued(_loc2_);
               this.agreeGrate.grateSigh = this;
            }
         }
      }
      ...
      {
         return GateStupid.waitingStupid(MarkZonked.proseMachine);
      }
   }
}
