package
{
   ...
   public class ActionHistorical implements MightyColor, InexpensiveSlip
   {
      ...
      public var partyFragile:ScintillatingInexpensive;
      
      public function ActionHistorical(param1:BalvankaSpurious)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is ScintillatingInexpensive)
            {
               this.partyFragile = ScintillatingInexpensive(_loc2_);
               this.partyFragile.anusCurved = this;
            }
         }
      }
      ...
      {
         return AlansonReligion.suzukaSisters;
      }
   }
}
