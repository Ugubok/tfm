package
{
   ...
   public class PailOranges implements RayChickens, KotskyTasteless
   {
      ...
      public var proseAnus:HateLeg;
      
      public function PailOranges(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is HateLeg)
            {
               this.proseAnus = HateLeg(_loc2_);
               this.proseAnus.superHistorical = this;
            }
         }
      }
      ...
      {
         return LaborerChop.uncleRobin(CardKuruma.healSuzuka);
      }
   }
}
