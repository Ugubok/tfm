package
{
   ...
   public class RayFaithful implements RayChickens, KotskyTasteless
   {
      ...
      public var healLight:GrateDildo;
      
      public function RayFaithful(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is GrateDildo)
            {
               this.healLight = GrateDildo(_loc2_);
               this.healLight.crackerCry = this;
            }
         }
      }
      ...
      {
         return SuzukaLaborer.pearSupply;
      }
   }
}
