package
{
   ...
   public class ArmyRecognise implements UnitAdmire, CrashPlan
   {
      ...
      public var orderAdvise:DildoThick;
      
      public function ArmyRecognise(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is DildoThick)
            {
               this.orderAdvise = DildoThick(_loc2_);
               this.orderAdvise.fragileProud = this;
            }
         }
      }
      ...
      {
         return GateStupid.waitingStupid(PearInjure.alluringJoyous);
      }
   }
}
