package
{
   ...
   public class GateJuice implements RayChickens, KotskyTasteless
   {
      ...
      public var legViolet:GullibleStupid;
      
      public function GateJuice(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is GullibleStupid)
            {
               this.legViolet = GullibleStupid(_loc2_);
               this.legViolet.trembleFix = this;
            }
         }
      }
      ...
      {
         return SuperReligion.obeisantYell;
      }
   }
}
