package
{
   ...
   public class BorrowPanoramic implements UnitAdmire, CrashPlan
   {
      ...
      public var tiresomeFaithful:ScintillatingBorrow;
      
      public function BorrowPanoramic(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is ScintillatingBorrow)
            {
               this.tiresomeFaithful = ScintillatingBorrow(_loc2_);
               this.tiresomeFaithful.listWing = this;
            }
         }
      }
      ...
      {
         return PlanAgreeable.machineGrate;
      }
   }
}
