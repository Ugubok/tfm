package
{
   ...
   public class AdaptableAlanson implements MightyColor, InexpensiveSlip
   {
      ...
      public var deadpanFrail:InexpensiveKotsky;
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               this.deadpanFrail = InexpensiveKotsky(_loc2_);
               this.seriousMighty = this;
            }
         }
      }
      ...
      {
         return OrderUnit.apatheticRare(WaitingCrib.knifeViolet);
      }
   }
}
