package
{
   ...
   public class AdaptableAlanson implements MightyColor, InexpensiveSlip
   {
      ...
      public var staleCrash:SeriousStupid;
      
      public function AdaptableAlanson(param1:BalvankaSpurious)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is SeriousStupid)
            {
               this.staleCrash = SeriousStupid(_loc2_);
               this.staleCrash.pipkaChicken = this;
            }
         }
      }
      ...
      {
         return RecogniseCompetition.prepareAgree(ConfusedPeck.metalDeadpan);
      }
   }
}
