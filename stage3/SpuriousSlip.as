package
{
   ...
   public class SpuriousSlip implements UnitAdmire
   {
      ...
      public function SpuriousSlip(param1:AlansonFrail)
      {
         super();
      ...
      {
         return GateStupid.waitingStupid(InviteReligion.hydrantBlade) + this.cryHanging.length;
      }
      ...
      {
         return UnitLook.panoramicFrail;
      }
   }
}
