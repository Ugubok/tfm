package
{
   ...
   public class CrimeFaint implements RayChickens, KotskyTasteless
   {
      ...
      public var fourBack:NoxiousCoal;
      
      public function CrimeFaint(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is NoxiousCoal)
            {
               this.fourBack = NoxiousCoal(_loc2_);
               this.fourBack.lipThick = this;
            }
         }
      }
