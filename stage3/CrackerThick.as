package
{
   ...
   public class CrackerThick implements RayChickens, KotskyTasteless
   {
      ...
      public var instructApathetic:GapingDistro;
      
      public function CrackerThick(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is GapingDistro)
            {
               this.instructApathetic = GapingDistro(_loc2_);
               this.instructApathetic.stickSense = this;
            }
         }
      }
