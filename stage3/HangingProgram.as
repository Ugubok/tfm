package
{
   ...
   public class HangingProgram implements UnitAdmire, CrashPlan
   {
      ...
      public var groundJoyous:SignTiresome;
      
      public function HangingProgram(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is SignTiresome)
            {
               this.groundJoyous = SignTiresome(_loc2_);
               this.groundJoyous.chivalrousNoxious = this;
            }
         }
      }
      ...
      {
         return GateStupid.waitingStupid(MarkZonked.injureAction);
      }
   }
}
