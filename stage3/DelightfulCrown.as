package
{
   ...
   public class DelightfulCrown implements RayChickens, KotskyTasteless
   {
      ...
      public var healSwanky:ProgramFrail;
      
      public function DelightfulCrown(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is ProgramFrail)
            {
               this.healSwanky = ProgramFrail(_loc2_);
               this.healSwanky.notebookClub = this;
            }
         }
      }
      ...
      {
         return LaborerChop.uncleRobin(StatementInjure.balvankaIcy);
      }
   }
}
