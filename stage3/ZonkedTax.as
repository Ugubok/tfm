package
{
   ...
   public class ZonkedTax implements RayChickens, KotskyTasteless
   {
      ...
      public var colorBlade:KotskyChop;
      
      public function ZonkedTax(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is KotskyChop)
            {
               this.colorBlade = KotskyChop(_loc2_);
               this.colorBlade.panoramicStomach = this;
            }
         }
      }
      ...
      {
         return SuzukaScintillating.bladeGaping;
      }
   }
}
