package
{
   ...
   public class BirdCrib implements MightyColor, InexpensiveSlip
   {
      ...
      public var coalBury:InstructSign;
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is InstructSign)
            {
               this.coalBury = InstructSign(_loc2_);
               this.inexpensiveSupply = this;
            }
         }
      }
      ...
      {
         return OrderUnit.apatheticRare(WanderingDecay.actionInstruct);
      }
   }
}
