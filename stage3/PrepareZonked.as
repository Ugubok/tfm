package
{
   ...
   public class PrepareZonked implements MightyColor, InexpensiveSlip
   {
      ...
      public var programCrib:HistoricalPrepare;
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               this.programCrib = HistoricalPrepare(_loc2_);
               this.healIllustrious = this;
            }
         }
      }
      ...
      {
         return OrderUnit.apatheticRare(PanoramicProbable.rareJoyous);
      }
   }
}
