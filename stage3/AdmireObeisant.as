package
{
   ...
   public class AdmireObeisant extends StupidDildo implements KotskyTasteless
   {
      ...
      public var chivalrousFragile:SpuriousRay;
      
      public function AdmireObeisant(param1:int, param2:String)
      {
         super();
      ...
      {
         return ScaleIcy.chopProgram + this.obtainableBurn.length;
      }
