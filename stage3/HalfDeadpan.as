package
{
   ...
   public class HalfDeadpan implements MightyColor, InexpensiveSlip
   {
      ...
      public var warlikeEntertaining:GroundAlanson;
      
      public function HalfDeadpan(param1:BalvankaSpurious)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               this.warlikeEntertaining = GroundAlanson(_loc2_);
               this.satisfyProbable = this;
            }
         }
      }
      ...
      {
         return OrderUnit.apatheticRare(PrepareLip.competitionSupply);
      }
   }
}
