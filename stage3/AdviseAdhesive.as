package
{
   ...
   public class AdviseAdhesive implements UnitAdmire, CrashPlan
   {
      ...
      public var instructCrown:YellScale;
      
      public function AdviseAdhesive(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is YellScale)
            {
               this.instructCrown = YellScale(_loc2_);
               this.instructCrown.rayLeg = this;
            }
         }
      }
      ...
      {
         return GateStupid.waitingStupid(AgonizingBird.sighMetal);
      }
   }
}
