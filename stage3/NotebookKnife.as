package
{
   ...
   public class NotebookKnife implements UnitAdmire
   {
      ...
      public function NotebookKnife(param1:AlansonFrail)
      {
         super();
      ...
      {
         return InviteReligion.hydrantBlade + this.cryHanging.length;
      }
      
      public function lecture(param1:ByteArray) : void
      {
         var _loc2_:int = param1.readShort();
         this.cryHanging = param1.readUTFBytes(_loc2_);
      }
      
      public function get suzukaGrate() : int
      {
         return GateStupid.waitingStupid(CuteConfused.crackerAnus);
      }
   }
}
