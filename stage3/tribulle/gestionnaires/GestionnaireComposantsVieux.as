package tribulle.gestionnaires
{
   ...
   public class GestionnaireComposantsVieux
   {
      ...
      public function GestionnaireComposantsVieux(param1:PrivateClass#40)
      {
         super();
      ...
      public static function getInstance() : GestionnaireComposantsVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireComposantsVieux(new PrivateClass#40());
         }
         return _singleton;
      }
...
class PrivateClass#40
{
    
   
   function PrivateClass#40()
   {
      super();
   }
}
