package tribulle.gestionnaires
{
   ...
   public class GestionnaireComposantsVieux
   {
      ...
      public function GestionnaireComposantsVieux(param1:PrivateClass#83)
      {
         super();
      ...
      public static function getInstance() : GestionnaireComposantsVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireComposantsVieux(new PrivateClass#83());
         }
         return _singleton;
      }
...
class PrivateClass#83
{
    
   
   function PrivateClass#83()
   {
      super();
   }
}
