package tribulle.gestionnaires
{
   ...
   public class GestionnaireComposantsVieux
   {
      ...
      public function GestionnaireComposantsVieux(param1:PrivateClass#69)
      {
         super();
      ...
      public static function getInstance() : GestionnaireComposantsVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireComposantsVieux(new PrivateClass#69());
         }
         return _singleton;
      }
...
class PrivateClass#69
{
    
   
   function PrivateClass#69()
   {
      super();
   }
}
