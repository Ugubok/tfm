package tribulle.gestionnaires
{
   ...
   public class GestionnaireTribuVieux
   {
      ...
      public function GestionnaireTribuVieux(param1:PrivateClass#95)
      {
         super();
      ...
      public static function getInstance() : GestionnaireTribuVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireTribuVieux(new PrivateClass#95());
         }
         return _singleton;
      }
...
class PrivateClass#95
{
    
   
   function PrivateClass#95()
   {
      super();
   }
}
