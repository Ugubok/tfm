package tribulle.gestionnaires
{
   ...
   public class GestionnaireTribuVieux
   {
      ...
      public function GestionnaireTribuVieux(param1:PrivateClass#37)
      {
         super();
      ...
      public static function getInstance() : GestionnaireTribuVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireTribuVieux(new PrivateClass#37());
         }
         return _singleton;
      }
...
class PrivateClass#37
{
    
   
   function PrivateClass#37()
   {
      super();
   }
}
