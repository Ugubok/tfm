package tribulle.gestionnaires
{
   ...
   public class GestionnaireDonneesUtilisateurVieux
   {
      ...
      public function GestionnaireDonneesUtilisateurVieux(param1:PrivateClass#108)
      {
         super();
      ...
      public static function getInstance() : GestionnaireDonneesUtilisateurVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireDonneesUtilisateurVieux(new PrivateClass#108());
         }
         return _singleton;
      }
...
class PrivateClass#108
{
    
   
   function PrivateClass#108()
   {
      super();
   }
}
