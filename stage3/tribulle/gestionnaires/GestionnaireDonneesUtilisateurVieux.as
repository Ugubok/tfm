package tribulle.gestionnaires
{
   ...
   public class GestionnaireDonneesUtilisateurVieux
   {
      ...
      public function GestionnaireDonneesUtilisateurVieux(param1:PrivateClass#41)
      {
         super();
      ...
      public static function getInstance() : GestionnaireDonneesUtilisateurVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireDonneesUtilisateurVieux(new PrivateClass#41());
         }
         return _singleton;
      }
...
class PrivateClass#41
{
    
   
   function PrivateClass#41()
   {
      super();
   }
}
