package tribulle.gestionnaires
{
   ...
   public class GestionnaireAmisVieux
   {
      ...
      public function GestionnaireAmisVieux(param1:PrivateClass#14)
      {
         super();
      ...
      public static function getInstance() : GestionnaireAmisVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireAmisVieux(new PrivateClass#14());
         }
         return _singleton;
      }
...
class PrivateClass#14
{
    
   
   function PrivateClass#14()
   {
      super();
   }
}
