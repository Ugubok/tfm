package tribulle.gestionnaires
{
   ...
   public class GestionnaireChatVieux
   {
      ...
      public function GestionnaireChatVieux(param1:PrivateClass#72)
      {
         super();
      ...
      public static function getInstance() : GestionnaireChatVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireChatVieux(new PrivateClass#72());
         }
         return _singleton;
      }
   }
...
class PrivateClass#72
{
    
   
   function PrivateClass#72()
   {
      super();
   }
}
