package tribulle.gestionnaires
{
   ...
   public class GestionnaireChatVieux
   {
      ...
      public function GestionnaireChatVieux(param1:PrivateClass#43)
      {
         super();
      ...
      public static function getInstance() : GestionnaireChatVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireChatVieux(new PrivateClass#43());
         }
         return _singleton;
      }
   }
...
class PrivateClass#43
{
    
   
   function PrivateClass#43()
   {
      super();
   }
}
