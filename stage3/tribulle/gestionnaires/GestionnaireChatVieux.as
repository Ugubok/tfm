package tribulle.gestionnaires
{
   ...
   public class GestionnaireChatVieux
   {
      ...
      public function GestionnaireChatVieux(param1:PrivateClass#27)
      {
         super();
      ...
      public static function getInstance() : GestionnaireChatVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireChatVieux(new PrivateClass#27());
         }
         return _singleton;
      }
   }
...
class PrivateClass#27
{
    
   
   function PrivateClass#27()
   {
      super();
   }
}
