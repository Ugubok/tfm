package tribulle.auto.protocole.entree
{
   ...
   public class V_ET_ResultatChangerDeGenre implements _IPaquetEntrant, _IPaquetSequenciel
   {
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is V_ST_ChangerDeGenre)
            {
               this.precedentChangerDeGenre = V_ST_ChangerDeGenre(_loc2_);
