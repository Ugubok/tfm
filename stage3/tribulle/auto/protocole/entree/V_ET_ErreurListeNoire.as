package tribulle.auto.protocole.entree
{
   ...
   public class V_ET_ErreurListeNoire implements _IPaquetEntrant, _IPaquetSequenciel
   {
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is V_ST_ListeNoire)
            {
               this.precedentListeNoire = V_ST_ListeNoire(_loc2_);
