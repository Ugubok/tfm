package
{
   ...
   public class JuiceMachine implements UnitAdmire, CrashPlan
   {
      ...
      public var rayVolcano:UnequaledArmy;
      
      public function JuiceMachine(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is UnequaledArmy)
            {
               this.rayVolcano = UnequaledArmy(_loc2_);
               this.rayVolcano.patBlade = this;
            }
         }
      }
      ...
      {
         return JoyousDelightful.distroUnit;
      }
   }
}
