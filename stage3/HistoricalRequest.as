package
{
   ...
   public class HistoricalRequest implements MightyColor
   {
      ...
      public function HistoricalRequest(param1:BalvankaSpurious)
      {
         super();
      ...
      {
         return RecogniseCompetition.prepareAgree(AdviseRobin.mouseProbable) + this.injureZonked.length + this.lookScintillating.length;
      }
