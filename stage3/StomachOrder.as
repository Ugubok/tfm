package
{
   ...
   public class StomachOrder implements UnitAdmire
   {
      ...
      public function StomachOrder(param1:AlansonFrail)
      {
         super();
      ...
      {
         return CuteConfused.trembleChivalrous + this.obtainableHysterical.length + this.knotSuper.length;
      }
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         this.knotSuper = param1.readUTFBytes(_loc3_);
      }
      
      public function get suzukaGrate() : int
      {
         return PearInjure.milkyCrown;
      }
   }
}
