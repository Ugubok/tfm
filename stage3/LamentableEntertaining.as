package
{
   ...
   public class LamentableEntertaining implements RayChickens, KotskyTasteless
   {
      ...
      public var coalArmy:DelightfulSense;
      
      public function LamentableEntertaining(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is DelightfulSense)
            {
               this.coalArmy = DelightfulSense(_loc2_);
               this.coalArmy.bagAbaft = this;
            }
         }
      }
      ...
      {
         return LaborerChop.uncleRobin(FlowerAnus.pailObeisant);
      }
   }
}
