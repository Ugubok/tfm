package
{
   ...
   public class PinusAnus implements MightyColor, InexpensiveSlip
   {
      ...
      public var decayPanoramic:FeebleWhistle;
      
      public function PinusAnus(param1:BalvankaSpurious)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is FeebleWhistle)
            {
               this.decayPanoramic = FeebleWhistle(_loc2_);
               this.decayPanoramic.dildoUnit = this;
            }
         }
      }
      ...
      {
         return GroundFour.bashfulMighty;
      }
   }
}
