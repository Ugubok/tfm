package
{
   ...
   public class CreatorCrown implements RayChickens, KotskyTasteless
   {
      ...
      public var seedStale:RaySpurious;
      
      public function CreatorCrown(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is RaySpurious)
            {
               this.seedStale = RaySpurious(_loc2_);
               this.seedStale.admireList = this;
            }
         }
      }
      ...
      {
         return SuperReligion.agreeableTax;
      }
   }
}
