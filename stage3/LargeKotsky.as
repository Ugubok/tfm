package
{
   ...
   public class LargeKotsky implements RayChickens, KotskyTasteless
   {
      ...
      public var requestMachine:InexpensiveOrange;
      
      public function LargeKotsky(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is InexpensiveOrange)
            {
               this.requestMachine = InexpensiveOrange(_loc2_);
               this.requestMachine.instructScale = this;
            }
         }
      }
