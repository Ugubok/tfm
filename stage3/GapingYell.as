package
{
   ...
   public class GapingYell extends CompanyHydrant implements CrashPlan
   {
      ...
      public var distroBurn:CuteScratch;
      
      public function GapingYell(param1:int, param2:String)
      {
         super();
      ...
      {
         return GullibleCommon.proudFour + this.seriousAgreeable.length;
      }
