package
{
   ...
   public class StupidSpurious implements MightyColor, InexpensiveSlip
   {
      ...
      public var crackerGullible:DeterminedDetermined;
      
      public function StupidSpurious(param1:BalvankaSpurious)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is DeterminedDetermined)
            {
               this.crackerGullible = DeterminedDetermined(_loc2_);
               this.crackerGullible.slipFaint = this;
            }
         }
      }
      ...
      {
         return ConfusedPeck.seriousLeg;
      }
   }
}
