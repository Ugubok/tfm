package
{
   ...
   public class AdmireHate implements UnitAdmire, CrashPlan
   {
      ...
      public var coalGround:RareHateful;
      
      public function AdmireHate(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is RareHateful)
            {
               this.coalGround = RareHateful(_loc2_);
               this.coalGround.legPlan = this;
            }
         }
      }
