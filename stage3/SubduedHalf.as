package
{
   ...
   public class SubduedHalf implements MightyColor, InexpensiveSlip
   {
      ...
      public var whistleIllustrious:RobinPrepare;
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               this.whistleIllustrious = RobinPrepare(_loc2_);
               this.whistleIllustrious.probableQuirky = this;
            }
         }
      }
      ...
      {
         return RecogniseCompetition.prepareAgree(CoalRay.violetBathe);
      }
   }
}
