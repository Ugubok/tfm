package
{
   ...
   public class SuzukaAmuse implements UnitAdmire, CrashPlan
   {
      ...
      public var tremblePlan:TouchFaithful;
      
      public function SuzukaAmuse(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is TouchFaithful)
            {
               this.tremblePlan = TouchFaithful(_loc2_);
               this.tremblePlan.waitingHalf = this;
            }
         }
      }
      ...
      {
         return GateStupid.waitingStupid(CompetitionSqueamish.laborerHate);
      }
   }
}
