package
{
   ...
   public class InviteHanging implements UnitAdmire, CrashPlan
   {
      ...
      public var scaleMouse:AdmireHeal;
      
      public function InviteHanging(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is AdmireHeal)
            {
               this.scaleMouse = AdmireHeal(_loc2_);
               this.scaleMouse.amuseDistro = this;
            }
         }
      }
      ...
      {
         return GateStupid.waitingStupid(PearInjure.mouseBabies);
      }
   }
}
