package
{
   ...
   public class OrderBashful implements RayChickens, KotskyTasteless
   {
      ...
      public var alansonSpurious:VolcanoHeal;
      
      public function OrderBashful(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is VolcanoHeal)
            {
               this.alansonSpurious = VolcanoHeal(_loc2_);
               this.alansonSpurious.pailPeck = this;
            }
         }
      }
      ...
      {
         return LaborerChop.uncleRobin(SuperReligion.fragileLarge);
      }
   }
}
