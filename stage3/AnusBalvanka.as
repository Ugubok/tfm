package
{
   ...
   public class AnusBalvanka implements MightyColor, InexpensiveSlip
   {
      ...
      public var machineAnnoying:LipKuruma;
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is LipKuruma)
            {
               this.machineAnnoying = LipKuruma(_loc2_);
               this.machineAnnoying.stayCrash = this;
            }
         }
      }
      ...
      {
         return LaborerFeeble.staleMark;
      }
   }
}
