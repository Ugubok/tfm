package
{
   ...
   public class SlipClub implements RayChickens, KotskyTasteless
   {
      ...
      public var instructScintillating:EliteTrail;
      
      public function SlipClub(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is EliteTrail)
            {
               this.instructScintillating = EliteTrail(_loc2_);
               this.instructScintillating.faithfulComplex = this;
            }
         }
      }
      ...
      {
         return DelightfulAdmire.alansonAdvise;
      }
   }
}
