package
{
   ...
   public class ChickensMighty implements UnitAdmire, CrashPlan
   {
      ...
      public var spuriousKnot:CompetitionKotsky;
      
      public function ChickensMighty(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is CompetitionKotsky)
            {
               this.spuriousKnot = CompetitionKotsky(_loc2_);
               this.spuriousKnot.stickInjure = this;
            }
         }
      }
      ...
      {
         return GateStupid.waitingStupid(AgonizingBird.creatorAgreeable);
      }
   }
}
