package
{
   ...
   public class VioletMilky implements UnitAdmire, CrashPlan
   {
      ...
      public var anusMilky:HealCrib;
      
      public function VioletMilky(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is HealCrib)
            {
               this.anusMilky = HealCrib(_loc2_);
               this.anusMilky.faithfulLamentable = this;
            }
         }
      }
      ...
      {
         return GateStupid.waitingStupid(EliteQuirky.proudProgram);
      }
   }
}
