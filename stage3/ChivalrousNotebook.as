package
{
   ...
   public class ChivalrousNotebook implements UnitAdmire, CrashPlan
   {
      ...
      public var colorBlade:VolcanoRare;
      
      public function ChivalrousNotebook(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is VolcanoRare)
            {
               this.colorBlade = VolcanoRare(_loc2_);
               this.colorBlade.slipStale = this;
            }
         }
      }
      ...
      {
         return JuiceWing.largeStatement;
      }
   }
}
