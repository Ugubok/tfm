package
{
   ...
   public class WhistleLook implements UnitAdmire, CrashPlan
   {
      ...
      public var waitingDetermined:PinusStomach;
      
      public function WhistleLook(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is PinusStomach)
            {
               this.waitingDetermined = PinusStomach(_loc2_);
               this.waitingDetermined.deadpanToe = this;
            }
         }
      }
