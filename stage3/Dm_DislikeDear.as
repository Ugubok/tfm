package
{
   ...
   public class Dm_DislikeDear extends Dm_WhistlePlough
   {
      ...
      {
         super(param1);
         this.dm_bagRight = param1.readInt();
         this.dm_pricklyLocket = param1.readByte();
         this.dm_zippyPayment = param1.readShort();
