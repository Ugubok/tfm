package
{
   ...
   public class VioletList implements UnitAdmire, CrashPlan
   {
      ...
      public var knifeWandering:BladeClub;
      
      public function VioletList(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is BladeClub)
            {
               this.knifeWandering = BladeClub(_loc2_);
               this.knifeWandering.unequaledFeeble = this;
            }
         }
      }
      ...
      {
         return GateStupid.waitingStupid(GullibleCommon.seedHydrant);
      }
   }
}
