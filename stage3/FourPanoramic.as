package
{
   ...
   public class FourPanoramic implements RayChickens, KotskyTasteless
   {
      ...
      public var wickedSerious:CurvedAir;
      
      public function FourPanoramic(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is CurvedAir)
            {
               this.wickedSerious = CurvedAir(_loc2_);
               this.wickedSerious.halfAmuse = this;
            }
         }
      }
      ...
      {
         return DeliverAlanson.joyousAgonizing;
      }
   }
}
