package
{
   ...
   public class DeterminedBathe implements RayChickens, KotskyTasteless
   {
      ...
      public var gapingCrib:StoreSisters;
      
      public function DeterminedBathe(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is StoreSisters)
            {
               this.gapingCrib = StoreSisters(_loc2_);
               this.gapingCrib.bagDeliver = this;
            }
         }
      }
      ...
      {
         return DeliverAlanson.machineLoaf;
      }
   }
}
