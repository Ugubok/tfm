package
{
   ...
   public class GroundAdaptable implements MightyColor, InexpensiveSlip
   {
      ...
      public var actionStale:KurumaWandering;
      
      public function GroundAdaptable(param1:BalvankaSpurious)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is KurumaWandering)
            {
               this.actionStale = KurumaWandering(_loc2_);
               this.prepareKnife = this;
            }
         }
      }
      ...
      {
         return OrderUnit.apatheticRare(PanoramicProbable.bladeProse);
      }
   }
}
