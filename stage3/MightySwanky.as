package
{
   ...
   public class MightySwanky implements RayChickens, KotskyTasteless
   {
      ...
      public var anusAdmire:AlansonTasteless;
      
      public function MightySwanky(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is AlansonTasteless)
            {
               this.anusAdmire = AlansonTasteless(_loc2_);
               this.anusAdmire.coalElite = this;
            }
         }
      }
      ...
      {
         return CardKuruma.programFrail;
      }
   }
}
