package
{
   ...
   public class SeriousWhistle implements MightyColor, InexpensiveSlip
   {
      ...
      public var adviseHate:MightyWandering;
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is MightyWandering)
            {
               this.adviseHate = MightyWandering(_loc2_);
               this.adviseHate.decayJumbled = this;
            }
         }
      }
      ...
      {
         return AlansonReligion.cribReligion;
      }
   }
}
