package
{
   ...
   public class WickedZonked implements UnitAdmire, CrashPlan
   {
      ...
      public var juiceNotebook:AmuseHanging;
      
      public function WickedZonked(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is AmuseHanging)
            {
               this.juiceNotebook = AmuseHanging(_loc2_);
               this.juiceNotebook.slipLight = this;
            }
         }
      }
