package
{
   ...
   public class HystericalOrange implements RayChickens, KotskyTasteless
   {
      ...
      public var gullibleDelightful:ThickColor;
      
      public function HystericalOrange(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is ThickColor)
            {
               this.gullibleDelightful = ThickColor(_loc2_);
               this.gullibleDelightful.obtainableAdhesive = this;
            }
         }
      }
