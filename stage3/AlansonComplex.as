package
{
   ...
   public class AlansonComplex implements RayChickens, KotskyTasteless
   {
      ...
      public var agreeableMilky:ObtainableArmy;
      
      public function AlansonComplex(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is ObtainableArmy)
            {
               this.agreeableMilky = ObtainableArmy(_loc2_);
               this.agreeableMilky.violetTiresome = this;
            }
         }
      }
      ...
      {
         return SuzukaScintillating.patZonked;
      }
   }
}
