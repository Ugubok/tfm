package
{
   ...
   public class CommonObtainable implements UnitAdmire, CrashPlan
   {
      ...
      public var swankyScale:RayArmy;
      
      public function CommonObtainable(param1:AlansonFrail)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is RayArmy)
            {
               this.swankyScale = RayArmy(_loc2_);
               this.swankyScale.uncleDelightful = this;
            }
         }
      }
