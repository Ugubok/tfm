package
{
   ...
   public class LamentableGaping extends PlanKotsky
   {
       
      
      public var lamentableRare:Vector.<DildoSwanky>;
      
      public function LamentableGaping(param1:ByteArray)
      {
         var _loc4_:int = 0;
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            this.lamentableRare.push(new ZonkedHalf(_loc4_,_loc5_,_loc6_,_loc7_,_loc8_,_loc9_));
            _loc3_++;
         }
      }
   }
