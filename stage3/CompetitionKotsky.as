package
{
   ...
   public class CompetitionKotsky extends CompanyHydrant implements CrashPlan
   {
       
      
      public var idSequence:int;
      
      public var stickInjure:ChickensMighty;
      
      public function CompetitionKotsky(param1:int)
      {
         super();
