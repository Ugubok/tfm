package
{
   ...
   public class HatefulSign implements MightyColor, InexpensiveSlip
   {
      ...
      public var faintList:DeterminedDetermined;
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               this.faintList = DeterminedDetermined(_loc2_);
               this.seriousStomach = this;
            }
         }
      }
      ...
      {
         return OrderUnit.apatheticRare(AdaptableInexpensive.halfDeadpan);
      }
   }
}
