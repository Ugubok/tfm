package
{
   ...
   public class BatheZonked implements MightyColor, InexpensiveSlip
   {
      ...
      public var delightfulJumbled:BabiesStore;
      
      public function BatheZonked(param1:BalvankaSpurious)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is BabiesStore)
            {
               this.delightfulJumbled = BabiesStore(_loc2_);
               this.delightfulJumbled.frailAgree = this;
            }
         }
      }
      ...
      {
         return RecogniseCompetition.prepareAgree(LipStore.adhesiveNoiseless);
      }
   }
}
