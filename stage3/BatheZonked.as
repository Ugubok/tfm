package
{
   ...
   public class BatheZonked implements MightyColor, InexpensiveSlip
   {
      ...
      public var groundPipka:TiresomeGround;
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is TiresomeGround)
            {
               this.groundPipka = TiresomeGround(_loc2_);
               this.chickenDeliver = this;
            }
         }
      }
      ...
      {
         return OrderUnit.apatheticRare(WanderingDecay.superCry);
      }
   }
}
