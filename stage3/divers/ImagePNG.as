package divers
{
   ...
   public class ImagePNG
   {
         ...
         while(_loc5_ < param1.height)
         {
            ...
            if(!param1.transparent)
            {
               ...
               while(_loc7_ < param1.width)
               {
                  ...
                  _loc4_.writeUnsignedInt(int((_loc6_ & 16777215) << 8 | 255));
                  _loc7_++;
               }
            }
            else
            {
               ...
               while(_loc7_ < param1.width)
               {
                  ...
                  _loc4_.writeUnsignedInt(int((_loc6_ & 16777215) << 8 | _loc6_ >>> 24));
                  _loc7_++;
               }
            }
            _loc5_++;
      ...
      private static function writeChunk(param1:ByteArray, param2:int, param3:ByteArray) : void
      {
         var _loc8_:* = 0;
         var _loc9_:int = 0;
         var _loc10_:int = 0;
