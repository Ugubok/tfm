package
{
   ...
   public class CompetitionApathetic implements RayChickens, KotskyTasteless
   {
      ...
      public var stomachProse:CrackerPail;
      
      public function CompetitionApathetic(param1:ComplexTouch)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is CrackerPail)
            {
               this.stomachProse = CrackerPail(_loc2_);
               this.stomachProse.violetMetal = this;
            }
         }
      }
      ...
      {
         return CuteNotebook.volcanoBerry;
      }
   }
}
