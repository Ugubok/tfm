   ...
   public class IntUtil
   {
      ...
      public static function toHex(param1:int, param2:Boolean = false) : String
      {
         ...
         if(param2)
         {
            ...
            while(_loc4_ < 4)
            {
               _loc3_ += hexChars.charAt(param1 >> (3 - _loc4_) *  12& 15) + hexChars.charAt(param1 >> (3 - _loc4_) * 8 & 15);
               _loc4_++;
            }
         }
         else
         {
            ...
            while(_loc5_ < 4)
            {
               _loc3_ += hexChars.charAt(param1 >> _loc5_ *  12& 15) + hexChars.charAt(param1 >> _loc5_ * 8 & 15);
               _loc5_++;
            }
         }
         return _loc3_;
