package
{
   ...
   public class §\x03\x06\x01\x06\b\x03\x07\x04\x07\x02\x02\x01§ implements §\x06\x07\x02\x06\x07\x05\x02\x07\b\x01\b\x07§, §\x06\x03\x06\x07\x07\x03\x06\x07\x03\x02§
   {
      ...
      public var §\x01\x01\x07\x07\x03\x06\b\b\x03\x06\x05\x05\x05§:§\x01\x04\x01\x05\x04\x04\x01\x03\b\x06§;
      
      public function §\x03\x06\x01\x06\b\x03\x07\x04\x07\x02\x02\x01§(param1:§\x05\x06\b\x02\x01\x04\x07\x05\x01\x03\x07§)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is §\x01\x04\x01\x05\x04\x04\x01\x03\b\x06§)
            {
               this.§\x01\x01\x07\x07\x03\x06\b\b\x03\x06\x05\x05\x05§ = §\x01\x04\x01\x05\x04\x04\x01\x03\b\x06§(_loc2_);
               this.§\x01\x01\x07\x07\x03\x06\b\b\x03\x06\x05\x05\x05§.§\x06\x01\x06\x01\x07\x01\x06\x06\x06\b\b\x07\x04§ = this;
            }
         }
      }
      ...
      {
         return §\x02\b\x05\x01\x06\x04\b\x01\x02§.§\x06\x07\x01\x03\x03\x04\x04\x01\x06\x05\x05§(§\x02\x04\x03\x07\x07\x01\x03\x07\b\x02\x07\x01§.§\x03\x03\x05\x05\x04\x02\x03\x05\x05\x06\x03\b\x05§);
      }
   }
}
