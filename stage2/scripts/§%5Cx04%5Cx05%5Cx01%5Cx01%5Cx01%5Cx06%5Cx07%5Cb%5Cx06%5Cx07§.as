package
{
   ...
   public class §\x04\x05\x01\x01\x01\x06\x07\b\x06\x07§ extends §\x01\x02\x07\x07\x01\x01\x06\x01\x05\x01\x01§
   {
       
      
      public var §\x07\b\x06\x02\x02\x05\x03\x02\x02\x04\x07§:Vector.<§\b\x07\x06\x07\b\x06\x03\x02\x04\x04\b§>;
      
      public function §\x04\x05\x01\x01\x01\x06\x07\b\x06\x07§(param1:ByteArray)
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            _loc4_.§\b\x06\x04\x03\b\x06\x01\x03\x05\x04§ = param1.readInt() / §\x02\x04\x03\x07\x07\x01\x03\x07\b\x02\x07\x01§.§\b\x03\x03\b\x07\x06\x05\x02\x01\x03\x05\x01§;
