package
{
   ...
   public class §\b\x07\x03\x06\b\b\x05\x04\x06\x06\x05\b\x02§ implements §\x06\x07\x02\x06\x07\x05\x02\x07\b\x01\b\x07§
   {
      ...
      public function §\b\x07\x03\x06\b\b\x05\x04\x06\x06\x05\b\x02§(param1:§\x05\x06\b\x02\x01\x04\x07\x05\x01\x03\x07§)
      {
         super();
      ...
      {
         return §\x03\x03\x01\b\x07\x05\x03\x01\x04\x03\x05\x05\x01§.§\x04\b\b\x02\x03\x07\x01\x01\b\b\x07§ + this.§\x05\b\x07\x07\x02\x06\x03\x01\x01\x07\x03\x06§.length;
      }
      
      public function lecture(param1:ByteArray) : void
      {
         var _loc2_:int = param1.readShort();
         this.§\x05\b\x07\x07\x02\x06\x03\x01\x01\x07\x03\x06§ = param1.readUTFBytes(_loc2_);
      }
