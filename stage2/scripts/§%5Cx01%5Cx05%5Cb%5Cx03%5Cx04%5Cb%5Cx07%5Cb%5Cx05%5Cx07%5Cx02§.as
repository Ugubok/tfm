package
{
   ...
   public class §\x01\x05\b\x03\x04\b\x07\b\x05\x07\x02§ implements §\x06\x07\x02\x06\x07\x05\x02\x07\b\x01\b\x07§, §\x06\x03\x06\x07\x07\x03\x06\x07\x03\x02§
   {
      ...
      public var §\x01\b\x01\x01\b\x07\x05\x02\x05\x07\x05§:§\x05\x02\x03\x03\x05\x01\x04\x03\x07\x04\x02\b\x04§;
      
      public function §\x01\x05\b\x03\x04\b\x07\b\x05\x07\x02§(param1:§\x05\x06\b\x02\x01\x04\x07\x05\x01\x03\x07§)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is §\x05\x02\x03\x03\x05\x01\x04\x03\x07\x04\x02\b\x04§)
            {
               this.§\x01\b\x01\x01\b\x07\x05\x02\x05\x07\x05§ = §\x05\x02\x03\x03\x05\x01\x04\x03\x07\x04\x02\b\x04§(_loc2_);
               this.§\x01\b\x01\x01\b\x07\x05\x02\x05\x07\x05§.§\x01\x06\b\x07\b\x02\x06\x05\x02\x05\b\x06§ = this;
            }
         }
      }
      ...
      {
         return §\x03\x01\x01\x03\b\x05\x05\x02\x03\x03\x03§.§\x04\x03\x06\x01\b\x07\b\x07\x06\x01\b\x05§;
      }
   }
}
