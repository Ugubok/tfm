package
{
   ...
   public class §\x01\x07\x06\x04\x04\b\x06\x04\x01\x03\b§ implements §\x06\x07\x02\x06\x07\x05\x02\x07\b\x01\b\x07§
   {
      ...
      public function §\x01\x07\x06\x04\x04\b\x06\x04\x01\x03\b§(param1:§\x05\x06\b\x02\x01\x04\x07\x05\x01\x03\x07§)
      {
         super();
      ...
      {
         return §\x03\x03\x01\b\x07\x05\x03\x01\x04\x03\x05\x05\x01§.§\x04\b\b\x02\x03\x07\x01\x01\b\b\x07§ + this.§\x02\x03\x05\b\b\x04\x06\x02\x07\x04\x05\x05§.length;
      }
      
      public function lecture(param1:ByteArray) : void
      {
         var _loc2_:int = param1.readShort();
         this.§\x02\x03\x05\b\b\x04\x06\x02\x07\x04\x05\x05§ = param1.readUTFBytes(_loc2_);
      }
      
      public function get §\b\x07\x01\x02\x04\x07\x03\x05\x04\x01\x02\x01§() : int
      {
         return §\x03\x01\x01\x03\b\x05\x05\x02\x03\x03\x03§.§\x01\x07\x04\x06\b\x06\b\x03\x01\x04\b§;
      }
   }
}
