package tribulle.auto.protocole.entree
{
   ...
   public class V_ET_ErreurListeRangs implements _IPaquetEntrant, _IPaquetSequenciel
   {
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is V_ST_ListeRangs)
            {
               this.precedentListeRangs = V_ST_ListeRangs(_loc2_);
