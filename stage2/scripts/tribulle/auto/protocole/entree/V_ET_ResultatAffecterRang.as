package tribulle.auto.protocole.entree
{
   ...
   public class V_ET_ResultatAffecterRang implements _IPaquetEntrant, _IPaquetSequenciel
   {
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is V_ST_AffecterRang)
            {
               this.precedentAffecterRang = V_ST_AffecterRang(_loc2_);
