package tribulle.auto.protocole.entree
{
   ...
   public class V_ET_ResultatListeRangs implements _IPaquetEntrant, _IPaquetSequenciel
   {
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         this.rangs = new Vector.<V_TT_Rang>(_loc2_);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            this.rangs[_loc3_] = V_TT_Rang.cree(param1);
            _loc3_++;
         }
         var _loc4_:_IPaquetSortant = this.connexion.recupereSequence(this.idSequence);
         if(_loc4_ != null)
         {
            if(_loc4_ is V_ST_ListeRangs)
            {
               this.precedentListeRangs = V_ST_ListeRangs(_loc4_);
