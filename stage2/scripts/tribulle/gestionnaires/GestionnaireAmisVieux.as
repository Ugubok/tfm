package tribulle.gestionnaires
{
   ...
   public class GestionnaireAmisVieux
   {
      ...
      public function GestionnaireAmisVieux(param1:PrivateClass#30)
      {
         super();
      ...
      public static function getInstance() : GestionnaireAmisVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireAmisVieux(new PrivateClass#30());
         }
         return _singleton;
      }
...
class PrivateClass#30
{
    
   
   function PrivateClass#30()
   {
      super();
   }
}
