package tribulle.gestionnaires
{
   ...
   public class GestionnaireListeNoireVieux
   {
      ...
      public function GestionnaireListeNoireVieux(param1:PrivateClass#8)
      {
      ...
      public static function getInstance() : GestionnaireListeNoireVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireListeNoireVieux(new PrivateClass#8());
         }
         return _singleton;
      }
...
class PrivateClass#8
{
    
   
   function PrivateClass#8()
   {
      super();
   }
}
