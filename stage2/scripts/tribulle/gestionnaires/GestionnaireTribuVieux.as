package tribulle.gestionnaires
{
   ...
   public class GestionnaireTribuVieux
   {
      ...
      public function GestionnaireTribuVieux(param1:PrivateClass#89)
      {
         super();
      ...
      public static function getInstance() : GestionnaireTribuVieux
      {
         if(_singleton == null)
         {
            _singleton = new GestionnaireTribuVieux(new PrivateClass#89());
         }
         return _singleton;
      }
...
class PrivateClass#89
{
    
   
   function PrivateClass#89()
   {
      super();
   }
}
