package
{
   ...
   public class §\x02\x03\x01\x07\x06\x04\b\x06\x02\x07§ implements §\x06\x07\x02\x06\x07\x05\x02\x07\b\x01\b\x07§, §\x06\x03\x06\x07\x07\x03\x06\x07\x03\x02§
   {
      ...
      public var §\x05\b\x01\x07\x02\x04\x01\x02\x07\b\b\x02\x07§:§\x04\b\x02\x06\x06\x05\x01\x01\b\x05\b\x07\b§;
      
      public function §\x02\x03\x01\x07\x06\x04\b\x06\x02\x07§(param1:§\x05\x06\b\x02\x01\x04\x07\x05\x01\x03\x07§)
      {
         super();
      ...
      public function lecture(param1:ByteArray) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_ is §\x04\b\x02\x06\x06\x05\x01\x01\b\x05\b\x07\b§)
            {
               this.§\x05\b\x01\x07\x02\x04\x01\x02\x07\b\b\x02\x07§ = §\x04\b\x02\x06\x06\x05\x01\x01\b\x05\b\x07\b§(_loc2_);
               this.§\x05\b\x01\x07\x02\x04\x01\x02\x07\b\b\x02\x07§.§\x07\x06\b\x05\b\x06\b\x02\x01\x07\b§ = this;
            }
         }
      }
