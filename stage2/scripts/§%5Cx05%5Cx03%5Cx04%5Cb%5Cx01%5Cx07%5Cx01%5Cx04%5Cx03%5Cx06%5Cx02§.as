package
{
   ...
   public class §\x05\x03\x04\b\x01\x07\x01\x04\x03\x06\x02§ implements §\x06\x07\x02\x06\x07\x05\x02\x07\b\x01\b\x07§
   {
       
      
      public var §\x02\x02\x04\x02\x06\x04\x04\x03\x04\x05\x03§:§\x05\x06\b\x02\x01\x04\x07\x05\x01\x03\x07§;
      
      public var §\x06\x02\x07\x05\x04\x01\x02\x04\x04\x04\x07\x03\x06§:int;
      
      public function §\x05\x03\x04\b\x01\x07\x01\x04\x03\x06\x02§(param1:§\x05\x06\b\x02\x01\x04\x07\x05\x01\x03\x07§)
      {
         super();
      ...
      {
         this.§\x06\x02\x07\x05\x04\x01\x02\x04\x04\x04\x07\x03\x06§ = param1.readByte();
      }
      
      public function get §\b\x07\x01\x02\x04\x07\x03\x05\x04\x01\x02\x01§() : int
      {
         return §\x04\x01\b\x06\x05\x04\x02\x05\x07\x07\x07\x03§.§\x06\x04\x05\x03\x04\x07\x06\b\x05\x06\x06\x06§;
      }
   }
}
