package
{
   ...
   public class §\x02\x07\x06\b\x07\x07\x03\x07\b§ extends §\x03\x02\x02\x06\x02\x02\x05\x05\x06\x06\x02§ implements §\x06\x03\x06\x07\x07\x03\x06\x07\x03\x02§
   {
      ...
      public var §\x02\x04\x03\x05\b\x04\x07\x05\x01\x05\x03§:§\x02\x02\x02\x02\x01\x03\x04\x06\x02\x04\x07\b§;
      
      public function §\x02\x07\x06\b\x07\x07\x03\x07\b§(param1:int, param2:String)
      {
         super();
      ...
      {
         return §\x04\x01\b\x06\x05\x04\x02\x05\x07\x07\x07\x03§.§\x03\x07\x06\x07\x06\x07\x07\x05\x03\b\b\x06§ + this.§\x03\x03\x06\x06\b\x01\x07\x01\x04\x05\x05\x02§.length;
      }
