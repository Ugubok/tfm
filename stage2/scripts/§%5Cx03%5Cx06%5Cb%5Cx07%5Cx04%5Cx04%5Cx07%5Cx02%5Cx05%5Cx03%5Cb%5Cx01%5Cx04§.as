package
{
   ...
   public class §\x03\x06\b\x07\x04\x04\x07\x02\x05\x03\b\x01\x04§ implements §\x06\x07\x02\x06\x07\x05\x02\x07\b\x01\b\x07§
   {
       
      
      public var §\x02\x02\x04\x02\x06\x04\x04\x03\x04\x05\x03§:§\x05\x06\b\x02\x01\x04\x07\x05\x01\x03\x07§;
      
      public var §\b\x01\x05\x06\x03\x03\x02\x04\x05\x06\x01§:int;
      
      public function §\x03\x06\b\x07\x04\x04\x07\x02\x05\x03\b\x01\x04§(param1:§\x05\x06\b\x02\x01\x04\x07\x05\x01\x03\x07§)
      {
         super();
      ...
      {
         this.§\b\x01\x05\x06\x03\x03\x02\x04\x05\x06\x01§ = param1.readInt();
      }
